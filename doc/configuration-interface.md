...
| `getHttpClientConfig()` | Http Client Configuration instance. See available [builder methods here](#httpclientconfiguration.builder-class). | `ReadonlyHttpClientConfiguration` |
