...
| `Note` | `String` | Optional | An optional note to associate with the checkout, as well any payments used to complete the checkout.<br>**Constraints**: *Maximum Length*: `250` | String getNote() |
