...
| `CustomerId` | `String` | Optional | The [Customer](/doc/models/customer.md) ID of the customer associated with the order.<br>**Constraints**: *Maximum Length*: `191` | String getCustomerId() |
...
| `ClosedAt` | `String` | Optional | Timestamp for when the order reached a terminal [state](/doc/models/order-state.md). In RFC 3339 format, e.g., "2016-09-04T23:59:33.123Z". | String getClosedAt() |
