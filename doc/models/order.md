...
| `CustomerId` | `String` | Optional | The ID of the [customer](/doc/models/customer.md) associated with the order.<br>**Constraints**: *Maximum Length*: `191` | String getCustomerId() |
...
| `Fulfillments` | [`List<OrderFulfillment>`](/doc/models/order-fulfillment.md) | Optional | Details about order fulfillment.<br><br>Orders can only be created with at most one fulfillment. However, orders returned<br>by the API might contain multiple fulfillments. | List<OrderFulfillment> getFulfillments() |
