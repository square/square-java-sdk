...
| `LocationId` | `String` |  | The ID of the merchant location this order is associated with. | String getLocationId() |
| `ReferenceId` | `String` | Optional | A client specified identifier to associate an entity in another system<br>with this order. | String getReferenceId() |
...
| `CustomerId` | `String` | Optional | The [Customer](#type-customer) ID of the customer associated with the order. | String getCustomerId() |
