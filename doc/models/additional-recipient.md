...
| `ReceivableId` | `String` | Optional | The unique ID for this [AdditionalRecipientReceivable](../../$m/AdditionalRecipientReceivable), assigned by the server.<br>**Constraints**: *Maximum Length*: `192` | String getReceivableId() |
