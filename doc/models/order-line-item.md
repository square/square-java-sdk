...
| `Note` | `String` | Optional | An optional note associated with the line item.<br>**Constraints**: *Maximum Length*: `2000` | String getNote() |
| `CatalogObjectId` | `String` | Optional | The [CatalogItemVariation](entity:CatalogItemVariation) ID applied to this line item.<br>**Constraints**: *Maximum Length*: `192` | String getCatalogObjectId() |
...
| `Modifiers` | [`List<OrderLineItemModifier>`](../../doc/models/order-line-item-modifier.md) | Optional | The [CatalogModifier](entity:CatalogModifier)s applied to this line item. | List<OrderLineItemModifier> getModifiers() |
