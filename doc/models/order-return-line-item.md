...
| `CatalogObjectId` | `String` | Optional | The [CatalogItemVariation](/doc/models/catalog-item-variation.md) id applied to this returned line item.<br>**Constraints**: *Maximum Length*: `192` | String getCatalogObjectId() |
| `VariationName` | `String` | Optional | The name of the variation applied to this returned line item.<br>**Constraints**: *Maximum Length*: `255` | String getVariationName() |
