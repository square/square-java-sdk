...
|  --- | --- | --- | --- | --- |
| `Id` | `String` |  | The unique ID for this refund, generated by Square. | String getId() |
...
| `LocationId` | `String` | Optional | The location ID associated with the payment this refund is attached to. | String getLocationId() |
...
| `CreatedAt` | `String` | Optional | The timestamp of when the refund was created, in RFC 3339 format. | String getCreatedAt() |
| `UpdatedAt` | `String` | Optional | The timestamp of when the refund was last updated, in RFC 3339 format. | String getUpdatedAt() |
