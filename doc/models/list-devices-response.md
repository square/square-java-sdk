...
|  --- | --- | --- | --- | --- |
| `Errors` | [`List<Error>`](../../doc/models/error.md) | Optional | Information about errors that occurred during the request. | List<Error> getErrors() |
| `Devices` | [`List<Device>`](../../doc/models/device.md) | Optional | The requested list of `Device` objects. | List<Device> getDevices() |
| `Cursor` | `String` | Optional | The pagination cursor to be used in a subsequent request. If empty,<br>this is the final response.<br>See [Pagination](https://developer.squareup.com/docs/build-basics/common-api-patterns/pagination) for more information. | String getCursor() |
