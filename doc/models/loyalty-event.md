...
|  --- | --- | --- | --- | --- |
| `Id` | `String` |  | The Square-assigned ID of the loyalty event.<br>**Constraints**: *Minimum Length*: `1` | String getId() |
| `Type` | [`String`](/doc/models/loyalty-event-type.md) |  | The type of the loyalty event. | String getType() |
| `CreatedAt` | `String` |  | The timestamp when the event was created, in RFC 3339 format.<br>**Constraints**: *Minimum Length*: `1` | String getCreatedAt() |
...
| `LoyaltyAccountId` | `String` |  | The ID of the [loyalty account](#type-LoyaltyAccount) in which the event occurred.<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `36` | String getLoyaltyAccountId() |
