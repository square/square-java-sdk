...
| `PaymentIds` | `List<String>` | Optional | The IDs of the [payments](entity:Payment) to collect.<br>The payment total must match the order total. | List<String> getPaymentIds() |
