...
| `Sellable` | `Boolean` | Optional | Whether this variation can be sold. | Boolean getSellable() |
| `Stockable` | `Boolean` | Optional | Whether stock is counted directly on this variation (TRUE) or only on its components (FALSE). | Boolean getStockable() |
