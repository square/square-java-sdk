...
| `PlanId` | `String` | Optional | The ID of the associated [subscription plan](/doc/models/catalog-subscription-plan.md). | String getPlanId() |
| `CustomerId` | `String` | Optional | The ID of the associated [customer](/doc/models/customer.md) profile. | String getCustomerId() |
