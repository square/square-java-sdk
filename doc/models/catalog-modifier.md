...
| `ImageIds` | `List<String>` | Optional | The IDs of images associated with this `CatalogModifier` instance.<br>Currently these images are not displayed by Square, but are free to be displayed in 3rd party applications. | List<String> getImageIds() |
