...
| `CatalogObjectId` | `String` | Optional | The catalog object ID referencing [CatalogDiscount](entity:CatalogDiscount).<br>**Constraints**: *Maximum Length*: `192` | String getCatalogObjectId() |
