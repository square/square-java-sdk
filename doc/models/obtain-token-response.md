...
| `IdToken` | `String` | Optional | The OpenID token belonging to this person. Only present if the<br>OPENID scope is included in the authorization request. | String getIdToken() |
