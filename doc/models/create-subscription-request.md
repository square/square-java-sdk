...
| `CustomerId` | `String` | Required | The ID of the [customer](entity:Customer) subscribing to the subscription plan.<br>**Constraints**: *Minimum Length*: `1` | String getCustomerId() |
