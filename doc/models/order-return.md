...
| `ReturnTips` | [`List<OrderReturnTip>`](../../doc/models/order-return-tip.md) | Optional | A collection of references to tips being returned for an order. | List<OrderReturnTip> getReturnTips() |
