...
|  --- | --- | --- | --- | --- |
| `Uid` | `String` | Optional | Unique ID that identifies the service charge only within this order. | String getUid() |
| `Name` | `String` | Optional | The name of the service charge. | String getName() |
| `CatalogObjectId` | `String` | Optional | The catalog object ID referencing the service charge [CatalogObject](#type-catalogobject). | String getCatalogObjectId() |
| `Percentage` | `String` | Optional | The service charge percentage as a string representation of a<br>decimal number. For example, `"7.25"` indicates a service charge of 7.25%.<br><br>Exactly 1 of `percentage` or `amount_money` should be set. | String getPercentage() |
