...
| `CatalogObjectId` | `String` | Optional | The catalog object ID referencing the service charge [CatalogObject](entity:CatalogObject).<br>**Constraints**: *Maximum Length*: `192` | String getCatalogObjectId() |
