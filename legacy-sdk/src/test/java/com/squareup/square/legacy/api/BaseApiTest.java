...
import com.squareup.square.legacy.testing.HttpCallbackCatcher;
...
public class BaseApiTest {
    ...
    protected static SquareClient createConfigurationFromEnvironment() {
        ...
        final String accessToken = System.getenv("TEST_SQUARE_TOKEN");
    ...
    protected static SquareClient createConfiguration() {
        ...
        config = config.newBuilder().httpCallback(httpResponse).build();
        return config;
    }
}
