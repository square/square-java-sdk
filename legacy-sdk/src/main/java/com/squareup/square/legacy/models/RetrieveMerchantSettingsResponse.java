...
public class RetrieveMerchantSettingsResponse {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(merchantSettings, other.merchantSettings);
    }
    ...
    public String toString() {
        return "RetrieveMerchantSettingsResponse [" + "errors=" + errors + ", merchantSettings=" + merchantSettings
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).merchantSettings(getMerchantSettings());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveMerchantSettingsResponse build() {
            RetrieveMerchantSettingsResponse model = new RetrieveMerchantSettingsResponse(errors, merchantSettings);
