...
public class CatalogPricingRule {
    ...
    protected CatalogPricingRule(
            ...
            OptionalNullable<List<String>> timePeriodIds,
            OptionalNullable<String> discountId,
            OptionalNullable<String> matchProductsId,
            OptionalNullable<String> applyProductsId,
            OptionalNullable<String> excludeProductsId,
            OptionalNullable<String> validFromDate,
            OptionalNullable<String> validFromLocalTime,
            OptionalNullable<String> validUntilDate,
            OptionalNullable<String> validUntilLocalTime,
            String excludeStrategy,
            Money minimumOrderSubtotalMoney,
            OptionalNullable<List<String>> customerGroupIdsAny) {
        this.name = name;
