...
public class ListPaymentLinksResponse {
    ...
    public String toString() {
        return "ListPaymentLinksResponse [" + "errors=" + errors + ", paymentLinks=" + paymentLinks + ", cursor="
                + cursor + "]";
    }
    ...
    public static class Builder {
        ...
        public ListPaymentLinksResponse build() {
            ListPaymentLinksResponse model = new ListPaymentLinksResponse(errors, paymentLinks, cursor);
