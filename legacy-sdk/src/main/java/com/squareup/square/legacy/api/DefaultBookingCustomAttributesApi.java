...
public final class DefaultBookingCustomAttributesApi extends BaseApi implements BookingCustomAttributesApi {
    ...
    public ListBookingCustomAttributeDefinitionsResponse listBookingCustomAttributeDefinitions(
        ...
        return prepareListBookingCustomAttributeDefinitionsRequest(limit, cursor)
                .execute();
    }
     ...
     */
    private ApiCall<ListBookingCustomAttributeDefinitionsResponse, ApiException>
            prepareListBookingCustomAttributeDefinitionsRequest(final Integer limit, final String cursor)
                    throws IOException {
        return new ApiCall.Builder<ListBookingCustomAttributeDefinitionsResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, ListBookingCustomAttributeDefinitionsResponse.class))
                        .nullify404(false)
     ...
     * @return    Returns the CreateBookingCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<CreateBookingCustomAttributeDefinitionResponse>
            createBookingCustomAttributeDefinitionAsync(final CreateBookingCustomAttributeDefinitionRequest body) {
        try {
     ...
     */
    private ApiCall<CreateBookingCustomAttributeDefinitionResponse, ApiException>
            prepareCreateBookingCustomAttributeDefinitionRequest(
        ...
        return new ApiCall.Builder<CreateBookingCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, CreateBookingCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public DeleteBookingCustomAttributeDefinitionResponse deleteBookingCustomAttributeDefinition(final String key)
     ...
     * @return    Returns the DeleteBookingCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<DeleteBookingCustomAttributeDefinitionResponse>
            deleteBookingCustomAttributeDefinitionAsync(final String key) {
        try {
     ...
     */
    private ApiCall<DeleteBookingCustomAttributeDefinitionResponse, ApiException>
            prepareDeleteBookingCustomAttributeDefinitionRequest(final String key) throws IOException {
        return new ApiCall.Builder<DeleteBookingCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, DeleteBookingCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public RetrieveBookingCustomAttributeDefinitionResponse retrieveBookingCustomAttributeDefinition(
        ...
        return prepareRetrieveBookingCustomAttributeDefinitionRequest(key, version)
                .execute();
    }
     ...
     * @return    Returns the RetrieveBookingCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<RetrieveBookingCustomAttributeDefinitionResponse>
            retrieveBookingCustomAttributeDefinitionAsync(final String key, final Integer version) {
        try {
            return prepareRetrieveBookingCustomAttributeDefinitionRequest(key, version)
                    .executeAsync();
        } catch (Exception e) {
     ...
     */
    private ApiCall<RetrieveBookingCustomAttributeDefinitionResponse, ApiException>
            prepareRetrieveBookingCustomAttributeDefinitionRequest(final String key, final Integer version)
                    throws IOException {
        return new ApiCall.Builder<RetrieveBookingCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, RetrieveBookingCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @return    Returns the UpdateBookingCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<UpdateBookingCustomAttributeDefinitionResponse>
            updateBookingCustomAttributeDefinitionAsync(
                    final String key, final UpdateBookingCustomAttributeDefinitionRequest body) {
        try {
            return prepareUpdateBookingCustomAttributeDefinitionRequest(key, body)
                    .executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
     ...
     */
    private ApiCall<UpdateBookingCustomAttributeDefinitionResponse, ApiException>
            prepareUpdateBookingCustomAttributeDefinitionRequest(
                    final String key, final UpdateBookingCustomAttributeDefinitionRequest body)
                    throws JsonProcessingException, IOException {
        return new ApiCall.Builder<UpdateBookingCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, UpdateBookingCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     */
    private ApiCall<BulkDeleteBookingCustomAttributesResponse, ApiException>
            prepareBulkDeleteBookingCustomAttributesRequest(final BulkDeleteBookingCustomAttributesRequest body)
                    throws JsonProcessingException, IOException {
        return new ApiCall.Builder<BulkDeleteBookingCustomAttributesResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, BulkDeleteBookingCustomAttributesResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     */
    private ApiCall<BulkUpsertBookingCustomAttributesResponse, ApiException>
            prepareBulkUpsertBookingCustomAttributesRequest(final BulkUpsertBookingCustomAttributesRequest body)
                    throws JsonProcessingException, IOException {
        return new ApiCall.Builder<BulkUpsertBookingCustomAttributesResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, BulkUpsertBookingCustomAttributesResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public ListBookingCustomAttributesResponse listBookingCustomAttributes(
            ...
            throws ApiException, IOException {
        return prepareListBookingCustomAttributesRequest(bookingId, limit, cursor, withDefinitions)
                .execute();
    }
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public DeleteBookingCustomAttributeResponse deleteBookingCustomAttribute(final String bookingId, final String key)
            throws ApiException, IOException {
    ...
    private ApiCall<DeleteBookingCustomAttributeResponse, ApiException> prepareDeleteBookingCustomAttributeRequest(
            final String bookingId, final String key) throws IOException {
    ...
    public RetrieveBookingCustomAttributeResponse retrieveBookingCustomAttribute(
            ...
            throws ApiException, IOException {
        return prepareRetrieveBookingCustomAttributeRequest(bookingId, key, withDefinition, version)
                .execute();
    }
    ...
    private ApiCall<RetrieveBookingCustomAttributeResponse, ApiException> prepareRetrieveBookingCustomAttributeRequest(
        ...
        return new ApiCall.Builder<RetrieveBookingCustomAttributeResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, RetrieveBookingCustomAttributeResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public CompletableFuture<UpsertBookingCustomAttributeResponse> upsertBookingCustomAttributeAsync(
            final String bookingId, final String key, final UpsertBookingCustomAttributeRequest body) {
        try {
            return prepareUpsertBookingCustomAttributeRequest(bookingId, key, body)
                    .executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
