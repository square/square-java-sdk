...
public class OrderLineItemPricingBlocklistsBlockedDiscount {
     ...
     * @param  discountCatalogObjectId  String value for discountCatalogObjectId.
     */
    protected OrderLineItemPricingBlocklistsBlockedDiscount(
    ...
    public boolean equals(Object obj) {
        ...
        OrderLineItemPricingBlocklistsBlockedDiscount other = (OrderLineItemPricingBlocklistsBlockedDiscount) obj;
    ...
    public String toString() {
        return "OrderLineItemPricingBlocklistsBlockedDiscount [" + "uid=" + uid + ", discountUid=" + discountUid
    ...
    public static class Builder {
        ...
        public OrderLineItemPricingBlocklistsBlockedDiscount build() {
            return new OrderLineItemPricingBlocklistsBlockedDiscount(uid, discountUid, discountCatalogObjectId);
        }
    }
}
