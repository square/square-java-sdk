...
public class UpdateOrderResponse {
     ...
     */
    @JsonCreator
    public UpdateOrderResponse(@JsonProperty("order") Order order, @JsonProperty("errors") List<Error> errors) {
        this.order = order;
        this.errors = errors;
    }
    ...
    public static class Builder {
        ...
        public UpdateOrderResponse build() {
            UpdateOrderResponse model = new UpdateOrderResponse(order, errors);
