...
public final class DefaultSubscriptionsApi extends BaseApi implements SubscriptionsApi {
     ...
     */
    public CreateSubscriptionResponse createSubscription(final CreateSubscriptionRequest body)
     ...
     * @return    Returns the CreateSubscriptionResponse response from the API call
     */
    public CompletableFuture<CreateSubscriptionResponse> createSubscriptionAsync(final CreateSubscriptionRequest body) {
        try {
    ...
    private ApiCall<CreateSubscriptionResponse, ApiException> prepareCreateSubscriptionRequest(
        ...
        return new ApiCall.Builder<CreateSubscriptionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CreateSubscriptionResponse.class))
                        .nullify404(false)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public BulkSwapPlanResponse bulkSwapPlan(final BulkSwapPlanRequest body) throws ApiException, IOException {
     ...
     * @return    Returns the BulkSwapPlanResponse response from the API call
     */
    public CompletableFuture<BulkSwapPlanResponse> bulkSwapPlanAsync(final BulkSwapPlanRequest body) {
        try {
     ...
     */
    private ApiCall<BulkSwapPlanResponse, ApiException> prepareBulkSwapPlanRequest(final BulkSwapPlanRequest body)
        ...
        return new ApiCall.Builder<BulkSwapPlanResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, BulkSwapPlanResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public SearchSubscriptionsResponse searchSubscriptions(final SearchSubscriptionsRequest body)
            throws ApiException, IOException {
    ...
    private ApiCall<SearchSubscriptionsResponse, ApiException> prepareSearchSubscriptionsRequest(
        ...
        return new ApiCall.Builder<SearchSubscriptionsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, SearchSubscriptionsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public RetrieveSubscriptionResponse retrieveSubscription(final String subscriptionId, final String include)
            throws ApiException, IOException {
    ...
    private ApiCall<RetrieveSubscriptionResponse, ApiException> prepareRetrieveSubscriptionRequest(
            final String subscriptionId, final String include) throws IOException {
        return new ApiCall.Builder<RetrieveSubscriptionResponse, ApiException>()
                .globalConfig(getGlobalConfiguration())
                .requestBuilder(requestBuilder -> requestBuilder
                        .server(Server.ENUM_DEFAULT.value())
                        .path("/v2/subscriptions/{subscription_id}")
                        .queryParam(param -> param.key("include").value(include).isRequired(false))
                        .templateParam(param -> param.key("subscription_id")
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RetrieveSubscriptionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public UpdateSubscriptionResponse updateSubscription(
            final String subscriptionId, final UpdateSubscriptionRequest body) throws ApiException, IOException {
    ...
    private ApiCall<UpdateSubscriptionResponse, ApiException> prepareUpdateSubscriptionRequest(
        ...
        return new ApiCall.Builder<UpdateSubscriptionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, UpdateSubscriptionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public DeleteSubscriptionActionResponse deleteSubscriptionAction(final String subscriptionId, final String actionId)
            throws ApiException, IOException {
    ...
    public CompletableFuture<DeleteSubscriptionActionResponse> deleteSubscriptionActionAsync(
        ...
        try {
            return prepareDeleteSubscriptionActionRequest(subscriptionId, actionId)
                    .executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
    ...
    private ApiCall<DeleteSubscriptionActionResponse, ApiException> prepareDeleteSubscriptionActionRequest(
            final String subscriptionId, final String actionId) throws IOException {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public CancelSubscriptionResponse cancelSubscription(final String subscriptionId) throws ApiException, IOException {
     ...
     * @return    Returns the CancelSubscriptionResponse response from the API call
     */
    public CompletableFuture<CancelSubscriptionResponse> cancelSubscriptionAsync(final String subscriptionId) {
        try {
    ...
    private ApiCall<CancelSubscriptionResponse, ApiException> prepareCancelSubscriptionRequest(
        ...
        return new ApiCall.Builder<CancelSubscriptionResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CancelSubscriptionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public ListSubscriptionEventsResponse listSubscriptionEvents(
        ...
        return prepareListSubscriptionEventsRequest(subscriptionId, cursor, limit)
                .execute();
    }
    ...
    private ApiCall<ListSubscriptionEventsResponse, ApiException> prepareListSubscriptionEventsRequest(
            final String subscriptionId, final String cursor, final Integer limit) throws IOException {
        return new ApiCall.Builder<ListSubscriptionEventsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListSubscriptionEventsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public PauseSubscriptionResponse pauseSubscription(final String subscriptionId, final PauseSubscriptionRequest body)
            throws ApiException, IOException {
    ...
    private ApiCall<PauseSubscriptionResponse, ApiException> preparePauseSubscriptionRequest(
        ...
        return new ApiCall.Builder<PauseSubscriptionResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, PauseSubscriptionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public ResumeSubscriptionResponse resumeSubscription(
            final String subscriptionId, final ResumeSubscriptionRequest body) throws ApiException, IOException {
    ...
    private ApiCall<ResumeSubscriptionResponse, ApiException> prepareResumeSubscriptionRequest(
        ...
        return new ApiCall.Builder<ResumeSubscriptionResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ResumeSubscriptionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public SwapPlanResponse swapPlan(final String subscriptionId, final SwapPlanRequest body)
            throws ApiException, IOException {
     ...
     * @return    Returns the SwapPlanResponse response from the API call
     */
    public CompletableFuture<SwapPlanResponse> swapPlanAsync(final String subscriptionId, final SwapPlanRequest body) {
        try {
    ...
    private ApiCall<SwapPlanResponse, ApiException> prepareSwapPlanRequest(
            final String subscriptionId, final SwapPlanRequest body) throws JsonProcessingException, IOException {
        return new ApiCall.Builder<SwapPlanResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, SwapPlanResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
