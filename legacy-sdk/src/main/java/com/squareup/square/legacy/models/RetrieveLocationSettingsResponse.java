...
public class RetrieveLocationSettingsResponse {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(locationSettings, other.locationSettings);
    }
    ...
    public String toString() {
        return "RetrieveLocationSettingsResponse [" + "errors=" + errors + ", locationSettings=" + locationSettings
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).locationSettings(getLocationSettings());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveLocationSettingsResponse build() {
            RetrieveLocationSettingsResponse model = new RetrieveLocationSettingsResponse(errors, locationSettings);
