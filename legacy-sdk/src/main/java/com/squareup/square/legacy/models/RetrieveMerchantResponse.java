...
public class RetrieveMerchantResponse {
    ...
    public RetrieveMerchantResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("merchant") Merchant merchant) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(merchant, other.merchant);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).merchant(getMerchant());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveMerchantResponse build() {
            RetrieveMerchantResponse model = new RetrieveMerchantResponse(errors, merchant);
