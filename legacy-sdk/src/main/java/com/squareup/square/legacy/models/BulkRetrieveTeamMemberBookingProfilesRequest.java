...
public class BulkRetrieveTeamMemberBookingProfilesRequest {
     ...
     */
    @JsonCreator
    public BulkRetrieveTeamMemberBookingProfilesRequest(@JsonProperty("team_member_ids") List<String> teamMemberIds) {
    ...
    public boolean equals(Object obj) {
        ...
        BulkRetrieveTeamMemberBookingProfilesRequest other = (BulkRetrieveTeamMemberBookingProfilesRequest) obj;
