...
public class ExternalPaymentDetails {
    ...
    protected ExternalPaymentDetails(
            String type, String source, OptionalNullable<String> sourceId, Money sourceFeeMoney) {
        this.type = type;
        this.source = source;
    ...
    public String toString() {
        return "ExternalPaymentDetails [" + "type=" + type + ", source=" + source + ", sourceId=" + sourceId
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(type, source).sourceFeeMoney(getSourceFeeMoney());
