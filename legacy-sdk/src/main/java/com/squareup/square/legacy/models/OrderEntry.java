...
public class OrderEntry {
     ...
     * @param  locationId  String value for locationId.
     */
    protected OrderEntry(OptionalNullable<String> orderId, Integer version, OptionalNullable<String> locationId) {
    ...
    public String toString() {
        return "OrderEntry [" + "orderId=" + orderId + ", version=" + version + ", locationId=" + locationId + "]";
    }
