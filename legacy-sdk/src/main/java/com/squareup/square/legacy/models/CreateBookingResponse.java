...
public class CreateBookingResponse {
     ...
     */
    @JsonCreator
    public CreateBookingResponse(@JsonProperty("booking") Booking booking, @JsonProperty("errors") List<Error> errors) {
    ...
    public static class Builder {
        ...
        public CreateBookingResponse build() {
            CreateBookingResponse model = new CreateBookingResponse(booking, errors);
