...
public class RetrieveWebhookSubscriptionResponse {
    ...
    public String toString() {
        return "RetrieveWebhookSubscriptionResponse [" + "errors=" + errors + ", subscription=" + subscription + "]";
    }
    ...
    public static class Builder {
        ...
        public RetrieveWebhookSubscriptionResponse build() {
            RetrieveWebhookSubscriptionResponse model = new RetrieveWebhookSubscriptionResponse(errors, subscription);
