...
public class LoyaltyAccountMapping {
     ...
     * @param  phoneNumber  String value for phoneNumber.
     */
    protected LoyaltyAccountMapping(String id, String createdAt, OptionalNullable<String> phoneNumber) {
        this.id = id;
        this.createdAt = createdAt;
    ...
    public String toString() {
        return "LoyaltyAccountMapping [" + "id=" + id + ", createdAt=" + createdAt + ", phoneNumber=" + phoneNumber
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().id(getId()).createdAt(getCreatedAt());
