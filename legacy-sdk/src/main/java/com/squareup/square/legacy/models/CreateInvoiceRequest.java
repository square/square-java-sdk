...
public class CreateInvoiceRequest {
    ...
    public CreateInvoiceRequest(
            @JsonProperty("invoice") Invoice invoice, @JsonProperty("idempotency_key") String idempotencyKey) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(invoice, other.invoice) && Objects.equals(idempotencyKey, other.idempotencyKey);
    }
    ...
    public String toString() {
        return "CreateInvoiceRequest [" + "invoice=" + invoice + ", idempotencyKey=" + idempotencyKey + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(invoice).idempotencyKey(getIdempotencyKey());
        return builder;
    }
