...
public class DeviceDetails {
    ...
    protected DeviceDetails(
            OptionalNullable<String> deviceId,
            OptionalNullable<String> deviceInstallationId,
            OptionalNullable<String> deviceName) {
    ...
    public String toString() {
        return "DeviceDetails [" + "deviceId=" + deviceId + ", deviceInstallationId=" + deviceInstallationId
