...
public class CreateShiftRequest {
    ...
    public CreateShiftRequest(
            @JsonProperty("shift") Shift shift, @JsonProperty("idempotency_key") String idempotencyKey) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(idempotencyKey, other.idempotencyKey) && Objects.equals(shift, other.shift);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(shift).idempotencyKey(getIdempotencyKey());
        return builder;
    }
