...
public class DeleteBookingCustomAttributeDefinitionResponse {
     ...
     */
    @JsonCreator
    public DeleteBookingCustomAttributeDefinitionResponse(@JsonProperty("errors") List<Error> errors) {
        this.errors = errors;
    }
    ...
    public boolean equals(Object obj) {
        ...
        DeleteBookingCustomAttributeDefinitionResponse other = (DeleteBookingCustomAttributeDefinitionResponse) obj;
