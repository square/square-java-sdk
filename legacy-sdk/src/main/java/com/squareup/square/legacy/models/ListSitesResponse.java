...
public class ListSitesResponse {
     ...
     */
    @JsonCreator
    public ListSitesResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("sites") List<Site> sites) {
        this.errors = errors;
        this.sites = sites;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(sites, other.sites);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).sites(getSites());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListSitesResponse build() {
            ListSitesResponse model = new ListSitesResponse(errors, sites);
