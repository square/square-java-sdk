...
public final class DefaultLocationCustomAttributesApi extends BaseApi implements LocationCustomAttributesApi {
    ...
    public ListLocationCustomAttributeDefinitionsResponse listLocationCustomAttributeDefinitions(
        ...
        return prepareListLocationCustomAttributeDefinitionsRequest(visibilityFilter, limit, cursor)
                .execute();
    }
     ...
     * @return    Returns the ListLocationCustomAttributeDefinitionsResponse response from the API call
     */
    public CompletableFuture<ListLocationCustomAttributeDefinitionsResponse>
     ...
     */
    private ApiCall<ListLocationCustomAttributeDefinitionsResponse, ApiException>
            prepareListLocationCustomAttributeDefinitionsRequest(
        ...
        return new ApiCall.Builder<ListLocationCustomAttributeDefinitionsResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, ListLocationCustomAttributeDefinitionsResponse.class))
                        .nullify404(false)
     ...
     * @return    Returns the CreateLocationCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<CreateLocationCustomAttributeDefinitionResponse>
            createLocationCustomAttributeDefinitionAsync(final CreateLocationCustomAttributeDefinitionRequest body) {
        try {
     ...
     */
    private ApiCall<CreateLocationCustomAttributeDefinitionResponse, ApiException>
            prepareCreateLocationCustomAttributeDefinitionRequest(
        ...
        return new ApiCall.Builder<CreateLocationCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, CreateLocationCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public DeleteLocationCustomAttributeDefinitionResponse deleteLocationCustomAttributeDefinition(final String key)
     ...
     * @return    Returns the DeleteLocationCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<DeleteLocationCustomAttributeDefinitionResponse>
            deleteLocationCustomAttributeDefinitionAsync(final String key) {
        try {
     ...
     */
    private ApiCall<DeleteLocationCustomAttributeDefinitionResponse, ApiException>
            prepareDeleteLocationCustomAttributeDefinitionRequest(final String key) throws IOException {
        return new ApiCall.Builder<DeleteLocationCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, DeleteLocationCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public RetrieveLocationCustomAttributeDefinitionResponse retrieveLocationCustomAttributeDefinition(
        ...
        return prepareRetrieveLocationCustomAttributeDefinitionRequest(key, version)
                .execute();
    }
     ...
     * @return    Returns the RetrieveLocationCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<RetrieveLocationCustomAttributeDefinitionResponse>
            retrieveLocationCustomAttributeDefinitionAsync(final String key, final Integer version) {
        try {
            return prepareRetrieveLocationCustomAttributeDefinitionRequest(key, version)
                    .executeAsync();
        } catch (Exception e) {
     ...
     */
    private ApiCall<RetrieveLocationCustomAttributeDefinitionResponse, ApiException>
            prepareRetrieveLocationCustomAttributeDefinitionRequest(final String key, final Integer version)
                    throws IOException {
        return new ApiCall.Builder<RetrieveLocationCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(
                                response, RetrieveLocationCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @return    Returns the UpdateLocationCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<UpdateLocationCustomAttributeDefinitionResponse>
            updateLocationCustomAttributeDefinitionAsync(
                    final String key, final UpdateLocationCustomAttributeDefinitionRequest body) {
        try {
            return prepareUpdateLocationCustomAttributeDefinitionRequest(key, body)
                    .executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
     ...
     */
    private ApiCall<UpdateLocationCustomAttributeDefinitionResponse, ApiException>
            prepareUpdateLocationCustomAttributeDefinitionRequest(
                    final String key, final UpdateLocationCustomAttributeDefinitionRequest body)
                    throws JsonProcessingException, IOException {
        return new ApiCall.Builder<UpdateLocationCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, UpdateLocationCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     */
    private ApiCall<BulkDeleteLocationCustomAttributesResponse, ApiException>
            prepareBulkDeleteLocationCustomAttributesRequest(final BulkDeleteLocationCustomAttributesRequest body)
                    throws JsonProcessingException, IOException {
        return new ApiCall.Builder<BulkDeleteLocationCustomAttributesResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, BulkDeleteLocationCustomAttributesResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     */
    private ApiCall<BulkUpsertLocationCustomAttributesResponse, ApiException>
            prepareBulkUpsertLocationCustomAttributesRequest(final BulkUpsertLocationCustomAttributesRequest body)
                    throws JsonProcessingException, IOException {
        return new ApiCall.Builder<BulkUpsertLocationCustomAttributesResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, BulkUpsertLocationCustomAttributesResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public ListLocationCustomAttributesResponse listLocationCustomAttributes(
            ...
            throws ApiException, IOException {
        return prepareListLocationCustomAttributesRequest(locationId, visibilityFilter, limit, cursor, withDefinitions)
                .execute();
    }
    ...
    public CompletableFuture<ListLocationCustomAttributesResponse> listLocationCustomAttributesAsync(
            ...
            final Boolean withDefinitions) {
        try {
            return prepareListLocationCustomAttributesRequest(
                            locationId, visibilityFilter, limit, cursor, withDefinitions)
                    .executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
    ...
    public DeleteLocationCustomAttributeResponse deleteLocationCustomAttribute(
            final String locationId, final String key) throws ApiException, IOException {
    ...
    private ApiCall<DeleteLocationCustomAttributeResponse, ApiException> prepareDeleteLocationCustomAttributeRequest(
            final String locationId, final String key) throws IOException {
        return new ApiCall.Builder<DeleteLocationCustomAttributeResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, DeleteLocationCustomAttributeResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public RetrieveLocationCustomAttributeResponse retrieveLocationCustomAttribute(
            ...
            throws ApiException, IOException {
        return prepareRetrieveLocationCustomAttributeRequest(locationId, key, withDefinition, version)
                .execute();
    }
     ...
     */
    private ApiCall<RetrieveLocationCustomAttributeResponse, ApiException>
            prepareRetrieveLocationCustomAttributeRequest(
                    final String locationId, final String key, final Boolean withDefinition, final Integer version)
                    throws IOException {
        return new ApiCall.Builder<RetrieveLocationCustomAttributeResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, RetrieveLocationCustomAttributeResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public UpsertLocationCustomAttributeResponse upsertLocationCustomAttribute(
            ...
            throws ApiException, IOException {
        return prepareUpsertLocationCustomAttributeRequest(locationId, key, body)
                .execute();
    }
    ...
    private ApiCall<UpsertLocationCustomAttributeResponse, ApiException> prepareUpsertLocationCustomAttributeRequest(
        ...
        return new ApiCall.Builder<UpsertLocationCustomAttributeResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, UpsertLocationCustomAttributeResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
