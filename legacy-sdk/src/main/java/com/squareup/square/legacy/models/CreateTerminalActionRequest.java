...
public class CreateTerminalActionRequest {
    ...
    public CreateTerminalActionRequest(
            @JsonProperty("idempotency_key") String idempotencyKey, @JsonProperty("action") TerminalAction action) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(idempotencyKey, other.idempotencyKey) && Objects.equals(action, other.action);
    }
    ...
    public String toString() {
        return "CreateTerminalActionRequest [" + "idempotencyKey=" + idempotencyKey + ", action=" + action + "]";
    }
