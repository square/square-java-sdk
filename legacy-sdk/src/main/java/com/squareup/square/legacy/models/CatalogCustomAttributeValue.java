...
public class CatalogCustomAttributeValue {
     ...
     * @param  key  String value for key.
     */
    protected CatalogCustomAttributeValue(
            OptionalNullable<String> name,
            OptionalNullable<String> stringValue,
            String customAttributeDefinitionId,
            String type,
            OptionalNullable<String> numberValue,
            OptionalNullable<Boolean> booleanValue,
            OptionalNullable<List<String>> selectionUidValues,
            String key) {
        this.name = name;
