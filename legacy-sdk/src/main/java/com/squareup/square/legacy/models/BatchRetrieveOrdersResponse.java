...
public class BatchRetrieveOrdersResponse {
    ...
    public BatchRetrieveOrdersResponse(
            @JsonProperty("orders") List<Order> orders, @JsonProperty("errors") List<Error> errors) {
        this.orders = orders;
        this.errors = errors;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(orders, other.orders) && Objects.equals(errors, other.errors);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().orders(getOrders()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public BatchRetrieveOrdersResponse build() {
            BatchRetrieveOrdersResponse model = new BatchRetrieveOrdersResponse(orders, errors);
