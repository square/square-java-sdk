...
public class CancelSubscriptionResponse {
    ...
    public String toString() {
        return "CancelSubscriptionResponse [" + "errors=" + errors + ", subscription=" + subscription + ", actions="
                + actions + "]";
    }
    ...
    public static class Builder {
        ...
        public CancelSubscriptionResponse build() {
            CancelSubscriptionResponse model = new CancelSubscriptionResponse(errors, subscription, actions);
