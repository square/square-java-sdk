...
public class ListBookingsResponse {
    ...
    public String toString() {
        return "ListBookingsResponse [" + "bookings=" + bookings + ", cursor=" + cursor + ", errors=" + errors + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().bookings(getBookings()).cursor(getCursor()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListBookingsResponse build() {
            ListBookingsResponse model = new ListBookingsResponse(bookings, cursor, errors);
