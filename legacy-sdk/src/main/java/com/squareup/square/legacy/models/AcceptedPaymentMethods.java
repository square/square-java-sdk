...
public class AcceptedPaymentMethods {
    ...
    protected AcceptedPaymentMethods(
            OptionalNullable<Boolean> applePay,
            OptionalNullable<Boolean> googlePay,
            OptionalNullable<Boolean> cashAppPay,
    ...
    public String toString() {
        return "AcceptedPaymentMethods [" + "applePay=" + applePay + ", googlePay=" + googlePay + ", cashAppPay="
                + cashAppPay + ", afterpayClearpay=" + afterpayClearpay + "]";
    }
