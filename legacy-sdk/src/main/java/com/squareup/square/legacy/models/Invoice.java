...
public class Invoice {
    ...
    protected Invoice(
            ...
            OptionalNullable<List<InvoicePaymentRequest>> paymentRequests,
            String deliveryMethod,
            OptionalNullable<String> invoiceNumber,
            OptionalNullable<String> title,
            OptionalNullable<String> description,
            OptionalNullable<String> scheduledAt,
            String publicUrl,
            ...
            OptionalNullable<String> saleOrServiceDate,
            OptionalNullable<String> paymentConditions,
