...
public class DeleteCustomerCustomAttributeResponse {
     ...
     */
    @JsonCreator
    public DeleteCustomerCustomAttributeResponse(@JsonProperty("errors") List<Error> errors) {
        this.errors = errors;
    }
    ...
    public static class Builder {
        ...
        public DeleteCustomerCustomAttributeResponse build() {
            DeleteCustomerCustomAttributeResponse model = new DeleteCustomerCustomAttributeResponse(errors);
