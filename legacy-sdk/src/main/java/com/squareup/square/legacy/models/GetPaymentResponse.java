...
public class GetPaymentResponse {
     ...
     */
    @JsonCreator
    public GetPaymentResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("payment") Payment payment) {
        this.errors = errors;
    ...
    public static class Builder {
        ...
        public GetPaymentResponse build() {
            GetPaymentResponse model = new GetPaymentResponse(errors, payment);
