...
public interface PayoutsApi {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    GetPayoutResponse getPayout(final String payoutId) throws ApiException, IOException;
     ...
     * @return    Returns the GetPayoutResponse response from the API call
     */
    CompletableFuture<GetPayoutResponse> getPayoutAsync(final String payoutId);
