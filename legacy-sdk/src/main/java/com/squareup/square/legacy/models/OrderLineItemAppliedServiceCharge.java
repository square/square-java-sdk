...
public class OrderLineItemAppliedServiceCharge {
     ...
     * @param  appliedMoney  Money value for appliedMoney.
     */
    protected OrderLineItemAppliedServiceCharge(
            String serviceChargeUid, OptionalNullable<String> uid, Money appliedMoney) {
        this.uid = uid;
        this.serviceChargeUid = serviceChargeUid;
        this.appliedMoney = appliedMoney;
    }
    ...
    public String toString() {
        return "OrderLineItemAppliedServiceCharge [" + "serviceChargeUid=" + serviceChargeUid + ", uid=" + uid
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(serviceChargeUid).appliedMoney(getAppliedMoney());
