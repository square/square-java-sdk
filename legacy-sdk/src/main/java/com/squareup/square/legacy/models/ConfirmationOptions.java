...
public class ConfirmationOptions {
     ...
     * @param  decision  ConfirmationDecision value for decision.
     */
    protected ConfirmationOptions(
            String title,
            String body,
            String agreeButtonText,
            OptionalNullable<String> disagreeButtonText,
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(title, body, agreeButtonText).decision(getDecision());
    ...
    public static class Builder {
        ...
        public ConfirmationOptions build() {
            return new ConfirmationOptions(title, body, agreeButtonText, disagreeButtonText, decision);
        }
    }
}
