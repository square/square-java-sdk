...
public class ListLocationsResponse {
    ...
    public ListLocationsResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("locations") List<Location> locations) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(locations, other.locations);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).locations(getLocations());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListLocationsResponse build() {
            ListLocationsResponse model = new ListLocationsResponse(errors, locations);
