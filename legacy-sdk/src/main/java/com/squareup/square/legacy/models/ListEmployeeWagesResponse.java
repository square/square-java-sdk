...
public class ListEmployeeWagesResponse {
    ...
    public String toString() {
        return "ListEmployeeWagesResponse [" + "employeeWages=" + employeeWages + ", cursor=" + cursor + ", errors="
                + errors + "]";
    }
    ...
    public static class Builder {
        ...
        public ListEmployeeWagesResponse build() {
            ListEmployeeWagesResponse model = new ListEmployeeWagesResponse(employeeWages, cursor, errors);
