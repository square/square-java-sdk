...
public class LoyaltyPromotionTriggerLimit {
     ...
     */
    @JsonCreator
    public LoyaltyPromotionTriggerLimit(@JsonProperty("times") int times, @JsonProperty("interval") String interval) {
        this.times = times;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(times, other.times) && Objects.equals(interval, other.interval);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(times).interval(getInterval());
        return builder;
    }
