...
public class SegmentFilter {
    ...
    public String toString() {
        return "SegmentFilter [" + "serviceVariationId=" + serviceVariationId + ", teamMemberIdFilter="
                + teamMemberIdFilter + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(serviceVariationId).teamMemberIdFilter(getTeamMemberIdFilter());
        return builder;
    }
