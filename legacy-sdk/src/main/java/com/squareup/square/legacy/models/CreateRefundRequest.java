...
public class CreateRefundRequest {
    ...
    public String toString() {
        return "CreateRefundRequest [" + "idempotencyKey=" + idempotencyKey + ", tenderId=" + tenderId
                + ", amountMoney=" + amountMoney + ", reason=" + reason + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(idempotencyKey, tenderId, amountMoney).reason(getReason());
        return builder;
    }
