...
public class UpdateCustomerCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        UpdateCustomerCustomAttributeDefinitionResponse other = (UpdateCustomerCustomAttributeDefinitionResponse) obj;
    ...
    public static class Builder {
        ...
        public UpdateCustomerCustomAttributeDefinitionResponse build() {
            UpdateCustomerCustomAttributeDefinitionResponse model =
                    new UpdateCustomerCustomAttributeDefinitionResponse(customAttributeDefinition, errors);
