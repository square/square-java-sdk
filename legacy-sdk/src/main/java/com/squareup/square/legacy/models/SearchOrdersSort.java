...
public class SearchOrdersSort {
    ...
    public SearchOrdersSort(
            @JsonProperty("sort_field") String sortField, @JsonProperty("sort_order") String sortOrder) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(sortField, other.sortField) && Objects.equals(sortOrder, other.sortOrder);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(sortField).sortOrder(getSortOrder());
        return builder;
    }
