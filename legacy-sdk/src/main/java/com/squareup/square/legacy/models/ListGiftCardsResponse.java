...
public class ListGiftCardsResponse {
    ...
    public String toString() {
        return "ListGiftCardsResponse [" + "errors=" + errors + ", giftCards=" + giftCards + ", cursor=" + cursor + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().errors(getErrors()).giftCards(getGiftCards()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListGiftCardsResponse build() {
            ListGiftCardsResponse model = new ListGiftCardsResponse(errors, giftCards, cursor);
