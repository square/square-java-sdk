...
public class UpsertCatalogObjectRequest {
    ...
    public UpsertCatalogObjectRequest(
            @JsonProperty("idempotency_key") String idempotencyKey, @JsonProperty("object") CatalogObject object) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(idempotencyKey, other.idempotencyKey) && Objects.equals(object, other.object);
    }
    ...
    public String toString() {
        return "UpsertCatalogObjectRequest [" + "idempotencyKey=" + idempotencyKey + ", object=" + object + "]";
    }
