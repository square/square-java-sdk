...
public final class DefaultEmployeesApi extends BaseApi implements EmployeesApi {
    ...
    public CompletableFuture<ListEmployeesResponse> listEmployeesAsync(
            final String locationId, final String status, final Integer limit, final String cursor) {
        try {
            return prepareListEmployeesRequest(locationId, status, limit, cursor)
                    .executeAsync();
        } catch (Exception e) {
    ...
    private ApiCall<ListEmployeesResponse, ApiException> prepareListEmployeesRequest(
            final String locationId, final String status, final Integer limit, final String cursor) throws IOException {
        return new ApiCall.Builder<ListEmployeesResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListEmployeesResponse.class))
                        .nullify404(false)
     ...
     */
    @Deprecated
    public RetrieveEmployeeResponse retrieveEmployee(final String id) throws ApiException, IOException {
     ...
     */
    @Deprecated
    public CompletableFuture<RetrieveEmployeeResponse> retrieveEmployeeAsync(final String id) {
        try {
     ...
     */
    private ApiCall<RetrieveEmployeeResponse, ApiException> prepareRetrieveEmployeeRequest(final String id)
            throws IOException {
        return new ApiCall.Builder<RetrieveEmployeeResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RetrieveEmployeeResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
