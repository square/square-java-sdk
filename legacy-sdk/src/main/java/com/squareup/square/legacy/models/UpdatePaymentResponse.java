...
public class UpdatePaymentResponse {
     ...
     */
    @JsonCreator
    public UpdatePaymentResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("payment") Payment payment) {
        this.errors = errors;
    ...
    public static class Builder {
        ...
        public UpdatePaymentResponse build() {
            UpdatePaymentResponse model = new UpdatePaymentResponse(errors, payment);
