...
public class HttpClientConfiguration implements ReadonlyHttpClientConfiguration {
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            configurationBuilder.httpStatusCodesToRetry(
                    Stream.of(408, 413, 429, 500, 502, 503, 504, 521, 522, 524).collect(Collectors.toSet()));
            configurationBuilder.httpMethodsToRetry(
                    Stream.of(Method.GET, Method.PUT).collect(Collectors.toSet()));
        }
