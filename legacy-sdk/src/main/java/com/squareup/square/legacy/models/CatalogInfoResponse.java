...
public class CatalogInfoResponse {
    ...
    public String toString() {
        return "CatalogInfoResponse [" + "errors=" + errors + ", limits=" + limits + ", standardUnitDescriptionGroup="
                + standardUnitDescriptionGroup + "]";
    }
    ...
    public static class Builder {
        ...
        public CatalogInfoResponse build() {
            CatalogInfoResponse model = new CatalogInfoResponse(errors, limits, standardUnitDescriptionGroup);
