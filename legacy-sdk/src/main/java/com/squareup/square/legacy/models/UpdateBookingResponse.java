...
public class UpdateBookingResponse {
     ...
     */
    @JsonCreator
    public UpdateBookingResponse(@JsonProperty("booking") Booking booking, @JsonProperty("errors") List<Error> errors) {
    ...
    public static class Builder {
        ...
        public UpdateBookingResponse build() {
            UpdateBookingResponse model = new UpdateBookingResponse(booking, errors);
