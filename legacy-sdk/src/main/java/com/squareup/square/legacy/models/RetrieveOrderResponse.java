...
public class RetrieveOrderResponse {
     ...
     */
    @JsonCreator
    public RetrieveOrderResponse(@JsonProperty("order") Order order, @JsonProperty("errors") List<Error> errors) {
        this.order = order;
        this.errors = errors;
    }
    ...
    public static class Builder {
        ...
        public RetrieveOrderResponse build() {
            RetrieveOrderResponse model = new RetrieveOrderResponse(order, errors);
