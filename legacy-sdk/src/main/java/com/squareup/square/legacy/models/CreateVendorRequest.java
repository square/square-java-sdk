...
public class CreateVendorRequest {
    ...
    public CreateVendorRequest(
            @JsonProperty("idempotency_key") String idempotencyKey, @JsonProperty("vendor") Vendor vendor) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(idempotencyKey, other.idempotencyKey) && Objects.equals(vendor, other.vendor);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(idempotencyKey).vendor(getVendor());
        return builder;
    }
