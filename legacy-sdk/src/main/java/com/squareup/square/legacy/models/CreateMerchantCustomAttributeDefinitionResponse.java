...
public class CreateMerchantCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CreateMerchantCustomAttributeDefinitionResponse)) {
            return false;
        }
        CreateMerchantCustomAttributeDefinitionResponse other = (CreateMerchantCustomAttributeDefinitionResponse) obj;
    ...
    public String toString() {
        return "CreateMerchantCustomAttributeDefinitionResponse [" + "customAttributeDefinition="
                + customAttributeDefinition + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link CreateMerchantCustomAttributeDefinitionResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreateMerchantCustomAttributeDefinitionResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreateMerchantCustomAttributeDefinitionResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CreateMerchantCustomAttributeDefinitionResponse} object using the set
         * fields.
         * @return {@link CreateMerchantCustomAttributeDefinitionResponse}
         */
        public CreateMerchantCustomAttributeDefinitionResponse build() {
            CreateMerchantCustomAttributeDefinitionResponse model =
                    new CreateMerchantCustomAttributeDefinitionResponse(customAttributeDefinition, errors);
