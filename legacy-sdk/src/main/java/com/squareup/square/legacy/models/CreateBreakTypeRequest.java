...
public class CreateBreakTypeRequest {
    ...
    public CreateBreakTypeRequest(
            @JsonProperty("break_type") BreakType breakType, @JsonProperty("idempotency_key") String idempotencyKey) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(idempotencyKey, other.idempotencyKey) && Objects.equals(breakType, other.breakType);
    }
    ...
    public String toString() {
        return "CreateBreakTypeRequest [" + "breakType=" + breakType + ", idempotencyKey=" + idempotencyKey + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(breakType).idempotencyKey(getIdempotencyKey());
        return builder;
    }
