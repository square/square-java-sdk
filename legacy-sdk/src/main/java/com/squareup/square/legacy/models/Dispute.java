...
public class Dispute {
    ...
    protected Dispute(
            ...
            String reason,
            String state,
            OptionalNullable<String> dueAt,
            DisputedPayment disputedPayment,
            OptionalNullable<List<String>> evidenceIds,
            String cardBrand,
            String createdAt,
            String updatedAt,
            OptionalNullable<String> brandDisputeId,
            OptionalNullable<String> reportedDate,
            OptionalNullable<String> reportedAt,
            Integer version,
