...
public class CatalogAvailabilityPeriod {
     ...
     * @param  dayOfWeek  String value for dayOfWeek.
     */
    protected CatalogAvailabilityPeriod(
            OptionalNullable<String> startLocalTime, OptionalNullable<String> endLocalTime, String dayOfWeek) {
    ...
    public String toString() {
        return "CatalogAvailabilityPeriod [" + "startLocalTime=" + startLocalTime + ", endLocalTime=" + endLocalTime
                + ", dayOfWeek=" + dayOfWeek + "]";
    }
