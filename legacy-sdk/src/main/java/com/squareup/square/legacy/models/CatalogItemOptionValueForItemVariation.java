...
public class CatalogItemOptionValueForItemVariation {
     ...
     * @param  itemOptionValueId  String value for itemOptionValueId.
     */
    protected CatalogItemOptionValueForItemVariation(
            OptionalNullable<String> itemOptionId, OptionalNullable<String> itemOptionValueId) {
    ...
    public String toString() {
        return "CatalogItemOptionValueForItemVariation [" + "itemOptionId=" + itemOptionId + ", itemOptionValueId="
                + itemOptionValueId + "]";
    }
