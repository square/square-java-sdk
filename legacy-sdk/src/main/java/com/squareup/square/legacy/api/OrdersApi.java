...
public interface OrdersApi {
     ...
     */
    CreateOrderResponse createOrder(final CreateOrderRequest body) throws ApiException, IOException;
     ...
     * @return    Returns the CreateOrderResponse response from the API call
     */
    CompletableFuture<CreateOrderResponse> createOrderAsync(final CreateOrderRequest body);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    BatchRetrieveOrdersResponse batchRetrieveOrders(final BatchRetrieveOrdersRequest body)
     ...
     * @return    Returns the BatchRetrieveOrdersResponse response from the API call
     */
    CompletableFuture<BatchRetrieveOrdersResponse> batchRetrieveOrdersAsync(final BatchRetrieveOrdersRequest body);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    CalculateOrderResponse calculateOrder(final CalculateOrderRequest body) throws ApiException, IOException;
     ...
     * @return    Returns the CalculateOrderResponse response from the API call
     */
    CompletableFuture<CalculateOrderResponse> calculateOrderAsync(final CalculateOrderRequest body);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    CloneOrderResponse cloneOrder(final CloneOrderRequest body) throws ApiException, IOException;
     ...
     * @return    Returns the CloneOrderResponse response from the API call
     */
    CompletableFuture<CloneOrderResponse> cloneOrderAsync(final CloneOrderRequest body);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    SearchOrdersResponse searchOrders(final SearchOrdersRequest body) throws ApiException, IOException;
     ...
     * @return    Returns the SearchOrdersResponse response from the API call
     */
    CompletableFuture<SearchOrdersResponse> searchOrdersAsync(final SearchOrdersRequest body);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    RetrieveOrderResponse retrieveOrder(final String orderId) throws ApiException, IOException;
     ...
     * @return    Returns the RetrieveOrderResponse response from the API call
     */
    CompletableFuture<RetrieveOrderResponse> retrieveOrderAsync(final String orderId);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    UpdateOrderResponse updateOrder(final String orderId, final UpdateOrderRequest body)
            throws ApiException, IOException;
     ...
     * @return    Returns the UpdateOrderResponse response from the API call
     */
    CompletableFuture<UpdateOrderResponse> updateOrderAsync(final String orderId, final UpdateOrderRequest body);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    PayOrderResponse payOrder(final String orderId, final PayOrderRequest body) throws ApiException, IOException;
     ...
     * @return    Returns the PayOrderResponse response from the API call
     */
    CompletableFuture<PayOrderResponse> payOrderAsync(final String orderId, final PayOrderRequest body);
}
