...
public class CatalogItemVariation {
     ...
     * @param  stockableConversion  CatalogStockConversion value for stockableConversion.
     */
    protected CatalogItemVariation(
            OptionalNullable<String> itemId,
            OptionalNullable<String> name,
            OptionalNullable<String> sku,
            OptionalNullable<String> upc,
            Integer ordinal,
            String pricingType,
            Money priceMoney,
            OptionalNullable<List<ItemVariationLocationOverrides>> locationOverrides,
            OptionalNullable<Boolean> trackInventory,
            String inventoryAlertType,
            OptionalNullable<Long> inventoryAlertThreshold,
            OptionalNullable<String> userData,
            OptionalNullable<Long> serviceDuration,
            OptionalNullable<Boolean> availableForBooking,
            OptionalNullable<List<CatalogItemOptionValueForItemVariation>> itemOptionValues,
            OptionalNullable<String> measurementUnitId,
            OptionalNullable<Boolean> sellable,
            OptionalNullable<Boolean> stockable,
