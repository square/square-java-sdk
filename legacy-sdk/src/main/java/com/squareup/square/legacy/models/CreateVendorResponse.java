...
public class CreateVendorResponse {
     ...
     */
    @JsonCreator
    public CreateVendorResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("vendor") Vendor vendor) {
        this.errors = errors;
        this.vendor = vendor;
    }
    ...
    public static class Builder {
        ...
        public CreateVendorResponse build() {
            CreateVendorResponse model = new CreateVendorResponse(errors, vendor);
