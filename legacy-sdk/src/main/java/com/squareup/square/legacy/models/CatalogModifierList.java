...
public class CatalogModifierList {
    ...
    protected CatalogModifierList(
            ...
            OptionalNullable<List<CatalogObject>> modifiers,
            OptionalNullable<List<String>> imageIds,
            String modifierType,
            OptionalNullable<Integer> maxLength,
            OptionalNullable<Boolean> textRequired,
    ...
    public int hashCode() {
        return Objects.hash(
                name, ordinal, selectionType, modifiers, imageIds, modifierType, maxLength, textRequired, internalName);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().selectionType(getSelectionType()).modifierType(getModifierType());
