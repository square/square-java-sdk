...
public class PublishInvoiceRequest {
    ...
    public PublishInvoiceRequest(
            @JsonProperty("version") int version, @JsonProperty("idempotency_key") String idempotencyKey) {
    ...
    /**
     * Getter for Version.
     * The version of the [invoice](entity:Invoice) to publish. This must match the current version
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(version, other.version) && Objects.equals(idempotencyKey, other.idempotencyKey);
    }
    ...
    public String toString() {
        return "PublishInvoiceRequest [" + "version=" + version + ", idempotencyKey=" + idempotencyKey + "]";
    }
