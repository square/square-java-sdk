...
public class SearchTeamMembersResponse {
    ...
    public String toString() {
        return "SearchTeamMembersResponse [" + "teamMembers=" + teamMembers + ", cursor=" + cursor + ", errors="
                + errors + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().teamMembers(getTeamMembers()).cursor(getCursor()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public SearchTeamMembersResponse build() {
            SearchTeamMembersResponse model = new SearchTeamMembersResponse(teamMembers, cursor, errors);
