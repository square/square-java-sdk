...
public class DeleteSubscriptionActionResponse {
    ...
    public String toString() {
        return "DeleteSubscriptionActionResponse [" + "errors=" + errors + ", subscription=" + subscription + "]";
    }
    ...
    public static class Builder {
        ...
        public DeleteSubscriptionActionResponse build() {
            DeleteSubscriptionActionResponse model = new DeleteSubscriptionActionResponse(errors, subscription);
