...
public class ChangeBillingAnchorDateResponse {
    ...
    public String toString() {
        return "ChangeBillingAnchorDateResponse [" + "errors=" + errors + ", subscription=" + subscription
                + ", actions=" + actions + "]";
    }
    ...
    public static class Builder {
        ...
        public ChangeBillingAnchorDateResponse build() {
            ChangeBillingAnchorDateResponse model = new ChangeBillingAnchorDateResponse(errors, subscription, actions);
