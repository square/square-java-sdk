...
public class CreateTerminalRefundRequest {
    ...
    public CreateTerminalRefundRequest(
            @JsonProperty("idempotency_key") String idempotencyKey, @JsonProperty("refund") TerminalRefund refund) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(idempotencyKey, other.idempotencyKey) && Objects.equals(refund, other.refund);
    }
    ...
    public String toString() {
        return "CreateTerminalRefundRequest [" + "idempotencyKey=" + idempotencyKey + ", refund=" + refund + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(idempotencyKey).refund(getRefund());
        return builder;
    }
