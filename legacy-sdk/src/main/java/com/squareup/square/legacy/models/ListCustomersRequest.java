...
public class ListCustomersRequest {
     ...
     * @param  count  Boolean value for count.
     */
    protected ListCustomersRequest(
            OptionalNullable<String> cursor,
            OptionalNullable<Integer> limit,
            String sortField,
            String sortOrder,
            OptionalNullable<Boolean> count) {
        this.cursor = cursor;
        this.limit = limit;
        this.sortField = sortField;
        this.sortOrder = sortOrder;
    ...
    public String toString() {
        return "ListCustomersRequest [" + "cursor=" + cursor + ", limit=" + limit + ", sortField=" + sortField
                + ", sortOrder=" + sortOrder + ", count=" + count + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().sortField(getSortField()).sortOrder(getSortOrder());
