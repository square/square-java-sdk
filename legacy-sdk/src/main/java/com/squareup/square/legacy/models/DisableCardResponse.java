...
public class DisableCardResponse {
     ...
     */
    @JsonCreator
    public DisableCardResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("card") Card card) {
        this.errors = errors;
        this.card = card;
    }
    ...
    public static class Builder {
        ...
        public DisableCardResponse build() {
            DisableCardResponse model = new DisableCardResponse(errors, card);
