...
public class V1OrderHistoryEntry {
     ...
     */
    @JsonCreator
    public V1OrderHistoryEntry(@JsonProperty("action") String action, @JsonProperty("created_at") String createdAt) {
        this.action = action;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(action, other.action) && Objects.equals(createdAt, other.createdAt);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().action(getAction()).createdAt(getCreatedAt());
        return builder;
    }
