...
public class ListPaymentsResponse {
    ...
    public String toString() {
        return "ListPaymentsResponse [" + "errors=" + errors + ", payments=" + payments + ", cursor=" + cursor + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().errors(getErrors()).payments(getPayments()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListPaymentsResponse build() {
            ListPaymentsResponse model = new ListPaymentsResponse(errors, payments, cursor);
