...
public class GiftCardActivityLoad {
     ...
     * @param  buyerPaymentInstrumentIds  List of String value for buyerPaymentInstrumentIds.
     */
    protected GiftCardActivityLoad(
            Money amountMoney,
     ...
     * that use the Square Orders API to process orders must specify the order ID in the
    ...
    public static class Builder {
        ...
        public GiftCardActivityLoad build() {
            return new GiftCardActivityLoad(amountMoney, orderId, lineItemUid, referenceId, buyerPaymentInstrumentIds);
        }
    }
}
