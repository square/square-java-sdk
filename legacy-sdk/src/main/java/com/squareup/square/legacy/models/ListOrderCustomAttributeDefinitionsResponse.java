...
public class ListOrderCustomAttributeDefinitionsResponse {
    ...
    public boolean equals(Object obj) {
        ...
        ListOrderCustomAttributeDefinitionsResponse other = (ListOrderCustomAttributeDefinitionsResponse) obj;
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder(customAttributeDefinitions).cursor(getCursor()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListOrderCustomAttributeDefinitionsResponse build() {
            ListOrderCustomAttributeDefinitionsResponse model =
                    new ListOrderCustomAttributeDefinitionsResponse(customAttributeDefinitions, cursor, errors);
