...
public class UpdatePaymentRequest {
    ...
    public UpdatePaymentRequest(
            @JsonProperty("idempotency_key") String idempotencyKey, @JsonProperty("payment") Payment payment) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(payment, other.payment) && Objects.equals(idempotencyKey, other.idempotencyKey);
    }
    ...
    public String toString() {
        return "UpdatePaymentRequest [" + "idempotencyKey=" + idempotencyKey + ", payment=" + payment + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(idempotencyKey).payment(getPayment());
        return builder;
    }
