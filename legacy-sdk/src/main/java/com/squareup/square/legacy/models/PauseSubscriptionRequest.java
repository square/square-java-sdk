...
public class PauseSubscriptionRequest {
     ...
     * @param  pauseReason  String value for pauseReason.
     */
    protected PauseSubscriptionRequest(
            OptionalNullable<String> pauseEffectiveDate,
            OptionalNullable<Long> pauseCycleDuration,
            OptionalNullable<String> resumeEffectiveDate,
            String resumeChangeTiming,
            OptionalNullable<String> pauseReason) {
    ...
    public int hashCode() {
        return Objects.hash(
                pauseEffectiveDate, pauseCycleDuration, resumeEffectiveDate, resumeChangeTiming, pauseReason);
    }
