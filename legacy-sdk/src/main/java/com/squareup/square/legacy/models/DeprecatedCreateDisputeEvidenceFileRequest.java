...
public class DeprecatedCreateDisputeEvidenceFileRequest {
     ...
     * @param  contentType  String value for contentType.
     */
    protected DeprecatedCreateDisputeEvidenceFileRequest(
            String idempotencyKey, String evidenceType, OptionalNullable<String> contentType) {
        this.idempotencyKey = idempotencyKey;
        this.evidenceType = evidenceType;
    ...
    public boolean equals(Object obj) {
        ...
        DeprecatedCreateDisputeEvidenceFileRequest other = (DeprecatedCreateDisputeEvidenceFileRequest) obj;
    ...
    public String toString() {
        return "DeprecatedCreateDisputeEvidenceFileRequest [" + "idempotencyKey=" + idempotencyKey + ", evidenceType="
                + evidenceType + ", contentType=" + contentType + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(idempotencyKey).evidenceType(getEvidenceType());
    ...
    public static class Builder {
        ...
        public DeprecatedCreateDisputeEvidenceFileRequest build() {
            return new DeprecatedCreateDisputeEvidenceFileRequest(idempotencyKey, evidenceType, contentType);
        }
    }
}
