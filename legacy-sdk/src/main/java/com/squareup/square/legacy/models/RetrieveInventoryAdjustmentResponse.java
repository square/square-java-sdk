...
public class RetrieveInventoryAdjustmentResponse {
    ...
    public RetrieveInventoryAdjustmentResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("adjustment") InventoryAdjustment adjustment) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(adjustment, other.adjustment);
    }
    ...
    public String toString() {
        return "RetrieveInventoryAdjustmentResponse [" + "errors=" + errors + ", adjustment=" + adjustment + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).adjustment(getAdjustment());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveInventoryAdjustmentResponse build() {
            RetrieveInventoryAdjustmentResponse model = new RetrieveInventoryAdjustmentResponse(errors, adjustment);
