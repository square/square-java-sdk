...
public interface PaymentsApi {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    CreatePaymentResponse createPayment(final CreatePaymentRequest body) throws ApiException, IOException;
     ...
     * @return    Returns the CreatePaymentResponse response from the API call
     */
    CompletableFuture<CreatePaymentResponse> createPaymentAsync(final CreatePaymentRequest body);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    CancelPaymentByIdempotencyKeyResponse cancelPaymentByIdempotencyKey(final CancelPaymentByIdempotencyKeyRequest body)
            throws ApiException, IOException;
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    GetPaymentResponse getPayment(final String paymentId) throws ApiException, IOException;
     ...
     * @return    Returns the GetPaymentResponse response from the API call
     */
    CompletableFuture<GetPaymentResponse> getPaymentAsync(final String paymentId);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    UpdatePaymentResponse updatePayment(final String paymentId, final UpdatePaymentRequest body)
            throws ApiException, IOException;
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    CancelPaymentResponse cancelPayment(final String paymentId) throws ApiException, IOException;
     ...
     * @return    Returns the CancelPaymentResponse response from the API call
     */
    CompletableFuture<CancelPaymentResponse> cancelPaymentAsync(final String paymentId);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    CompletePaymentResponse completePayment(final String paymentId, final CompletePaymentRequest body)
            throws ApiException, IOException;
