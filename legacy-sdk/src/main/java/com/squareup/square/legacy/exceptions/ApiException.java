package com.squareup.square.legacy.exceptions;

import com.fasterxml.jackson.databind.JsonNode;
import com.squareup.square.legacy.models.Error;
...
public class ApiException extends CoreApiException {
    ...
    public ApiException(String reason, Context context) {
        ...
        try {
            ...
            JsonNode jsonNode =
                    CoreHelper.getMapper().readTree(context.getResponse().getBody());
            ...
            if (jsonNode.hasNonNull("errors")) {
                errors = Arrays.asList(CoreHelper.getMapper().convertValue(jsonNode.get("errors"), Error[].class));
            } else {
                errors = new ArrayList<>();
                Error.Builder v1ErrorBuilder = new Error.Builder(
                        "V1_ERROR",
