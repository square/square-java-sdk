...
import com.squareup.square.legacy.models.BulkCreateVendorsRequest;
import com.squareup.square.legacy.models.BulkCreateVendorsResponse;
import com.squareup.square.legacy.models.BulkRetrieveVendorsRequest;
import com.squareup.square.legacy.models.BulkRetrieveVendorsResponse;
import com.squareup.square.legacy.models.BulkUpdateVendorsRequest;
import com.squareup.square.legacy.models.BulkUpdateVendorsResponse;
import com.squareup.square.legacy.models.CreateVendorRequest;
import com.squareup.square.legacy.models.CreateVendorResponse;
import com.squareup.square.legacy.models.RetrieveVendorResponse;
import com.squareup.square.legacy.models.SearchVendorsRequest;
import com.squareup.square.legacy.models.SearchVendorsResponse;
import com.squareup.square.legacy.models.UpdateVendorRequest;
import com.squareup.square.legacy.models.UpdateVendorResponse;
...
public final class DefaultVendorsApi extends BaseApi implements VendorsApi {
     ...
     */
    public BulkCreateVendorsResponse bulkCreateVendors(final BulkCreateVendorsRequest body)
     ...
     * @return    Returns the BulkCreateVendorsResponse response from the API call
     */
    public CompletableFuture<BulkCreateVendorsResponse> bulkCreateVendorsAsync(final BulkCreateVendorsRequest body) {
        try {
    ...
    private ApiCall<BulkCreateVendorsResponse, ApiException> prepareBulkCreateVendorsRequest(
        ...
        return new ApiCall.Builder<BulkCreateVendorsResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, BulkCreateVendorsResponse.class))
                        .nullify404(false)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public BulkRetrieveVendorsResponse bulkRetrieveVendors(final BulkRetrieveVendorsRequest body)
            throws ApiException, IOException {
    ...
    private ApiCall<BulkRetrieveVendorsResponse, ApiException> prepareBulkRetrieveVendorsRequest(
        ...
        return new ApiCall.Builder<BulkRetrieveVendorsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, BulkRetrieveVendorsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public BulkUpdateVendorsResponse bulkUpdateVendors(final BulkUpdateVendorsRequest body)
            throws ApiException, IOException {
     ...
     * @return    Returns the BulkUpdateVendorsResponse response from the API call
     */
    public CompletableFuture<BulkUpdateVendorsResponse> bulkUpdateVendorsAsync(final BulkUpdateVendorsRequest body) {
        try {
    ...
    private ApiCall<BulkUpdateVendorsResponse, ApiException> prepareBulkUpdateVendorsRequest(
        ...
        return new ApiCall.Builder<BulkUpdateVendorsResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, BulkUpdateVendorsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public CreateVendorResponse createVendor(final CreateVendorRequest body) throws ApiException, IOException {
     ...
     * @return    Returns the CreateVendorResponse response from the API call
     */
    public CompletableFuture<CreateVendorResponse> createVendorAsync(final CreateVendorRequest body) {
        try {
     ...
     */
    private ApiCall<CreateVendorResponse, ApiException> prepareCreateVendorRequest(final CreateVendorRequest body)
        ...
        return new ApiCall.Builder<CreateVendorResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CreateVendorResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public SearchVendorsResponse searchVendors(final SearchVendorsRequest body) throws ApiException, IOException {
     ...
     * @return    Returns the SearchVendorsResponse response from the API call
     */
    public CompletableFuture<SearchVendorsResponse> searchVendorsAsync(final SearchVendorsRequest body) {
        try {
     ...
     */
    private ApiCall<SearchVendorsResponse, ApiException> prepareSearchVendorsRequest(final SearchVendorsRequest body)
            throws JsonProcessingException, IOException {
        return new ApiCall.Builder<SearchVendorsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, SearchVendorsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public RetrieveVendorResponse retrieveVendor(final String vendorId) throws ApiException, IOException {
     ...
     * @return    Returns the RetrieveVendorResponse response from the API call
     */
    public CompletableFuture<RetrieveVendorResponse> retrieveVendorAsync(final String vendorId) {
        try {
     ...
     */
    private ApiCall<RetrieveVendorResponse, ApiException> prepareRetrieveVendorRequest(final String vendorId)
            throws IOException {
        return new ApiCall.Builder<RetrieveVendorResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(
                                param -> param.key("vendor_id").value(vendorId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RetrieveVendorResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public UpdateVendorResponse updateVendor(final UpdateVendorRequest body, final String vendorId)
            throws ApiException, IOException {
    ...
    public CompletableFuture<UpdateVendorResponse> updateVendorAsync(
            final UpdateVendorRequest body, final String vendorId) {
        try {
    ...
    private ApiCall<UpdateVendorResponse, ApiException> prepareUpdateVendorRequest(
            final UpdateVendorRequest body, final String vendorId) throws JsonProcessingException, IOException {
        return new ApiCall.Builder<UpdateVendorResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.PUT))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, UpdateVendorResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
