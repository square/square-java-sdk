...
public class OrderFulfillmentDeliveryDetails {
     ...
     * @param  managedDelivery  Boolean value for managedDelivery.
     */
    protected OrderFulfillmentDeliveryDetails(
            OrderFulfillmentRecipient recipient,
            String scheduleType,
            String placedAt,
            OptionalNullable<String> deliverAt,
            OptionalNullable<String> prepTimeDuration,
            OptionalNullable<String> deliveryWindowDuration,
            ...
            OptionalNullable<String> courierPickupAt,
            OptionalNullable<String> courierPickupWindowDuration,
            OptionalNullable<Boolean> isNoContactDelivery,
            OptionalNullable<String> dropoffNotes,
            OptionalNullable<String> courierProviderName,
            OptionalNullable<String> courierSupportPhoneNumber,
            OptionalNullable<String> squareDeliveryId,
            OptionalNullable<String> externalDeliveryId,
