...
public class GetDeviceResponse {
     ...
     */
    @JsonCreator
    public GetDeviceResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("device") Device device) {
        this.errors = errors;
        this.device = device;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(device, other.device);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).device(getDevice());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public GetDeviceResponse build() {
            GetDeviceResponse model = new GetDeviceResponse(errors, device);
