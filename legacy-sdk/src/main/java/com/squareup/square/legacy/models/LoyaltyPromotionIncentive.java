...
public class LoyaltyPromotionIncentive {
    ...
    public String toString() {
        return "LoyaltyPromotionIncentive [" + "type=" + type + ", pointsMultiplierData=" + pointsMultiplierData
                + ", pointsAdditionData=" + pointsAdditionData + "]";
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder pointsMultiplierData(LoyaltyPromotionIncentivePointsMultiplierData pointsMultiplierData) {
            this.pointsMultiplierData = pointsMultiplierData;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder pointsAdditionData(LoyaltyPromotionIncentivePointsAdditionData pointsAdditionData) {
            this.pointsAdditionData = pointsAdditionData;
            return this;
        }
