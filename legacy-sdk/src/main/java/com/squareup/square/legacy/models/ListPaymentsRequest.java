...
public class ListPaymentsRequest {
    ...
    protected ListPaymentsRequest(
            ...
            OptionalNullable<Long> total,
            OptionalNullable<String> last4,
            OptionalNullable<String> cardBrand,
            OptionalNullable<Integer> limit,
            OptionalNullable<Boolean> isOfflinePayment,
            OptionalNullable<String> offlineBeginTime,
            OptionalNullable<String> offlineEndTime,
            OptionalNullable<String> updatedAtBeginTime,
            OptionalNullable<String> updatedAtEndTime,
            String sortField) {
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().sortField(getSortField());
