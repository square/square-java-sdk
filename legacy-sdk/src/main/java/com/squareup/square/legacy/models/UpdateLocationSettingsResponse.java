...
public class UpdateLocationSettingsResponse {
    ...
    public String toString() {
        return "UpdateLocationSettingsResponse [" + "errors=" + errors + ", locationSettings=" + locationSettings + "]";
    }
    ...
    public static class Builder {
        ...
        public UpdateLocationSettingsResponse build() {
            UpdateLocationSettingsResponse model = new UpdateLocationSettingsResponse(errors, locationSettings);
