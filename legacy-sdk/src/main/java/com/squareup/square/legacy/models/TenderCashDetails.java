...
public class TenderCashDetails {
    ...
    public String toString() {
        return "TenderCashDetails [" + "buyerTenderedMoney=" + buyerTenderedMoney + ", changeBackMoney="
                + changeBackMoney + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().buyerTenderedMoney(getBuyerTenderedMoney()).changeBackMoney(getChangeBackMoney());
        return builder;
    }
