...
public interface MerchantCustomAttributesApi {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    DeleteMerchantCustomAttributeDefinitionResponse deleteMerchantCustomAttributeDefinition(final String key)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    DeleteMerchantCustomAttributeResponse deleteMerchantCustomAttribute(final String merchantId, final String key)
            throws ApiException, IOException;
