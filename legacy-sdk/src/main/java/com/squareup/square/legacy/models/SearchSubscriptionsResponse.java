...
public class SearchSubscriptionsResponse {
    ...
    public String toString() {
        return "SearchSubscriptionsResponse [" + "errors=" + errors + ", subscriptions=" + subscriptions + ", cursor="
                + cursor + "]";
    }
    ...
    public static class Builder {
        ...
        public SearchSubscriptionsResponse build() {
            SearchSubscriptionsResponse model = new SearchSubscriptionsResponse(errors, subscriptions, cursor);
