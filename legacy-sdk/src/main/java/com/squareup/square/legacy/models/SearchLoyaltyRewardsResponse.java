...
public class SearchLoyaltyRewardsResponse {
    ...
    public String toString() {
        return "SearchLoyaltyRewardsResponse [" + "errors=" + errors + ", rewards=" + rewards + ", cursor=" + cursor
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().errors(getErrors()).rewards(getRewards()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public SearchLoyaltyRewardsResponse build() {
            SearchLoyaltyRewardsResponse model = new SearchLoyaltyRewardsResponse(errors, rewards, cursor);
