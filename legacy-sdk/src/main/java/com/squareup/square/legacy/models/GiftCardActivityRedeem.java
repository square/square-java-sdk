...
public class GiftCardActivityRedeem {
     ...
     * @param  status  String value for status.
     */
    protected GiftCardActivityRedeem(
            Money amountMoney, String paymentId, OptionalNullable<String> referenceId, String status) {
        this.amountMoney = amountMoney;
        this.paymentId = paymentId;
    ...
    public String toString() {
        return "GiftCardActivityRedeem [" + "amountMoney=" + amountMoney + ", paymentId=" + paymentId + ", referenceId="
                + referenceId + ", status=" + status + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(amountMoney).paymentId(getPaymentId()).status(getStatus());
