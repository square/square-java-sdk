...
public class TenderBuyNowPayLaterDetails {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(buyNowPayLaterBrand, other.buyNowPayLaterBrand) && Objects.equals(status, other.status);
    }
    ...
    public String toString() {
        return "TenderBuyNowPayLaterDetails [" + "buyNowPayLaterBrand=" + buyNowPayLaterBrand + ", status=" + status
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().buyNowPayLaterBrand(getBuyNowPayLaterBrand()).status(getStatus());
        return builder;
    }
