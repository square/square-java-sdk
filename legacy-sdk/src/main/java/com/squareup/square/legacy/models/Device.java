...
public class Device {
     ...
     */
    protected Device(
            DeviceAttributes attributes, String id, OptionalNullable<List<Component>> components, DeviceStatus status) {
        this.id = id;
        this.attributes = attributes;
    ...
    public String toString() {
        return "Device [" + "attributes=" + attributes + ", id=" + id + ", components=" + components + ", status="
                + status + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(attributes).id(getId()).status(getStatus());
