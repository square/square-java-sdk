...
public class PayOrderResponse {
     ...
     */
    @JsonCreator
    public PayOrderResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("order") Order order) {
        this.errors = errors;
        this.order = order;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(order, other.order);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).order(getOrder());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public PayOrderResponse build() {
            PayOrderResponse model = new PayOrderResponse(errors, order);
