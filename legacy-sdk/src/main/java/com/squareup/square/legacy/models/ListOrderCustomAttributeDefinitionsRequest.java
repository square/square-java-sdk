...
public class ListOrderCustomAttributeDefinitionsRequest {
     ...
     * @param  limit  Integer value for limit.
     */
    protected ListOrderCustomAttributeDefinitionsRequest(
            String visibilityFilter, OptionalNullable<String> cursor, OptionalNullable<Integer> limit) {
        this.visibilityFilter = visibilityFilter;
        this.cursor = cursor;
        this.limit = limit;
    }
    ...
    public boolean equals(Object obj) {
        ...
        ListOrderCustomAttributeDefinitionsRequest other = (ListOrderCustomAttributeDefinitionsRequest) obj;
    ...
    public String toString() {
        return "ListOrderCustomAttributeDefinitionsRequest [" + "visibilityFilter=" + visibilityFilter + ", cursor="
                + cursor + ", limit=" + limit + "]";
    }
