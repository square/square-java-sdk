...
import com.squareup.square.legacy.models.DisableEventsResponse;
import com.squareup.square.legacy.models.EnableEventsResponse;
import com.squareup.square.legacy.models.ListEventTypesResponse;
import com.squareup.square.legacy.models.SearchEventsRequest;
import com.squareup.square.legacy.models.SearchEventsResponse;
...
public final class DefaultEventsApi extends BaseApi implements EventsApi {
     ...
     */
    public SearchEventsResponse searchEvents(final SearchEventsRequest body) throws ApiException, IOException {
     ...
     * @return    Returns the SearchEventsResponse response from the API call
     */
    public CompletableFuture<SearchEventsResponse> searchEventsAsync(final SearchEventsRequest body) {
        try {
     ...
     */
    private ApiCall<SearchEventsResponse, ApiException> prepareSearchEventsRequest(final SearchEventsRequest body)
        ...
        return new ApiCall.Builder<SearchEventsResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, SearchEventsResponse.class))
                        .nullify404(false)
    ...
    private ApiCall<DisableEventsResponse, ApiException> prepareDisableEventsRequest() throws IOException {
        return new ApiCall.Builder<DisableEventsResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, DisableEventsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    private ApiCall<EnableEventsResponse, ApiException> prepareEnableEventsRequest() throws IOException {
        return new ApiCall.Builder<EnableEventsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.PUT))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, EnableEventsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public ListEventTypesResponse listEventTypes(final String apiVersion) throws ApiException, IOException {
     ...
     * @return    Returns the ListEventTypesResponse response from the API call
     */
    public CompletableFuture<ListEventTypesResponse> listEventTypesAsync(final String apiVersion) {
        try {
     ...
     */
    private ApiCall<ListEventTypesResponse, ApiException> prepareListEventTypesRequest(final String apiVersion)
            throws IOException {
        return new ApiCall.Builder<ListEventTypesResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListEventTypesResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
