...
public class CreateLoyaltyPromotionResponse {
    ...
    public String toString() {
        return "CreateLoyaltyPromotionResponse [" + "errors=" + errors + ", loyaltyPromotion=" + loyaltyPromotion + "]";
    }
    ...
    public static class Builder {
        ...
        public CreateLoyaltyPromotionResponse build() {
            CreateLoyaltyPromotionResponse model = new CreateLoyaltyPromotionResponse(errors, loyaltyPromotion);
