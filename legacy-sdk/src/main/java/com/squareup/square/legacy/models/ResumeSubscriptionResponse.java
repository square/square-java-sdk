...
public class ResumeSubscriptionResponse {
    ...
    public String toString() {
        return "ResumeSubscriptionResponse [" + "errors=" + errors + ", subscription=" + subscription + ", actions="
                + actions + "]";
    }
    ...
    public static class Builder {
        ...
        public ResumeSubscriptionResponse build() {
            ResumeSubscriptionResponse model = new ResumeSubscriptionResponse(errors, subscription, actions);
