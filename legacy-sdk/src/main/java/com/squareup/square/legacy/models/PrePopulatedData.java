...
public class PrePopulatedData {
     ...
     * @param  buyerAddress  Address value for buyerAddress.
     */
    protected PrePopulatedData(
            OptionalNullable<String> buyerEmail, OptionalNullable<String> buyerPhoneNumber, Address buyerAddress) {
    ...
    public String toString() {
        return "PrePopulatedData [" + "buyerEmail=" + buyerEmail + ", buyerPhoneNumber=" + buyerPhoneNumber
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().buyerAddress(getBuyerAddress());
