...
public class ModifierLocationOverrides {
     ...
     * @param  soldOut  Boolean value for soldOut.
     */
    protected ModifierLocationOverrides(OptionalNullable<String> locationId, Money priceMoney, Boolean soldOut) {
    ...
    public String toString() {
        return "ModifierLocationOverrides [" + "locationId=" + locationId + ", priceMoney=" + priceMoney + ", soldOut="
                + soldOut + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().priceMoney(getPriceMoney()).soldOut(getSoldOut());
