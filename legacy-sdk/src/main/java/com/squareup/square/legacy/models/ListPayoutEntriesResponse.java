...
public class ListPayoutEntriesResponse {
    ...
    public String toString() {
        return "ListPayoutEntriesResponse [" + "payoutEntries=" + payoutEntries + ", cursor=" + cursor + ", errors="
                + errors + "]";
    }
    ...
    public static class Builder {
        ...
        public ListPayoutEntriesResponse build() {
            ListPayoutEntriesResponse model = new ListPayoutEntriesResponse(payoutEntries, cursor, errors);
