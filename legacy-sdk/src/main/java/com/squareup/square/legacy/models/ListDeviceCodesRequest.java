...
public class ListDeviceCodesRequest {
     ...
     * @param  status  List of String value for status.
     */
    protected ListDeviceCodesRequest(
    ...
    public String toString() {
        return "ListDeviceCodesRequest [" + "cursor=" + cursor + ", locationId=" + locationId + ", productType="
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().productType(getProductType());
