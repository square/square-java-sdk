...
public class ListCashDrawerShiftEventsRequest {
     ...
     * @param  cursor  String value for cursor.
     */
    protected ListCashDrawerShiftEventsRequest(
            String locationId, OptionalNullable<Integer> limit, OptionalNullable<String> cursor) {
        this.locationId = locationId;
        this.limit = limit;
        this.cursor = cursor;
    }
    ...
    public String toString() {
        return "ListCashDrawerShiftEventsRequest [" + "locationId=" + locationId + ", limit=" + limit + ", cursor="
                + cursor + "]";
    }
