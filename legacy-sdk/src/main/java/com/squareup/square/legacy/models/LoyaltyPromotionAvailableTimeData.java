...
public class LoyaltyPromotionAvailableTimeData {
    ...
    public String toString() {
        return "LoyaltyPromotionAvailableTimeData [" + "timePeriods=" + timePeriods + ", startDate=" + startDate
                + ", endDate=" + endDate + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(timePeriods).startDate(getStartDate()).endDate(getEndDate());
        return builder;
    }
