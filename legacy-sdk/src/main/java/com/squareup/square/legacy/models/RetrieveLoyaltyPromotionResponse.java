...
public class RetrieveLoyaltyPromotionResponse {
    ...
    public String toString() {
        return "RetrieveLoyaltyPromotionResponse [" + "errors=" + errors + ", loyaltyPromotion=" + loyaltyPromotion
                + "]";
    }
    ...
    public static class Builder {
        ...
        public RetrieveLoyaltyPromotionResponse build() {
            RetrieveLoyaltyPromotionResponse model = new RetrieveLoyaltyPromotionResponse(errors, loyaltyPromotion);
