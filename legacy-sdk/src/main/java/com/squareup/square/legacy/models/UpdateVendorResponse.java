...
public class UpdateVendorResponse {
     ...
     */
    @JsonCreator
    public UpdateVendorResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("vendor") Vendor vendor) {
        this.errors = errors;
        this.vendor = vendor;
    }
    ...
    public static class Builder {
        ...
        public UpdateVendorResponse build() {
            UpdateVendorResponse model = new UpdateVendorResponse(errors, vendor);
