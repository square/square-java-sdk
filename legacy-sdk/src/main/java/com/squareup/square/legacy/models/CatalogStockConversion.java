...
public class CatalogStockConversion {
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(stockableItemVariationId, stockableQuantity, nonstockableQuantity);
        return builder;
    }
    ...
    public static class Builder {
        ...
        public CatalogStockConversion build() {
            return new CatalogStockConversion(stockableItemVariationId, stockableQuantity, nonstockableQuantity);
        }
    }
}
