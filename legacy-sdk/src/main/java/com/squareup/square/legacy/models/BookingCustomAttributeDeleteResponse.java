...
public class BookingCustomAttributeDeleteResponse {
    ...
    public BookingCustomAttributeDeleteResponse(
            @JsonProperty("booking_id") String bookingId, @JsonProperty("errors") List<Error> errors) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(bookingId, other.bookingId) && Objects.equals(errors, other.errors);
    }
    ...
    public String toString() {
        return "BookingCustomAttributeDeleteResponse [" + "bookingId=" + bookingId + ", errors=" + errors + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().bookingId(getBookingId()).errors(getErrors());
        return builder;
    }
