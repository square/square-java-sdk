...
public class BulkSwapPlanResponse {
    ...
    public String toString() {
        return "BulkSwapPlanResponse [" + "errors=" + errors + ", affectedSubscriptions=" + affectedSubscriptions + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).affectedSubscriptions(getAffectedSubscriptions());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public BulkSwapPlanResponse build() {
            BulkSwapPlanResponse model = new BulkSwapPlanResponse(errors, affectedSubscriptions);
