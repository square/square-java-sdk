...
public final class DefaultBookingsApi extends BaseApi implements BookingsApi {
    ...
    public ListBookingsResponse listBookings(
        ...
        return prepareListBookingsRequest(limit, cursor, customerId, teamMemberId, locationId, startAtMin, startAtMax)
                .execute();
    }
    ...
    public CompletableFuture<ListBookingsResponse> listBookingsAsync(
            ...
            final String startAtMax) {
        try {
            return prepareListBookingsRequest(
                            limit, cursor, customerId, teamMemberId, locationId, startAtMin, startAtMax)
                    .executeAsync();
        } catch (Exception e) {
    ...
    private ApiCall<ListBookingsResponse, ApiException> prepareListBookingsRequest(
        ...
        return new ApiCall.Builder<ListBookingsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .queryParam(param ->
                                param.key("start_at_min").value(startAtMin).isRequired(false))
                        .queryParam(param ->
                                param.key("start_at_max").value(startAtMax).isRequired(false))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListBookingsResponse.class))
                        .nullify404(false)
     ...
     * @return    Returns the CreateBookingResponse response from the API call
     */
    public CompletableFuture<CreateBookingResponse> createBookingAsync(final CreateBookingRequest body) {
        try {
     ...
     */
    private ApiCall<CreateBookingResponse, ApiException> prepareCreateBookingRequest(final CreateBookingRequest body)
     ...
     * @return    Returns the SearchAvailabilityResponse response from the API call
     */
    public CompletableFuture<SearchAvailabilityResponse> searchAvailabilityAsync(final SearchAvailabilityRequest body) {
        try {
     ...
     */
    private ApiCall<RetrieveBusinessBookingProfileResponse, ApiException> prepareRetrieveBusinessBookingProfileRequest()
            throws IOException {
     ...
     */
    private ApiCall<BulkRetrieveTeamMemberBookingProfilesResponse, ApiException>
     ...
     */
    private ApiCall<RetrieveTeamMemberBookingProfileResponse, ApiException>
     ...
     * @return    Returns the RetrieveBookingResponse response from the API call
     */
    public CompletableFuture<RetrieveBookingResponse> retrieveBookingAsync(final String bookingId) {
        try {
     ...
     */
    private ApiCall<RetrieveBookingResponse, ApiException> prepareRetrieveBookingRequest(final String bookingId)
            throws IOException {
