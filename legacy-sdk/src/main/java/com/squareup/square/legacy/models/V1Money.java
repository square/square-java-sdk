...
public class V1Money {
     ...
     */
    @JsonCreator
    public V1Money(@JsonProperty("amount") Integer amount, @JsonProperty("currency_code") String currencyCode) {
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().currencyCode(getCurrencyCode());
