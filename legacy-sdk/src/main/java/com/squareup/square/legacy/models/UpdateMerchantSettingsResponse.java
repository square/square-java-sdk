...
public class UpdateMerchantSettingsResponse {
    ...
    public String toString() {
        return "UpdateMerchantSettingsResponse [" + "errors=" + errors + ", merchantSettings=" + merchantSettings + "]";
    }
    ...
    public static class Builder {
        ...
        public UpdateMerchantSettingsResponse build() {
            UpdateMerchantSettingsResponse model = new UpdateMerchantSettingsResponse(errors, merchantSettings);
