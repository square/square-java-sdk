...
public class OrderReturnTax {
     ...
     * @param  scope  String value for scope.
     */
    protected OrderReturnTax(
            OptionalNullable<String> uid,
            OptionalNullable<String> sourceTaxUid,
    ...
    public int hashCode() {
        return Objects.hash(
                uid, sourceTaxUid, catalogObjectId, catalogVersion, name, type, percentage, appliedMoney, scope);
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().type(getType()).appliedMoney(getAppliedMoney()).scope(getScope());
