...
public class RiskEvaluation {
     ...
     */
    @JsonCreator
    public RiskEvaluation(@JsonProperty("created_at") String createdAt, @JsonProperty("risk_level") String riskLevel) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(createdAt, other.createdAt) && Objects.equals(riskLevel, other.riskLevel);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().createdAt(getCreatedAt()).riskLevel(getRiskLevel());
        return builder;
    }
