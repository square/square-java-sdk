...
import com.squareup.square.legacy.models.DeleteSnippetResponse;
import com.squareup.square.legacy.models.RetrieveSnippetResponse;
import com.squareup.square.legacy.models.UpsertSnippetRequest;
import com.squareup.square.legacy.models.UpsertSnippetResponse;
...
public final class DefaultSnippetsApi extends BaseApi implements SnippetsApi {
     ...
     */
    public DeleteSnippetResponse deleteSnippet(final String siteId) throws ApiException, IOException {
     ...
     * @return    Returns the DeleteSnippetResponse response from the API call
     */
    public CompletableFuture<DeleteSnippetResponse> deleteSnippetAsync(final String siteId) {
        try {
     ...
     */
    private ApiCall<DeleteSnippetResponse, ApiException> prepareDeleteSnippetRequest(final String siteId)
            throws IOException {
        return new ApiCall.Builder<DeleteSnippetResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(
                                param -> param.key("site_id").value(siteId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.DELETE))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, DeleteSnippetResponse.class))
                        .nullify404(false)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public RetrieveSnippetResponse retrieveSnippet(final String siteId) throws ApiException, IOException {
     ...
     * @return    Returns the RetrieveSnippetResponse response from the API call
     */
    public CompletableFuture<RetrieveSnippetResponse> retrieveSnippetAsync(final String siteId) {
        try {
     ...
     */
    private ApiCall<RetrieveSnippetResponse, ApiException> prepareRetrieveSnippetRequest(final String siteId)
            throws IOException {
        return new ApiCall.Builder<RetrieveSnippetResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RetrieveSnippetResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public UpsertSnippetResponse upsertSnippet(final String siteId, final UpsertSnippetRequest body)
    ...
    public CompletableFuture<UpsertSnippetResponse> upsertSnippetAsync(
            final String siteId, final UpsertSnippetRequest body) {
        try {
    ...
    private ApiCall<UpsertSnippetResponse, ApiException> prepareUpsertSnippetRequest(
            final String siteId, final UpsertSnippetRequest body) throws JsonProcessingException, IOException {
        return new ApiCall.Builder<UpsertSnippetResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, UpsertSnippetResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
