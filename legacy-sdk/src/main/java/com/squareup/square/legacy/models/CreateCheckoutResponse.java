...
public class CreateCheckoutResponse {
    ...
    public CreateCheckoutResponse(
            @JsonProperty("checkout") Checkout checkout, @JsonProperty("errors") List<Error> errors) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(checkout, other.checkout) && Objects.equals(errors, other.errors);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().checkout(getCheckout()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public CreateCheckoutResponse build() {
            CreateCheckoutResponse model = new CreateCheckoutResponse(checkout, errors);
