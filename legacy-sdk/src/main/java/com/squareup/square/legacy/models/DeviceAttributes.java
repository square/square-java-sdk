...
public class DeviceAttributes {
    ...
    protected DeviceAttributes(
            String type,
            String manufacturer,
            OptionalNullable<String> model,
            OptionalNullable<String> name,
            OptionalNullable<String> manufacturersId,
            String updatedAt,
            String version,
            OptionalNullable<String> merchantToken) {
        this.type = type;
        this.manufacturer = manufacturer;
        this.model = model;
        this.name = name;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(type, manufacturer, model, name, manufacturersId, updatedAt, version, merchantToken);
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder(type, manufacturer).updatedAt(getUpdatedAt()).version(getVersion());
    ...
    public static class Builder {
        ...
        public DeviceAttributes build() {
            return new DeviceAttributes(
                    type, manufacturer, model, name, manufacturersId, updatedAt, version, merchantToken);
        }
    }
}
