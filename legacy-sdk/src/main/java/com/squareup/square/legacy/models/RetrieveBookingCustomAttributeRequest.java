...
public class RetrieveBookingCustomAttributeRequest {
     ...
     * @param  version  Integer value for version.
     */
    protected RetrieveBookingCustomAttributeRequest(OptionalNullable<Boolean> withDefinition, Integer version) {
    ...
    public String toString() {
        return "RetrieveBookingCustomAttributeRequest [" + "withDefinition=" + withDefinition + ", version=" + version
                + "]";
    }
