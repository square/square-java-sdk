...
public class RetrieveTeamMemberResponse {
    ...
    public RetrieveTeamMemberResponse(
            @JsonProperty("team_member") TeamMember teamMember, @JsonProperty("errors") List<Error> errors) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(teamMember, other.teamMember) && Objects.equals(errors, other.errors);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().teamMember(getTeamMember()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveTeamMemberResponse build() {
            RetrieveTeamMemberResponse model = new RetrieveTeamMemberResponse(teamMember, errors);
