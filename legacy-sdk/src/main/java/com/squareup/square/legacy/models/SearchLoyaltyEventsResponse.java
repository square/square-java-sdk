...
public class SearchLoyaltyEventsResponse {
    ...
    public String toString() {
        return "SearchLoyaltyEventsResponse [" + "errors=" + errors + ", events=" + events + ", cursor=" + cursor + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).events(getEvents()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public SearchLoyaltyEventsResponse build() {
            SearchLoyaltyEventsResponse model = new SearchLoyaltyEventsResponse(errors, events, cursor);
