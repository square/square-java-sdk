...
public class BulkDeleteMerchantCustomAttributesRequestMerchantCustomAttributeDeleteRequest {
    ...
    public String toString() {
        return "BulkDeleteMerchantCustomAttributesRequestMerchantCustomAttributeDeleteRequest [" + "key=" + key + "]";
    }
    ...
    public static class Builder {
        ...
        public BulkDeleteMerchantCustomAttributesRequestMerchantCustomAttributeDeleteRequest build() {
            return new BulkDeleteMerchantCustomAttributesRequestMerchantCustomAttributeDeleteRequest(key);
        }
    }
}
