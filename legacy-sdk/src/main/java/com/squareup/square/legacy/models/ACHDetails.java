...
public class ACHDetails {
    ...
    protected ACHDetails(
            ...
            OptionalNullable<String> accountNumberSuffix,
            OptionalNullable<String> accountType) {
    ...
    public String toString() {
        return "ACHDetails [" + "routingNumber=" + routingNumber + ", accountNumberSuffix=" + accountNumberSuffix
