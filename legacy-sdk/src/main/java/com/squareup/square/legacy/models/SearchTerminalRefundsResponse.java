...
public class SearchTerminalRefundsResponse {
    ...
    public String toString() {
        return "SearchTerminalRefundsResponse [" + "errors=" + errors + ", refunds=" + refunds + ", cursor=" + cursor
                + "]";
    }
    ...
    public static class Builder {
        ...
        public SearchTerminalRefundsResponse build() {
            SearchTerminalRefundsResponse model = new SearchTerminalRefundsResponse(errors, refunds, cursor);
