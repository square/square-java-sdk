...
public class CreateInvoiceAttachmentRequest {
    ...
    public CreateInvoiceAttachmentRequest(
            @JsonProperty("idempotency_key") String idempotencyKey, @JsonProperty("description") String description) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(idempotencyKey, other.idempotencyKey) && Objects.equals(description, other.description);
    }
    ...
    public String toString() {
        return "CreateInvoiceAttachmentRequest [" + "idempotencyKey=" + idempotencyKey + ", description=" + description
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().idempotencyKey(getIdempotencyKey()).description(getDescription());
        return builder;
    }
