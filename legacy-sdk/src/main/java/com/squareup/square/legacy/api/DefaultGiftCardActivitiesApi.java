...
import com.squareup.square.legacy.models.CreateGiftCardActivityRequest;
import com.squareup.square.legacy.models.CreateGiftCardActivityResponse;
import com.squareup.square.legacy.models.ListGiftCardActivitiesResponse;
...
public final class DefaultGiftCardActivitiesApi extends BaseApi implements GiftCardActivitiesApi {
    ...
    public ListGiftCardActivitiesResponse listGiftCardActivities(
        ...
        return prepareListGiftCardActivitiesRequest(
    ...
    private ApiCall<ListGiftCardActivitiesResponse, ApiException> prepareListGiftCardActivitiesRequest(
        ...
        return new ApiCall.Builder<ListGiftCardActivitiesResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .queryParam(param ->
                                param.key("gift_card_id").value(giftCardId).isRequired(false))
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListGiftCardActivitiesResponse.class))
                        .nullify404(false)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public CreateGiftCardActivityResponse createGiftCardActivity(final CreateGiftCardActivityRequest body)
            throws ApiException, IOException {
    ...
    private ApiCall<CreateGiftCardActivityResponse, ApiException> prepareCreateGiftCardActivityRequest(
        ...
        return new ApiCall.Builder<CreateGiftCardActivityResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CreateGiftCardActivityResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
