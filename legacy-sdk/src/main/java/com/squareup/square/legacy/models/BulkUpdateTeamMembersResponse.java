...
public class BulkUpdateTeamMembersResponse {
    ...
    public String toString() {
        return "BulkUpdateTeamMembersResponse [" + "teamMembers=" + teamMembers + ", errors=" + errors + "]";
    }
    ...
    public static class Builder {
        ...
        public BulkUpdateTeamMembersResponse build() {
            BulkUpdateTeamMembersResponse model = new BulkUpdateTeamMembersResponse(teamMembers, errors);
