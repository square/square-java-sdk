...
public class ReceiptOptions {
     ...
     * @param  isDuplicate  Boolean value for isDuplicate.
     */
    protected ReceiptOptions(
            String paymentId, OptionalNullable<Boolean> printOnly, OptionalNullable<Boolean> isDuplicate) {
        this.paymentId = paymentId;
    ...
    public String toString() {
        return "ReceiptOptions [" + "paymentId=" + paymentId + ", printOnly=" + printOnly + ", isDuplicate="
                + isDuplicate + "]";
    }
