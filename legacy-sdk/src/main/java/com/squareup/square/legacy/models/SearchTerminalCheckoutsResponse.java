...
public class SearchTerminalCheckoutsResponse {
    ...
    public String toString() {
        return "SearchTerminalCheckoutsResponse [" + "errors=" + errors + ", checkouts=" + checkouts + ", cursor="
                + cursor + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().errors(getErrors()).checkouts(getCheckouts()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public SearchTerminalCheckoutsResponse build() {
            SearchTerminalCheckoutsResponse model = new SearchTerminalCheckoutsResponse(errors, checkouts, cursor);
