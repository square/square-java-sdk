...
public class CreateLocationCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        CreateLocationCustomAttributeDefinitionResponse other = (CreateLocationCustomAttributeDefinitionResponse) obj;
    ...
    public static class Builder {
        ...
        public CreateLocationCustomAttributeDefinitionResponse build() {
            CreateLocationCustomAttributeDefinitionResponse model =
                    new CreateLocationCustomAttributeDefinitionResponse(customAttributeDefinition, errors);
