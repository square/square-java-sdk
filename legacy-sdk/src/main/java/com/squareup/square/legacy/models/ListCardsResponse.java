...
public class ListCardsResponse {
    ...
    public String toString() {
        return "ListCardsResponse [" + "errors=" + errors + ", cards=" + cards + ", cursor=" + cursor + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).cards(getCards()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListCardsResponse build() {
            ListCardsResponse model = new ListCardsResponse(errors, cards, cursor);
