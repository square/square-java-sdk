...
public class SearchInvoicesResponse {
    ...
    public String toString() {
        return "SearchInvoicesResponse [" + "invoices=" + invoices + ", cursor=" + cursor + ", errors=" + errors + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().invoices(getInvoices()).cursor(getCursor()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public SearchInvoicesResponse build() {
            SearchInvoicesResponse model = new SearchInvoicesResponse(invoices, cursor, errors);
