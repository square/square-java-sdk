...
public class BulkUpdateVendorsResponse {
     ...
     * A set of [UpdateVendorResponse](entity:UpdateVendorResponse) objects encapsulating
     * successfully created [Vendor](entity:Vendor) objects or error responses for failed attempts.
     * The set is represented by a collection of `Vendor`-ID/`UpdateVendorResponse`-object or
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(responses, other.responses);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).responses(getResponses());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public BulkUpdateVendorsResponse build() {
            BulkUpdateVendorsResponse model = new BulkUpdateVendorsResponse(errors, responses);
