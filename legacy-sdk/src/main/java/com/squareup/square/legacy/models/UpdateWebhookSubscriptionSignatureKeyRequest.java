...
public class UpdateWebhookSubscriptionSignatureKeyRequest {
     ...
     */
    @JsonCreator
    public UpdateWebhookSubscriptionSignatureKeyRequest(@JsonProperty("idempotency_key") String idempotencyKey) {
     ...
     * @param  idempotencyKey  String value for idempotencyKey.
     */
    protected UpdateWebhookSubscriptionSignatureKeyRequest(OptionalNullable<String> idempotencyKey) {
    ...
    public boolean equals(Object obj) {
        ...
        UpdateWebhookSubscriptionSignatureKeyRequest other = (UpdateWebhookSubscriptionSignatureKeyRequest) obj;
