...
public class ListDeviceCodesResponse {
    ...
    public String toString() {
        return "ListDeviceCodesResponse [" + "errors=" + errors + ", deviceCodes=" + deviceCodes + ", cursor=" + cursor
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().errors(getErrors()).deviceCodes(getDeviceCodes()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListDeviceCodesResponse build() {
            ListDeviceCodesResponse model = new ListDeviceCodesResponse(errors, deviceCodes, cursor);
