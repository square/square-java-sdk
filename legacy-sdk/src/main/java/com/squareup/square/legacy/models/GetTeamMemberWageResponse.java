...
public class GetTeamMemberWageResponse {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(teamMemberWage, other.teamMemberWage) && Objects.equals(errors, other.errors);
    }
    ...
    public String toString() {
        return "GetTeamMemberWageResponse [" + "teamMemberWage=" + teamMemberWage + ", errors=" + errors + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().teamMemberWage(getTeamMemberWage()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public GetTeamMemberWageResponse build() {
            GetTeamMemberWageResponse model = new GetTeamMemberWageResponse(teamMemberWage, errors);
