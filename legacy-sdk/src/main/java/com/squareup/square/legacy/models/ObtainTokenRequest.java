...
public class ObtainTokenRequest {
    ...
    protected ObtainTokenRequest(
            ...
            OptionalNullable<String> code,
            OptionalNullable<String> redirectUri,
            OptionalNullable<String> refreshToken,
            OptionalNullable<String> migrationToken,
            OptionalNullable<List<String>> scopes,
            OptionalNullable<Boolean> shortLived,
            OptionalNullable<String> codeVerifier) {
        this.clientId = clientId;
