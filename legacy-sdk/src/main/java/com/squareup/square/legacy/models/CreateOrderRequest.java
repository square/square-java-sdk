...
public class CreateOrderRequest {
    ...
    public CreateOrderRequest(
            @JsonProperty("order") Order order, @JsonProperty("idempotency_key") String idempotencyKey) {
        this.order = order;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(order, other.order) && Objects.equals(idempotencyKey, other.idempotencyKey);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().order(getOrder()).idempotencyKey(getIdempotencyKey());
        return builder;
    }
