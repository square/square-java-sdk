...
public class BookingCustomAttributeUpsertRequest {
     ...
     * @param  idempotencyKey  String value for idempotencyKey.
     */
    protected BookingCustomAttributeUpsertRequest(
            String bookingId, CustomAttribute customAttribute, OptionalNullable<String> idempotencyKey) {
        this.bookingId = bookingId;
        this.customAttribute = customAttribute;
    ...
    public static class Builder {
        ...
        public BookingCustomAttributeUpsertRequest build() {
            return new BookingCustomAttributeUpsertRequest(bookingId, customAttribute, idempotencyKey);
        }
    }
}
