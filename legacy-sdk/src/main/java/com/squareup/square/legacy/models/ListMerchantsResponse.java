...
public class ListMerchantsResponse {
    ...
    public String toString() {
        return "ListMerchantsResponse [" + "errors=" + errors + ", merchant=" + merchant + ", cursor=" + cursor + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().errors(getErrors()).merchant(getMerchant()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListMerchantsResponse build() {
            ListMerchantsResponse model = new ListMerchantsResponse(errors, merchant, cursor);
