...
public class CustomAttributeFilter {
     ...
     * @param  boolFilter  Boolean value for boolFilter.
     */
    protected CustomAttributeFilter(
            OptionalNullable<String> customAttributeDefinitionId,
            OptionalNullable<String> key,
            OptionalNullable<String> stringFilter,
            Range numberFilter,
    ...
    public int hashCode() {
        return Objects.hash(
                customAttributeDefinitionId, key, stringFilter, numberFilter, selectionUidsFilter, boolFilter);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().numberFilter(getNumberFilter());
