...
public class CreateCustomerCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        CreateCustomerCustomAttributeDefinitionResponse other = (CreateCustomerCustomAttributeDefinitionResponse) obj;
    ...
    public static class Builder {
        ...
        public CreateCustomerCustomAttributeDefinitionResponse build() {
            CreateCustomerCustomAttributeDefinitionResponse model =
                    new CreateCustomerCustomAttributeDefinitionResponse(customAttributeDefinition, errors);
