...
public class UpdateInvoiceRequest {
    ...
    protected UpdateInvoiceRequest(
            Invoice invoice, OptionalNullable<String> idempotencyKey, OptionalNullable<List<String>> fieldsToClear) {
        this.invoice = invoice;
    ...
    public String toString() {
        return "UpdateInvoiceRequest [" + "invoice=" + invoice + ", idempotencyKey=" + idempotencyKey
