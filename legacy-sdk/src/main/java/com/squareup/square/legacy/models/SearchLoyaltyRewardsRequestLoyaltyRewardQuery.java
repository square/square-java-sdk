...
public class SearchLoyaltyRewardsRequestLoyaltyRewardQuery {
    ...
    public SearchLoyaltyRewardsRequestLoyaltyRewardQuery(
            @JsonProperty("loyalty_account_id") String loyaltyAccountId, @JsonProperty("status") String status) {
    ...
    public boolean equals(Object obj) {
        ...
        SearchLoyaltyRewardsRequestLoyaltyRewardQuery other = (SearchLoyaltyRewardsRequestLoyaltyRewardQuery) obj;
        return Objects.equals(loyaltyAccountId, other.loyaltyAccountId) && Objects.equals(status, other.status);
    }
    ...
    public String toString() {
        return "SearchLoyaltyRewardsRequestLoyaltyRewardQuery [" + "loyaltyAccountId=" + loyaltyAccountId + ", status="
                + status + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(loyaltyAccountId).status(getStatus());
        return builder;
    }
