...
public class ListBookingsRequest {
    ...
    protected ListBookingsRequest(
            ...
            OptionalNullable<String> startAtMin,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(limit, cursor, customerId, teamMemberId, locationId, startAtMin, startAtMax);
    }
    ...
    public static class Builder {
        ...
        public ListBookingsRequest build() {
            return new ListBookingsRequest(limit, cursor, customerId, teamMemberId, locationId, startAtMin, startAtMax);
        }
    }
}
