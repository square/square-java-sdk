...
public interface SnippetsApi {
     ...
     */
    DeleteSnippetResponse deleteSnippet(final String siteId) throws ApiException, IOException;
     ...
     * @return    Returns the DeleteSnippetResponse response from the API call
     */
    CompletableFuture<DeleteSnippetResponse> deleteSnippetAsync(final String siteId);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    RetrieveSnippetResponse retrieveSnippet(final String siteId) throws ApiException, IOException;
     ...
     * @return    Returns the RetrieveSnippetResponse response from the API call
     */
    CompletableFuture<RetrieveSnippetResponse> retrieveSnippetAsync(final String siteId);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    UpsertSnippetResponse upsertSnippet(final String siteId, final UpsertSnippetRequest body)
     ...
     * @return    Returns the UpsertSnippetResponse response from the API call
     */
    CompletableFuture<UpsertSnippetResponse> upsertSnippetAsync(final String siteId, final UpsertSnippetRequest body);
}
