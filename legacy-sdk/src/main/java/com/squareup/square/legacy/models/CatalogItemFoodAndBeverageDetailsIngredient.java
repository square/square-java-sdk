...
public class CatalogItemFoodAndBeverageDetailsIngredient {
     ...
     * @param  customName  String value for customName.
     */
    protected CatalogItemFoodAndBeverageDetailsIngredient(
            String type, String standardName, OptionalNullable<String> customName) {
        this.type = type;
        this.standardName = standardName;
    ...
    public String toString() {
        return "CatalogItemFoodAndBeverageDetailsIngredient [" + "type=" + type + ", standardName=" + standardName
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().type(getType()).standardName(getStandardName());
