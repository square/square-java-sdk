...
public class BatchRetrieveInventoryChangesRequest {
     ...
     * @param  limit  Integer value for limit.
     */
    protected BatchRetrieveInventoryChangesRequest(
            OptionalNullable<List<String>> catalogObjectIds,
            OptionalNullable<List<String>> locationIds,
            OptionalNullable<List<String>> types,
            OptionalNullable<List<String>> states,
            OptionalNullable<String> updatedAfter,
            OptionalNullable<String> updatedBefore,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(catalogObjectIds, locationIds, types, states, updatedAfter, updatedBefore, cursor, limit);
    }
    ...
    public static class Builder {
        ...
        public BatchRetrieveInventoryChangesRequest build() {
            return new BatchRetrieveInventoryChangesRequest(
                    catalogObjectIds, locationIds, types, states, updatedAfter, updatedBefore, cursor, limit);
        }
    }
}
