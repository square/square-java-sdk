...
public class DeprecatedCreateDisputeEvidenceFileResponse {
    ...
    public DeprecatedCreateDisputeEvidenceFileResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("evidence") DisputeEvidence evidence) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        DeprecatedCreateDisputeEvidenceFileResponse other = (DeprecatedCreateDisputeEvidenceFileResponse) obj;
        return Objects.equals(errors, other.errors) && Objects.equals(evidence, other.evidence);
    }
    ...
    public String toString() {
        return "DeprecatedCreateDisputeEvidenceFileResponse [" + "errors=" + errors + ", evidence=" + evidence + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).evidence(getEvidence());
        return builder;
    }
