...
public class CatalogSubscriptionPlanVariation {
     ...
     * @param  successorPlanVariationId  String value for successorPlanVariationId.
     */
    protected CatalogSubscriptionPlanVariation(
            String name,
            List<SubscriptionPhase> phases,
            OptionalNullable<String> subscriptionPlanId,
            OptionalNullable<Long> monthlyBillingAnchorDate,
            OptionalNullable<Boolean> canProrate,
    ...
    public int hashCode() {
        return Objects.hash(
                name, phases, subscriptionPlanId, monthlyBillingAnchorDate, canProrate, successorPlanVariationId);
    }
