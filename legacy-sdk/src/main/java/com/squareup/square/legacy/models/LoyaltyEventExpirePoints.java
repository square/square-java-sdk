...
public class LoyaltyEventExpirePoints {
    ...
    public LoyaltyEventExpirePoints(
            @JsonProperty("loyalty_program_id") String loyaltyProgramId, @JsonProperty("points") int points) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(loyaltyProgramId, other.loyaltyProgramId) && Objects.equals(points, other.points);
    }
    ...
    public String toString() {
        return "LoyaltyEventExpirePoints [" + "loyaltyProgramId=" + loyaltyProgramId + ", points=" + points + "]";
    }
