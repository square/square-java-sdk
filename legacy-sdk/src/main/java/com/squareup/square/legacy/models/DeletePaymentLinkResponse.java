...
public class DeletePaymentLinkResponse {
    ...
    public String toString() {
        return "DeletePaymentLinkResponse [" + "errors=" + errors + ", id=" + id + ", cancelledOrderId="
                + cancelledOrderId + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).id(getId()).cancelledOrderId(getCancelledOrderId());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public DeletePaymentLinkResponse build() {
            DeletePaymentLinkResponse model = new DeletePaymentLinkResponse(errors, id, cancelledOrderId);
