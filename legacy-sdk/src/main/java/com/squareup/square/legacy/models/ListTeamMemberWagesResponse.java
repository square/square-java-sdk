...
public class ListTeamMemberWagesResponse {
    ...
    public String toString() {
        return "ListTeamMemberWagesResponse [" + "teamMemberWages=" + teamMemberWages + ", cursor=" + cursor
                + ", errors=" + errors + "]";
    }
    ...
    public static class Builder {
        ...
        public ListTeamMemberWagesResponse build() {
            ListTeamMemberWagesResponse model = new ListTeamMemberWagesResponse(teamMemberWages, cursor, errors);
