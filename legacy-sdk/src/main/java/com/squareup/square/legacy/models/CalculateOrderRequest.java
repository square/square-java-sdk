...
public class CalculateOrderRequest {
    ...
    public CalculateOrderRequest(
            @JsonProperty("order") Order order, @JsonProperty("proposed_rewards") List<OrderReward> proposedRewards) {
        this.order = order;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(order, other.order) && Objects.equals(proposedRewards, other.proposedRewards);
    }
