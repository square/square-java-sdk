...
public class BulkDeleteOrderCustomAttributesResponse {
    ...
    public boolean equals(Object obj) {
        ...
        BulkDeleteOrderCustomAttributesResponse other = (BulkDeleteOrderCustomAttributesResponse) obj;
    ...
    public String toString() {
        return "BulkDeleteOrderCustomAttributesResponse [" + "values=" + values + ", errors=" + errors + "]";
    }
    ...
    public static class Builder {
        ...
        public BulkDeleteOrderCustomAttributesResponse build() {
            BulkDeleteOrderCustomAttributesResponse model = new BulkDeleteOrderCustomAttributesResponse(values, errors);
