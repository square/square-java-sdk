...
public class DeviceCheckoutOptions {
     ...
     * @param  showItemizedCart  Boolean value for showItemizedCart.
     */
    protected DeviceCheckoutOptions(
            String deviceId,
            OptionalNullable<Boolean> skipReceiptScreen,
            OptionalNullable<Boolean> collectSignature,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(deviceId, skipReceiptScreen, collectSignature, tipSettings, showItemizedCart);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(deviceId).tipSettings(getTipSettings());
    ...
    public static class Builder {
        ...
        public DeviceCheckoutOptions build() {
            return new DeviceCheckoutOptions(
                    deviceId, skipReceiptScreen, collectSignature, tipSettings, showItemizedCart);
        }
    }
}
