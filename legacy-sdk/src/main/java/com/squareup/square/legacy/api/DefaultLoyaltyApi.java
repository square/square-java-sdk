...
import com.squareup.square.legacy.models.AccumulateLoyaltyPointsRequest;
import com.squareup.square.legacy.models.AccumulateLoyaltyPointsResponse;
import com.squareup.square.legacy.models.AdjustLoyaltyPointsRequest;
import com.squareup.square.legacy.models.AdjustLoyaltyPointsResponse;
import com.squareup.square.legacy.models.CalculateLoyaltyPointsRequest;
import com.squareup.square.legacy.models.CalculateLoyaltyPointsResponse;
import com.squareup.square.legacy.models.CancelLoyaltyPromotionResponse;
import com.squareup.square.legacy.models.CreateLoyaltyAccountRequest;
import com.squareup.square.legacy.models.CreateLoyaltyAccountResponse;
import com.squareup.square.legacy.models.CreateLoyaltyPromotionRequest;
import com.squareup.square.legacy.models.CreateLoyaltyPromotionResponse;
import com.squareup.square.legacy.models.CreateLoyaltyRewardRequest;
import com.squareup.square.legacy.models.CreateLoyaltyRewardResponse;
import com.squareup.square.legacy.models.DeleteLoyaltyRewardResponse;
import com.squareup.square.legacy.models.ListLoyaltyProgramsResponse;
import com.squareup.square.legacy.models.ListLoyaltyPromotionsResponse;
import com.squareup.square.legacy.models.RedeemLoyaltyRewardRequest;
import com.squareup.square.legacy.models.RedeemLoyaltyRewardResponse;
import com.squareup.square.legacy.models.RetrieveLoyaltyAccountResponse;
import com.squareup.square.legacy.models.RetrieveLoyaltyProgramResponse;
import com.squareup.square.legacy.models.RetrieveLoyaltyPromotionResponse;
import com.squareup.square.legacy.models.RetrieveLoyaltyRewardResponse;
import com.squareup.square.legacy.models.SearchLoyaltyAccountsRequest;
import com.squareup.square.legacy.models.SearchLoyaltyAccountsResponse;
import com.squareup.square.legacy.models.SearchLoyaltyEventsRequest;
import com.squareup.square.legacy.models.SearchLoyaltyEventsResponse;
import com.squareup.square.legacy.models.SearchLoyaltyRewardsRequest;
import com.squareup.square.legacy.models.SearchLoyaltyRewardsResponse;
...
public final class DefaultLoyaltyApi extends BaseApi implements LoyaltyApi {
     ...
     */
    public CreateLoyaltyAccountResponse createLoyaltyAccount(final CreateLoyaltyAccountRequest body)
    ...
    private ApiCall<CreateLoyaltyAccountResponse, ApiException> prepareCreateLoyaltyAccountRequest(
        ...
        return new ApiCall.Builder<CreateLoyaltyAccountResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CreateLoyaltyAccountResponse.class))
                        .nullify404(false)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public SearchLoyaltyAccountsResponse searchLoyaltyAccounts(final SearchLoyaltyAccountsRequest body)
            throws ApiException, IOException {
    ...
    private ApiCall<SearchLoyaltyAccountsResponse, ApiException> prepareSearchLoyaltyAccountsRequest(
        ...
        return new ApiCall.Builder<SearchLoyaltyAccountsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, SearchLoyaltyAccountsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public RetrieveLoyaltyAccountResponse retrieveLoyaltyAccount(final String accountId)
            throws ApiException, IOException {
     ...
     * @return    Returns the RetrieveLoyaltyAccountResponse response from the API call
     */
    public CompletableFuture<RetrieveLoyaltyAccountResponse> retrieveLoyaltyAccountAsync(final String accountId) {
        try {
    ...
    private ApiCall<RetrieveLoyaltyAccountResponse, ApiException> prepareRetrieveLoyaltyAccountRequest(
        ...
        return new ApiCall.Builder<RetrieveLoyaltyAccountResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(param ->
                                param.key("account_id").value(accountId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RetrieveLoyaltyAccountResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public AccumulateLoyaltyPointsResponse accumulateLoyaltyPoints(
            final String accountId, final AccumulateLoyaltyPointsRequest body) throws ApiException, IOException {
    ...
    public CompletableFuture<AccumulateLoyaltyPointsResponse> accumulateLoyaltyPointsAsync(
            final String accountId, final AccumulateLoyaltyPointsRequest body) {
        try {
    ...
    public AdjustLoyaltyPointsResponse adjustLoyaltyPoints(
            final String accountId, final AdjustLoyaltyPointsRequest body) throws ApiException, IOException {
    ...
    public CompletableFuture<AdjustLoyaltyPointsResponse> adjustLoyaltyPointsAsync(
            final String accountId, final AdjustLoyaltyPointsRequest body) {
        try {
    ...
    private ApiCall<AdjustLoyaltyPointsResponse, ApiException> prepareAdjustLoyaltyPointsRequest(
            final String accountId, final AdjustLoyaltyPointsRequest body) throws JsonProcessingException, IOException {
        return new ApiCall.Builder<AdjustLoyaltyPointsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, AdjustLoyaltyPointsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public SearchLoyaltyEventsResponse searchLoyaltyEvents(final SearchLoyaltyEventsRequest body)
            throws ApiException, IOException {
    ...
    private ApiCall<SearchLoyaltyEventsResponse, ApiException> prepareSearchLoyaltyEventsRequest(
        ...
        return new ApiCall.Builder<SearchLoyaltyEventsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, SearchLoyaltyEventsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    private ApiCall<ListLoyaltyProgramsResponse, ApiException> prepareListLoyaltyProgramsRequest() throws IOException {
        return new ApiCall.Builder<ListLoyaltyProgramsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListLoyaltyProgramsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public RetrieveLoyaltyProgramResponse retrieveLoyaltyProgram(final String programId)
            throws ApiException, IOException {
     ...
     * @return    Returns the RetrieveLoyaltyProgramResponse response from the API call
     */
    public CompletableFuture<RetrieveLoyaltyProgramResponse> retrieveLoyaltyProgramAsync(final String programId) {
        try {
    ...
    private ApiCall<RetrieveLoyaltyProgramResponse, ApiException> prepareRetrieveLoyaltyProgramRequest(
        ...
        return new ApiCall.Builder<RetrieveLoyaltyProgramResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(param ->
                                param.key("program_id").value(programId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RetrieveLoyaltyProgramResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public CalculateLoyaltyPointsResponse calculateLoyaltyPoints(
            final String programId, final CalculateLoyaltyPointsRequest body) throws ApiException, IOException {
    ...
    public CompletableFuture<CalculateLoyaltyPointsResponse> calculateLoyaltyPointsAsync(
            final String programId, final CalculateLoyaltyPointsRequest body) {
        try {
    ...
    private ApiCall<CalculateLoyaltyPointsResponse, ApiException> prepareCalculateLoyaltyPointsRequest(
        ...
        return new ApiCall.Builder<CalculateLoyaltyPointsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CalculateLoyaltyPointsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public ListLoyaltyPromotionsResponse listLoyaltyPromotions(
            final String programId, final String status, final String cursor, final Integer limit)
            throws ApiException, IOException {
        return prepareListLoyaltyPromotionsRequest(programId, status, cursor, limit)
                .execute();
    }
    ...
    private ApiCall<ListLoyaltyPromotionsResponse, ApiException> prepareListLoyaltyPromotionsRequest(
            final String programId, final String status, final String cursor, final Integer limit) throws IOException {
        return new ApiCall.Builder<ListLoyaltyPromotionsResponse, ApiException>()
                .globalConfig(getGlobalConfiguration())
                .requestBuilder(requestBuilder -> requestBuilder
                        .server(Server.ENUM_DEFAULT.value())
                        .path("/v2/loyalty/programs/{program_id}/promotions")
                        .queryParam(param -> param.key("status").value(status).isRequired(false))
                        ...
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListLoyaltyPromotionsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public CreateLoyaltyPromotionResponse createLoyaltyPromotion(
            final String programId, final CreateLoyaltyPromotionRequest body) throws ApiException, IOException {
    ...
    public CompletableFuture<CreateLoyaltyPromotionResponse> createLoyaltyPromotionAsync(
            final String programId, final CreateLoyaltyPromotionRequest body) {
        try {
    ...
    private ApiCall<CreateLoyaltyPromotionResponse, ApiException> prepareCreateLoyaltyPromotionRequest(
        ...
        return new ApiCall.Builder<CreateLoyaltyPromotionResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CreateLoyaltyPromotionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public RetrieveLoyaltyPromotionResponse retrieveLoyaltyPromotion(final String promotionId, final String programId)
            throws ApiException, IOException {
    ...
    public CompletableFuture<RetrieveLoyaltyPromotionResponse> retrieveLoyaltyPromotionAsync(
            final String promotionId, final String programId) {
        try {
            return prepareRetrieveLoyaltyPromotionRequest(promotionId, programId)
                    .executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
    ...
    private ApiCall<RetrieveLoyaltyPromotionResponse, ApiException> prepareRetrieveLoyaltyPromotionRequest(
            final String promotionId, final String programId) throws IOException {
        return new ApiCall.Builder<RetrieveLoyaltyPromotionResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(param ->
                                param.key("promotion_id").value(promotionId).shouldEncode(true))
                        .templateParam(param ->
                                param.key("program_id").value(programId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public CancelLoyaltyPromotionResponse cancelLoyaltyPromotion(final String promotionId, final String programId)
            throws ApiException, IOException {
    ...
    private ApiCall<CancelLoyaltyPromotionResponse, ApiException> prepareCancelLoyaltyPromotionRequest(
        ...
        return new ApiCall.Builder<CancelLoyaltyPromotionResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CancelLoyaltyPromotionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public CreateLoyaltyRewardResponse createLoyaltyReward(final CreateLoyaltyRewardRequest body)
            throws ApiException, IOException {
    ...
    private ApiCall<CreateLoyaltyRewardResponse, ApiException> prepareCreateLoyaltyRewardRequest(
        ...
        return new ApiCall.Builder<CreateLoyaltyRewardResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CreateLoyaltyRewardResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public SearchLoyaltyRewardsResponse searchLoyaltyRewards(final SearchLoyaltyRewardsRequest body)
            throws ApiException, IOException {
    ...
    private ApiCall<SearchLoyaltyRewardsResponse, ApiException> prepareSearchLoyaltyRewardsRequest(
        ...
        return new ApiCall.Builder<SearchLoyaltyRewardsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, SearchLoyaltyRewardsResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public DeleteLoyaltyRewardResponse deleteLoyaltyReward(final String rewardId) throws ApiException, IOException {
     ...
     * @return    Returns the DeleteLoyaltyRewardResponse response from the API call
     */
    public CompletableFuture<DeleteLoyaltyRewardResponse> deleteLoyaltyRewardAsync(final String rewardId) {
        try {
     ...
     */
    private ApiCall<DeleteLoyaltyRewardResponse, ApiException> prepareDeleteLoyaltyRewardRequest(final String rewardId)
            throws IOException {
        return new ApiCall.Builder<DeleteLoyaltyRewardResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(
                                param -> param.key("reward_id").value(rewardId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.DELETE))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, DeleteLoyaltyRewardResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public RetrieveLoyaltyRewardResponse retrieveLoyaltyReward(final String rewardId) throws ApiException, IOException {
     ...
     * @return    Returns the RetrieveLoyaltyRewardResponse response from the API call
     */
    public CompletableFuture<RetrieveLoyaltyRewardResponse> retrieveLoyaltyRewardAsync(final String rewardId) {
        try {
    ...
    private ApiCall<RetrieveLoyaltyRewardResponse, ApiException> prepareRetrieveLoyaltyRewardRequest(
        ...
        return new ApiCall.Builder<RetrieveLoyaltyRewardResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RetrieveLoyaltyRewardResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public RedeemLoyaltyRewardResponse redeemLoyaltyReward(final String rewardId, final RedeemLoyaltyRewardRequest body)
            throws ApiException, IOException {
    ...
    public CompletableFuture<RedeemLoyaltyRewardResponse> redeemLoyaltyRewardAsync(
            final String rewardId, final RedeemLoyaltyRewardRequest body) {
        try {
    ...
    private ApiCall<RedeemLoyaltyRewardResponse, ApiException> prepareRedeemLoyaltyRewardRequest(
            final String rewardId, final RedeemLoyaltyRewardRequest body) throws JsonProcessingException, IOException {
        return new ApiCall.Builder<RedeemLoyaltyRewardResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RedeemLoyaltyRewardResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
