...
public class CreateCatalogImageRequest {
    ...
    public String toString() {
        return "CreateCatalogImageRequest [" + "idempotencyKey=" + idempotencyKey + ", image=" + image + ", objectId="
                + objectId + ", isPrimary=" + isPrimary + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder(idempotencyKey, image).objectId(getObjectId()).isPrimary(getIsPrimary());
        return builder;
    }
