...
public class RetrieveVendorResponse {
     ...
     */
    @JsonCreator
    public RetrieveVendorResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("vendor") Vendor vendor) {
        this.errors = errors;
        this.vendor = vendor;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(vendor, other.vendor);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).vendor(getVendor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveVendorResponse build() {
            RetrieveVendorResponse model = new RetrieveVendorResponse(errors, vendor);
