...
public class SwapPlanResponse {
    ...
    public String toString() {
        return "SwapPlanResponse [" + "errors=" + errors + ", subscription=" + subscription + ", actions=" + actions
                + "]";
    }
    ...
    public static class Builder {
        ...
        public SwapPlanResponse build() {
            SwapPlanResponse model = new SwapPlanResponse(errors, subscription, actions);
