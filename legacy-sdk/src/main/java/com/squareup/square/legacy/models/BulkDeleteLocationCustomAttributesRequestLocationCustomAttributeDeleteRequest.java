...
public class BulkDeleteLocationCustomAttributesRequestLocationCustomAttributeDeleteRequest {
    ...
    public String toString() {
        return "BulkDeleteLocationCustomAttributesRequestLocationCustomAttributeDeleteRequest [" + "key=" + key + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().key(getKey());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public BulkDeleteLocationCustomAttributesRequestLocationCustomAttributeDeleteRequest build() {
            return new BulkDeleteLocationCustomAttributesRequestLocationCustomAttributeDeleteRequest(key);
        }
    }
}
