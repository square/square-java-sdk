...
public class ShippingFee {
     ...
     */
    @JsonCreator
    public ShippingFee(@JsonProperty("charge") Money charge, @JsonProperty("name") String name) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(name, other.name) && Objects.equals(charge, other.charge);
    }
