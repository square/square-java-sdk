...
public class CreateLoyaltyRewardRequest {
    ...
    public CreateLoyaltyRewardRequest(
            @JsonProperty("reward") LoyaltyReward reward, @JsonProperty("idempotency_key") String idempotencyKey) {
        this.reward = reward;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(reward, other.reward) && Objects.equals(idempotencyKey, other.idempotencyKey);
    }
    ...
    public String toString() {
        return "CreateLoyaltyRewardRequest [" + "reward=" + reward + ", idempotencyKey=" + idempotencyKey + "]";
    }
