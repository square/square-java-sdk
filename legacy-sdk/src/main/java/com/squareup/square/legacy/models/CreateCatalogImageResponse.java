...
public class CreateCatalogImageResponse {
    ...
    public CreateCatalogImageResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("image") CatalogObject image) {
        this.errors = errors;
        this.image = image;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(image, other.image);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).image(getImage());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public CreateCatalogImageResponse build() {
            CreateCatalogImageResponse model = new CreateCatalogImageResponse(errors, image);
