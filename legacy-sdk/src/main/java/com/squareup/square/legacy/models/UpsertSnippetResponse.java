...
public class UpsertSnippetResponse {
     ...
     */
    @JsonCreator
    public UpsertSnippetResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("snippet") Snippet snippet) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(snippet, other.snippet);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).snippet(getSnippet());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public UpsertSnippetResponse build() {
            UpsertSnippetResponse model = new UpsertSnippetResponse(errors, snippet);
