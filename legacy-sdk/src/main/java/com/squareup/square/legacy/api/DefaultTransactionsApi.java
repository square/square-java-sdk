...
import com.squareup.square.legacy.models.CaptureTransactionResponse;
import com.squareup.square.legacy.models.ListTransactionsResponse;
import com.squareup.square.legacy.models.RetrieveTransactionResponse;
import com.squareup.square.legacy.models.VoidTransactionResponse;
...
public final class DefaultTransactionsApi extends BaseApi implements TransactionsApi {
    ...
    public ListTransactionsResponse listTransactions(
        ...
        return prepareListTransactionsRequest(locationId, beginTime, endTime, sortOrder, cursor)
                .execute();
    }
    ...
    private ApiCall<ListTransactionsResponse, ApiException> prepareListTransactionsRequest(
        ...
        return new ApiCall.Builder<ListTransactionsResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListTransactionsResponse.class))
                        .nullify404(false)
     ...
     */
    @Deprecated
    public RetrieveTransactionResponse retrieveTransaction(final String locationId, final String transactionId)
            throws ApiException, IOException {
    ...
    public CompletableFuture<RetrieveTransactionResponse> retrieveTransactionAsync(
            final String locationId, final String transactionId) {
        try {
    ...
    private ApiCall<RetrieveTransactionResponse, ApiException> prepareRetrieveTransactionRequest(
            final String locationId, final String transactionId) throws IOException {
        return new ApiCall.Builder<RetrieveTransactionResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(param ->
                                param.key("location_id").value(locationId).shouldEncode(true))
                        .templateParam(param ->
                                param.key("transaction_id").value(transactionId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RetrieveTransactionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     */
    @Deprecated
    public CaptureTransactionResponse captureTransaction(final String locationId, final String transactionId)
            throws ApiException, IOException {
    ...
    private ApiCall<CaptureTransactionResponse, ApiException> prepareCaptureTransactionRequest(
        ...
        return new ApiCall.Builder<CaptureTransactionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CaptureTransactionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     */
    @Deprecated
    public VoidTransactionResponse voidTransaction(final String locationId, final String transactionId)
            throws ApiException, IOException {
    ...
    private ApiCall<VoidTransactionResponse, ApiException> prepareVoidTransactionRequest(
        ...
        return new ApiCall.Builder<VoidTransactionResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, VoidTransactionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
