...
public class CatalogItem {
    ...
    protected CatalogItem(
            ...
            OptionalNullable<Boolean> isTaxable,
            OptionalNullable<Boolean> availableOnline,
            OptionalNullable<Boolean> availableForPickup,
            OptionalNullable<Boolean> availableElectronically,
            OptionalNullable<String> categoryId,
            OptionalNullable<List<String>> taxIds,
            OptionalNullable<List<CatalogItemModifierListInfo>> modifierListInfo,
            OptionalNullable<List<CatalogObject>> variations,
            String productType,
            ...
            OptionalNullable<String> sortName,
            OptionalNullable<List<CatalogObjectCategory>> categories,
            OptionalNullable<String> descriptionHtml,
