...
public interface GiftCardsApi {
     ...
     * @return    Returns the CreateGiftCardResponse response from the API call
     */
    CompletableFuture<CreateGiftCardResponse> createGiftCardAsync(final CreateGiftCardRequest body);
     ...
     * @return    Returns the RetrieveGiftCardResponse response from the API call
     */
    CompletableFuture<RetrieveGiftCardResponse> retrieveGiftCardAsync(final String id);
}
