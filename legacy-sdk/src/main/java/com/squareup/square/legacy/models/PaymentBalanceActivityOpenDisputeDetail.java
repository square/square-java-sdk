...
public class PaymentBalanceActivityOpenDisputeDetail {
    ...
    public PaymentBalanceActivityOpenDisputeDetail(
            @JsonProperty("payment_id") String paymentId, @JsonProperty("dispute_id") String disputeId) {
     ...
     * @param  disputeId  String value for disputeId.
     */
    protected PaymentBalanceActivityOpenDisputeDetail(
            OptionalNullable<String> paymentId, OptionalNullable<String> disputeId) {
    ...
    public boolean equals(Object obj) {
        ...
        PaymentBalanceActivityOpenDisputeDetail other = (PaymentBalanceActivityOpenDisputeDetail) obj;
        return Objects.equals(paymentId, other.paymentId) && Objects.equals(disputeId, other.disputeId);
    }
    ...
    public String toString() {
        return "PaymentBalanceActivityOpenDisputeDetail [" + "paymentId=" + paymentId + ", disputeId=" + disputeId
                + "]";
    }
