...
public class DeleteDisputeEvidenceResponse {
     ...
     */
    @JsonCreator
    public DeleteDisputeEvidenceResponse(@JsonProperty("errors") List<Error> errors) {
        this.errors = errors;
    }
    ...
    public static class Builder {
        ...
        public DeleteDisputeEvidenceResponse build() {
            DeleteDisputeEvidenceResponse model = new DeleteDisputeEvidenceResponse(errors);
