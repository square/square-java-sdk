...
public class UpdateWebhookSubscriptionResponse {
    ...
    public String toString() {
        return "UpdateWebhookSubscriptionResponse [" + "errors=" + errors + ", subscription=" + subscription + "]";
    }
    ...
    public static class Builder {
        ...
        public UpdateWebhookSubscriptionResponse build() {
            UpdateWebhookSubscriptionResponse model = new UpdateWebhookSubscriptionResponse(errors, subscription);
