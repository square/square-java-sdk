...
public class ListLoyaltyPromotionsResponse {
    ...
    public String toString() {
        return "ListLoyaltyPromotionsResponse [" + "errors=" + errors + ", loyaltyPromotions=" + loyaltyPromotions
                + ", cursor=" + cursor + "]";
    }
    ...
    public static class Builder {
        ...
        public ListLoyaltyPromotionsResponse build() {
            ListLoyaltyPromotionsResponse model = new ListLoyaltyPromotionsResponse(errors, loyaltyPromotions, cursor);
