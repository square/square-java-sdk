...
public class ListDevicesResponse {
    ...
    public String toString() {
        return "ListDevicesResponse [" + "errors=" + errors + ", devices=" + devices + ", cursor=" + cursor + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().errors(getErrors()).devices(getDevices()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListDevicesResponse build() {
            ListDevicesResponse model = new ListDevicesResponse(errors, devices, cursor);
