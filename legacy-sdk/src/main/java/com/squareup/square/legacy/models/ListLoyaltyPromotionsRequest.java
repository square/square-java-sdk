...
public class ListLoyaltyPromotionsRequest {
     ...
     * @param  limit  Integer value for limit.
     */
    protected ListLoyaltyPromotionsRequest(
            String status, OptionalNullable<String> cursor, OptionalNullable<Integer> limit) {
        this.status = status;
        this.cursor = cursor;
        this.limit = limit;
    }
    ...
    public String toString() {
        return "ListLoyaltyPromotionsRequest [" + "status=" + status + ", cursor=" + cursor + ", limit=" + limit + "]";
    }
