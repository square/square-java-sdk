...
public class GetInvoiceResponse {
     ...
     */
    @JsonCreator
    public GetInvoiceResponse(@JsonProperty("invoice") Invoice invoice, @JsonProperty("errors") List<Error> errors) {
    ...
    public static class Builder {
        ...
        public GetInvoiceResponse build() {
            GetInvoiceResponse model = new GetInvoiceResponse(invoice, errors);
