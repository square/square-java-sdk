...
public class LoyaltyAccountExpiringPointDeadline {
    ...
    public LoyaltyAccountExpiringPointDeadline(
            @JsonProperty("points") int points, @JsonProperty("expires_at") String expiresAt) {
        this.points = points;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(points, other.points) && Objects.equals(expiresAt, other.expiresAt);
    }
    ...
    public String toString() {
        return "LoyaltyAccountExpiringPointDeadline [" + "points=" + points + ", expiresAt=" + expiresAt + "]";
    }
