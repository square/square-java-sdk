...
public class CreateDeviceCodeResponse {
    ...
    public CreateDeviceCodeResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("device_code") DeviceCode deviceCode) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(deviceCode, other.deviceCode);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).deviceCode(getDeviceCode());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public CreateDeviceCodeResponse build() {
            CreateDeviceCodeResponse model = new CreateDeviceCodeResponse(errors, deviceCode);
