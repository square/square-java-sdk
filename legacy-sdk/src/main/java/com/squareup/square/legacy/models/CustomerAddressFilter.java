...
public class CustomerAddressFilter {
    ...
    public CustomerAddressFilter(
            @JsonProperty("postal_code") CustomerTextFilter postalCode, @JsonProperty("country") String country) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(postalCode, other.postalCode) && Objects.equals(country, other.country);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().postalCode(getPostalCode()).country(getCountry());
        return builder;
    }
