...
public class DeprecatedCreateDisputeEvidenceTextResponse {
    ...
    public boolean equals(Object obj) {
        ...
        DeprecatedCreateDisputeEvidenceTextResponse other = (DeprecatedCreateDisputeEvidenceTextResponse) obj;
    ...
    public String toString() {
        return "DeprecatedCreateDisputeEvidenceTextResponse [" + "errors=" + errors + ", evidence=" + evidence + "]";
    }
