...
/**
 * This is a model class for CreateJobResponse type.
 */
public class CreateJobResponse {
     ...
     */
    @JsonCreator
    public CreateJobResponse(@JsonProperty("job") Job job, @JsonProperty("errors") List<Error> errors) {
        this.job = job;
        this.errors = errors;
    }
    ...
    /**
     * Converts this CreateJobResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CreateJobResponse [" + "job=" + job + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link CreateJobResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreateJobResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreateJobResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CreateJobResponse} object using the set fields.
         * @return {@link CreateJobResponse}
         */
        public CreateJobResponse build() {
            CreateJobResponse model = new CreateJobResponse(job, errors);
