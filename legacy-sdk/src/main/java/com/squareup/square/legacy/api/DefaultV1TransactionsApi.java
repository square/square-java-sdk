...
public final class DefaultV1TransactionsApi extends BaseApi implements V1TransactionsApi {
    ...
    public CompletableFuture<List<V1Order>> v1ListOrdersAsync(
            final String locationId, final String order, final Integer limit, final String batchToken) {
        try {
            return prepareV1ListOrdersRequest(locationId, order, limit, batchToken)
                    .executeAsync();
        } catch (Exception e) {
    ...
    private ApiCall<List<V1Order>, ApiException> prepareV1ListOrdersRequest(
        ...
        return new ApiCall.Builder<List<V1Order>, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .queryParam(param -> param.key("order").value(order).isRequired(false))
                        .queryParam(param -> param.key("limit").value(limit).isRequired(false))
                        .queryParam(param ->
                                param.key("batch_token").value(batchToken).isRequired(false))
                        .templateParam(param ->
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserializeArray(response, V1Order[].class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> {
                            for (int i = 0; i < result.size(); i++) {
                                result.set(
                                        i,
                                        result.get(i).toBuilder()
     ...
     */
    @Deprecated
    public V1Order v1RetrieveOrder(final String locationId, final String orderId) throws ApiException, IOException {
     ...
     */
    @Deprecated
    public CompletableFuture<V1Order> v1RetrieveOrderAsync(final String locationId, final String orderId) {
        try {
     ...
     */
    private ApiCall<V1Order, ApiException> prepareV1RetrieveOrderRequest(final String locationId, final String orderId)
            throws IOException {
        return new ApiCall.Builder<V1Order, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, V1Order.class))
                        .nullify404(false)
     ...
     */
    @Deprecated
    public V1Order v1UpdateOrder(final String locationId, final String orderId, final V1UpdateOrderRequest body)
            throws ApiException, IOException {
