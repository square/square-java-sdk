...
public class SearchVendorsResponse {
    ...
    public String toString() {
        return "SearchVendorsResponse [" + "errors=" + errors + ", vendors=" + vendors + ", cursor=" + cursor + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().errors(getErrors()).vendors(getVendors()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public SearchVendorsResponse build() {
            SearchVendorsResponse model = new SearchVendorsResponse(errors, vendors, cursor);
