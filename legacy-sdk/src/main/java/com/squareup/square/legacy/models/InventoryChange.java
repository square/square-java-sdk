...
public class InventoryChange {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(type, physicalCount, adjustment, transfer, measurementUnit, measurementUnitId);
    }
    ...
    public static class Builder {
        ...
        public InventoryChange build() {
            return new InventoryChange(type, physicalCount, adjustment, transfer, measurementUnit, measurementUnitId);
        }
    }
}
