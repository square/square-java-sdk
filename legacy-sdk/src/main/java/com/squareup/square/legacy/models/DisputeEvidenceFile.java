...
public class DisputeEvidenceFile {
     ...
     */
    @JsonCreator
    public DisputeEvidenceFile(@JsonProperty("filename") String filename, @JsonProperty("filetype") String filetype) {
     ...
     * @param  filetype  String value for filetype.
     */
    protected DisputeEvidenceFile(OptionalNullable<String> filename, OptionalNullable<String> filetype) {
