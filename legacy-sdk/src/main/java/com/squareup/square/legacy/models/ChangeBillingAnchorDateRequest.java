...
public class ChangeBillingAnchorDateRequest {
     ...
     * @param  effectiveDate  String value for effectiveDate.
     */
    protected ChangeBillingAnchorDateRequest(
            OptionalNullable<Integer> monthlyBillingAnchorDate, OptionalNullable<String> effectiveDate) {
    ...
    public String toString() {
        return "ChangeBillingAnchorDateRequest [" + "monthlyBillingAnchorDate=" + monthlyBillingAnchorDate
