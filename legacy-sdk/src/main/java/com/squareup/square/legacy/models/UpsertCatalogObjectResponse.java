...
public class UpsertCatalogObjectResponse {
    ...
    public String toString() {
        return "UpsertCatalogObjectResponse [" + "errors=" + errors + ", catalogObject=" + catalogObject
    ...
    public static class Builder {
        ...
        public UpsertCatalogObjectResponse build() {
            UpsertCatalogObjectResponse model = new UpsertCatalogObjectResponse(errors, catalogObject, idMappings);
