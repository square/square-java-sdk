...
public class LoyaltyPromotionIncentivePointsAdditionData {
     ...
     */
    @JsonCreator
    public LoyaltyPromotionIncentivePointsAdditionData(@JsonProperty("points_addition") int pointsAddition) {
    ...
    public boolean equals(Object obj) {
        ...
        LoyaltyPromotionIncentivePointsAdditionData other = (LoyaltyPromotionIncentivePointsAdditionData) obj;
