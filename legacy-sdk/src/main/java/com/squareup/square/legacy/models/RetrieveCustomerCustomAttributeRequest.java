...
public class RetrieveCustomerCustomAttributeRequest {
     ...
     * @param  version  Integer value for version.
     */
    protected RetrieveCustomerCustomAttributeRequest(OptionalNullable<Boolean> withDefinition, Integer version) {
    ...
    public String toString() {
        return "RetrieveCustomerCustomAttributeRequest [" + "withDefinition=" + withDefinition + ", version=" + version
                + "]";
    }
