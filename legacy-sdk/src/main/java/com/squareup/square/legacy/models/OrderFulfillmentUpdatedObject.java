...
public class OrderFulfillmentUpdatedObject {
    ...
    public String toString() {
        return "OrderFulfillmentUpdatedObject [" + "orderFulfillmentUpdated=" + orderFulfillmentUpdated + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().orderFulfillmentUpdated(getOrderFulfillmentUpdated());
        return builder;
    }
