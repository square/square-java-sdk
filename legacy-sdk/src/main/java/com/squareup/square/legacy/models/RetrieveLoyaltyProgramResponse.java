...
public class RetrieveLoyaltyProgramResponse {
    ...
    public RetrieveLoyaltyProgramResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("program") LoyaltyProgram program) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(program, other.program);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).program(getProgram());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveLoyaltyProgramResponse build() {
            RetrieveLoyaltyProgramResponse model = new RetrieveLoyaltyProgramResponse(errors, program);
