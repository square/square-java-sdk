...
public class LoyaltyEventDeleteReward {
    ...
    /**
     * Getter for RewardId.
     * The ID of the deleted [loyalty reward](entity:LoyaltyReward). This field is returned only if
    ...
    public String toString() {
        return "LoyaltyEventDeleteReward [" + "loyaltyProgramId=" + loyaltyProgramId + ", points=" + points
                + ", rewardId=" + rewardId + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(loyaltyProgramId, points).rewardId(getRewardId());
        return builder;
    }
