...
public interface BankAccountsApi {
     ...
     */
    ListBankAccountsResponse listBankAccounts(final String cursor, final Integer limit, final String locationId)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    GetBankAccountByV1IdResponse getBankAccountByV1Id(final String v1BankAccountId) throws ApiException, IOException;
     ...
     * @return    Returns the GetBankAccountByV1IdResponse response from the API call
     */
    CompletableFuture<GetBankAccountByV1IdResponse> getBankAccountByV1IdAsync(final String v1BankAccountId);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    GetBankAccountResponse getBankAccount(final String bankAccountId) throws ApiException, IOException;
     ...
     * @return    Returns the GetBankAccountResponse response from the API call
     */
    CompletableFuture<GetBankAccountResponse> getBankAccountAsync(final String bankAccountId);
}
