...
public class ListLoyaltyProgramsResponse {
    ...
    public ListLoyaltyProgramsResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("programs") List<LoyaltyProgram> programs) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(programs, other.programs);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).programs(getPrograms());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListLoyaltyProgramsResponse build() {
            ListLoyaltyProgramsResponse model = new ListLoyaltyProgramsResponse(errors, programs);
