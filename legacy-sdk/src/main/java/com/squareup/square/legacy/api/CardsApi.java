...
public interface CardsApi {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    CreateCardResponse createCard(final CreateCardRequest body) throws ApiException, IOException;
     ...
     * @return    Returns the CreateCardResponse response from the API call
     */
    CompletableFuture<CreateCardResponse> createCardAsync(final CreateCardRequest body);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    RetrieveCardResponse retrieveCard(final String cardId) throws ApiException, IOException;
     ...
     * @return    Returns the RetrieveCardResponse response from the API call
     */
    CompletableFuture<RetrieveCardResponse> retrieveCardAsync(final String cardId);
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    DisableCardResponse disableCard(final String cardId) throws ApiException, IOException;
     ...
     * @return    Returns the DisableCardResponse response from the API call
     */
    CompletableFuture<DisableCardResponse> disableCardAsync(final String cardId);
}
