...
public class UpdateMerchantCustomAttributeDefinitionRequest {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateMerchantCustomAttributeDefinitionRequest)) {
            return false;
        }
        UpdateMerchantCustomAttributeDefinitionRequest other = (UpdateMerchantCustomAttributeDefinitionRequest) obj;
    ...
    public String toString() {
        return "UpdateMerchantCustomAttributeDefinitionRequest [" + "customAttributeDefinition="
                + customAttributeDefinition + ", idempotencyKey=" + idempotencyKey + "]";
    }

    /**
     * Builds a new {@link UpdateMerchantCustomAttributeDefinitionRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UpdateMerchantCustomAttributeDefinitionRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UpdateMerchantCustomAttributeDefinitionRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UpdateMerchantCustomAttributeDefinitionRequest} object using the set
         * fields.
         * @return {@link UpdateMerchantCustomAttributeDefinitionRequest}
         */
        public UpdateMerchantCustomAttributeDefinitionRequest build() {
            return new UpdateMerchantCustomAttributeDefinitionRequest(customAttributeDefinition, idempotencyKey);
        }
    }
}
