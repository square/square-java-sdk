...
public class RetrieveInventoryCountResponse {
    ...
    public String toString() {
        return "RetrieveInventoryCountResponse [" + "errors=" + errors + ", counts=" + counts + ", cursor=" + cursor
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).counts(getCounts()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveInventoryCountResponse build() {
            RetrieveInventoryCountResponse model = new RetrieveInventoryCountResponse(errors, counts, cursor);
