...
public class AdjustLoyaltyPointsResponse {
    ...
    public AdjustLoyaltyPointsResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("event") LoyaltyEvent event) {
        this.errors = errors;
        this.event = event;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(event, other.event);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).event(getEvent());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public AdjustLoyaltyPointsResponse build() {
            AdjustLoyaltyPointsResponse model = new AdjustLoyaltyPointsResponse(errors, event);
