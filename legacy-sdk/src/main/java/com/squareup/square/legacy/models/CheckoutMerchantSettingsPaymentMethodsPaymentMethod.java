...
public class CheckoutMerchantSettingsPaymentMethodsPaymentMethod {
     ...
     */
    @JsonCreator
    public CheckoutMerchantSettingsPaymentMethodsPaymentMethod(@JsonProperty("enabled") Boolean enabled) {
     ...
     * @param  enabled  Boolean value for enabled.
     */
    protected CheckoutMerchantSettingsPaymentMethodsPaymentMethod(OptionalNullable<Boolean> enabled) {
