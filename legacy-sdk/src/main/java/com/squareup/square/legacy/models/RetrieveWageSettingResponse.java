...
public class RetrieveWageSettingResponse {
    ...
    public RetrieveWageSettingResponse(
            @JsonProperty("wage_setting") WageSetting wageSetting, @JsonProperty("errors") List<Error> errors) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(wageSetting, other.wageSetting) && Objects.equals(errors, other.errors);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().wageSetting(getWageSetting()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveWageSettingResponse build() {
            RetrieveWageSettingResponse model = new RetrieveWageSettingResponse(wageSetting, errors);
