...
public class ListCustomerCustomAttributeDefinitionsRequest {
     ...
     * @param  cursor  String value for cursor.
     */
    protected ListCustomerCustomAttributeDefinitionsRequest(
    ...
    public boolean equals(Object obj) {
        ...
        ListCustomerCustomAttributeDefinitionsRequest other = (ListCustomerCustomAttributeDefinitionsRequest) obj;
    ...
    public String toString() {
        return "ListCustomerCustomAttributeDefinitionsRequest [" + "limit=" + limit + ", cursor=" + cursor + "]";
    }
