...
public class BankAccountPaymentDetails {
     ...
     * @param  errors  List of Error value for errors.
     */
    protected BankAccountPaymentDetails(
            OptionalNullable<String> bankName,
            OptionalNullable<String> transferType,
            OptionalNullable<String> accountOwnershipType,
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().achDetails(getAchDetails());
