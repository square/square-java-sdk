...
public class GetEmployeeWageResponse {
    ...
    public GetEmployeeWageResponse(
            @JsonProperty("employee_wage") EmployeeWage employeeWage, @JsonProperty("errors") List<Error> errors) {
     ...
     * `title` property of this object. Deprecated at version 2020-08-26. Use
     * [TeamMemberWage](entity:TeamMemberWage).
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(employeeWage, other.employeeWage) && Objects.equals(errors, other.errors);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().employeeWage(getEmployeeWage()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public GetEmployeeWageResponse build() {
            GetEmployeeWageResponse model = new GetEmployeeWageResponse(employeeWage, errors);
