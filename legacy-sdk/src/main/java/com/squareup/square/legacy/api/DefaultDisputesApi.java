...
import com.squareup.square.legacy.models.AcceptDisputeResponse;
import com.squareup.square.legacy.models.CreateDisputeEvidenceFileRequest;
import com.squareup.square.legacy.models.CreateDisputeEvidenceFileResponse;
import com.squareup.square.legacy.models.CreateDisputeEvidenceTextRequest;
import com.squareup.square.legacy.models.CreateDisputeEvidenceTextResponse;
import com.squareup.square.legacy.models.DeleteDisputeEvidenceResponse;
import com.squareup.square.legacy.models.ListDisputeEvidenceResponse;
import com.squareup.square.legacy.models.ListDisputesResponse;
import com.squareup.square.legacy.models.RetrieveDisputeEvidenceResponse;
import com.squareup.square.legacy.models.RetrieveDisputeResponse;
import com.squareup.square.legacy.models.SubmitEvidenceResponse;
...
public final class DefaultDisputesApi extends BaseApi implements DisputesApi {
     ...
     */
    public ListDisputesResponse listDisputes(final String cursor, final String states, final String locationId)
    ...
    public CompletableFuture<ListDisputesResponse> listDisputesAsync(
            final String cursor, final String states, final String locationId) {
        try {
    ...
    private ApiCall<ListDisputesResponse, ApiException> prepareListDisputesRequest(
            final String cursor, final String states, final String locationId) throws IOException {
        return new ApiCall.Builder<ListDisputesResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .queryParam(param -> param.key("states").value(states).isRequired(false))
                        .queryParam(param ->
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListDisputesResponse.class))
                        .nullify404(false)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public RetrieveDisputeResponse retrieveDispute(final String disputeId) throws ApiException, IOException {
     ...
     * @return    Returns the RetrieveDisputeResponse response from the API call
     */
    public CompletableFuture<RetrieveDisputeResponse> retrieveDisputeAsync(final String disputeId) {
        try {
     ...
     */
    private ApiCall<RetrieveDisputeResponse, ApiException> prepareRetrieveDisputeRequest(final String disputeId)
            throws IOException {
        return new ApiCall.Builder<RetrieveDisputeResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(param ->
                                param.key("dispute_id").value(disputeId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RetrieveDisputeResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public AcceptDisputeResponse acceptDispute(final String disputeId) throws ApiException, IOException {
     ...
     * @return    Returns the AcceptDisputeResponse response from the API call
     */
    public CompletableFuture<AcceptDisputeResponse> acceptDisputeAsync(final String disputeId) {
        try {
     ...
     */
    private ApiCall<AcceptDisputeResponse, ApiException> prepareAcceptDisputeRequest(final String disputeId)
            throws IOException {
        return new ApiCall.Builder<AcceptDisputeResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, AcceptDisputeResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public ListDisputeEvidenceResponse listDisputeEvidence(final String disputeId, final String cursor)
            throws ApiException, IOException {
    ...
    public CompletableFuture<ListDisputeEvidenceResponse> listDisputeEvidenceAsync(
            final String disputeId, final String cursor) {
        try {
    ...
    private ApiCall<ListDisputeEvidenceResponse, ApiException> prepareListDisputeEvidenceRequest(
            final String disputeId, final String cursor) throws IOException {
        return new ApiCall.Builder<ListDisputeEvidenceResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListDisputeEvidenceResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public CreateDisputeEvidenceFileResponse createDisputeEvidenceFile(
            final String disputeId, final CreateDisputeEvidenceFileRequest request, final FileWrapper imageFile)
            throws ApiException, IOException {
        return prepareCreateDisputeEvidenceFileRequest(disputeId, request, imageFile)
                .execute();
    }
        ...
        return new ApiCall.Builder<CreateDisputeEvidenceFileResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .formParam(param -> param.key("request")
                                .value(request)
                                .multipartSerializer(() -> ApiHelper.serialize(request))
    ...
    public CreateDisputeEvidenceTextResponse createDisputeEvidenceText(
            final String disputeId, final CreateDisputeEvidenceTextRequest body) throws ApiException, IOException {
    ...
    public CompletableFuture<CreateDisputeEvidenceTextResponse> createDisputeEvidenceTextAsync(
            final String disputeId, final CreateDisputeEvidenceTextRequest body) {
        try {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public DeleteDisputeEvidenceResponse deleteDisputeEvidence(final String disputeId, final String evidenceId)
            throws ApiException, IOException {
    ...
    public CompletableFuture<DeleteDisputeEvidenceResponse> deleteDisputeEvidenceAsync(
            final String disputeId, final String evidenceId) {
        try {
    ...
    private ApiCall<DeleteDisputeEvidenceResponse, ApiException> prepareDeleteDisputeEvidenceRequest(
            final String disputeId, final String evidenceId) throws IOException {
        return new ApiCall.Builder<DeleteDisputeEvidenceResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(param ->
                                param.key("dispute_id").value(disputeId).shouldEncode(true))
                        .templateParam(param ->
                                param.key("evidence_id").value(evidenceId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.DELETE))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, DeleteDisputeEvidenceResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public RetrieveDisputeEvidenceResponse retrieveDisputeEvidence(final String disputeId, final String evidenceId)
            throws ApiException, IOException {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public SubmitEvidenceResponse submitEvidence(final String disputeId) throws ApiException, IOException {
     ...
     * @return    Returns the SubmitEvidenceResponse response from the API call
     */
    public CompletableFuture<SubmitEvidenceResponse> submitEvidenceAsync(final String disputeId) {
        try {
     ...
     */
    private ApiCall<SubmitEvidenceResponse, ApiException> prepareSubmitEvidenceRequest(final String disputeId)
            throws IOException {
        return new ApiCall.Builder<SubmitEvidenceResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, SubmitEvidenceResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
