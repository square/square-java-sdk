...
import com.squareup.square.legacy.models.CancelPaymentByIdempotencyKeyRequest;
import com.squareup.square.legacy.models.CancelPaymentByIdempotencyKeyResponse;
import com.squareup.square.legacy.models.CancelPaymentResponse;
import com.squareup.square.legacy.models.CompletePaymentRequest;
import com.squareup.square.legacy.models.CompletePaymentResponse;
import com.squareup.square.legacy.models.CreatePaymentRequest;
import com.squareup.square.legacy.models.CreatePaymentResponse;
import com.squareup.square.legacy.models.GetPaymentResponse;
import com.squareup.square.legacy.models.ListPaymentsResponse;
import com.squareup.square.legacy.models.UpdatePaymentRequest;
import com.squareup.square.legacy.models.UpdatePaymentResponse;
...
public final class DefaultPaymentsApi extends BaseApi implements PaymentsApi {
    ...
    public ListPaymentsResponse listPayments(
        ...
        return prepareListPaymentsRequest(
                        beginTime,
                        endTime,
                        sortOrder,
                        cursor,
    ...
    private ApiCall<ListPaymentsResponse, ApiException> prepareListPaymentsRequest(
        ...
        return new ApiCall.Builder<ListPaymentsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .path("/v2/payments")
                        .queryParam(param ->
                                param.key("begin_time").value(beginTime).isRequired(false))
                        .queryParam(
                                param -> param.key("end_time").value(endTime).isRequired(false))
                        .queryParam(param ->
                        ...
                        .queryParam(param -> param.key("total").value(total).isRequired(false))
                        .queryParam(param -> param.key("last_4").value(last4).isRequired(false))
                        .queryParam(param ->
                                param.key("card_brand").value(cardBrand).isRequired(false))
                        .queryParam(param -> param.key("limit").value(limit).isRequired(false))
                        .queryParam(param -> param.key("is_offline_payment")
                                .value((isOfflinePayment != null) ? isOfflinePayment : false)
                                .isRequired(false))
                        .queryParam(param -> param.key("offline_begin_time")
                                .value(offlineBeginTime)
                                .isRequired(false))
                        .queryParam(param -> param.key("offline_end_time")
                                .value(offlineEndTime)
                                .isRequired(false))
                        .queryParam(param -> param.key("updated_at_begin_time")
                                .value(updatedAtBeginTime)
                                .isRequired(false))
                        .queryParam(param -> param.key("updated_at_end_time")
                                .value(updatedAtEndTime)
                                .isRequired(false))
                        .queryParam(param ->
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListPaymentsResponse.class))
                        .nullify404(false)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public CreatePaymentResponse createPayment(final CreatePaymentRequest body) throws ApiException, IOException {
     ...
     * @return    Returns the CreatePaymentResponse response from the API call
     */
    public CompletableFuture<CreatePaymentResponse> createPaymentAsync(final CreatePaymentRequest body) {
        try {
     ...
     */
    private ApiCall<CreatePaymentResponse, ApiException> prepareCreatePaymentRequest(final CreatePaymentRequest body)
        ...
        return new ApiCall.Builder<CreatePaymentResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CreatePaymentResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
        ...
        return new ApiCall.Builder<CancelPaymentByIdempotencyKeyResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, CancelPaymentByIdempotencyKeyResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public GetPaymentResponse getPayment(final String paymentId) throws ApiException, IOException {
     ...
     * @return    Returns the GetPaymentResponse response from the API call
     */
    public CompletableFuture<GetPaymentResponse> getPaymentAsync(final String paymentId) {
        try {
     ...
     */
    private ApiCall<GetPaymentResponse, ApiException> prepareGetPaymentRequest(final String paymentId)
            throws IOException {
        return new ApiCall.Builder<GetPaymentResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(param ->
                                param.key("payment_id").value(paymentId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, GetPaymentResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public UpdatePaymentResponse updatePayment(final String paymentId, final UpdatePaymentRequest body)
            throws ApiException, IOException {
    ...
    public CompletableFuture<UpdatePaymentResponse> updatePaymentAsync(
            final String paymentId, final UpdatePaymentRequest body) {
        try {
    ...
    private ApiCall<UpdatePaymentResponse, ApiException> prepareUpdatePaymentRequest(
            final String paymentId, final UpdatePaymentRequest body) throws JsonProcessingException, IOException {
        return new ApiCall.Builder<UpdatePaymentResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, UpdatePaymentResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public CancelPaymentResponse cancelPayment(final String paymentId) throws ApiException, IOException {
     ...
     * @return    Returns the CancelPaymentResponse response from the API call
     */
    public CompletableFuture<CancelPaymentResponse> cancelPaymentAsync(final String paymentId) {
        try {
     ...
     */
    private ApiCall<CancelPaymentResponse, ApiException> prepareCancelPaymentRequest(final String paymentId)
            throws IOException {
        return new ApiCall.Builder<CancelPaymentResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CancelPaymentResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public CompletePaymentResponse completePayment(final String paymentId, final CompletePaymentRequest body)
            throws ApiException, IOException {
    ...
    public CompletableFuture<CompletePaymentResponse> completePaymentAsync(
            final String paymentId, final CompletePaymentRequest body) {
        try {
    ...
    private ApiCall<CompletePaymentResponse, ApiException> prepareCompletePaymentRequest(
            final String paymentId, final CompletePaymentRequest body) throws JsonProcessingException, IOException {
        return new ApiCall.Builder<CompletePaymentResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CompletePaymentResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
