...
public class ListSubscriptionEventsRequest {
     ...
     */
    @JsonCreator
    public ListSubscriptionEventsRequest(@JsonProperty("cursor") String cursor, @JsonProperty("limit") Integer limit) {
     ...
     * @param  limit  Integer value for limit.
     */
    protected ListSubscriptionEventsRequest(OptionalNullable<String> cursor, OptionalNullable<Integer> limit) {
        this.cursor = cursor;
        this.limit = limit;
    }
