...
public class CashPaymentDetails {
    ...
    public String toString() {
        return "CashPaymentDetails [" + "buyerSuppliedMoney=" + buyerSuppliedMoney + ", changeBackMoney="
                + changeBackMoney + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(buyerSuppliedMoney).changeBackMoney(getChangeBackMoney());
        return builder;
    }
