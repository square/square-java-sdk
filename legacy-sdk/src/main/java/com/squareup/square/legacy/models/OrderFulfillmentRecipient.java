...
public class OrderFulfillmentRecipient {
     ...
     * @param  address  Address value for address.
     */
    protected OrderFulfillmentRecipient(
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().address(getAddress());
    ...
    public static class Builder {
        ...
        public OrderFulfillmentRecipient build() {
            return new OrderFulfillmentRecipient(customerId, displayName, emailAddress, phoneNumber, address);
        }
    }
}
