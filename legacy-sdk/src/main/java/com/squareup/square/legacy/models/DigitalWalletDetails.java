...
public class DigitalWalletDetails {
     ...
     * @param  cashAppDetails  CashAppDetails value for cashAppDetails.
     */
    protected DigitalWalletDetails(
            OptionalNullable<String> status, OptionalNullable<String> brand, CashAppDetails cashAppDetails) {
        this.status = status;
        this.brand = brand;
        this.cashAppDetails = cashAppDetails;
    }
    ...
    public String toString() {
        return "DigitalWalletDetails [" + "status=" + status + ", brand=" + brand + ", cashAppDetails=" + cashAppDetails
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().cashAppDetails(getCashAppDetails());
