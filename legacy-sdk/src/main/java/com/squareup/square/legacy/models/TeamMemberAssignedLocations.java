...
public class TeamMemberAssignedLocations {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(assignmentType, other.assignmentType) && Objects.equals(locationIds, other.locationIds);
    }
    ...
    public String toString() {
        return "TeamMemberAssignedLocations [" + "assignmentType=" + assignmentType + ", locationIds=" + locationIds
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().assignmentType(getAssignmentType());
