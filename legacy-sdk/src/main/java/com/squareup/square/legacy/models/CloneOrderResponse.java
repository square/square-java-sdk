...
public class CloneOrderResponse {
     ...
     */
    @JsonCreator
    public CloneOrderResponse(@JsonProperty("order") Order order, @JsonProperty("errors") List<Error> errors) {
        this.order = order;
        this.errors = errors;
    }
    ...
    public static class Builder {
        ...
        public CloneOrderResponse build() {
            CloneOrderResponse model = new CloneOrderResponse(order, errors);
