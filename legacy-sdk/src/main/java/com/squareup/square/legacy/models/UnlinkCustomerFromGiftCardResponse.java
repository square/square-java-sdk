...
public class UnlinkCustomerFromGiftCardResponse {
    ...
    public String toString() {
        return "UnlinkCustomerFromGiftCardResponse [" + "errors=" + errors + ", giftCard=" + giftCard + "]";
    }
    ...
    public static class Builder {
        ...
        public UnlinkCustomerFromGiftCardResponse build() {
            UnlinkCustomerFromGiftCardResponse model = new UnlinkCustomerFromGiftCardResponse(errors, giftCard);
