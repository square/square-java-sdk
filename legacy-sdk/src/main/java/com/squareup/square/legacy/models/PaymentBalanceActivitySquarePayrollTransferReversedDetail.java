...
public class PaymentBalanceActivitySquarePayrollTransferReversedDetail {
     ...
     */
    @JsonCreator
    public PaymentBalanceActivitySquarePayrollTransferReversedDetail(@JsonProperty("payment_id") String paymentId) {
     ...
     * @param  paymentId  String value for paymentId.
     */
    protected PaymentBalanceActivitySquarePayrollTransferReversedDetail(OptionalNullable<String> paymentId) {
    ...
    public String toString() {
        return "PaymentBalanceActivitySquarePayrollTransferReversedDetail [" + "paymentId=" + paymentId + "]";
    }
