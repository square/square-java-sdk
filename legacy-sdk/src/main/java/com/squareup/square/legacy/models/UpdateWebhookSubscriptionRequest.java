...
public class UpdateWebhookSubscriptionRequest {
     ...
     */
    @JsonCreator
    public UpdateWebhookSubscriptionRequest(@JsonProperty("subscription") WebhookSubscription subscription) {
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().subscription(getSubscription());
        return builder;
    }
