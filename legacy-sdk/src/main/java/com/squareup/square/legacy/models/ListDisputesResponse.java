...
public class ListDisputesResponse {
    ...
    public String toString() {
        return "ListDisputesResponse [" + "errors=" + errors + ", disputes=" + disputes + ", cursor=" + cursor + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().errors(getErrors()).disputes(getDisputes()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListDisputesResponse build() {
            ListDisputesResponse model = new ListDisputesResponse(errors, disputes, cursor);
