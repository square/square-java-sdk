...
public class CatalogObjectCategory {
     ...
     */
    @JsonCreator
    public CatalogObjectCategory(@JsonProperty("id") String id, @JsonProperty("ordinal") Long ordinal) {
        this.id = id;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(id, other.id) && Objects.equals(ordinal, other.ordinal);
    }
