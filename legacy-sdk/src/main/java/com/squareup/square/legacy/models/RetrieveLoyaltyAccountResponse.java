...
public class RetrieveLoyaltyAccountResponse {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(loyaltyAccount, other.loyaltyAccount);
    }
    ...
    public String toString() {
        return "RetrieveLoyaltyAccountResponse [" + "errors=" + errors + ", loyaltyAccount=" + loyaltyAccount + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).loyaltyAccount(getLoyaltyAccount());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveLoyaltyAccountResponse build() {
            RetrieveLoyaltyAccountResponse model = new RetrieveLoyaltyAccountResponse(errors, loyaltyAccount);
