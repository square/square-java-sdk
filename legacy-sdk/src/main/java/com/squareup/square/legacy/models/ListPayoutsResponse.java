...
public class ListPayoutsResponse {
    ...
    public String toString() {
        return "ListPayoutsResponse [" + "payouts=" + payouts + ", cursor=" + cursor + ", errors=" + errors + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().payouts(getPayouts()).cursor(getCursor()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListPayoutsResponse build() {
            ListPayoutsResponse model = new ListPayoutsResponse(payouts, cursor, errors);
