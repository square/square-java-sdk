...
public class UpdateInvoiceResponse {
     ...
     */
    @JsonCreator
    public UpdateInvoiceResponse(@JsonProperty("invoice") Invoice invoice, @JsonProperty("errors") List<Error> errors) {
    ...
    public static class Builder {
        ...
        public UpdateInvoiceResponse build() {
            UpdateInvoiceResponse model = new UpdateInvoiceResponse(invoice, errors);
