...
public class CreateTeamMemberRequest {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(idempotencyKey, other.idempotencyKey) && Objects.equals(teamMember, other.teamMember);
    }
    ...
    public String toString() {
        return "CreateTeamMemberRequest [" + "idempotencyKey=" + idempotencyKey + ", teamMember=" + teamMember + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().idempotencyKey(getIdempotencyKey()).teamMember(getTeamMember());
        return builder;
    }
