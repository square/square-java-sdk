...
public class SearchShiftsResponse {
    ...
    public String toString() {
        return "SearchShiftsResponse [" + "shifts=" + shifts + ", cursor=" + cursor + ", errors=" + errors + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().shifts(getShifts()).cursor(getCursor()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public SearchShiftsResponse build() {
            SearchShiftsResponse model = new SearchShiftsResponse(shifts, cursor, errors);
