...
public class SearchTerminalActionsResponse {
    ...
    public String toString() {
        return "SearchTerminalActionsResponse [" + "errors=" + errors + ", action=" + action + ", cursor=" + cursor
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).action(getAction()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public SearchTerminalActionsResponse build() {
            SearchTerminalActionsResponse model = new SearchTerminalActionsResponse(errors, action, cursor);
