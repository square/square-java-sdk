...
public class SearchAvailabilityResponse {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(availabilities, other.availabilities) && Objects.equals(errors, other.errors);
    }
    ...
    public String toString() {
        return "SearchAvailabilityResponse [" + "availabilities=" + availabilities + ", errors=" + errors + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().availabilities(getAvailabilities()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public SearchAvailabilityResponse build() {
            SearchAvailabilityResponse model = new SearchAvailabilityResponse(availabilities, errors);
