...
public class CreateCardResponse {
     ...
     */
    @JsonCreator
    public CreateCardResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("card") Card card) {
        this.errors = errors;
        this.card = card;
    }
    ...
    public static class Builder {
        ...
        public CreateCardResponse build() {
            CreateCardResponse model = new CreateCardResponse(errors, card);
