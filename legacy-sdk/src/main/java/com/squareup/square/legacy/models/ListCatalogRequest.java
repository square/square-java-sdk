...
public class ListCatalogRequest {
     ...
     * @param  catalogVersion  Long value for catalogVersion.
     */
    protected ListCatalogRequest(
            OptionalNullable<String> cursor, OptionalNullable<String> types, OptionalNullable<Long> catalogVersion) {
        this.cursor = cursor;
        this.types = types;
    ...
    public String toString() {
        return "ListCatalogRequest [" + "cursor=" + cursor + ", types=" + types + ", catalogVersion=" + catalogVersion
                + "]";
    }
