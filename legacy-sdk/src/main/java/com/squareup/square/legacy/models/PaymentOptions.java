...
public class PaymentOptions {
    ...
    protected PaymentOptions(
            OptionalNullable<Boolean> autocomplete,
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().delayAction(getDelayAction());
    ...
    public static class Builder {
        ...
        public PaymentOptions build() {
            return new PaymentOptions(autocomplete, delayDuration, acceptPartialAuthorization, delayAction);
        }
    }
}
