...
public class CreateWebhookSubscriptionResponse {
    ...
    public String toString() {
        return "CreateWebhookSubscriptionResponse [" + "errors=" + errors + ", subscription=" + subscription + "]";
    }
    ...
    public static class Builder {
        ...
        public CreateWebhookSubscriptionResponse build() {
            CreateWebhookSubscriptionResponse model = new CreateWebhookSubscriptionResponse(errors, subscription);
