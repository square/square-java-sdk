...
public class ListPaymentRefundsResponse {
    ...
    public String toString() {
        return "ListPaymentRefundsResponse [" + "errors=" + errors + ", refunds=" + refunds + ", cursor=" + cursor
                + "]";
    }
    ...
    public static class Builder {
        ...
        public ListPaymentRefundsResponse build() {
            ListPaymentRefundsResponse model = new ListPaymentRefundsResponse(errors, refunds, cursor);
