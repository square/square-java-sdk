...
public class GetPayoutResponse {
     ...
     */
    @JsonCreator
    public GetPayoutResponse(@JsonProperty("payout") Payout payout, @JsonProperty("errors") List<Error> errors) {
        this.payout = payout;
        this.errors = errors;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(payout, other.payout) && Objects.equals(errors, other.errors);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().payout(getPayout()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public GetPayoutResponse build() {
            GetPayoutResponse model = new GetPayoutResponse(payout, errors);
