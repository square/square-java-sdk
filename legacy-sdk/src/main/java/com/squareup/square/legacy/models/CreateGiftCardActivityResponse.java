...
public class CreateGiftCardActivityResponse {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(giftCardActivity, other.giftCardActivity);
    }
    ...
    public String toString() {
        return "CreateGiftCardActivityResponse [" + "errors=" + errors + ", giftCardActivity=" + giftCardActivity + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).giftCardActivity(getGiftCardActivity());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public CreateGiftCardActivityResponse build() {
            CreateGiftCardActivityResponse model = new CreateGiftCardActivityResponse(errors, giftCardActivity);
