...
public class ListTransactionsResponse {
    ...
    public String toString() {
        return "ListTransactionsResponse [" + "errors=" + errors + ", transactions=" + transactions + ", cursor="
                + cursor + "]";
    }
    ...
    public static class Builder {
        ...
        public ListTransactionsResponse build() {
            ListTransactionsResponse model = new ListTransactionsResponse(errors, transactions, cursor);
