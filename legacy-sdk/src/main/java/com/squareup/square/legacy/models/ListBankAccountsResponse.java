...
public class ListBankAccountsResponse {
    ...
    public String toString() {
        return "ListBankAccountsResponse [" + "errors=" + errors + ", bankAccounts=" + bankAccounts + ", cursor="
                + cursor + "]";
    }
    ...
    public static class Builder {
        ...
        public ListBankAccountsResponse build() {
            ListBankAccountsResponse model = new ListBankAccountsResponse(errors, bankAccounts, cursor);
