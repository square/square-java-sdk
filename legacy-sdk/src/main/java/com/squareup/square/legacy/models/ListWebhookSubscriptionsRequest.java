...
public class ListWebhookSubscriptionsRequest {
     ...
     * @param  limit  Integer value for limit.
     */
    protected ListWebhookSubscriptionsRequest(
            OptionalNullable<String> cursor,
            OptionalNullable<Boolean> includeDisabled,
            String sortOrder,
    ...
    public String toString() {
        return "ListWebhookSubscriptionsRequest [" + "cursor=" + cursor + ", includeDisabled=" + includeDisabled
