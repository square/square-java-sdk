...
public class Customer {
    ...
    protected Customer(
            ...
            String createdAt,
            String updatedAt,
            OptionalNullable<List<Card>> cards,
            ...
            OptionalNullable<List<String>> groupIds,
            OptionalNullable<List<String>> segmentIds,
            Long version,
     ...
     * calling [ListCards](api-endpoint:Cards-ListCards) (for credit and debit cards on file) or
