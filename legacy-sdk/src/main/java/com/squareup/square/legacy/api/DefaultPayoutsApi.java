...
import com.squareup.square.legacy.models.GetPayoutResponse;
import com.squareup.square.legacy.models.ListPayoutEntriesResponse;
import com.squareup.square.legacy.models.ListPayoutsResponse;
...
public final class DefaultPayoutsApi extends BaseApi implements PayoutsApi {
    ...
    public ListPayoutsResponse listPayouts(
        ...
        return prepareListPayoutsRequest(locationId, status, beginTime, endTime, sortOrder, cursor, limit)
                .execute();
    }
    ...
    private ApiCall<ListPayoutsResponse, ApiException> prepareListPayoutsRequest(
        ...
        return new ApiCall.Builder<ListPayoutsResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListPayoutsResponse.class))
                        .nullify404(false)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public GetPayoutResponse getPayout(final String payoutId) throws ApiException, IOException {
     ...
     * @return    Returns the GetPayoutResponse response from the API call
     */
    public CompletableFuture<GetPayoutResponse> getPayoutAsync(final String payoutId) {
        try {
     ...
     */
    private ApiCall<GetPayoutResponse, ApiException> prepareGetPayoutRequest(final String payoutId) throws IOException {
        return new ApiCall.Builder<GetPayoutResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(
                                param -> param.key("payout_id").value(payoutId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, GetPayoutResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public ListPayoutEntriesResponse listPayoutEntries(
            final String payoutId, final String sortOrder, final String cursor, final Integer limit)
            throws ApiException, IOException {
        return prepareListPayoutEntriesRequest(payoutId, sortOrder, cursor, limit)
                .execute();
    }
    ...
    private ApiCall<ListPayoutEntriesResponse, ApiException> prepareListPayoutEntriesRequest(
        ...
        return new ApiCall.Builder<ListPayoutEntriesResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListPayoutEntriesResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
