...
public class OrderCreated {
    ...
    public String toString() {
        return "OrderCreated [" + "orderId=" + orderId + ", version=" + version + ", locationId=" + locationId
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().version(getVersion()).state(getState()).createdAt(getCreatedAt());
