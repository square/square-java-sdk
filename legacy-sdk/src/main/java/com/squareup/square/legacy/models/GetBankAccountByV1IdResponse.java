...
public class GetBankAccountByV1IdResponse {
    ...
    public GetBankAccountByV1IdResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("bank_account") BankAccount bankAccount) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(bankAccount, other.bankAccount);
    }
    ...
    public String toString() {
        return "GetBankAccountByV1IdResponse [" + "errors=" + errors + ", bankAccount=" + bankAccount + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).bankAccount(getBankAccount());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public GetBankAccountByV1IdResponse build() {
            GetBankAccountByV1IdResponse model = new GetBankAccountByV1IdResponse(errors, bankAccount);
