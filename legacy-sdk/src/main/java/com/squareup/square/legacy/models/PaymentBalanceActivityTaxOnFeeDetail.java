...
public class PaymentBalanceActivityTaxOnFeeDetail {
     ...
     * @param  taxRateDescription  String value for taxRateDescription.
     */
    protected PaymentBalanceActivityTaxOnFeeDetail(
            OptionalNullable<String> paymentId, OptionalNullable<String> taxRateDescription) {
    ...
    public String toString() {
        return "PaymentBalanceActivityTaxOnFeeDetail [" + "paymentId=" + paymentId + ", taxRateDescription="
                + taxRateDescription + "]";
    }
