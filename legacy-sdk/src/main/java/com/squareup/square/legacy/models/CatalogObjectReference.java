...
public class CatalogObjectReference {
    ...
    public CatalogObjectReference(
            @JsonProperty("object_id") String objectId, @JsonProperty("catalog_version") Long catalogVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(objectId, other.objectId) && Objects.equals(catalogVersion, other.catalogVersion);
    }
    ...
    public String toString() {
        return "CatalogObjectReference [" + "objectId=" + objectId + ", catalogVersion=" + catalogVersion + "]";
    }
