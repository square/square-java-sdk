...
public class CancelBookingResponse {
     ...
     */
    @JsonCreator
    public CancelBookingResponse(@JsonProperty("booking") Booking booking, @JsonProperty("errors") List<Error> errors) {
    ...
    public static class Builder {
        ...
        public CancelBookingResponse build() {
            CancelBookingResponse model = new CancelBookingResponse(booking, errors);
