...
public class LoyaltyProgramAccrualRuleVisitData {
    ...
    public LoyaltyProgramAccrualRuleVisitData(
            @JsonProperty("tax_mode") String taxMode, @JsonProperty("minimum_amount_money") Money minimumAmountMoney) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(minimumAmountMoney, other.minimumAmountMoney) && Objects.equals(taxMode, other.taxMode);
    }
    ...
    public String toString() {
        return "LoyaltyProgramAccrualRuleVisitData [" + "taxMode=" + taxMode + ", minimumAmountMoney="
                + minimumAmountMoney + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(taxMode).minimumAmountMoney(getMinimumAmountMoney());
        return builder;
    }
