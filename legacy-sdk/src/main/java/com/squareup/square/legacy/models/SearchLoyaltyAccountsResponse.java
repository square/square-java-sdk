...
public class SearchLoyaltyAccountsResponse {
    ...
    public String toString() {
        return "SearchLoyaltyAccountsResponse [" + "errors=" + errors + ", loyaltyAccounts=" + loyaltyAccounts
                + ", cursor=" + cursor + "]";
    }
    ...
    public static class Builder {
        ...
        public SearchLoyaltyAccountsResponse build() {
            SearchLoyaltyAccountsResponse model = new SearchLoyaltyAccountsResponse(errors, loyaltyAccounts, cursor);
