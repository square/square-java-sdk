...
public class RetrieveLocationCustomAttributeRequest {
     ...
     * @param  version  Integer value for version.
     */
    protected RetrieveLocationCustomAttributeRequest(OptionalNullable<Boolean> withDefinition, Integer version) {
    ...
    public String toString() {
        return "RetrieveLocationCustomAttributeRequest [" + "withDefinition=" + withDefinition + ", version=" + version
                + "]";
    }
