...
public class CatalogCustomAttributeDefinitionStringConfig {
     ...
     */
    @JsonCreator
    public CatalogCustomAttributeDefinitionStringConfig(@JsonProperty("enforce_uniqueness") Boolean enforceUniqueness) {
     ...
     * @param  enforceUniqueness  Boolean value for enforceUniqueness.
     */
    protected CatalogCustomAttributeDefinitionStringConfig(OptionalNullable<Boolean> enforceUniqueness) {
    ...
    public boolean equals(Object obj) {
        ...
        CatalogCustomAttributeDefinitionStringConfig other = (CatalogCustomAttributeDefinitionStringConfig) obj;
    ...
    public String toString() {
        return "CatalogCustomAttributeDefinitionStringConfig [" + "enforceUniqueness=" + enforceUniqueness + "]";
    }
