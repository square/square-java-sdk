...
public class RetrieveCustomerGroupResponse {
    ...
    public RetrieveCustomerGroupResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("group") CustomerGroup group) {
        this.errors = errors;
        this.group = group;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(group, other.group);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).group(getGroup());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveCustomerGroupResponse build() {
            RetrieveCustomerGroupResponse model = new RetrieveCustomerGroupResponse(errors, group);
