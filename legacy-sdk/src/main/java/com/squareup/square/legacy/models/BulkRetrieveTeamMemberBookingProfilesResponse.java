...
public class BulkRetrieveTeamMemberBookingProfilesResponse {
    ...
    public boolean equals(Object obj) {
        ...
        BulkRetrieveTeamMemberBookingProfilesResponse other = (BulkRetrieveTeamMemberBookingProfilesResponse) obj;
    ...
    public static class Builder {
        ...
        public BulkRetrieveTeamMemberBookingProfilesResponse build() {
            BulkRetrieveTeamMemberBookingProfilesResponse model =
                    new BulkRetrieveTeamMemberBookingProfilesResponse(teamMemberBookingProfiles, errors);
