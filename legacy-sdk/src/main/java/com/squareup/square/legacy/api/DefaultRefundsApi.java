...
import com.squareup.square.legacy.models.GetPaymentRefundResponse;
import com.squareup.square.legacy.models.ListPaymentRefundsResponse;
import com.squareup.square.legacy.models.RefundPaymentRequest;
import com.squareup.square.legacy.models.RefundPaymentResponse;
...
public final class DefaultRefundsApi extends BaseApi implements RefundsApi {
    ...
    public ListPaymentRefundsResponse listPaymentRefunds(
        ...
        return prepareListPaymentRefundsRequest(
                        beginTime,
                        endTime,
                        sortOrder,
                        cursor,
    ...
    private ApiCall<ListPaymentRefundsResponse, ApiException> prepareListPaymentRefundsRequest(
        ...
        return new ApiCall.Builder<ListPaymentRefundsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .queryParam(param ->
                                param.key("source_type").value(sourceType).isRequired(false))
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListPaymentRefundsResponse.class))
                        .nullify404(false)
     ...
     * @return    Returns the RefundPaymentResponse response from the API call
     */
    public CompletableFuture<RefundPaymentResponse> refundPaymentAsync(final RefundPaymentRequest body) {
        try {
     ...
     */
    private ApiCall<RefundPaymentResponse, ApiException> prepareRefundPaymentRequest(final RefundPaymentRequest body)
     ...
     * @return    Returns the GetPaymentRefundResponse response from the API call
     */
    public CompletableFuture<GetPaymentRefundResponse> getPaymentRefundAsync(final String refundId) {
        try {
     ...
     */
    private ApiCall<GetPaymentRefundResponse, ApiException> prepareGetPaymentRefundRequest(final String refundId)
            throws IOException {
