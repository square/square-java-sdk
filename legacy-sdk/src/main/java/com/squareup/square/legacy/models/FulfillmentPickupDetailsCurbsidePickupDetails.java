...
public class FulfillmentPickupDetailsCurbsidePickupDetails {
    ...
    public boolean equals(Object obj) {
        ...
        FulfillmentPickupDetailsCurbsidePickupDetails other = (FulfillmentPickupDetailsCurbsidePickupDetails) obj;
    ...
    public String toString() {
        return "FulfillmentPickupDetailsCurbsidePickupDetails [" + "curbsideDetails=" + curbsideDetails
    ...
    public static class Builder {
        ...
        public FulfillmentPickupDetailsCurbsidePickupDetails build() {
            return new FulfillmentPickupDetailsCurbsidePickupDetails(curbsideDetails, buyerArrivedAt);
        }
    }
}
