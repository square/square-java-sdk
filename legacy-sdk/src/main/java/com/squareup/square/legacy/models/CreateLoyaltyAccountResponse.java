...
public class CreateLoyaltyAccountResponse {
    ...
    public String toString() {
        return "CreateLoyaltyAccountResponse [" + "errors=" + errors + ", loyaltyAccount=" + loyaltyAccount + "]";
    }
    ...
    public static class Builder {
        ...
        public CreateLoyaltyAccountResponse build() {
            CreateLoyaltyAccountResponse model = new CreateLoyaltyAccountResponse(errors, loyaltyAccount);
