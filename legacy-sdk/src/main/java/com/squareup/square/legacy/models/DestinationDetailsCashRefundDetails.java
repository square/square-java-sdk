...
public class DestinationDetailsCashRefundDetails {
    ...
    public String toString() {
        return "DestinationDetailsCashRefundDetails [" + "sellerSuppliedMoney=" + sellerSuppliedMoney
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(sellerSuppliedMoney).changeBackMoney(getChangeBackMoney());
        return builder;
    }
