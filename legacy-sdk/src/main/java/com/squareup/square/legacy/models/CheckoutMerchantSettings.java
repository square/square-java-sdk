...
public class CheckoutMerchantSettings {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(paymentMethods, other.paymentMethods) && Objects.equals(updatedAt, other.updatedAt);
    }
    ...
    public String toString() {
        return "CheckoutMerchantSettings [" + "paymentMethods=" + paymentMethods + ", updatedAt=" + updatedAt + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().paymentMethods(getPaymentMethods()).updatedAt(getUpdatedAt());
        return builder;
    }
