...
public class CalculateOrderResponse {
     ...
     */
    @JsonCreator
    public CalculateOrderResponse(@JsonProperty("order") Order order, @JsonProperty("errors") List<Error> errors) {
        this.order = order;
        this.errors = errors;
    }
    ...
    public static class Builder {
        ...
        public CalculateOrderResponse build() {
            CalculateOrderResponse model = new CalculateOrderResponse(order, errors);
