...
public class RetrieveOrderCustomAttributeRequest {
    ...
    public RetrieveOrderCustomAttributeRequest(
            @JsonProperty("version") Integer version, @JsonProperty("with_definition") Boolean withDefinition) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(version, other.version) && Objects.equals(withDefinition, other.withDefinition);
    }
    ...
    public String toString() {
        return "RetrieveOrderCustomAttributeRequest [" + "version=" + version + ", withDefinition=" + withDefinition
                + "]";
    }
