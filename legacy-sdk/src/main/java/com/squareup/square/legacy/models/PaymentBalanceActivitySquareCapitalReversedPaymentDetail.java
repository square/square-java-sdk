...
public class PaymentBalanceActivitySquareCapitalReversedPaymentDetail {
     ...
     */
    @JsonCreator
    public PaymentBalanceActivitySquareCapitalReversedPaymentDetail(@JsonProperty("payment_id") String paymentId) {
     ...
     * @param  paymentId  String value for paymentId.
     */
    protected PaymentBalanceActivitySquareCapitalReversedPaymentDetail(OptionalNullable<String> paymentId) {
    ...
    public String toString() {
        return "PaymentBalanceActivitySquareCapitalReversedPaymentDetail [" + "paymentId=" + paymentId + "]";
    }
