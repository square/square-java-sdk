...
public class ListTeamMemberBookingProfilesRequest {
     ...
     * @param  locationId  String value for locationId.
     */
    protected ListTeamMemberBookingProfilesRequest(
            OptionalNullable<Boolean> bookableOnly,
    ...
    public String toString() {
        return "ListTeamMemberBookingProfilesRequest [" + "bookableOnly=" + bookableOnly + ", limit=" + limit
                + ", cursor=" + cursor + ", locationId=" + locationId + "]";
    }
    ...
    public static class Builder {
        ...
        public ListTeamMemberBookingProfilesRequest build() {
            return new ListTeamMemberBookingProfilesRequest(bookableOnly, limit, cursor, locationId);
        }
    }
}
