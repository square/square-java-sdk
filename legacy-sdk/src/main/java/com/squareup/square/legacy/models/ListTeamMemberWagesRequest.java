...
public class ListTeamMemberWagesRequest {
     ...
     * @param  cursor  String value for cursor.
     */
    protected ListTeamMemberWagesRequest(
            OptionalNullable<String> teamMemberId, OptionalNullable<Integer> limit, OptionalNullable<String> cursor) {
    ...
    public String toString() {
        return "ListTeamMemberWagesRequest [" + "teamMemberId=" + teamMemberId + ", limit=" + limit + ", cursor="
                + cursor + "]";
    }
