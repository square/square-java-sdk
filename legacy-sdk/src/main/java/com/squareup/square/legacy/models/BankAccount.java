...
public class BankAccount {
    ...
    public BankAccount(
        ...
        this.secondaryBankIdentificationNumber = OptionalNullable.of(secondaryBankIdentificationNumber);
    ...
    protected BankAccount(
            ...
            OptionalNullable<String> debitMandateReferenceId,
            OptionalNullable<String> referenceId,
            OptionalNullable<String> locationId,
            OptionalNullable<String> fingerprint,
            Integer version,
            OptionalNullable<String> bankName) {
        this.id = id;
        this.accountNumberSuffix = accountNumberSuffix;
        this.country = country;
        this.currency = currency;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(id, other.id)
                ...
                && Objects.equals(primaryBankIdentificationNumber, other.primaryBankIdentificationNumber)
                && Objects.equals(secondaryBankIdentificationNumber, other.secondaryBankIdentificationNumber)
