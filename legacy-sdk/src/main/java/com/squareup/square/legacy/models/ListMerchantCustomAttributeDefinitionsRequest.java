...
public class ListMerchantCustomAttributeDefinitionsRequest {
     ...
     * @param  cursor  String value for cursor.
     */
    protected ListMerchantCustomAttributeDefinitionsRequest(
    ...
    public boolean equals(Object obj) {
        ...
        ListMerchantCustomAttributeDefinitionsRequest other = (ListMerchantCustomAttributeDefinitionsRequest) obj;
    ...
    public String toString() {
        return "ListMerchantCustomAttributeDefinitionsRequest [" + "visibilityFilter=" + visibilityFilter + ", limit="
                + limit + ", cursor=" + cursor + "]";
    }

    /**
     * Builds a new {@link ListMerchantCustomAttributeDefinitionsRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListMerchantCustomAttributeDefinitionsRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListMerchantCustomAttributeDefinitionsRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListMerchantCustomAttributeDefinitionsRequest} object using the set
         * fields.
         * @return {@link ListMerchantCustomAttributeDefinitionsRequest}
         */
        public ListMerchantCustomAttributeDefinitionsRequest build() {
            return new ListMerchantCustomAttributeDefinitionsRequest(visibilityFilter, limit, cursor);
        }
    }
}
