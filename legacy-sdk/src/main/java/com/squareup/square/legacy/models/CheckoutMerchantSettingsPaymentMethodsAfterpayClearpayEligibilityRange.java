...
public class CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange {
    ...
    public CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange(
            @JsonProperty("min") Money min, @JsonProperty("max") Money max) {
        this.min = min;
        this.max = max;
    }
    ...
    public String toString() {
        return "CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange [" + "min=" + min + ", max="
                + max + "]";
    }
    ...
    public static class Builder {
        ...
        public CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange build() {
            return new CheckoutMerchantSettingsPaymentMethodsAfterpayClearpayEligibilityRange(min, max);
        }
    }
}
