...
public class ListMerchantCustomAttributesResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ListMerchantCustomAttributesResponse)) {
            return false;
        }
        ListMerchantCustomAttributesResponse other = (ListMerchantCustomAttributesResponse) obj;
    ...
    public String toString() {
        return "ListMerchantCustomAttributesResponse [" + "customAttributes=" + customAttributes + ", cursor=" + cursor
                + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link ListMerchantCustomAttributesResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListMerchantCustomAttributesResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListMerchantCustomAttributesResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListMerchantCustomAttributesResponse} object using the set fields.
         * @return {@link ListMerchantCustomAttributesResponse}
         */
        public ListMerchantCustomAttributesResponse build() {
            ListMerchantCustomAttributesResponse model =
                    new ListMerchantCustomAttributesResponse(customAttributes, cursor, errors);
