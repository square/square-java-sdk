...
public class RedeemLoyaltyRewardRequest {
    ...
    public RedeemLoyaltyRewardRequest(
            @JsonProperty("idempotency_key") String idempotencyKey, @JsonProperty("location_id") String locationId) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(idempotencyKey, other.idempotencyKey) && Objects.equals(locationId, other.locationId);
    }
    ...
    public String toString() {
        return "RedeemLoyaltyRewardRequest [" + "idempotencyKey=" + idempotencyKey + ", locationId=" + locationId + "]";
    }
