...
public class UpdateWorkweekConfigResponse {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(workweekConfig, other.workweekConfig) && Objects.equals(errors, other.errors);
    }
    ...
    public String toString() {
        return "UpdateWorkweekConfigResponse [" + "workweekConfig=" + workweekConfig + ", errors=" + errors + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().workweekConfig(getWorkweekConfig()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public UpdateWorkweekConfigResponse build() {
            UpdateWorkweekConfigResponse model = new UpdateWorkweekConfigResponse(workweekConfig, errors);
