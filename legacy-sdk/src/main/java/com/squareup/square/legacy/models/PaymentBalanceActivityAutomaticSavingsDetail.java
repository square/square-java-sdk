...
public class PaymentBalanceActivityAutomaticSavingsDetail {
    ...
    public PaymentBalanceActivityAutomaticSavingsDetail(
            @JsonProperty("payment_id") String paymentId, @JsonProperty("payout_id") String payoutId) {
     ...
     * @param  payoutId  String value for payoutId.
     */
    protected PaymentBalanceActivityAutomaticSavingsDetail(
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(paymentId, other.paymentId) && Objects.equals(payoutId, other.payoutId);
    }
    ...
    public String toString() {
        return "PaymentBalanceActivityAutomaticSavingsDetail [" + "paymentId=" + paymentId + ", payoutId=" + payoutId
                + "]";
    }
