...
public class CreateInvoiceAttachmentResponse {
    ...
    public CreateInvoiceAttachmentResponse(
            @JsonProperty("attachment") InvoiceAttachment attachment, @JsonProperty("errors") List<Error> errors) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(attachment, other.attachment) && Objects.equals(errors, other.errors);
    }
    ...
    public String toString() {
        return "CreateInvoiceAttachmentResponse [" + "attachment=" + attachment + ", errors=" + errors + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().attachment(getAttachment()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public CreateInvoiceAttachmentResponse build() {
            CreateInvoiceAttachmentResponse model = new CreateInvoiceAttachmentResponse(attachment, errors);
