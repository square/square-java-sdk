...
public class BatchRetrieveCatalogObjectsResponse {
     ...
     * A list of [CatalogObject](entity:CatalogObject)s referenced by the object in the `objects`
     * field.
     * @return Returns the List of CatalogObject
     */
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().errors(getErrors()).objects(getObjects()).relatedObjects(getRelatedObjects());
        return builder;
    }
