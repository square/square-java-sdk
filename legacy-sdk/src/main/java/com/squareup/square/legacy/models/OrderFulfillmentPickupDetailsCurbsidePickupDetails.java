...
public class OrderFulfillmentPickupDetailsCurbsidePickupDetails {
    ...
    public String toString() {
        return "OrderFulfillmentPickupDetailsCurbsidePickupDetails [" + "curbsideDetails=" + curbsideDetails
    ...
    public static class Builder {
        ...
        public OrderFulfillmentPickupDetailsCurbsidePickupDetails build() {
            return new OrderFulfillmentPickupDetailsCurbsidePickupDetails(curbsideDetails, buyerArrivedAt);
        }
    }
}
