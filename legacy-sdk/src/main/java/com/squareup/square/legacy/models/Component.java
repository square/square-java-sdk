...
public class Component {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(type, applicationDetails, cardReaderDetails, batteryDetails, wifiDetails, ethernetDetails);
    }
    ...
    public static class Builder {
        ...
        public Component build() {
            return new Component(
                    type, applicationDetails, cardReaderDetails, batteryDetails, wifiDetails, ethernetDetails);
        }
    }
}
