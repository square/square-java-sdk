...
public class EmployeeWage {
    ...
    protected EmployeeWage(
            String id, OptionalNullable<String> employeeId, OptionalNullable<String> title, Money hourlyRate) {
        this.id = id;
    ...
    public String toString() {
        return "EmployeeWage [" + "id=" + id + ", employeeId=" + employeeId + ", title=" + title + ", hourlyRate="
                + hourlyRate + "]";
    }
