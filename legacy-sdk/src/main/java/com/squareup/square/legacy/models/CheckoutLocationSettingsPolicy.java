...
public class CheckoutLocationSettingsPolicy {
     ...
     * @param  description  String value for description.
     */
    protected CheckoutLocationSettingsPolicy(
            OptionalNullable<String> uid, OptionalNullable<String> title, OptionalNullable<String> description) {
        this.uid = uid;
        this.title = title;
    ...
    public String toString() {
        return "CheckoutLocationSettingsPolicy [" + "uid=" + uid + ", title=" + title + ", description=" + description
                + "]";
    }
