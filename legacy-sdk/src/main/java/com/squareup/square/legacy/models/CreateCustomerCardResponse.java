...
public class CreateCustomerCardResponse {
     ...
     */
    @JsonCreator
    public CreateCustomerCardResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("card") Card card) {
        this.errors = errors;
        this.card = card;
    }
    ...
    public static class Builder {
        ...
        public CreateCustomerCardResponse build() {
            CreateCustomerCardResponse model = new CreateCustomerCardResponse(errors, card);
