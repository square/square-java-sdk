...
public class UpdateWebhookSubscriptionSignatureKeyResponse {
    ...
    public UpdateWebhookSubscriptionSignatureKeyResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("signature_key") String signatureKey) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(signatureKey, other.signatureKey);
    }
    ...
    public String toString() {
        return "UpdateWebhookSubscriptionSignatureKeyResponse [" + "errors=" + errors + ", signatureKey=" + signatureKey
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).signatureKey(getSignatureKey());
        return builder;
    }
