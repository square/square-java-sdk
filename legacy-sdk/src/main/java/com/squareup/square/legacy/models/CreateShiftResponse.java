...
public class CreateShiftResponse {
     ...
     */
    @JsonCreator
    public CreateShiftResponse(@JsonProperty("shift") Shift shift, @JsonProperty("errors") List<Error> errors) {
        this.shift = shift;
        this.errors = errors;
    }
    ...
    public static class Builder {
        ...
        public CreateShiftResponse build() {
            CreateShiftResponse model = new CreateShiftResponse(shift, errors);
