...
public class DeleteCatalogObjectResponse {
    ...
    public String toString() {
        return "DeleteCatalogObjectResponse [" + "errors=" + errors + ", deletedObjectIds=" + deletedObjectIds
                + ", deletedAt=" + deletedAt + "]";
    }
    ...
    public static class Builder {
        ...
        public DeleteCatalogObjectResponse build() {
            DeleteCatalogObjectResponse model = new DeleteCatalogObjectResponse(errors, deletedObjectIds, deletedAt);
