...
public interface OrderCustomAttributesApi {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    DeleteOrderCustomAttributeDefinitionResponse deleteOrderCustomAttributeDefinition(final String key)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    DeleteOrderCustomAttributeResponse deleteOrderCustomAttribute(final String orderId, final String customAttributeKey)
            throws ApiException, IOException;
