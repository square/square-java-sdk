...
public class OrderReturnTip {
     ...
     * @param  sourceTenderId  String value for sourceTenderId.
     */
    protected OrderReturnTip(
            OptionalNullable<String> uid,
            Money appliedMoney,
            OptionalNullable<String> sourceTenderUid,
            OptionalNullable<String> sourceTenderId) {
        this.uid = uid;
        this.appliedMoney = appliedMoney;
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().appliedMoney(getAppliedMoney());
