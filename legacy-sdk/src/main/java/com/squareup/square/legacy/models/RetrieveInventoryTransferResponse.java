...
public class RetrieveInventoryTransferResponse {
    ...
    public RetrieveInventoryTransferResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("transfer") InventoryTransfer transfer) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(transfer, other.transfer);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).transfer(getTransfer());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveInventoryTransferResponse build() {
            RetrieveInventoryTransferResponse model = new RetrieveInventoryTransferResponse(errors, transfer);
