...
public class ListCustomerCustomAttributeDefinitionsResponse {
    ...
    public boolean equals(Object obj) {
        ...
        ListCustomerCustomAttributeDefinitionsResponse other = (ListCustomerCustomAttributeDefinitionsResponse) obj;
    ...
    public static class Builder {
        ...
        public ListCustomerCustomAttributeDefinitionsResponse build() {
            ListCustomerCustomAttributeDefinitionsResponse model =
                    new ListCustomerCustomAttributeDefinitionsResponse(customAttributeDefinitions, cursor, errors);
