...
import com.squareup.square.legacy.models.CreateCustomerGroupRequest;
import com.squareup.square.legacy.models.CreateCustomerGroupResponse;
import com.squareup.square.legacy.models.DeleteCustomerGroupResponse;
import com.squareup.square.legacy.models.ListCustomerGroupsResponse;
import com.squareup.square.legacy.models.RetrieveCustomerGroupResponse;
import com.squareup.square.legacy.models.UpdateCustomerGroupRequest;
import com.squareup.square.legacy.models.UpdateCustomerGroupResponse;
...
public final class DefaultCustomerGroupsApi extends BaseApi implements CustomerGroupsApi {
     ...
     */
    public ListCustomerGroupsResponse listCustomerGroups(final String cursor, final Integer limit)
    ...
    private ApiCall<ListCustomerGroupsResponse, ApiException> prepareListCustomerGroupsRequest(
        ...
        return new ApiCall.Builder<ListCustomerGroupsResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListCustomerGroupsResponse.class))
                        .nullify404(false)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public CreateCustomerGroupResponse createCustomerGroup(final CreateCustomerGroupRequest body)
            throws ApiException, IOException {
    ...
    private ApiCall<CreateCustomerGroupResponse, ApiException> prepareCreateCustomerGroupRequest(
        ...
        return new ApiCall.Builder<CreateCustomerGroupResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CreateCustomerGroupResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public DeleteCustomerGroupResponse deleteCustomerGroup(final String groupId) throws ApiException, IOException {
     ...
     * @return    Returns the DeleteCustomerGroupResponse response from the API call
     */
    public CompletableFuture<DeleteCustomerGroupResponse> deleteCustomerGroupAsync(final String groupId) {
        try {
     ...
     */
    private ApiCall<DeleteCustomerGroupResponse, ApiException> prepareDeleteCustomerGroupRequest(final String groupId)
            throws IOException {
        return new ApiCall.Builder<DeleteCustomerGroupResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, DeleteCustomerGroupResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public RetrieveCustomerGroupResponse retrieveCustomerGroup(final String groupId) throws ApiException, IOException {
     ...
     * @return    Returns the RetrieveCustomerGroupResponse response from the API call
     */
    public CompletableFuture<RetrieveCustomerGroupResponse> retrieveCustomerGroupAsync(final String groupId) {
        try {
    ...
    private ApiCall<RetrieveCustomerGroupResponse, ApiException> prepareRetrieveCustomerGroupRequest(
        ...
        return new ApiCall.Builder<RetrieveCustomerGroupResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RetrieveCustomerGroupResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public UpdateCustomerGroupResponse updateCustomerGroup(final String groupId, final UpdateCustomerGroupRequest body)
            throws ApiException, IOException {
    ...
    public CompletableFuture<UpdateCustomerGroupResponse> updateCustomerGroupAsync(
            final String groupId, final UpdateCustomerGroupRequest body) {
        try {
    ...
    private ApiCall<UpdateCustomerGroupResponse, ApiException> prepareUpdateCustomerGroupRequest(
            final String groupId, final UpdateCustomerGroupRequest body) throws JsonProcessingException, IOException {
        return new ApiCall.Builder<UpdateCustomerGroupResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, UpdateCustomerGroupResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
