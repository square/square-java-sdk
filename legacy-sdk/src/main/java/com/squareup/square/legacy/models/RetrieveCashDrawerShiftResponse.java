...
public class RetrieveCashDrawerShiftResponse {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(cashDrawerShift, other.cashDrawerShift) && Objects.equals(errors, other.errors);
    }
    ...
    public String toString() {
        return "RetrieveCashDrawerShiftResponse [" + "cashDrawerShift=" + cashDrawerShift + ", errors=" + errors + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().cashDrawerShift(getCashDrawerShift()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveCashDrawerShiftResponse build() {
            RetrieveCashDrawerShiftResponse model = new RetrieveCashDrawerShiftResponse(cashDrawerShift, errors);
