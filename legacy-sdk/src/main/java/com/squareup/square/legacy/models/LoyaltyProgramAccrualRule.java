...
public class LoyaltyProgramAccrualRule {
     ...
     * @param  categoryData  LoyaltyProgramAccrualRuleCategoryData value for categoryData.
     */
    protected LoyaltyProgramAccrualRule(
            String accrualType,
            OptionalNullable<Integer> points,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(accrualType, points, visitData, spendData, itemVariationData, categoryData);
    }
    ...
    public static class Builder {
        ...
        public LoyaltyProgramAccrualRule build() {
            return new LoyaltyProgramAccrualRule(
                    accrualType, points, visitData, spendData, itemVariationData, categoryData);
        }
    }
}
