...
public class RetrieveCustomerResponse {
    ...
    public RetrieveCustomerResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("customer") Customer customer) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(customer, other.customer);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).customer(getCustomer());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveCustomerResponse build() {
            RetrieveCustomerResponse model = new RetrieveCustomerResponse(errors, customer);
