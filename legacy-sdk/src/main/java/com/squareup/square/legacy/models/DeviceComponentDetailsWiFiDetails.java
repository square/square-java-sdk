...
public class DeviceComponentDetailsWiFiDetails {
     ...
     * @param  signalStrength  DeviceComponentDetailsMeasurement value for signalStrength.
     */
    protected DeviceComponentDetailsWiFiDetails(
            OptionalNullable<Boolean> active,
            OptionalNullable<String> ssid,
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().signalStrength(getSignalStrength());
    ...
    public static class Builder {
        ...
        public DeviceComponentDetailsWiFiDetails build() {
            return new DeviceComponentDetailsWiFiDetails(active, ssid, ipAddressV4, secureConnection, signalStrength);
        }
    }
}
