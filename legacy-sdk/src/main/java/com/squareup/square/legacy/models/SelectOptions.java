...
public class SelectOptions {
    ...
    public String toString() {
        return "SelectOptions [" + "title=" + title + ", body=" + body + ", options=" + options + ", selectedOption="
                + selectedOption + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(title, body, options).selectedOption(getSelectedOption());
        return builder;
    }
