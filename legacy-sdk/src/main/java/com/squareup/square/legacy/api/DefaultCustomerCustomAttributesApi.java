...
import com.squareup.square.legacy.models.BulkUpsertCustomerCustomAttributesRequest;
import com.squareup.square.legacy.models.BulkUpsertCustomerCustomAttributesResponse;
import com.squareup.square.legacy.models.CreateCustomerCustomAttributeDefinitionRequest;
import com.squareup.square.legacy.models.CreateCustomerCustomAttributeDefinitionResponse;
import com.squareup.square.legacy.models.DeleteCustomerCustomAttributeDefinitionResponse;
import com.squareup.square.legacy.models.DeleteCustomerCustomAttributeResponse;
import com.squareup.square.legacy.models.ListCustomerCustomAttributeDefinitionsResponse;
import com.squareup.square.legacy.models.ListCustomerCustomAttributesResponse;
import com.squareup.square.legacy.models.RetrieveCustomerCustomAttributeDefinitionResponse;
import com.squareup.square.legacy.models.RetrieveCustomerCustomAttributeResponse;
import com.squareup.square.legacy.models.UpdateCustomerCustomAttributeDefinitionRequest;
import com.squareup.square.legacy.models.UpdateCustomerCustomAttributeDefinitionResponse;
import com.squareup.square.legacy.models.UpsertCustomerCustomAttributeRequest;
import com.squareup.square.legacy.models.UpsertCustomerCustomAttributeResponse;
...
public final class DefaultCustomerCustomAttributesApi extends BaseApi implements CustomerCustomAttributesApi {
    ...
    public ListCustomerCustomAttributeDefinitionsResponse listCustomerCustomAttributeDefinitions(
        ...
        return prepareListCustomerCustomAttributeDefinitionsRequest(limit, cursor)
                .execute();
    }
     ...
     * @return    Returns the ListCustomerCustomAttributeDefinitionsResponse response from the API call
     */
    public CompletableFuture<ListCustomerCustomAttributeDefinitionsResponse>
            listCustomerCustomAttributeDefinitionsAsync(final Integer limit, final String cursor) {
        try {
            return prepareListCustomerCustomAttributeDefinitionsRequest(limit, cursor)
                    .executeAsync();
        } catch (Exception e) {
     ...
     */
    private ApiCall<ListCustomerCustomAttributeDefinitionsResponse, ApiException>
            prepareListCustomerCustomAttributeDefinitionsRequest(final Integer limit, final String cursor)
                    throws IOException {
        return new ApiCall.Builder<ListCustomerCustomAttributeDefinitionsResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, ListCustomerCustomAttributeDefinitionsResponse.class))
                        .nullify404(false)
     ...
     * @return    Returns the CreateCustomerCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<CreateCustomerCustomAttributeDefinitionResponse>
            createCustomerCustomAttributeDefinitionAsync(final CreateCustomerCustomAttributeDefinitionRequest body) {
        try {
     ...
     */
    private ApiCall<CreateCustomerCustomAttributeDefinitionResponse, ApiException>
            prepareCreateCustomerCustomAttributeDefinitionRequest(
        ...
        return new ApiCall.Builder<CreateCustomerCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, CreateCustomerCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public DeleteCustomerCustomAttributeDefinitionResponse deleteCustomerCustomAttributeDefinition(final String key)
     ...
     * @return    Returns the DeleteCustomerCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<DeleteCustomerCustomAttributeDefinitionResponse>
            deleteCustomerCustomAttributeDefinitionAsync(final String key) {
        try {
     ...
     */
    private ApiCall<DeleteCustomerCustomAttributeDefinitionResponse, ApiException>
            prepareDeleteCustomerCustomAttributeDefinitionRequest(final String key) throws IOException {
        return new ApiCall.Builder<DeleteCustomerCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, DeleteCustomerCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public RetrieveCustomerCustomAttributeDefinitionResponse retrieveCustomerCustomAttributeDefinition(
        ...
        return prepareRetrieveCustomerCustomAttributeDefinitionRequest(key, version)
                .execute();
    }
     ...
     * @return    Returns the RetrieveCustomerCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<RetrieveCustomerCustomAttributeDefinitionResponse>
            retrieveCustomerCustomAttributeDefinitionAsync(final String key, final Integer version) {
        try {
            return prepareRetrieveCustomerCustomAttributeDefinitionRequest(key, version)
                    .executeAsync();
        } catch (Exception e) {
     ...
     */
    private ApiCall<RetrieveCustomerCustomAttributeDefinitionResponse, ApiException>
            prepareRetrieveCustomerCustomAttributeDefinitionRequest(final String key, final Integer version)
                    throws IOException {
        return new ApiCall.Builder<RetrieveCustomerCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(
                                response, RetrieveCustomerCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public UpdateCustomerCustomAttributeDefinitionResponse updateCustomerCustomAttributeDefinition(
            final String key, final UpdateCustomerCustomAttributeDefinitionRequest body)
            throws ApiException, IOException {
     ...
     * @return    Returns the UpdateCustomerCustomAttributeDefinitionResponse response from the API call
     */
    public CompletableFuture<UpdateCustomerCustomAttributeDefinitionResponse>
            updateCustomerCustomAttributeDefinitionAsync(
                    final String key, final UpdateCustomerCustomAttributeDefinitionRequest body) {
        try {
            return prepareUpdateCustomerCustomAttributeDefinitionRequest(key, body)
                    .executeAsync();
        } catch (Exception e) {
            throw new CompletionException(e);
        }
     ...
     */
    private ApiCall<UpdateCustomerCustomAttributeDefinitionResponse, ApiException>
            prepareUpdateCustomerCustomAttributeDefinitionRequest(
                    final String key, final UpdateCustomerCustomAttributeDefinitionRequest body)
                    throws JsonProcessingException, IOException {
        return new ApiCall.Builder<UpdateCustomerCustomAttributeDefinitionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, UpdateCustomerCustomAttributeDefinitionResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     */
    private ApiCall<BulkUpsertCustomerCustomAttributesResponse, ApiException>
            prepareBulkUpsertCustomerCustomAttributesRequest(final BulkUpsertCustomerCustomAttributesRequest body)
                    throws JsonProcessingException, IOException {
        return new ApiCall.Builder<BulkUpsertCustomerCustomAttributesResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, BulkUpsertCustomerCustomAttributesResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public ListCustomerCustomAttributesResponse listCustomerCustomAttributes(
            final String customerId, final Integer limit, final String cursor, final Boolean withDefinitions)
            throws ApiException, IOException {
        return prepareListCustomerCustomAttributesRequest(customerId, limit, cursor, withDefinitions)
                .execute();
    }
    ...
    public DeleteCustomerCustomAttributeResponse deleteCustomerCustomAttribute(
            final String customerId, final String key) throws ApiException, IOException {
    ...
    public CompletableFuture<DeleteCustomerCustomAttributeResponse> deleteCustomerCustomAttributeAsync(
            final String customerId, final String key) {
        try {
    ...
    private ApiCall<DeleteCustomerCustomAttributeResponse, ApiException> prepareDeleteCustomerCustomAttributeRequest(
            final String customerId, final String key) throws IOException {
        return new ApiCall.Builder<DeleteCustomerCustomAttributeResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, DeleteCustomerCustomAttributeResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public RetrieveCustomerCustomAttributeResponse retrieveCustomerCustomAttribute(
            final String customerId, final String key, final Boolean withDefinition, final Integer version)
            throws ApiException, IOException {
        return prepareRetrieveCustomerCustomAttributeRequest(customerId, key, withDefinition, version)
                .execute();
    }
     ...
     */
    private ApiCall<RetrieveCustomerCustomAttributeResponse, ApiException>
            prepareRetrieveCustomerCustomAttributeRequest(
                    final String customerId, final String key, final Boolean withDefinition, final Integer version)
                    throws IOException {
        return new ApiCall.Builder<RetrieveCustomerCustomAttributeResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, RetrieveCustomerCustomAttributeResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public UpsertCustomerCustomAttributeResponse upsertCustomerCustomAttribute(
            final String customerId, final String key, final UpsertCustomerCustomAttributeRequest body)
            throws ApiException, IOException {
        return prepareUpsertCustomerCustomAttributeRequest(customerId, key, body)
                .execute();
    }
    ...
    private ApiCall<UpsertCustomerCustomAttributeResponse, ApiException> prepareUpsertCustomerCustomAttributeRequest(
        ...
        return new ApiCall.Builder<UpsertCustomerCustomAttributeResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response ->
                                ApiHelper.deserialize(response, UpsertCustomerCustomAttributeResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
