...
public class UpdateMerchantCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateMerchantCustomAttributeDefinitionResponse)) {
            return false;
        }
        UpdateMerchantCustomAttributeDefinitionResponse other = (UpdateMerchantCustomAttributeDefinitionResponse) obj;
    ...
    public String toString() {
        return "UpdateMerchantCustomAttributeDefinitionResponse [" + "customAttributeDefinition="
                + customAttributeDefinition + ", errors=" + errors + "]";
    }

    /**
     * Builds a new {@link UpdateMerchantCustomAttributeDefinitionResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UpdateMerchantCustomAttributeDefinitionResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UpdateMerchantCustomAttributeDefinitionResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UpdateMerchantCustomAttributeDefinitionResponse} object using the set
         * fields.
         * @return {@link UpdateMerchantCustomAttributeDefinitionResponse}
         */
        public UpdateMerchantCustomAttributeDefinitionResponse build() {
            UpdateMerchantCustomAttributeDefinitionResponse model =
                    new UpdateMerchantCustomAttributeDefinitionResponse(customAttributeDefinition, errors);
