...
public class ListDisputeEvidenceResponse {
    ...
    public String toString() {
        return "ListDisputeEvidenceResponse [" + "evidence=" + evidence + ", errors=" + errors + ", cursor=" + cursor
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().evidence(getEvidence()).errors(getErrors()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListDisputeEvidenceResponse build() {
            ListDisputeEvidenceResponse model = new ListDisputeEvidenceResponse(evidence, errors, cursor);
