...
public class RetrieveInventoryPhysicalCountResponse {
    ...
    public RetrieveInventoryPhysicalCountResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("count") InventoryPhysicalCount count) {
        this.errors = errors;
        this.count = count;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(count, other.count);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).count(getCount());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveInventoryPhysicalCountResponse build() {
            RetrieveInventoryPhysicalCountResponse model = new RetrieveInventoryPhysicalCountResponse(errors, count);
