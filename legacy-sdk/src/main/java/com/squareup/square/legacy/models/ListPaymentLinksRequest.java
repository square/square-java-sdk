...
public class ListPaymentLinksRequest {
     ...
     */
    @JsonCreator
    public ListPaymentLinksRequest(@JsonProperty("cursor") String cursor, @JsonProperty("limit") Integer limit) {
     ...
     * @param  limit  Integer value for limit.
     */
    protected ListPaymentLinksRequest(OptionalNullable<String> cursor, OptionalNullable<Integer> limit) {
        this.cursor = cursor;
        this.limit = limit;
    }
