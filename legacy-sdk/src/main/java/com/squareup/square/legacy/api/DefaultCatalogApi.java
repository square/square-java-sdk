...
public final class DefaultCatalogApi extends BaseApi implements CatalogApi {
     ...
     */
    public BatchDeleteCatalogObjectsResponse batchDeleteCatalogObjects(final BatchDeleteCatalogObjectsRequest body)
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public BatchUpsertCatalogObjectsResponse batchUpsertCatalogObjects(final BatchUpsertCatalogObjectsRequest body)
            throws ApiException, IOException {
    ...
    public CreateCatalogImageResponse createCatalogImage(
            final CreateCatalogImageRequest request, final FileWrapper imageFile) throws ApiException, IOException {
    ...
    private ApiCall<CreateCatalogImageResponse, ApiException> prepareCreateCatalogImageRequest(
        ...
        return new ApiCall.Builder<CreateCatalogImageResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CreateCatalogImageResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
        ...
        return new ApiCall.Builder<UpdateCatalogImageResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .formParam(param -> param.key("image_file")
                                ...
                                .multipartHeaders("Content-Type", "image/jpeg"))
                        .templateParam(
                                param -> param.key("image_id").value(imageId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.PUT))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, UpdateCatalogImageResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    private ApiCall<CatalogInfoResponse, ApiException> prepareCatalogInfoRequest() throws IOException {
        return new ApiCall.Builder<CatalogInfoResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, CatalogInfoResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public ListCatalogResponse listCatalog(final String cursor, final String types, final Long catalogVersion)
            throws ApiException, IOException {
    ...
    private ApiCall<ListCatalogResponse, ApiException> prepareListCatalogRequest(
            final String cursor, final String types, final Long catalogVersion) throws IOException {
        return new ApiCall.Builder<ListCatalogResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .queryParam(param -> param.key("types").value(types).isRequired(false))
                        ...
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, ListCatalogResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public UpsertCatalogObjectResponse upsertCatalogObject(final UpsertCatalogObjectRequest body)
            throws ApiException, IOException {
    ...
    private ApiCall<UpsertCatalogObjectResponse, ApiException> prepareUpsertCatalogObjectRequest(
        ...
        return new ApiCall.Builder<UpsertCatalogObjectResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .httpMethod(HttpMethod.POST))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, UpsertCatalogObjectResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public DeleteCatalogObjectResponse deleteCatalogObject(final String objectId) throws ApiException, IOException {
     ...
     * @return    Returns the DeleteCatalogObjectResponse response from the API call
     */
    public CompletableFuture<DeleteCatalogObjectResponse> deleteCatalogObjectAsync(final String objectId) {
        try {
     ...
     */
    private ApiCall<DeleteCatalogObjectResponse, ApiException> prepareDeleteCatalogObjectRequest(final String objectId)
            throws IOException {
        return new ApiCall.Builder<DeleteCatalogObjectResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .templateParam(
                                param -> param.key("object_id").value(objectId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .withAuth(auth -> auth.add("global"))
                        .httpMethod(HttpMethod.DELETE))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, DeleteCatalogObjectResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
    ...
    public RetrieveCatalogObjectResponse retrieveCatalogObject(
            ...
            throws ApiException, IOException {
        return prepareRetrieveCatalogObjectRequest(
                        objectId, includeRelatedObjects, catalogVersion, includeCategoryPathToRoot)
                .execute();
    }
        ...
        return new ApiCall.Builder<RetrieveCatalogObjectResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .queryParam(param -> param.key("include_related_objects")
                                .value((includeRelatedObjects != null) ? includeRelatedObjects : false)
                                .isRequired(false))
                        .queryParam(param -> param.key("catalog_version")
                                .value(catalogVersion)
                                .isRequired(false))
                        .queryParam(param -> param.key("include_category_path_to_root")
                                .value((includeCategoryPathToRoot != null) ? includeCategoryPathToRoot : false)
                                .isRequired(false))
                        .templateParam(
                                param -> param.key("object_id").value(objectId).shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        ...
                        .httpMethod(HttpMethod.GET))
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(response -> ApiHelper.deserialize(response, RetrieveCatalogObjectResponse.class))
                        .nullify404(false)
                        .contextInitializer((context, result) -> result.toBuilder()
                                .httpContext((HttpContext) context)
                                .build())
     ...
     * @return    Returns the SearchCatalogItemsResponse response from the API call
     */
    public CompletableFuture<SearchCatalogItemsResponse> searchCatalogItemsAsync(final SearchCatalogItemsRequest body) {
        try {
     ...
     * @return    Returns the UpdateItemTaxesResponse response from the API call
     */
    public CompletableFuture<UpdateItemTaxesResponse> updateItemTaxesAsync(final UpdateItemTaxesRequest body) {
        try {
