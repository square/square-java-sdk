...
public class WageSetting {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(teamMemberId, jobAssignments, isOvertimeExempt, version, createdAt, updatedAt);
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().version(getVersion()).createdAt(getCreatedAt()).updatedAt(getUpdatedAt());
    ...
    public static class Builder {
        ...
        public WageSetting build() {
            return new WageSetting(teamMemberId, jobAssignments, isOvertimeExempt, version, createdAt, updatedAt);
        }
    }
}
