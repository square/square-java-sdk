...
public class CreateWebhookSubscriptionRequest {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(idempotencyKey, other.idempotencyKey) && Objects.equals(subscription, other.subscription);
    }
    ...
    public String toString() {
        return "CreateWebhookSubscriptionRequest [" + "subscription=" + subscription + ", idempotencyKey="
                + idempotencyKey + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(subscription).idempotencyKey(getIdempotencyKey());
        return builder;
    }
