...
public class ListCashDrawerShiftsRequest {
     ...
     * @param  cursor  String value for cursor.
     */
    protected ListCashDrawerShiftsRequest(
            String locationId,
            String sortOrder,
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(locationId).sortOrder(getSortOrder());
    ...
    public static class Builder {
        ...
        public ListCashDrawerShiftsRequest build() {
            return new ListCashDrawerShiftsRequest(locationId, sortOrder, beginTime, endTime, limit, cursor);
        }
    }
}
