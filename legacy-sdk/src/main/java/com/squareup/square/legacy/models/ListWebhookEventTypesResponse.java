...
public class ListWebhookEventTypesResponse {
    ...
    public String toString() {
        return "ListWebhookEventTypesResponse [" + "errors=" + errors + ", eventTypes=" + eventTypes + ", metadata="
                + metadata + "]";
    }
    ...
    public static class Builder {
        ...
        public ListWebhookEventTypesResponse build() {
            ListWebhookEventTypesResponse model = new ListWebhookEventTypesResponse(errors, eventTypes, metadata);
