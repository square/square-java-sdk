...
public class CardPaymentTimeline {
    ...
    protected CardPaymentTimeline(
            OptionalNullable<String> authorizedAt,
            OptionalNullable<String> capturedAt,
            OptionalNullable<String> voidedAt) {
    ...
    public String toString() {
        return "CardPaymentTimeline [" + "authorizedAt=" + authorizedAt + ", capturedAt=" + capturedAt + ", voidedAt="
                + voidedAt + "]";
    }
