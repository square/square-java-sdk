...
public class LoyaltyEventRedeemReward {
    ...
    public String toString() {
        return "LoyaltyEventRedeemReward [" + "loyaltyProgramId=" + loyaltyProgramId + ", rewardId=" + rewardId
                + ", orderId=" + orderId + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(loyaltyProgramId).rewardId(getRewardId()).orderId(getOrderId());
        return builder;
    }
