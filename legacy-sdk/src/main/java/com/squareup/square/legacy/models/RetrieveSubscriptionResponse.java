...
public class RetrieveSubscriptionResponse {
    ...
    public String toString() {
        return "RetrieveSubscriptionResponse [" + "errors=" + errors + ", subscription=" + subscription + "]";
    }
    ...
    public static class Builder {
        ...
        public RetrieveSubscriptionResponse build() {
            RetrieveSubscriptionResponse model = new RetrieveSubscriptionResponse(errors, subscription);
