...
public class OrderFulfillmentShipmentDetails {
     ...
     * @param  failureReason  String value for failureReason.
     */
    protected OrderFulfillmentShipmentDetails(
            OrderFulfillmentRecipient recipient,
            OptionalNullable<String> carrier,
            OptionalNullable<String> shippingNote,
            OptionalNullable<String> shippingType,
            OptionalNullable<String> trackingNumber,
            OptionalNullable<String> trackingUrl,
            String placedAt,
            String inProgressAt,
            String packagedAt,
            OptionalNullable<String> expectedShippedAt,
            String shippedAt,
            OptionalNullable<String> canceledAt,
            OptionalNullable<String> cancelReason,
            String failedAt,
            OptionalNullable<String> failureReason) {
        this.recipient = recipient;
