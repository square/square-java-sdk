...
public class ListCustomerSegmentsResponse {
    ...
    public String toString() {
        return "ListCustomerSegmentsResponse [" + "errors=" + errors + ", segments=" + segments + ", cursor=" + cursor
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().errors(getErrors()).segments(getSegments()).cursor(getCursor());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListCustomerSegmentsResponse build() {
            ListCustomerSegmentsResponse model = new ListCustomerSegmentsResponse(errors, segments, cursor);
