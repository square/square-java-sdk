...
public class AccumulateLoyaltyPointsResponse {
    ...
    public String toString() {
        return "AccumulateLoyaltyPointsResponse [" + "errors=" + errors + ", event=" + event + ", events=" + events
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).event(getEvent()).events(getEvents());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public AccumulateLoyaltyPointsResponse build() {
            AccumulateLoyaltyPointsResponse model = new AccumulateLoyaltyPointsResponse(errors, event, events);
