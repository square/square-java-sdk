...
public class RetrieveCustomerSegmentResponse {
    ...
    public RetrieveCustomerSegmentResponse(
            @JsonProperty("errors") List<Error> errors, @JsonProperty("segment") CustomerSegment segment) {
        this.errors = errors;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(errors, other.errors) && Objects.equals(segment, other.segment);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).segment(getSegment());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RetrieveCustomerSegmentResponse build() {
            RetrieveCustomerSegmentResponse model = new RetrieveCustomerSegmentResponse(errors, segment);
