...
public class PauseSubscriptionResponse {
    ...
    public String toString() {
        return "PauseSubscriptionResponse [" + "errors=" + errors + ", subscription=" + subscription + ", actions="
                + actions + "]";
    }
    ...
    public static class Builder {
        ...
        public PauseSubscriptionResponse build() {
            PauseSubscriptionResponse model = new PauseSubscriptionResponse(errors, subscription, actions);
