...
public class PaymentBalanceActivityAppFeeRevenueDetail {
    ...
    public PaymentBalanceActivityAppFeeRevenueDetail(
            @JsonProperty("payment_id") String paymentId, @JsonProperty("location_id") String locationId) {
     ...
     * @param  locationId  String value for locationId.
     */
    protected PaymentBalanceActivityAppFeeRevenueDetail(
            OptionalNullable<String> paymentId, OptionalNullable<String> locationId) {
    ...
    public boolean equals(Object obj) {
        ...
        PaymentBalanceActivityAppFeeRevenueDetail other = (PaymentBalanceActivityAppFeeRevenueDetail) obj;
        return Objects.equals(paymentId, other.paymentId) && Objects.equals(locationId, other.locationId);
    }
    ...
    public String toString() {
        return "PaymentBalanceActivityAppFeeRevenueDetail [" + "paymentId=" + paymentId + ", locationId=" + locationId
                + "]";
    }
