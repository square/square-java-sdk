...
public class RetrieveInventoryCountRequest {
    ...
    public RetrieveInventoryCountRequest(
            @JsonProperty("location_ids") String locationIds, @JsonProperty("cursor") String cursor) {
     ...
     * @param  cursor  String value for cursor.
     */
    protected RetrieveInventoryCountRequest(OptionalNullable<String> locationIds, OptionalNullable<String> cursor) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(locationIds, other.locationIds) && Objects.equals(cursor, other.cursor);
    }
    ...
    public String toString() {
        return "RetrieveInventoryCountRequest [" + "locationIds=" + locationIds + ", cursor=" + cursor + "]";
    }
