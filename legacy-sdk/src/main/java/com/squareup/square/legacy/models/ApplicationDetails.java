...
public class ApplicationDetails {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(squareProduct, other.squareProduct) && Objects.equals(applicationId, other.applicationId);
    }
    ...
    public String toString() {
        return "ApplicationDetails [" + "squareProduct=" + squareProduct + ", applicationId=" + applicationId + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().squareProduct(getSquareProduct());
