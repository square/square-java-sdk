...
public class ListLocationCustomAttributeDefinitionsResponse {
    ...
    public boolean equals(Object obj) {
        ...
        ListLocationCustomAttributeDefinitionsResponse other = (ListLocationCustomAttributeDefinitionsResponse) obj;
    ...
    public static class Builder {
        ...
        public ListLocationCustomAttributeDefinitionsResponse build() {
            ListLocationCustomAttributeDefinitionsResponse model =
                    new ListLocationCustomAttributeDefinitionsResponse(customAttributeDefinitions, cursor, errors);
