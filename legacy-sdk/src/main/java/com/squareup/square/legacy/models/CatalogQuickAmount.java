...
public class CatalogQuickAmount {
     ...
     * @param  ordinal  Long value for ordinal.
     */
    protected CatalogQuickAmount(
            String type, Money amount, OptionalNullable<Long> score, OptionalNullable<Long> ordinal) {
        this.type = type;
        this.amount = amount;
        this.score = score;
    ...
    public String toString() {
        return "CatalogQuickAmount [" + "type=" + type + ", amount=" + amount + ", score=" + score + ", ordinal="
                + ordinal + "]";
    }
