...
public class V1Order {
    ...
    protected V1Order(
            ...
            String id,
            OptionalNullable<String> buyerEmail,
            OptionalNullable<String> recipientName,
            OptionalNullable<String> recipientPhoneNumber,
            String state,
            ...
            OptionalNullable<String> buyerNote,
            OptionalNullable<String> completedNote,
            OptionalNullable<String> refundedNote,
            OptionalNullable<String> canceledNote,
            V1Tender tender,
            OptionalNullable<List<V1OrderHistoryEntry>> orderHistory,
            OptionalNullable<String> promoCode,
            OptionalNullable<String> btcReceiveAddress,
