...
public class SubscriptionAction {
    ...
    protected SubscriptionAction(
            ...
            OptionalNullable<String> newPlanVariationId) {
        this.id = id;
        this.type = type;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, type, effectiveDate, monthlyBillingAnchorDate, phases, newPlanVariationId);
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().id(getId()).type(getType());
    ...
    public static class Builder {
        ...
        public SubscriptionAction build() {
            return new SubscriptionAction(
                    id, type, effectiveDate, monthlyBillingAnchorDate, phases, newPlanVariationId);
        }
    }
}
