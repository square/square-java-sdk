...
public class PayOrderRequest {
    ...
    protected PayOrderRequest(
            String idempotencyKey, OptionalNullable<Integer> orderVersion, OptionalNullable<List<String>> paymentIds) {
        this.idempotencyKey = idempotencyKey;
    ...
    public String toString() {
        return "PayOrderRequest [" + "idempotencyKey=" + idempotencyKey + ", orderVersion=" + orderVersion
