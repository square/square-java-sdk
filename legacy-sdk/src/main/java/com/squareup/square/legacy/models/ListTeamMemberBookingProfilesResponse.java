...
public class ListTeamMemberBookingProfilesResponse {
    ...
    public String toString() {
        return "ListTeamMemberBookingProfilesResponse [" + "teamMemberBookingProfiles=" + teamMemberBookingProfiles
    ...
    public static class Builder {
        ...
        public ListTeamMemberBookingProfilesResponse build() {
            ListTeamMemberBookingProfilesResponse model =
                    new ListTeamMemberBookingProfilesResponse(teamMemberBookingProfiles, cursor, errors);
