...
public class CatalogItemFoodAndBeverageDetailsDietaryPreference {
     ...
     * @param  customName  String value for customName.
     */
    protected CatalogItemFoodAndBeverageDetailsDietaryPreference(
    ...
    public String toString() {
        return "CatalogItemFoodAndBeverageDetailsDietaryPreference [" + "type=" + type + ", standardName="
    ...
    public static class Builder {
        ...
        public CatalogItemFoodAndBeverageDetailsDietaryPreference build() {
            return new CatalogItemFoodAndBeverageDetailsDietaryPreference(type, standardName, customName);
        }
    }
}
