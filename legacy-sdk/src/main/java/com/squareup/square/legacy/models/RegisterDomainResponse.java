...
public class RegisterDomainResponse {
     ...
     */
    @JsonCreator
    public RegisterDomainResponse(@JsonProperty("errors") List<Error> errors, @JsonProperty("status") String status) {
        this.errors = errors;
        this.status = status;
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder().errors(getErrors()).status(getStatus());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public RegisterDomainResponse build() {
            RegisterDomainResponse model = new RegisterDomainResponse(errors, status);
