...
public class ListBreakTypesResponse {
    ...
    public String toString() {
        return "ListBreakTypesResponse [" + "breakTypes=" + breakTypes + ", cursor=" + cursor + ", errors=" + errors
                + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder =
                new Builder().breakTypes(getBreakTypes()).cursor(getCursor()).errors(getErrors());
        return builder;
    }
    ...
    public static class Builder {
        ...
        public ListBreakTypesResponse build() {
            ListBreakTypesResponse model = new ListBreakTypesResponse(breakTypes, cursor, errors);
