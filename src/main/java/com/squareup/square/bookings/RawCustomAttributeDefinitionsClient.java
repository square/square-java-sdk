...
public class RawCustomAttributeDefinitionsClient {
     ...
     */
    public SquareClientHttpResponse<CreateBookingCustomAttributeDefinitionResponse> create(
     ...
     * To call this endpoint with seller-level permissions, set <code>APPOINTMENTS_ALL_READ</code> and <code>APPOINTMENTS_READ</code> for the OAuth scope.</p>
     */
    public SquareClientHttpResponse<RetrieveBookingCustomAttributeDefinitionResponse> get(
     ...
     * or <em>Appointments Premium</em>.</p>
     */
    public SquareClientHttpResponse<UpdateBookingCustomAttributeDefinitionResponse> update(
     ...
     * or <em>Appointments Premium</em>.</p>
     */
    public SquareClientHttpResponse<DeleteBookingCustomAttributeDefinitionResponse> delete(
