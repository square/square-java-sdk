...
public class AsyncRawCustomAttributesClient {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<BulkDeleteBookingCustomAttributesResponse>> batchDelete(
    ...
    public CompletableFuture<SquareClientHttpResponse<BulkDeleteBookingCustomAttributesResponse>> batchDelete(
        ...
        CompletableFuture<SquareClientHttpResponse<BulkDeleteBookingCustomAttributesResponse>> future =
     ...
     * or <em>Appointments Premium</em>.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<BulkUpsertBookingCustomAttributesResponse>> batchUpsert(
    ...
    public CompletableFuture<SquareClientHttpResponse<BulkUpsertBookingCustomAttributesResponse>> batchUpsert(
        ...
        CompletableFuture<SquareClientHttpResponse<BulkUpsertBookingCustomAttributesResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
     ...
     * To call this endpoint with seller-level permissions, set <code>APPOINTMENTS_ALL_READ</code> and <code>APPOINTMENTS_READ</code> for the OAuth scope.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<RetrieveBookingCustomAttributeResponse>> get(
    ...
    public CompletableFuture<SquareClientHttpResponse<RetrieveBookingCustomAttributeResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<RetrieveBookingCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
     ...
     * or <em>Appointments Premium</em>.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<UpsertBookingCustomAttributeResponse>> upsert(
    ...
    public CompletableFuture<SquareClientHttpResponse<UpsertBookingCustomAttributeResponse>> upsert(
        ...
        CompletableFuture<SquareClientHttpResponse<UpsertBookingCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
     ...
     * or <em>Appointments Premium</em>.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteBookingCustomAttributeResponse>> delete(
    ...
    public CompletableFuture<SquareClientHttpResponse<DeleteBookingCustomAttributeResponse>> delete(
        ...
        CompletableFuture<SquareClientHttpResponse<DeleteBookingCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
