...
@JsonDeserialize(builder = UpdateBookingCustomAttributeDefinitionRequest.Builder.class)
public final class UpdateBookingCustomAttributeDefinitionRequest {
    ...
    private UpdateBookingCustomAttributeDefinitionRequest(
            String key,
    ...
    /**
     * @return The custom attribute definition that contains the fields to update. Only the following fields can be updated:
     * <ul>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateBookingCustomAttributeDefinitionRequest
                && equalTo((UpdateBookingCustomAttributeDefinitionRequest) other);
    }
    ...
    private boolean equalTo(UpdateBookingCustomAttributeDefinitionRequest other) {
    ...
    public static final class Builder implements KeyStage, CustomAttributeDefinitionStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpdateBookingCustomAttributeDefinitionRequest other) {
            key(other.getKey());
