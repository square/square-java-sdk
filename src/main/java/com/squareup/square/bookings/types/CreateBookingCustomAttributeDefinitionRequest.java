...
@JsonDeserialize(builder = CreateBookingCustomAttributeDefinitionRequest.Builder.class)
public final class CreateBookingCustomAttributeDefinitionRequest {
    ...
    private CreateBookingCustomAttributeDefinitionRequest(
    ...
    /**
     * @return The custom attribute definition to create, with the following fields:
     * <ul>
     * <li>
     * <p><code>key</code></p>
     * </li>
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateBookingCustomAttributeDefinitionRequest
                && equalTo((CreateBookingCustomAttributeDefinitionRequest) other);
    }
    ...
    private boolean equalTo(CreateBookingCustomAttributeDefinitionRequest other) {
    ...
    public static final class Builder implements CustomAttributeDefinitionStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CreateBookingCustomAttributeDefinitionRequest other) {
