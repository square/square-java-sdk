...
public final class ListCustomAttributesRequest {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.bookingId, this.limit, this.cursor, this.withDefinitions);
    }
    ...
    public static final class Builder implements BookingIdStage, _FinalStage {
        ...
        public ListCustomAttributesRequest build() {
            return new ListCustomAttributesRequest(bookingId, limit, cursor, withDefinitions, additionalProperties);
        }
    }
}
