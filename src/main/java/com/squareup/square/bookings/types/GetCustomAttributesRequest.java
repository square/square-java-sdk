...
public final class GetCustomAttributesRequest {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.bookingId, this.key, this.withDefinition, this.version);
    }
    ...
    public static final class Builder implements BookingIdStage, KeyStage, _FinalStage {
        ...
        public GetCustomAttributesRequest build() {
            return new GetCustomAttributesRequest(bookingId, key, withDefinition, version, additionalProperties);
        }
    }
}
