...
public class AsyncRawSnippetsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawSnippetsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetSnippetResponse>> get(GetSnippetsRequest request) {
    ...
    public CompletableFuture<SquareClientHttpResponse<GetSnippetResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetSnippetResponse>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetSnippetResponse.class),
                                response));
                        return;
                    }
     ...
     * <p><strong>Note:</strong> Square Online APIs are publicly available as part of an early access program. For more information, see <a href="https://developer.squareup.com/docs/online-api#early-access-program-for-square-online-apis">Early access program for Square Online APIs</a>.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<UpsertSnippetResponse>> upsert(UpsertSnippetRequest request) {
    ...
    public CompletableFuture<SquareClientHttpResponse<UpsertSnippetResponse>> upsert(
        ...
        CompletableFuture<SquareClientHttpResponse<UpsertSnippetResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UpsertSnippetResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * <p><strong>Note:</strong> Square Online APIs are publicly available as part of an early access program. For more information, see <a href="https://developer.squareup.com/docs/online-api#early-access-program-for-square-online-apis">Early access program for Square Online APIs</a>.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteSnippetResponse>> delete(DeleteSnippetsRequest request) {
    ...
    public CompletableFuture<SquareClientHttpResponse<DeleteSnippetResponse>> delete(
        ...
        CompletableFuture<SquareClientHttpResponse<DeleteSnippetResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DeleteSnippetResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
