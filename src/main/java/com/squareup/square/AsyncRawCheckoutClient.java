...
public class AsyncRawCheckoutClient {
    ...
    public CompletableFuture<SquareClientHttpResponse<RetrieveLocationSettingsResponse>> retrieveLocationSettings(
        ...
        CompletableFuture<SquareClientHttpResponse<RetrieveLocationSettingsResponse>> future =
    ...
    public CompletableFuture<SquareClientHttpResponse<UpdateLocationSettingsResponse>> updateLocationSettings(
        ...
        CompletableFuture<SquareClientHttpResponse<UpdateLocationSettingsResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<SquareClientHttpResponse<RetrieveMerchantSettingsResponse>> retrieveMerchantSettings(
        ...
        CompletableFuture<SquareClientHttpResponse<RetrieveMerchantSettingsResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
    ...
    public CompletableFuture<SquareClientHttpResponse<UpdateMerchantSettingsResponse>> updateMerchantSettings(
        ...
        CompletableFuture<SquareClientHttpResponse<UpdateMerchantSettingsResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
