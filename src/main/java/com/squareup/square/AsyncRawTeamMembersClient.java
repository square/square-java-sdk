...
public class AsyncRawTeamMembersClient {
     ...
     * <p>Learn about <a href="https://developer.squareup.com/docs/team/troubleshooting#createteammember">Troubleshooting the Team API</a>.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<CreateTeamMemberResponse>> create(RequestOptions requestOptions) {
    ...
    public CompletableFuture<SquareClientHttpResponse<CreateTeamMemberResponse>> create(
        ...
        CompletableFuture<SquareClientHttpResponse<CreateTeamMemberResponse>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<BatchCreateTeamMembersResponse>> batchCreate(
    ...
    public CompletableFuture<SquareClientHttpResponse<BatchCreateTeamMembersResponse>> batchCreate(
        ...
        CompletableFuture<SquareClientHttpResponse<BatchCreateTeamMembersResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<BatchUpdateTeamMembersResponse>> batchUpdate(
    ...
    public CompletableFuture<SquareClientHttpResponse<BatchUpdateTeamMembersResponse>> batchUpdate(
        ...
        CompletableFuture<SquareClientHttpResponse<BatchUpdateTeamMembersResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     * Learn about <a href="https://developer.squareup.com/docs/team/troubleshooting#retrieve-a-team-member">Troubleshooting the Team API</a>.
     */
    public CompletableFuture<SquareClientHttpResponse<GetTeamMemberResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetTeamMemberResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<UpdateTeamMemberResponse>> update(
    ...
    public CompletableFuture<SquareClientHttpResponse<UpdateTeamMemberResponse>> update(
        ...
        CompletableFuture<SquareClientHttpResponse<UpdateTeamMemberResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
