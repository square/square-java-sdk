...
public class AsyncEmployeesClient {
    ...
    public CompletableFuture<SyncPagingIterable<Employee>> list(
        ...
        CompletableFuture<SyncPagingIterable<Employee>> future = new CompletableFuture<>();
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new SyncPagingIterable<Employee>(startingAfter.isPresent(), result, () -> {
                            try {
    ...
    public CompletableFuture<GetEmployeeResponse> get(GetEmployeesRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<GetEmployeeResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
