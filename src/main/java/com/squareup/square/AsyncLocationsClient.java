...
public class AsyncLocationsClient {
    ...
    public CompletableFuture<ListLocationsResponse> list(RequestOptions requestOptions) {
        ...
        CompletableFuture<ListLocationsResponse> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(ObjectMappers.JSON_MAPPER.readValue(
                                responseBody.string(), ListLocationsResponse.class));
                        return;
                    }
    ...
    public CompletableFuture<CreateLocationResponse> create(
        ...
        CompletableFuture<CreateLocationResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<GetLocationResponse> get(GetLocationsRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<GetLocationResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<UpdateLocationResponse> update(
        ...
        CompletableFuture<UpdateLocationResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<CreateCheckoutResponse> checkouts(
        ...
        CompletableFuture<CreateCheckoutResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
