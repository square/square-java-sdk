...
import com.squareup.square.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncSquareClientBuilder {
    ...
    private String version = "2026-07-15";
     ...
     */
    public AsyncSquareClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncSquareClientBuilder addHeader(String name, String value) {
     ...
     */
    protected void setCustomHeaders(ClientOptions.Builder builder) {
        builder.addHeader("Square-Version", this.version);
    }
    ...
    public AsyncSquareClient build() {
        ...
        return new AsyncSquareClient(buildClientOptions());
    }
}
