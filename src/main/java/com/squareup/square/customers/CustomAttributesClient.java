...
public class CustomAttributesClient {
     ...
     */
    public GetCustomerCustomAttributeResponse get(GetCustomAttributesRequest request) {
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public GetCustomerCustomAttributeResponse get(GetCustomAttributesRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v2/customers")
                .addPathSegment(request.getCustomerId())
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public UpsertCustomerCustomAttributeResponse upsert(UpsertCustomerCustomAttributeRequest request) {
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public UpsertCustomerCustomAttributeResponse upsert(
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public DeleteCustomerCustomAttributeResponse delete(DeleteCustomAttributesRequest request) {
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public DeleteCustomerCustomAttributeResponse delete(
