...
public class RawSegmentsClient {
     ...
     */
    public SquareClientHttpResponse<SyncPagingIterable<CustomerSegment>> list() {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ListCustomerSegmentsResponse parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListCustomerSegmentsResponse.class);
     ...
     */
    public SquareClientHttpResponse<GetCustomerSegmentResponse> get(GetSegmentsRequest request) {
     ...
     * Retrieves a specific customer segment as identified by the <code>segment_id</code> value.
     */
    public SquareClientHttpResponse<GetCustomerSegmentResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetCustomerSegmentResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
