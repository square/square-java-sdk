...
public class RawCardsClient {
     ...
     */
    public SquareClientHttpResponse<CreateCustomerCardResponse> create(CreateCustomerCardRequest request) {
     ...
     * with the provided nonce during the <em>first</em> call.</p>
     */
    public SquareClientHttpResponse<CreateCustomerCardResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CreateCustomerCardResponse.class),
                        response);
            }
     ...
     */
    public SquareClientHttpResponse<DeleteCustomerCardResponse> delete(DeleteCardsRequest request) {
     ...
     * Removes a card on file from a customer.
     */
    public SquareClientHttpResponse<DeleteCustomerCardResponse> delete(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), DeleteCustomerCardResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new SquareApiException(
