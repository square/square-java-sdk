...
public final class DeleteCustomAttributesRequest {
    ...
    private DeleteCustomAttributesRequest(String customerId, String key, Map<String, Object> additionalProperties) {
    ...
    private boolean equalTo(DeleteCustomAttributesRequest other) {
        return customerId.equals(other.customerId) && key.equals(other.key);
    }

    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.customerId, this.key);
    }
    ...
    public static final class Builder implements CustomerIdStage, KeyStage, _FinalStage {
        ...
        public DeleteCustomAttributesRequest build() {
            return new DeleteCustomAttributesRequest(customerId, key, additionalProperties);
        }
    }
}
