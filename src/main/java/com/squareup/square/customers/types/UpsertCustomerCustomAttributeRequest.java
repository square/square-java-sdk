...
@JsonDeserialize(builder = UpsertCustomerCustomAttributeRequest.Builder.class)
public final class UpsertCustomerCustomAttributeRequest {
    ...
    private UpsertCustomerCustomAttributeRequest(
            String customerId,
            String key,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpsertCustomerCustomAttributeRequest
                && equalTo((UpsertCustomerCustomAttributeRequest) other);
    }
    ...
    private boolean equalTo(UpsertCustomerCustomAttributeRequest other) {
    ...
    public interface CustomerIdStage {
        KeyStage customerId(@NotNull String customerId);

        Builder from(UpsertCustomerCustomAttributeRequest other);
    }
    ...
    public static final class Builder implements CustomerIdStage, KeyStage, CustomAttributeStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpsertCustomerCustomAttributeRequest other) {
        ...
        public UpsertCustomerCustomAttributeRequest build() {
            return new UpsertCustomerCustomAttributeRequest(
                    customerId, key, customAttribute, idempotencyKey, additionalProperties);
        }
    }
}
