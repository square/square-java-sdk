...
public class AsyncRawCustomAttributesClient {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetCustomerCustomAttributeResponse>> get(
    ...
    public CompletableFuture<SquareClientHttpResponse<GetCustomerCustomAttributeResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetCustomerCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<UpsertCustomerCustomAttributeResponse>> upsert(
    ...
    public CompletableFuture<SquareClientHttpResponse<UpsertCustomerCustomAttributeResponse>> upsert(
        ...
        CompletableFuture<SquareClientHttpResponse<UpsertCustomerCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteCustomerCustomAttributeResponse>> delete(
    ...
    public CompletableFuture<SquareClientHttpResponse<DeleteCustomerCustomAttributeResponse>> delete(
        ...
        CompletableFuture<SquareClientHttpResponse<DeleteCustomerCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
