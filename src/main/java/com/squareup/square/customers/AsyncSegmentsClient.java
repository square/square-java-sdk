...
public class AsyncSegmentsClient {
    ...
    public CompletableFuture<SyncPagingIterable<CustomerSegment>> list(
        ...
        CompletableFuture<SyncPagingIterable<CustomerSegment>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<GetCustomerSegmentResponse> get(
        ...
        CompletableFuture<GetCustomerSegmentResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
