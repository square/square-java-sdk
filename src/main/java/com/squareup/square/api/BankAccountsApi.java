 ...
 */
public final class BankAccountsApi extends BaseApi {
     ...
     * @param authManagers
     */
    public BankAccountsApi(Configuration config, HttpClient httpClient, Map<String, AuthManager> authManagers) {
     ...
     * @param httpCallback
     */
    public BankAccountsApi(Configuration config, HttpClient httpClient, Map<String, AuthManager> authManagers, HttpCallback httpCallback) {
