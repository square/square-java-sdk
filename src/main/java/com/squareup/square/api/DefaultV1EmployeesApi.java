...
public final class DefaultV1EmployeesApi extends BaseApi implements V1EmployeesApi {
    ...
    public List<V1Timecard> listTimecards(
            ...
            final Integer limit,
            final String batchToken) throws ApiException, IOException {
        HttpRequest request = buildListTimecardsRequest(order, employeeId, beginClockinTime,
                endClockinTime, beginClockoutTime, endClockoutTime, beginUpdatedAt, endUpdatedAt,
                deleted, limit, batchToken);
        authManagers.get("global").apply(request);
    ...
    public CompletableFuture<List<V1Timecard>> listTimecardsAsync(
            ...
            final Integer limit,
            final String batchToken) {
        return makeHttpCallAsync(() -> buildListTimecardsRequest(order, employeeId,
                beginClockinTime, endClockinTime, beginClockoutTime, endClockoutTime,
                beginUpdatedAt, endUpdatedAt, deleted, limit, batchToken),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsStringAsync(request)),
     ...
     * @return An object of type List of V1Timecard
     */
    private List<V1Timecard> handleListTimecardsResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
     ...
     */
    private V1Timecard handleCreateTimecardResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
    ...
    private HttpRequest buildDeleteTimecardRequest(
        ...
        //process template parameters
        Map<String, SimpleEntry<Object, Boolean>> templateParameters = new HashMap<>();
        templateParameters.put("timecard_id",
                new SimpleEntry<Object, Boolean>(timecardId, true));
        ApiHelper.appendUrlWithTemplateParameters(queryBuilder, templateParameters);
     ...
     */
    private Object handleDeleteTimecardResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
     ...
     * @return An object of type V1Timecard
     */
    private V1Timecard handleRetrieveTimecardResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
     ...
     * @return An object of type V1Timecard
     */
    private V1Timecard handleUpdateTimecardResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
     ...
     * @return An object of type List of V1TimecardEvent
     */
    private List<V1TimecardEvent> handleListTimecardEventsResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
    ...
    public List<V1CashDrawerShift> listCashDrawerShifts(
        ...
        HttpRequest request = buildListCashDrawerShiftsRequest(locationId, order, beginTime,
                endTime);
        authManagers.get("global").apply(request);
    ...
    public CompletableFuture<List<V1CashDrawerShift>> listCashDrawerShiftsAsync(
        ...
        return makeHttpCallAsync(() -> buildListCashDrawerShiftsRequest(locationId, order,
                beginTime, endTime),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsStringAsync(request)),
     ...
     * @return An object of type List of V1CashDrawerShift
     */
    private List<V1CashDrawerShift> handleListCashDrawerShiftsResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
     ...
     */
    private V1CashDrawerShift handleRetrieveCashDrawerShiftResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
