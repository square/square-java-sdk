 ...
 */
public final class DefaultReportingApi extends BaseApi implements ReportingApi {
     ...
     * @param authManagers
     */
    public DefaultReportingApi(Configuration config, HttpClient httpClient, Map<String, AuthManager> authManagers) {
     ...
     * @param httpCallback
     */
    public DefaultReportingApi(Configuration config, HttpClient httpClient, Map<String, AuthManager> authManagers, HttpCallback httpCallback) {
