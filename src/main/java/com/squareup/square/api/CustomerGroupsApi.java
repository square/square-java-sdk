 ...
 */
public final class CustomerGroupsApi extends BaseApi {
     ...
     * @param authManagers
     */
    public CustomerGroupsApi(Configuration config, HttpClient httpClient, Map<String, AuthManager> authManagers) {
     ...
     * @param httpCallback
     */
    public CustomerGroupsApi(Configuration config, HttpClient httpClient, Map<String, AuthManager> authManagers, HttpCallback httpCallback) {
