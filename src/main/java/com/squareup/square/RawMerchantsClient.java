...
public class RawMerchantsClient {
     ...
     * endpoint to retrieve the merchant information.</p>
     */
    public SquareClientHttpResponse<SyncPagingIterable<Merchant>> list(RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new SquareClientHttpResponse<>(
                        new SyncPagingIterable<Merchant>(startingAfter.isPresent(), result, parsedResponse, () -> list(
