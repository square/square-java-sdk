...
@JsonDeserialize(builder = UpdateOrderCustomAttributeDefinitionRequest.Builder.class)
public final class UpdateOrderCustomAttributeDefinitionRequest {
    ...
    private UpdateOrderCustomAttributeDefinitionRequest(
            String key,
    ...
    /**
     * @return The custom attribute definition that contains the fields to update. This endpoint supports sparse updates,
     * so only new or changed fields need to be included in the request.  For more information, see
     * <a href="https://developer.squareup.com/docs/orders-custom-attributes-api/custom-attribute-definitions#updatable-definition-fields">Updatable definition fields</a>.
     * <p>To enable <a href="https://developer.squareup.com/docs/build-basics/common-api-patterns/optimistic-concurrency">optimistic concurrency</a> control, include the optional <code>version</code> field and specify the current version of the custom attribute definition.</p>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateOrderCustomAttributeDefinitionRequest
                && equalTo((UpdateOrderCustomAttributeDefinitionRequest) other);
    }
    ...
    private boolean equalTo(UpdateOrderCustomAttributeDefinitionRequest other) {
    ...
    public interface KeyStage {
        ...
        Builder from(UpdateOrderCustomAttributeDefinitionRequest other);
    }

    public interface CustomAttributeDefinitionStage {
        /**
         * <p>The custom attribute definition that contains the fields to update. This endpoint supports sparse updates,
         * so only new or changed fields need to be included in the request.  For more information, see
         * <a href="https://developer.squareup.com/docs/orders-custom-attributes-api/custom-attribute-definitions#updatable-definition-fields">Updatable definition fields</a>.</p>
         * <p>To enable <a href="https://developer.squareup.com/docs/build-basics/common-api-patterns/optimistic-concurrency">optimistic concurrency</a> control, include the optional <code>version</code> field and specify the current version of the custom attribute definition.</p>
         */
    ...
    public interface _FinalStage {
        UpdateOrderCustomAttributeDefinitionRequest build();
    ...
    public static final class Builder implements KeyStage, CustomAttributeDefinitionStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpdateOrderCustomAttributeDefinitionRequest other) {
            key(other.getKey());
