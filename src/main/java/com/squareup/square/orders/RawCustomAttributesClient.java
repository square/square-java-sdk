...
public class RawCustomAttributesClient {
     ...
     */
    public SquareClientHttpResponse<BulkDeleteOrderCustomAttributesResponse> batchDelete(
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, BulkDeleteOrderCustomAttributesResponse.class),
                        response);
            }
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public SquareClientHttpResponse<BulkUpsertOrderCustomAttributesResponse> batchUpsert(
    ...
    public SquareClientHttpResponse<BulkUpsertOrderCustomAttributesResponse> batchUpsert(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, BulkUpsertOrderCustomAttributesResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ListOrderCustomAttributesResponse parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                        responseBodyString, ListOrderCustomAttributesResponse.class);
     ...
     * also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public SquareClientHttpResponse<RetrieveOrderCustomAttributeResponse> get(GetCustomAttributesRequest request) {
     ...
     * also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public SquareClientHttpResponse<RetrieveOrderCustomAttributeResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, RetrieveOrderCustomAttributeResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public SquareClientHttpResponse<UpsertOrderCustomAttributeResponse> upsert(
    ...
    public SquareClientHttpResponse<UpsertOrderCustomAttributeResponse> upsert(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, UpsertOrderCustomAttributeResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public SquareClientHttpResponse<DeleteOrderCustomAttributeResponse> delete(DeleteCustomAttributesRequest request) {
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public SquareClientHttpResponse<DeleteOrderCustomAttributeResponse> delete(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, DeleteOrderCustomAttributeResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
