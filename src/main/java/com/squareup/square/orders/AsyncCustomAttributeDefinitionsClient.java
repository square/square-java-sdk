...
public class AsyncCustomAttributeDefinitionsClient {
     ...
     */
    public CompletableFuture<CreateOrderCustomAttributeDefinitionResponse> create(
    ...
    public CompletableFuture<CreateOrderCustomAttributeDefinitionResponse> create(
        ...
        CompletableFuture<CreateOrderCustomAttributeDefinitionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<RetrieveOrderCustomAttributeDefinitionResponse> get(
    ...
    public CompletableFuture<RetrieveOrderCustomAttributeDefinitionResponse> get(
        ...
        CompletableFuture<RetrieveOrderCustomAttributeDefinitionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<UpdateOrderCustomAttributeDefinitionResponse> update(
    ...
    public CompletableFuture<UpdateOrderCustomAttributeDefinitionResponse> update(
        ...
        CompletableFuture<UpdateOrderCustomAttributeDefinitionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<DeleteOrderCustomAttributeDefinitionResponse> delete(
    ...
    public CompletableFuture<DeleteOrderCustomAttributeDefinitionResponse> delete(
        ...
        CompletableFuture<DeleteOrderCustomAttributeDefinitionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
