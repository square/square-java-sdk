...
public class AsyncCustomAttributesClient {
     ...
     */
    public CompletableFuture<BulkDeleteOrderCustomAttributesResponse> batchDelete(
    ...
    public CompletableFuture<BulkDeleteOrderCustomAttributesResponse> batchDelete(
        ...
        CompletableFuture<BulkDeleteOrderCustomAttributesResponse> future = new CompletableFuture<>();
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public CompletableFuture<BulkUpsertOrderCustomAttributesResponse> batchUpsert(
    ...
    public CompletableFuture<BulkUpsertOrderCustomAttributesResponse> batchUpsert(
        ...
        CompletableFuture<BulkUpsertOrderCustomAttributesResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     * also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public CompletableFuture<RetrieveOrderCustomAttributeResponse> get(
        ...
        CompletableFuture<RetrieveOrderCustomAttributeResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public CompletableFuture<UpsertOrderCustomAttributeResponse> upsert(
        ...
        CompletableFuture<UpsertOrderCustomAttributeResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     * (also known as custom fields) are always set to <code>VISIBILITY_READ_WRITE_VALUES</code>.</p>
     */
    public CompletableFuture<DeleteOrderCustomAttributeResponse> delete(
        ...
        CompletableFuture<DeleteOrderCustomAttributeResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
