...
@JsonDeserialize(builder = InventoryTransfer.Builder.class)
public final class InventoryTransfer {
     ...
     * <code>InventoryTransfer</code> to an external system.
     */
    @JsonIgnore
    ...
    /**
     * @return The <a href="entity:InventoryState">inventory state</a> for the quantity of
    ...
    /**
     * @return The number of items affected by the transfer as a decimal string.
     ...
     * the transfer took place. For write actions, the <code>occurred_at</code> timestamp
    ...
    /**
     * @return An RFC 3339-formatted timestamp that indicates when Square
    ...
    /**
     * @return Information about the application that initiated the
     * inventory transfer.
     */
    @JsonProperty("source")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InventoryTransfer && equalTo((InventoryTransfer) other);
    }
    ...
    private boolean equalTo(InventoryTransfer other) {
    ...
    public static final class Builder {
        ...
        public Builder from(InventoryTransfer other) {
            id(other.getId());
         ...
         * <code>InventoryTransfer</code> to an external system.</p>
         */
        ...
        /**
         * <p>The <a href="entity:InventoryState">inventory state</a> for the quantity of
         * items being transferred.
         ...
         * quantity of items was tracked before the transfer.</p>
         */
        ...
        /**
         * <p>The Square-generated ID of the <a href="entity:Location">Location</a> where the related
         * quantity of items was tracked after the transfer.</p>
         */
        ...
        /**
         * <p>The number of items affected by the transfer as a decimal string.
        ...
        /**
         * <p>An RFC 3339-formatted timestamp that indicates when Square
         * received the transfer request.</p>
         */
        ...
        /**
         * <p>Information about the application that initiated the
         * inventory transfer.</p>
         */
