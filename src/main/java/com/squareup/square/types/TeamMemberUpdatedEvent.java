...
@JsonDeserialize(builder = TeamMemberUpdatedEvent.Builder.class)
public final class TeamMemberUpdatedEvent {
    ...
    private final Optional<TeamMemberUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private TeamMemberUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<TeamMemberUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;team_member.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<TeamMemberUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TeamMemberUpdatedEvent && equalTo((TeamMemberUpdatedEvent) other);
    }
    ...
    private boolean equalTo(TeamMemberUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<TeamMemberUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(TeamMemberUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;team_member.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<TeamMemberUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(TeamMemberUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public TeamMemberUpdatedEvent build() {
            return new TeamMemberUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
