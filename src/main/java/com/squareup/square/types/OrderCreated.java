...
@JsonDeserialize(builder = OrderCreated.Builder.class)
public final class OrderCreated {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof OrderCreated && equalTo((OrderCreated) other);
    }
    ...
    private boolean equalTo(OrderCreated other) {
    ...
    public static final class Builder {
        ...
        public Builder from(OrderCreated other) {
        ...
        public OrderCreated build() {
            return new OrderCreated(orderId, version, locationId, state, createdAt, additionalProperties);
        }
    }
}
