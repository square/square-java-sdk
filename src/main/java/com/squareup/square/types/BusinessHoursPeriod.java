...
@JsonDeserialize(builder = BusinessHoursPeriod.Builder.class)
public final class BusinessHoursPeriod {
    ...
    /**
     * @return The day of the week for this time period.
    ...
    /**
     * @return The start time of a business hours period, specified in local time using partial-time
    ...
    /**
     * @return The end time of a business hours period, specified in local time using partial-time
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BusinessHoursPeriod && equalTo((BusinessHoursPeriod) other);
    }
    ...
    private boolean equalTo(BusinessHoursPeriod other) {
        return dayOfWeek.equals(other.dayOfWeek)
                && startLocalTime.equals(other.startLocalTime)
