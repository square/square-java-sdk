...
public final class CatalogPricingRule {
    ...
    public static final class Builder {
        ...
        /**
         * <p>User-defined name for the pricing rule. For example, &quot;Buy one get one
         * free&quot; or &quot;10% off&quot;.</p>
         */
        ...
        /**
         * <p>A list of unique IDs for the catalog time periods when
         * this pricing rule is in effect. If left unset, the pricing rule is always
         * in effect.</p>
         */
        ...
        /**
         * <p>Unique ID for the <code>CatalogDiscount</code> to take off
         * the price of all matched items.</p>
         */
        ...
        /**
         * <p>Unique ID for the <code>CatalogProductSet</code> that will be matched by this rule. A match rule
         * matches within the entire cart, and can match multiple times. This field will always be set.</p>
         */
        ...
        /**
         * <p><strong>Deprecated</strong>: Please use the <code>exclude_products_id</code> field to apply
         * an exclude set instead. Exclude sets allow better control over quantity
         * ranges and offer more flexibility for which matched items receive a discount.</p>
         * <p><code>CatalogProductSet</code> to apply the pricing to.
         * An apply rule matches within the subset of the cart that fits the match rules (the match set).
         * An apply rule can only match once in the match set.
         * If not supplied, the pricing will be applied to all products in the match set.
        ...
        /**
         * <p><code>CatalogProductSet</code> to exclude from the pricing rule.
         * An exclude rule matches within the subset of the cart that fits the match rules (the match set).
         * An exclude rule can only match once in the match set.
         * If not supplied, the pricing will be applied to all products in the match set.
         * Other products retain their base price, or a price generated by other rules.</p>
        ...
        /**
         * <p>Represents the date the Pricing Rule is valid from. Represented in RFC 3339 full-date format (YYYY-MM-DD).</p>
         */
        ...
        /**
         * <p>Represents the local time the pricing rule should be valid from. Represented in RFC 3339 partial-time format
         * (HH:MM:SS). Partial seconds will be truncated.</p>
         */
        ...
        /**
         * <p>Represents the date the Pricing Rule is valid until. Represented in RFC 3339 full-date format (YYYY-MM-DD).</p>
         */
        ...
        /**
         * <p>Represents the local time the pricing rule should be valid until. Represented in RFC 3339 partial-time format
         * (HH:MM:SS). Partial seconds will be truncated.</p>
         */
        ...
        /**
         * <p>If an <code>exclude_products_id</code> was given, controls which subset of matched
         * products is excluded from any discounts.</p>
         * <p>Default value: <code>LEAST_EXPENSIVE</code>
         * See <a href="#type-excludestrategy">ExcludeStrategy</a> for possible values</p>
         */
        ...
        /**
         * <p>The minimum order subtotal (before discounts or taxes are applied)
         * that must be met before this rule may be applied.</p>
         */
        ...
        /**
         * <p>A list of IDs of customer groups, the members of which are eligible for discounts specified in this pricing rule.
         * Notice that a group ID is generated by the Customers API.
         * If this field is not set, the specified discount applies to matched products sold to anyone whether the buyer
         * has a customer profile created or not. If this <code>customer_group_ids_any</code> field is set, the specified discount
         * applies only to matched products sold to customers belonging to the specified customer groups.</p>
         */
