...
@JsonDeserialize(builder = UpsertMerchantCustomAttributeResponse.Builder.class)
public final class UpsertMerchantCustomAttributeResponse {
    ...
    private UpsertMerchantCustomAttributeResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpsertMerchantCustomAttributeResponse
                && equalTo((UpsertMerchantCustomAttributeResponse) other);
    }
    ...
    private boolean equalTo(UpsertMerchantCustomAttributeResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpsertMerchantCustomAttributeResponse other) {
        ...
        public UpsertMerchantCustomAttributeResponse build() {
            return new UpsertMerchantCustomAttributeResponse(customAttribute, errors, additionalProperties);
        }
    }
}
