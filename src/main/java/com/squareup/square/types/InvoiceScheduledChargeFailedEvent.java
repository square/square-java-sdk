...
@JsonDeserialize(builder = InvoiceScheduledChargeFailedEvent.Builder.class)
public final class InvoiceScheduledChargeFailedEvent {
    ...
    private final Optional<InvoiceScheduledChargeFailedEventData> data;

    private final Map<String, Object> additionalProperties;

    private InvoiceScheduledChargeFailedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<InvoiceScheduledChargeFailedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;invoice.scheduled_charge_failed&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<InvoiceScheduledChargeFailedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InvoiceScheduledChargeFailedEvent && equalTo((InvoiceScheduledChargeFailedEvent) other);
    }
    ...
    private boolean equalTo(InvoiceScheduledChargeFailedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<InvoiceScheduledChargeFailedEventData> data = Optional.empty();
        ...
        public Builder from(InvoiceScheduledChargeFailedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;invoice.scheduled_charge_failed&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<InvoiceScheduledChargeFailedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(InvoiceScheduledChargeFailedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public InvoiceScheduledChargeFailedEvent build() {
            return new InvoiceScheduledChargeFailedEvent(
