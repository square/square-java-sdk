...
@JsonDeserialize(builder = PayOrderResponse.Builder.class)
public final class PayOrderResponse {
    ...
    private PayOrderResponse(
            Optional<List<Error>> errors, Optional<Order> order, Map<String, Object> additionalProperties) {
        this.errors = errors;
        this.order = order;
    ...
    /**
     * @return The paid, updated <a href="entity:Order">order</a>.
     */
    @JsonProperty("order")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PayOrderResponse && equalTo((PayOrderResponse) other);
    }
    ...
    private boolean equalTo(PayOrderResponse other) {
        return errors.equals(other.errors) && order.equals(other.order);
    }
    ...
    public static final class Builder {
        ...
        public PayOrderResponse build() {
            return new PayOrderResponse(errors, order, additionalProperties);
        }
    }
}
