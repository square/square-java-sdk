...
@JsonDeserialize(builder = LaborScheduledShiftDeletedEvent.Builder.class)
public final class LaborScheduledShiftDeletedEvent {
    ...
    private final Optional<LaborScheduledShiftDeletedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LaborScheduledShiftDeletedEvent(
            Optional<String> merchantId,
            Optional<String> locationId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LaborScheduledShiftDeletedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>labor.scheduled_shift.deleted</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LaborScheduledShiftDeletedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LaborScheduledShiftDeletedEvent && equalTo((LaborScheduledShiftDeletedEvent) other);
    }
    ...
    private boolean equalTo(LaborScheduledShiftDeletedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LaborScheduledShiftDeletedEventData> data = Optional.empty();
        ...
        public Builder from(LaborScheduledShiftDeletedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>labor.scheduled_shift.deleted</code>.</p>
         */
        ...
        public Builder data(Optional<LaborScheduledShiftDeletedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LaborScheduledShiftDeletedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LaborScheduledShiftDeletedEvent build() {
            return new LaborScheduledShiftDeletedEvent(
