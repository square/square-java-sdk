...
@JsonDeserialize(builder = GiftCardCreatedEvent.Builder.class)
public final class GiftCardCreatedEvent {
    ...
    private final Optional<GiftCardCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private GiftCardCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<GiftCardCreatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>gift_card.created</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<GiftCardCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GiftCardCreatedEvent && equalTo((GiftCardCreatedEvent) other);
    }
    ...
    private boolean equalTo(GiftCardCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<GiftCardCreatedEventData> data = Optional.empty();
        ...
        public Builder from(GiftCardCreatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>gift_card.created</code>.</p>
         */
        ...
        public Builder data(Optional<GiftCardCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(GiftCardCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public GiftCardCreatedEvent build() {
            return new GiftCardCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
