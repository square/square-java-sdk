...
@JsonDeserialize(builder = BookingUpdatedEvent.Builder.class)
public final class BookingUpdatedEvent {
    ...
    private final Optional<BookingUpdatedEventData> data;
    ...
    private BookingUpdatedEvent(
            ...
            Optional<BookingUpdatedEventData> data,
    ...
    /**
     * @return The type of this event. The value is <code>&quot;booking.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<BookingUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BookingUpdatedEvent && equalTo((BookingUpdatedEvent) other);
    }
    ...
    private boolean equalTo(BookingUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<BookingUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(BookingUpdatedEvent other) {
        ...
        /**
         * <p>The type of this event. The value is <code>&quot;booking.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<BookingUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(BookingUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public BookingUpdatedEvent build() {
            return new BookingUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
