...
@JsonDeserialize(builder = CatalogObjectItemOption.Builder.class)
public final class CatalogObjectItemOption implements ICatalogObjectBase {
    ...
    private CatalogObjectItemOption(
            String id,
            ...
            Optional<CatalogItemOption> itemOptionData,
    ...
    /**
     * @return Structured data for a <code>CatalogItemOption</code>, set for CatalogObjects of type <code>ITEM_OPTION</code>.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectItemOption && equalTo((CatalogObjectItemOption) other);
    }
    ...
    private boolean equalTo(CatalogObjectItemOption other) {
        return id.equals(other.id)
                ...
                && itemOptionData.equals(other.itemOptionData);
    }
    ...
    public interface IdStage {
        ...
        Builder from(CatalogObjectItemOption other);
    }

    public interface _FinalStage {
        CatalogObjectItemOption build();
        ...
        /**
         * <p>Structured data for a <code>CatalogItemOption</code>, set for CatalogObjects of type <code>ITEM_OPTION</code>.</p>
         */
        _FinalStage itemOptionData(Optional<CatalogItemOption> itemOptionData);

        _FinalStage itemOptionData(CatalogItemOption itemOptionData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        public Builder from(CatalogObjectItemOption other) {
            ...
            itemOptionData(other.getItemOptionData());
            return this;
        }
        ...
        public CatalogObjectItemOption build() {
            return new CatalogObjectItemOption(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
