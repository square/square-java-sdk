...
@JsonDeserialize(builder = InvoiceRefundedEvent.Builder.class)
public final class InvoiceRefundedEvent {
    ...
    private final Optional<InvoiceRefundedEventData> data;

    private final Map<String, Object> additionalProperties;

    private InvoiceRefundedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<InvoiceRefundedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;invoice.refunded&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<InvoiceRefundedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InvoiceRefundedEvent && equalTo((InvoiceRefundedEvent) other);
    }
    ...
    private boolean equalTo(InvoiceRefundedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<InvoiceRefundedEventData> data = Optional.empty();
        ...
        public Builder from(InvoiceRefundedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;invoice.refunded&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<InvoiceRefundedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(InvoiceRefundedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public InvoiceRefundedEvent build() {
            return new InvoiceRefundedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
