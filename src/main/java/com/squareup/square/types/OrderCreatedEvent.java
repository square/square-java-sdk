...
public final class OrderCreatedEvent {
    ...
    private final Optional<OrderCreatedEventData> data;
    ...
    private OrderCreatedEvent(
            ...
            Optional<OrderCreatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;order.created&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<OrderCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof OrderCreatedEvent && equalTo((OrderCreatedEvent) other);
    }
    ...
    private boolean equalTo(OrderCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<OrderCreatedEventData> data = Optional.empty();
        ...
        public Builder from(OrderCreatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;order.created&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<OrderCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(OrderCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public OrderCreatedEvent build() {
            return new OrderCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
