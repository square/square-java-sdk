...
@JsonDeserialize(builder = CatalogObjectMeasurementUnit.Builder.class)
public final class CatalogObjectMeasurementUnit implements ICatalogObjectBase {
    ...
    private final Optional<CatalogMeasurementUnit> measurementUnitData;

    private final Map<String, Object> additionalProperties;

    private CatalogObjectMeasurementUnit(
            String id,
            ...
            Optional<CatalogMeasurementUnit> measurementUnitData,
    ...
    /**
     * @return Structured data for a <code>CatalogMeasurementUnit</code>, set for CatalogObjects of type <code>MEASUREMENT_UNIT</code>.
     */
    @JsonProperty("measurement_unit_data")
    public Optional<CatalogMeasurementUnit> getMeasurementUnitData() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectMeasurementUnit && equalTo((CatalogObjectMeasurementUnit) other);
    }
    ...
    private boolean equalTo(CatalogObjectMeasurementUnit other) {
        return id.equals(other.id)
                ...
                && measurementUnitData.equals(other.measurementUnitData);
    }
    ...
    public interface IdStage {
        ...
        Builder from(CatalogObjectMeasurementUnit other);
    }

    public interface _FinalStage {
        CatalogObjectMeasurementUnit build();
        ...
        /**
         * <p>Structured data for a <code>CatalogMeasurementUnit</code>, set for CatalogObjects of type <code>MEASUREMENT_UNIT</code>.</p>
         */
        _FinalStage measurementUnitData(Optional<CatalogMeasurementUnit> measurementUnitData);

        _FinalStage measurementUnitData(CatalogMeasurementUnit measurementUnitData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        private Optional<CatalogMeasurementUnit> measurementUnitData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CatalogObjectMeasurementUnit other) {
            id(other.getId());
            ...
            measurementUnitData(other.getMeasurementUnitData());
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage measurementUnitData(CatalogMeasurementUnit measurementUnitData) {
            this.measurementUnitData = Optional.ofNullable(measurementUnitData);
            return this;
        }
         ...
         */
        @java.lang.Override
        @JsonSetter(value = "measurement_unit_data", nulls = Nulls.SKIP)
        public _FinalStage measurementUnitData(Optional<CatalogMeasurementUnit> measurementUnitData) {
            this.measurementUnitData = measurementUnitData;
            return this;
        }
        ...
        @java.lang.Override
        public CatalogObjectMeasurementUnit build() {
            return new CatalogObjectMeasurementUnit(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
