...
@JsonDeserialize(builder = InvoiceUpdatedEvent.Builder.class)
public final class InvoiceUpdatedEvent {
    ...
    private final Optional<InvoiceUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private InvoiceUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<InvoiceUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;invoice.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<InvoiceUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InvoiceUpdatedEvent && equalTo((InvoiceUpdatedEvent) other);
    }
    ...
    private boolean equalTo(InvoiceUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<InvoiceUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(InvoiceUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;invoice.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<InvoiceUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(InvoiceUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public InvoiceUpdatedEvent build() {
            return new InvoiceUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
