...
@JsonDeserialize(builder = GetCustomerResponse.Builder.class)
public final class GetCustomerResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetCustomerResponse && equalTo((GetCustomerResponse) other);
    }
    ...
    public static final class Builder {
        ...
        public GetCustomerResponse build() {
            return new GetCustomerResponse(errors, customer, additionalProperties);
        }
    }
}
