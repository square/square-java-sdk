...
@JsonDeserialize(builder = RefundCreatedEvent.Builder.class)
public final class RefundCreatedEvent {
    ...
    private final Optional<RefundCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private RefundCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<RefundCreatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;refund.created&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<RefundCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RefundCreatedEvent && equalTo((RefundCreatedEvent) other);
    }
    ...
    private boolean equalTo(RefundCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<RefundCreatedEventData> data = Optional.empty();
        ...
        public Builder from(RefundCreatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;refund.created&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<RefundCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(RefundCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public RefundCreatedEvent build() {
            return new RefundCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
