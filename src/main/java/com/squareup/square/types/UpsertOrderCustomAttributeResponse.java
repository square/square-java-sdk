...
@JsonDeserialize(builder = UpsertOrderCustomAttributeResponse.Builder.class)
public final class UpsertOrderCustomAttributeResponse {
    ...
    private UpsertOrderCustomAttributeResponse(
    ...
    /**
     * @return The order custom attribute that was created or modified.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpsertOrderCustomAttributeResponse
                && equalTo((UpsertOrderCustomAttributeResponse) other);
    }
    ...
    private boolean equalTo(UpsertOrderCustomAttributeResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(UpsertOrderCustomAttributeResponse other) {
        ...
        public UpsertOrderCustomAttributeResponse build() {
            return new UpsertOrderCustomAttributeResponse(customAttribute, errors, additionalProperties);
        }
    }
}
