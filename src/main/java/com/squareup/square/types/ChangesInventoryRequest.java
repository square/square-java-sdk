...
@JsonDeserialize(builder = ChangesInventoryRequest.Builder.class)
public final class ChangesInventoryRequest {
    ...
    private ChangesInventoryRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ChangesInventoryRequest && equalTo((ChangesInventoryRequest) other);
    }
    ...
    private boolean equalTo(ChangesInventoryRequest other) {
    ...
    public static final class Builder implements CatalogObjectIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ChangesInventoryRequest other) {
