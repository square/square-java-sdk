...
@JsonDeserialize(builder = LoyaltyAccountCreatedEvent.Builder.class)
public final class LoyaltyAccountCreatedEvent {
    ...
    private final Optional<LoyaltyAccountCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LoyaltyAccountCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LoyaltyAccountCreatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>loyalty.account.created</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LoyaltyAccountCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LoyaltyAccountCreatedEvent && equalTo((LoyaltyAccountCreatedEvent) other);
    }
    ...
    private boolean equalTo(LoyaltyAccountCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LoyaltyAccountCreatedEventData> data = Optional.empty();
        ...
        public Builder from(LoyaltyAccountCreatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>loyalty.account.created</code>.</p>
         */
        ...
        public Builder data(Optional<LoyaltyAccountCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LoyaltyAccountCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LoyaltyAccountCreatedEvent build() {
            return new LoyaltyAccountCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
