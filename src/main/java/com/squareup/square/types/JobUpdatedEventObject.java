...
@JsonDeserialize(builder = JobUpdatedEventObject.Builder.class)
public final class JobUpdatedEventObject {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof JobUpdatedEventObject && equalTo((JobUpdatedEventObject) other);
    }
    ...
    public static final class Builder {
        ...
        public JobUpdatedEventObject build() {
            return new JobUpdatedEventObject(job, additionalProperties);
        }
    }
}
