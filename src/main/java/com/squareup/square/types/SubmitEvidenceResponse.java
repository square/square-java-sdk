...
@JsonDeserialize(builder = SubmitEvidenceResponse.Builder.class)
public final class SubmitEvidenceResponse {
    ...
    private SubmitEvidenceResponse(
    ...
    /**
     * @return The <code>Dispute</code> for which evidence was submitted.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SubmitEvidenceResponse && equalTo((SubmitEvidenceResponse) other);
    }
    ...
    public static final class Builder {
        ...
        /**
         * <p>The <code>Dispute</code> for which evidence was submitted.</p>
         */
        ...
        public SubmitEvidenceResponse build() {
            return new SubmitEvidenceResponse(errors, dispute, additionalProperties);
        }
    }
}
