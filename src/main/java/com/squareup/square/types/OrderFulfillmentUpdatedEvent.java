...
@JsonDeserialize(builder = OrderFulfillmentUpdatedEvent.Builder.class)
public final class OrderFulfillmentUpdatedEvent {
    ...
    private final Optional<OrderFulfillmentUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private OrderFulfillmentUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<OrderFulfillmentUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;order.fulfillment.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<OrderFulfillmentUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof OrderFulfillmentUpdatedEvent && equalTo((OrderFulfillmentUpdatedEvent) other);
    }
    ...
    private boolean equalTo(OrderFulfillmentUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<OrderFulfillmentUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(OrderFulfillmentUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;order.fulfillment.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<OrderFulfillmentUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(OrderFulfillmentUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public OrderFulfillmentUpdatedEvent build() {
            return new OrderFulfillmentUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
