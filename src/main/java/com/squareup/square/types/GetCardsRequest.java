...
public final class GetCardsRequest {
    ...
    private GetCardsRequest(String cardId, Map<String, Object> additionalProperties) {
        this.cardId = cardId;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetCardsRequest && equalTo((GetCardsRequest) other);
    }
    ...
    private boolean equalTo(GetCardsRequest other) {
    ...
    public static final class Builder implements CardIdStage, _FinalStage {
        ...
        public GetCardsRequest build() {
            return new GetCardsRequest(cardId, additionalProperties);
        }
    }
}
