...
@JsonDeserialize(builder = InvoiceCreatedEvent.Builder.class)
public final class InvoiceCreatedEvent {
    ...
    private final Optional<InvoiceCreatedEventData> data;
    ...
    private InvoiceCreatedEvent(
            ...
            Optional<InvoiceCreatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;invoice.created&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<InvoiceCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InvoiceCreatedEvent && equalTo((InvoiceCreatedEvent) other);
    }
    ...
    private boolean equalTo(InvoiceCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<InvoiceCreatedEventData> data = Optional.empty();
        ...
        public Builder from(InvoiceCreatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;invoice.created&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<InvoiceCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(InvoiceCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public InvoiceCreatedEvent build() {
            return new InvoiceCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
