...
@JsonDeserialize(builder = PayoutPaidEvent.Builder.class)
public final class PayoutPaidEvent {
    ...
    private final Optional<PayoutPaidEventData> data;

    private final Map<String, Object> additionalProperties;

    private PayoutPaidEvent(
            Optional<String> merchantId,
            Optional<String> locationId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<PayoutPaidEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;payout.paid&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<PayoutPaidEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PayoutPaidEvent && equalTo((PayoutPaidEvent) other);
    }
    ...
    private boolean equalTo(PayoutPaidEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<PayoutPaidEventData> data = Optional.empty();
        ...
        public Builder from(PayoutPaidEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;payout.paid&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<PayoutPaidEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(PayoutPaidEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public PayoutPaidEvent build() {
            return new PayoutPaidEvent(merchantId, locationId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
