...
@JsonDeserialize(builder = CardUpdatedEvent.Builder.class)
public final class CardUpdatedEvent {
    ...
    private final Optional<CardUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private CardUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<CardUpdatedEventData> data,
    ...
    /**
     * @return The type of this event. The value is <code>&quot;card.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<CardUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CardUpdatedEvent && equalTo((CardUpdatedEvent) other);
    }
    ...
    private boolean equalTo(CardUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<CardUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(CardUpdatedEvent other) {
        ...
        /**
         * <p>The type of this event. The value is <code>&quot;card.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<CardUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(CardUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public CardUpdatedEvent build() {
            return new CardUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
