...
@JsonDeserialize(builder = OrderUpdated.Builder.class)
public final class OrderUpdated {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof OrderUpdated && equalTo((OrderUpdated) other);
    }
    ...
    private boolean equalTo(OrderUpdated other) {
    ...
    public static final class Builder {
        ...
        public Builder from(OrderUpdated other) {
        ...
        public OrderUpdated build() {
            return new OrderUpdated(orderId, version, locationId, state, createdAt, updatedAt, additionalProperties);
        }
    }
}
