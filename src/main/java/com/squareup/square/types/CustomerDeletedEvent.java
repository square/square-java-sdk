...
@JsonDeserialize(builder = CustomerDeletedEvent.Builder.class)
public final class CustomerDeletedEvent {
    ...
    private final Optional<CustomerDeletedEventData> data;
    ...
    private CustomerDeletedEvent(
            ...
            Optional<CustomerDeletedEventData> data,
    ...
    /**
     * @return The type of event. For this object, the value is <code>customer.deleted</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<CustomerDeletedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CustomerDeletedEvent && equalTo((CustomerDeletedEvent) other);
    }
    ...
    private boolean equalTo(CustomerDeletedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<CustomerDeletedEventData> data = Optional.empty();
        ...
        public Builder from(CustomerDeletedEvent other) {
        ...
        /**
         * <p>The type of event. For this object, the value is <code>customer.deleted</code>.</p>
         */
        ...
        public Builder data(Optional<CustomerDeletedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(CustomerDeletedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public CustomerDeletedEvent build() {
            return new CustomerDeletedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
