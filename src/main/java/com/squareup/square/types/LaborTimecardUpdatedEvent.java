...
@JsonDeserialize(builder = LaborTimecardUpdatedEvent.Builder.class)
public final class LaborTimecardUpdatedEvent {
    ...
    private final Optional<LaborTimecardUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LaborTimecardUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LaborTimecardUpdatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>labor.timecard.updated</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LaborTimecardUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LaborTimecardUpdatedEvent && equalTo((LaborTimecardUpdatedEvent) other);
    }
    ...
    private boolean equalTo(LaborTimecardUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LaborTimecardUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(LaborTimecardUpdatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>labor.timecard.updated</code>.</p>
         */
        ...
        public Builder data(Optional<LaborTimecardUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LaborTimecardUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LaborTimecardUpdatedEvent build() {
            return new LaborTimecardUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
