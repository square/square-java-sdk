...
@JsonDeserialize(builder = TeamMemberWageSettingUpdatedEvent.Builder.class)
public final class TeamMemberWageSettingUpdatedEvent {
    ...
    private final Optional<TeamMemberWageSettingUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private TeamMemberWageSettingUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<TeamMemberWageSettingUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;team_member.wage_setting.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<TeamMemberWageSettingUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TeamMemberWageSettingUpdatedEvent && equalTo((TeamMemberWageSettingUpdatedEvent) other);
    }
    ...
    private boolean equalTo(TeamMemberWageSettingUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<TeamMemberWageSettingUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(TeamMemberWageSettingUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;team_member.wage_setting.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<TeamMemberWageSettingUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(TeamMemberWageSettingUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public TeamMemberWageSettingUpdatedEvent build() {
            return new TeamMemberWageSettingUpdatedEvent(
