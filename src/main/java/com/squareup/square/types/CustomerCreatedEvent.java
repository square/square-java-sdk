...
@JsonDeserialize(builder = CustomerCreatedEvent.Builder.class)
public final class CustomerCreatedEvent {
    ...
    private final Optional<CustomerCreatedEventData> data;
    ...
    private CustomerCreatedEvent(
            ...
            Optional<CustomerCreatedEventData> data,
    ...
    /**
     * @return The ID of the seller associated with the event.
     */
    @JsonIgnore
    ...
    /**
     * @return The type of event. For this object, the value is <code>customer.created</code>.
     */
    @JsonIgnore
    ...
    /**
     * @return The unique ID of the event, which is used for <a href="https://developer.squareup.com/docs/webhooks/step4manage#webhooks-best-practices">idempotency support</a>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<CustomerCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CustomerCreatedEvent && equalTo((CustomerCreatedEvent) other);
    }
    ...
    private boolean equalTo(CustomerCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<CustomerCreatedEventData> data = Optional.empty();
        ...
        public Builder from(CustomerCreatedEvent other) {
        ...
        /**
         * <p>The ID of the seller associated with the event.</p>
         */
        ...
        /**
         * <p>The type of event. For this object, the value is <code>customer.created</code>.</p>
         */
        ...
        /**
         * <p>The unique ID of the event, which is used for <a href="https://developer.squareup.com/docs/webhooks/step4manage#webhooks-best-practices">idempotency support</a>.</p>
         */
        ...
        public Builder data(Optional<CustomerCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(CustomerCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public CustomerCreatedEvent build() {
            return new CustomerCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
