...
@JsonDeserialize(builder = LoyaltyAccountUpdatedEvent.Builder.class)
public final class LoyaltyAccountUpdatedEvent {
    ...
    private final Optional<LoyaltyAccountUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LoyaltyAccountUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LoyaltyAccountUpdatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>loyalty.account.updated</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LoyaltyAccountUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LoyaltyAccountUpdatedEvent && equalTo((LoyaltyAccountUpdatedEvent) other);
    }
    ...
    private boolean equalTo(LoyaltyAccountUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LoyaltyAccountUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(LoyaltyAccountUpdatedEvent other) {
        ...
        public Builder data(LoyaltyAccountUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LoyaltyAccountUpdatedEvent build() {
            return new LoyaltyAccountUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
