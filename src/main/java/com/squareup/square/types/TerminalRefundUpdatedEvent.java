...
@JsonDeserialize(builder = TerminalRefundUpdatedEvent.Builder.class)
public final class TerminalRefundUpdatedEvent {
    ...
    private final Optional<TerminalRefundUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private TerminalRefundUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<TerminalRefundUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;terminal.refund.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<TerminalRefundUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TerminalRefundUpdatedEvent && equalTo((TerminalRefundUpdatedEvent) other);
    }
    ...
    private boolean equalTo(TerminalRefundUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<TerminalRefundUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(TerminalRefundUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;terminal.refund.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<TerminalRefundUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(TerminalRefundUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public TerminalRefundUpdatedEvent build() {
            return new TerminalRefundUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
