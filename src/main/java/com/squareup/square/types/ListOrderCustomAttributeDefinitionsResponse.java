...
@JsonDeserialize(builder = ListOrderCustomAttributeDefinitionsResponse.Builder.class)
public final class ListOrderCustomAttributeDefinitionsResponse {
    ...
    private ListOrderCustomAttributeDefinitionsResponse(
    ...
    /**
     * @return The retrieved custom attribute definitions. If no custom attribute definitions are found, Square returns an empty object (<code>{}</code>).
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListOrderCustomAttributeDefinitionsResponse
                && equalTo((ListOrderCustomAttributeDefinitionsResponse) other);
    }
    ...
    private boolean equalTo(ListOrderCustomAttributeDefinitionsResponse other) {
    ...
    public static final class Builder {
        private List<CustomAttributeDefinition> customAttributeDefinitions = new ArrayList<>();
        ...
        public Builder from(ListOrderCustomAttributeDefinitionsResponse other) {
        ...
        /**
         * <p>The retrieved custom attribute definitions. If no custom attribute definitions are found, Square returns an empty object (<code>{}</code>).</p>
         */
        ...
        public Builder addCustomAttributeDefinitions(CustomAttributeDefinition customAttributeDefinitions) {
            this.customAttributeDefinitions.add(customAttributeDefinitions);
            return this;
        }
