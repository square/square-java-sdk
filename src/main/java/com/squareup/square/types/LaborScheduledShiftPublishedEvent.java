...
@JsonDeserialize(builder = LaborScheduledShiftPublishedEvent.Builder.class)
public final class LaborScheduledShiftPublishedEvent {
    ...
    private final Optional<LaborScheduledShiftPublishedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LaborScheduledShiftPublishedEvent(
            Optional<String> merchantId,
            Optional<String> locationId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LaborScheduledShiftPublishedEventData> data,
    ...
    /**
     * @return The ID of the merchant associated with the event.
     */
    @JsonIgnore
    ...
    /**
     * @return The ID of the location associated with the event.
     */
    @JsonIgnore
    ...
    /**
     * @return The type of event. For this event, the value is <code>labor.scheduled_shift.published</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LaborScheduledShiftPublishedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LaborScheduledShiftPublishedEvent && equalTo((LaborScheduledShiftPublishedEvent) other);
    }
    ...
    private boolean equalTo(LaborScheduledShiftPublishedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LaborScheduledShiftPublishedEventData> data = Optional.empty();
        ...
        public Builder from(LaborScheduledShiftPublishedEvent other) {
        ...
        /**
         * <p>The ID of the merchant associated with the event.</p>
         */
        ...
        /**
         * <p>The ID of the location associated with the event.</p>
         */
        ...
        /**
         * <p>The type of event. For this event, the value is <code>labor.scheduled_shift.published</code>.</p>
         */
        ...
        public Builder data(Optional<LaborScheduledShiftPublishedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LaborScheduledShiftPublishedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LaborScheduledShiftPublishedEvent build() {
            return new LaborScheduledShiftPublishedEvent(
