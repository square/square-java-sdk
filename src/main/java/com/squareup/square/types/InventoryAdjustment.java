...
public final class InventoryAdjustment {
    ...
    private final Optional<String> fromLocationId;

    private final Optional<String> toLocationId;
    ...
    private final Optional<Money> costMoney;

    private final Optional<String> vendorId;

    private final Optional<String> physicalCountId;

    private final Optional<InventoryAdjustmentReasonId> reasonId;
    ...
    private InventoryAdjustment(
            ...
            Optional<String> fromLocationId,
            Optional<String> toLocationId,
            ...
            Optional<Money> costMoney,
            Optional<String> vendorId,
            Optional<String> physicalCountId,
            Optional<InventoryAdjustmentReasonId> reasonId,
     ...
     */
    @JsonIgnore
    public Optional<String> getFromLocationId() {
     ...
     */
    @JsonIgnore
    public Optional<String> getToLocationId() {
    ...
    /**
     * @return The total amount paid by the merchant to the supplying vendor for these units of the product.
    ...
    public Optional<Money> getCostMoney() {
        return costMoney;
    }

    /**
     * @return The Square-generated ID of the Vendor from which the merchant purchased this product.
     * This field is only applicable for stock receive adjustments that introduce stock into the system (from_state is NONE or UNLINKED_RETURN).
     * This field will only accept writes if the merchant has an active subscription for either Retail Plus, Restaurants Plus, or Restaurants Premium.
     */
    @JsonIgnore
    ...
    /**
     * @return The Square-generated ID of the InventoryPhysicalCount (recount) that generated this adjustment, if applicable.
     * The quantity of an adjustment generated by a physical count cannot be edited.
     */
    @JsonProperty("physical_count_id")
    public Optional<String> getPhysicalCountId() {
        return physicalCountId;
    }

    /**
     * @return Identifies the reason for this inventory adjustment.
     */
    @JsonProperty("reason_id")
    public Optional<InventoryAdjustmentReasonId> getReasonId() {
        return reasonId;
    }
    ...
    private Optional<String> _getFromLocationId() {
        return fromLocationId;
    }

    @JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = NullableNonemptyFilter.class)
    @JsonProperty("to_location_id")
    private Optional<String> _getToLocationId() {
        return toLocationId;
    }
    ...
    private boolean equalTo(InventoryAdjustment other) {
        return id.equals(other.id)
                ...
                && costMoney.equals(other.costMoney)
                && vendorId.equals(other.vendorId)
                && physicalCountId.equals(other.physicalCountId)
    ...
    public static final class Builder {
        ...
        private Optional<String> fromLocationId = Optional.empty();

        private Optional<String> toLocationId = Optional.empty();
        ...
        private Optional<Money> costMoney = Optional.empty();

        private Optional<String> vendorId = Optional.empty();

        private Optional<String> physicalCountId = Optional.empty();

        private Optional<InventoryAdjustmentReasonId> reasonId = Optional.empty();
        ...
        public Builder from(InventoryAdjustment other) {
            ...
            fromLocationId(other.getFromLocationId());
            toLocationId(other.getToLocationId());
        ...
        /**
         * <p>A unique ID generated by Square for the
         * <code>InventoryAdjustment</code>.</p>
         */
        ...
        /**
         * <p>The <a href="entity:InventoryState">inventory state</a> of the related quantity
         * of items before the adjustment.
         ...
         * quantity of items is being tracked before the adjustment.</p>
         */
        @JsonSetter(value = "from_location_id", nulls = Nulls.SKIP)
        public Builder fromLocationId(Optional<String> fromLocationId) {
            this.fromLocationId = fromLocationId;
            return this;
        }

        public Builder fromLocationId(String fromLocationId) {
            this.fromLocationId = Optional.ofNullable(fromLocationId);
            return this;
        }

        public Builder fromLocationId(Nullable<String> fromLocationId) {
            if (fromLocationId.isNull()) {
                this.fromLocationId = null;
            } else if (fromLocationId.isEmpty()) {
                this.fromLocationId = Optional.empty();
            } else {
                this.fromLocationId = Optional.of(fromLocationId.get());
            }
            return this;
        }
        ...
        /**
         * <p>The Square-generated ID of the <a href="entity:Location">Location</a> where the related
         * quantity of items is being tracked after the adjustment.</p>
         */
        @JsonSetter(value = "to_location_id", nulls = Nulls.SKIP)
        public Builder toLocationId(Optional<String> toLocationId) {
            this.toLocationId = toLocationId;
            return this;
        }

        public Builder toLocationId(String toLocationId) {
            this.toLocationId = Optional.ofNullable(toLocationId);
            return this;
        }

        public Builder toLocationId(Nullable<String> toLocationId) {
            if (toLocationId.isNull()) {
                this.toLocationId = null;
            } else if (toLocationId.isEmpty()) {
                this.toLocationId = Optional.empty();
            } else {
                this.toLocationId = Optional.of(toLocationId.get());
            }
            return this;
        }
        ...
        /**
         * <p>The number of items affected by the adjustment as a decimal string.
        ...
        /**
         * <p>The total price paid for goods associated with the
         * adjustment. Present if and only if <code>to_state</code> is <code>SOLD</code>. Always
         * non-negative.</p>
         */
        ...
        /**
         * <p>An RFC 3339-formatted timestamp that indicates when the inventory adjustment is received.</p>
         */
        ...
        /**
         * <p>Information about the application that caused the
        ...
        /**
         * <p>The Square-generated ID of the <a href="entity:Transaction">Transaction</a> that
         * caused the adjustment. Only relevant for payment-related state
         * transitions.</p>
         */
        ...
        /**
         * <p>The Square-generated ID of the <a href="entity:Refund">Refund</a> that
         * caused the adjustment. Only relevant for refund-related state
         * transitions.</p>
         */
        ...
        /**
         * <p>The Square-generated ID of the purchase order that caused the
         * adjustment. Only relevant for state transitions from the Square for Retail
         * app.</p>
         */
        ...
        /**
         * <p>The Square-generated ID of the goods receipt that caused the
         * adjustment. Only relevant for state transitions from the Square for Retail
         * app.</p>
         */
        ...
        /**
         * <p>An adjustment group bundling the related adjustments of item variations through stock conversions in a single inventory event.</p>
         */
        ...
        /**
         * <p>The total amount paid by the merchant to the supplying vendor for these units of the product.
         * This field is only applicable for stock receive adjustments that introduce stock into the system (from_state is NONE or UNLINKED_RETURN).
         * May be empty.
         * This field will only accept writes if the merchant has an active subscription for either Retail Plus, Restaurants Plus, or Restaurants Premium.</p>
         */
        @JsonSetter(value = "cost_money", nulls = Nulls.SKIP)
        public Builder costMoney(Optional<Money> costMoney) {
            this.costMoney = costMoney;
            return this;
        }

        public Builder costMoney(Money costMoney) {
            this.costMoney = Optional.ofNullable(costMoney);
            return this;
        }

        /**
         * <p>The Square-generated ID of the Vendor from which the merchant purchased this product.
         * This field is only applicable for stock receive adjustments that introduce stock into the system (from_state is NONE or UNLINKED_RETURN).
         * This field will only accept writes if the merchant has an active subscription for either Retail Plus, Restaurants Plus, or Restaurants Premium.</p>
         */
        ...
        /**
         * <p>The Square-generated ID of the InventoryPhysicalCount (recount) that generated this adjustment, if applicable.
         * The quantity of an adjustment generated by a physical count cannot be edited.</p>
         */
        @JsonSetter(value = "physical_count_id", nulls = Nulls.SKIP)
        public Builder physicalCountId(Optional<String> physicalCountId) {
            this.physicalCountId = physicalCountId;
            return this;
        }

        public Builder physicalCountId(String physicalCountId) {
            this.physicalCountId = Optional.ofNullable(physicalCountId);
            return this;
        }

        /**
         * <p>Identifies the reason for this inventory adjustment.</p>
         */
        @JsonSetter(value = "reason_id", nulls = Nulls.SKIP)
        public Builder reasonId(Optional<InventoryAdjustmentReasonId> reasonId) {
            this.reasonId = reasonId;
            return this;
        }

        public Builder reasonId(InventoryAdjustmentReasonId reasonId) {
