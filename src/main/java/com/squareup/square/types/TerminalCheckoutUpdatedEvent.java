...
@JsonDeserialize(builder = TerminalCheckoutUpdatedEvent.Builder.class)
public final class TerminalCheckoutUpdatedEvent {
    ...
    private final Optional<TerminalCheckoutUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private TerminalCheckoutUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<TerminalCheckoutUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;terminal.checkout.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<TerminalCheckoutUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TerminalCheckoutUpdatedEvent && equalTo((TerminalCheckoutUpdatedEvent) other);
    }
    ...
    private boolean equalTo(TerminalCheckoutUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<TerminalCheckoutUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(TerminalCheckoutUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;terminal.checkout.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<TerminalCheckoutUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(TerminalCheckoutUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public TerminalCheckoutUpdatedEvent build() {
            return new TerminalCheckoutUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
