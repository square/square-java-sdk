...
@JsonDeserialize(builder = TerminalRefundCreatedEvent.Builder.class)
public final class TerminalRefundCreatedEvent {
    ...
    private final Optional<TerminalRefundCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private TerminalRefundCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<TerminalRefundCreatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;terminal.refund.created&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<TerminalRefundCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TerminalRefundCreatedEvent && equalTo((TerminalRefundCreatedEvent) other);
    }
    ...
    private boolean equalTo(TerminalRefundCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<TerminalRefundCreatedEventData> data = Optional.empty();
        ...
        public Builder from(TerminalRefundCreatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;terminal.refund.created&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<TerminalRefundCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(TerminalRefundCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public TerminalRefundCreatedEvent build() {
            return new TerminalRefundCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
