...
@JsonDeserialize(builder = CancelPaymentResponse.Builder.class)
public final class CancelPaymentResponse {
    ...
    /**
     * @return The successfully canceled <code>Payment</code> object.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CancelPaymentResponse && equalTo((CancelPaymentResponse) other);
    }
    ...
    private boolean equalTo(CancelPaymentResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CancelPaymentResponse other) {
        ...
        /**
         * <p>The successfully canceled <code>Payment</code> object.</p>
         */
        ...
        public CancelPaymentResponse build() {
            return new CancelPaymentResponse(errors, payment, additionalProperties);
        }
    }
}
