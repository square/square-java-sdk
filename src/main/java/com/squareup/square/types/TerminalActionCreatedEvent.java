...
@JsonDeserialize(builder = TerminalActionCreatedEvent.Builder.class)
public final class TerminalActionCreatedEvent {
    ...
    private final Optional<TerminalActionCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private TerminalActionCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<TerminalActionCreatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;terminal.action.created&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<TerminalActionCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TerminalActionCreatedEvent && equalTo((TerminalActionCreatedEvent) other);
    }
    ...
    private boolean equalTo(TerminalActionCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<TerminalActionCreatedEventData> data = Optional.empty();
        ...
        public Builder from(TerminalActionCreatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;terminal.action.created&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<TerminalActionCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(TerminalActionCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public TerminalActionCreatedEvent build() {
            return new TerminalActionCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
