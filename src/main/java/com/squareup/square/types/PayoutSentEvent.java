...
@JsonDeserialize(builder = PayoutSentEvent.Builder.class)
public final class PayoutSentEvent {
    ...
    private final Optional<PayoutSentEventData> data;

    private final Map<String, Object> additionalProperties;

    private PayoutSentEvent(
            Optional<String> merchantId,
            Optional<String> locationId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<PayoutSentEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;payout.sent&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<PayoutSentEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PayoutSentEvent && equalTo((PayoutSentEvent) other);
    }
    ...
    private boolean equalTo(PayoutSentEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<PayoutSentEventData> data = Optional.empty();
        ...
        public Builder from(PayoutSentEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;payout.sent&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<PayoutSentEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(PayoutSentEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public PayoutSentEvent build() {
            return new PayoutSentEvent(merchantId, locationId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
