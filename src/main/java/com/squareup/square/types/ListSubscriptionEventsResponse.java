...
@JsonDeserialize(builder = ListSubscriptionEventsResponse.Builder.class)
public final class ListSubscriptionEventsResponse {
    ...
    private ListSubscriptionEventsResponse(
            Optional<List<Error>> errors,
            Optional<List<SubscriptionEvent>> subscriptionEvents,
    ...
    /**
     * @return The retrieved subscription events.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListSubscriptionEventsResponse && equalTo((ListSubscriptionEventsResponse) other);
    }
    ...
    private boolean equalTo(ListSubscriptionEventsResponse other) {
        return errors.equals(other.errors)
                && subscriptionEvents.equals(other.subscriptionEvents)
    ...
    public static final class Builder {
        ...
        public Builder from(ListSubscriptionEventsResponse other) {
            ...
            subscriptionEvents(other.getSubscriptionEvents());
        ...
        public ListSubscriptionEventsResponse build() {
            return new ListSubscriptionEventsResponse(errors, subscriptionEvents, cursor, additionalProperties);
        }
    }
}
