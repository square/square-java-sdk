...
@JsonDeserialize(builder = CatalogObjectSubscriptionPlan.Builder.class)
public final class CatalogObjectSubscriptionPlan implements ICatalogObjectBase {
    ...
    private final Optional<CatalogSubscriptionPlan> subscriptionPlanData;

    private final Map<String, Object> additionalProperties;

    private CatalogObjectSubscriptionPlan(
            String id,
            ...
            Optional<CatalogSubscriptionPlan> subscriptionPlanData,
    ...
    /**
     * @return Structured data for a <code>CatalogSubscriptionPlan</code>, set for CatalogObjects of type <code>SUBSCRIPTION_PLAN</code>.
     */
    @JsonProperty("subscription_plan_data")
    public Optional<CatalogSubscriptionPlan> getSubscriptionPlanData() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectSubscriptionPlan && equalTo((CatalogObjectSubscriptionPlan) other);
    }
    ...
    private boolean equalTo(CatalogObjectSubscriptionPlan other) {
        return id.equals(other.id)
                ...
                && subscriptionPlanData.equals(other.subscriptionPlanData);
    }
    ...
    public interface IdStage {
        ...
        Builder from(CatalogObjectSubscriptionPlan other);
    }

    public interface _FinalStage {
        CatalogObjectSubscriptionPlan build();
        ...
        _FinalStage subscriptionPlanData(Optional<CatalogSubscriptionPlan> subscriptionPlanData);

        _FinalStage subscriptionPlanData(CatalogSubscriptionPlan subscriptionPlanData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        private Optional<CatalogSubscriptionPlan> subscriptionPlanData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CatalogObjectSubscriptionPlan other) {
            id(other.getId());
            ...
            subscriptionPlanData(other.getSubscriptionPlanData());
            return this;
        }
        ...
        /**
         * <p>Structured data for a <code>CatalogSubscriptionPlan</code>, set for CatalogObjects of type <code>SUBSCRIPTION_PLAN</code>.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
        public _FinalStage subscriptionPlanData(CatalogSubscriptionPlan subscriptionPlanData) {
            this.subscriptionPlanData = Optional.ofNullable(subscriptionPlanData);
            return this;
        }

        @java.lang.Override
        @JsonSetter(value = "subscription_plan_data", nulls = Nulls.SKIP)
        public _FinalStage subscriptionPlanData(Optional<CatalogSubscriptionPlan> subscriptionPlanData) {
            this.subscriptionPlanData = subscriptionPlanData;
            return this;
        }
        ...
        @java.lang.Override
        public CatalogObjectSubscriptionPlan build() {
            return new CatalogObjectSubscriptionPlan(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
