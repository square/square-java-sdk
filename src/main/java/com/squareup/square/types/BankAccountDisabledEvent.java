...
@JsonDeserialize(builder = BankAccountDisabledEvent.Builder.class)
public final class BankAccountDisabledEvent {
    ...
    private final Optional<BankAccountDisabledEventData> data;

    private final Map<String, Object> additionalProperties;

    private BankAccountDisabledEvent(
            Optional<String> merchantId,
            Optional<String> locationId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<BankAccountDisabledEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;bank_account.disabled&quot;</code>.
     */
    @JsonIgnore
    ...
    /**
     * @return Timestamp of when the event was disabled, in RFC 3339 format.
     */
     ...
     */
    @JsonProperty("data")
    public Optional<BankAccountDisabledEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BankAccountDisabledEvent && equalTo((BankAccountDisabledEvent) other);
    }
    ...
    private boolean equalTo(BankAccountDisabledEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<BankAccountDisabledEventData> data = Optional.empty();
        ...
        public Builder from(BankAccountDisabledEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;bank_account.disabled&quot;</code>.</p>
         */
        ...
        /**
         * <p>Timestamp of when the event was disabled, in RFC 3339 format.</p>
         */
        ...
        public Builder data(Optional<BankAccountDisabledEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(BankAccountDisabledEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public BankAccountDisabledEvent build() {
            return new BankAccountDisabledEvent(
