...
@JsonDeserialize(builder = VendorCreatedEvent.Builder.class)
public final class VendorCreatedEvent {
    ...
    private final Optional<VendorCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private VendorCreatedEvent(
            Optional<String> merchantId,
            Optional<String> locationId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<VendorCreatedEventData> data,
    ...
    /**
     * @return The ID of a location associated with the event, if the event is associated with the location of the seller.
     */
    @JsonIgnore
    ...
    /**
     * @return The type of this event. The value is <code>&quot;vendor.created&quot;.</code>
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<VendorCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VendorCreatedEvent && equalTo((VendorCreatedEvent) other);
    }
    ...
    private boolean equalTo(VendorCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<VendorCreatedEventData> data = Optional.empty();
        ...
        public Builder from(VendorCreatedEvent other) {
        ...
        public Builder data(VendorCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public VendorCreatedEvent build() {
            return new VendorCreatedEvent(merchantId, locationId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
