...
@JsonDeserialize(builder = AcceptDisputesRequest.Builder.class)
public final class AcceptDisputesRequest {
    private final String disputeId;

    private final Map<String, Object> additionalProperties;

    private AcceptDisputesRequest(String disputeId, Map<String, Object> additionalProperties) {
        this.disputeId = disputeId;
        this.additionalProperties = additionalProperties;
    }

    /**
     * @return The ID of the dispute you want to accept.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AcceptDisputesRequest && equalTo((AcceptDisputesRequest) other);
    }
    ...
    private boolean equalTo(AcceptDisputesRequest other) {
    ...
    public static final class Builder implements DisputeIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(AcceptDisputesRequest other) {
        ...
        @java.lang.Override
        public AcceptDisputesRequest build() {
            return new AcceptDisputesRequest(disputeId, additionalProperties);
        }
    }
}
