...
@JsonDeserialize(builder = TeamMemberCreatedEvent.Builder.class)
public final class TeamMemberCreatedEvent {
    ...
    private final Optional<TeamMemberCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private TeamMemberCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<TeamMemberCreatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;team_member.created&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<TeamMemberCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TeamMemberCreatedEvent && equalTo((TeamMemberCreatedEvent) other);
    }
    ...
    private boolean equalTo(TeamMemberCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<TeamMemberCreatedEventData> data = Optional.empty();
        ...
        public Builder from(TeamMemberCreatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;team_member.created&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<TeamMemberCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(TeamMemberCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public TeamMemberCreatedEvent build() {
            return new TeamMemberCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
