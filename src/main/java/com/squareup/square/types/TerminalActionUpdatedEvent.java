...
@JsonDeserialize(builder = TerminalActionUpdatedEvent.Builder.class)
public final class TerminalActionUpdatedEvent {
    ...
    private final Optional<TerminalActionUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private TerminalActionUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<TerminalActionUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;terminal.action.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<TerminalActionUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TerminalActionUpdatedEvent && equalTo((TerminalActionUpdatedEvent) other);
    }
    ...
    private boolean equalTo(TerminalActionUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<TerminalActionUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(TerminalActionUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;terminal.action.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<TerminalActionUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(TerminalActionUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public TerminalActionUpdatedEvent build() {
            return new TerminalActionUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
