...
public final class Transaction {
    ...
    public static final class Builder {
        ...
        /**
         * <p>The transaction's unique ID, issued by Square payments servers.</p>
         */
        ...
        /**
         * <p>The timestamp for when the transaction was created, in RFC 3339 format.</p>
         */
        ...
        /**
         * <p>The tenders used to pay in the transaction.</p>
         */
        ...
        /**
         * <p>Refunds that have been applied to any tender in the transaction.</p>
         */
        ...
        /**
         * <p>If the transaction was created with the <a href="api-endpoint:Transactions-Charge">Charge</a>
         * endpoint, this value is the same as the value provided for the <code>reference_id</code>
         * parameter in the request to that endpoint. Otherwise, it is not set.</p>
         */
        ...
        /**
         * <p>The Square product that processed the transaction.
         * See <a href="#type-transactionproduct">TransactionProduct</a> for possible values</p>
         */
        ...
        /**
         * <p>If the transaction was created in the Square Point of Sale app, this value
         * is the ID generated for the transaction by Square Point of Sale.</p>
         * <p>This ID has no relationship to the transaction's canonical <code>id</code>, which is
         * generated by Square's backend servers. This value is generated for bookkeeping
         * purposes, in case the transaction cannot immediately be completed (for example,
         * if the transaction is processed in offline mode).</p>
        ...
        /**
         * <p>The shipping address provided in the request, if any.</p>
         */
        ...
        /**
         * <p>The order_id is an identifier for the order associated with this transaction, if any.</p>
         */
