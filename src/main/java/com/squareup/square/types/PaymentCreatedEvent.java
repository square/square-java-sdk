...
@JsonDeserialize(builder = PaymentCreatedEvent.Builder.class)
public final class PaymentCreatedEvent {
    ...
    private final Optional<PaymentCreatedEventData> data;
    ...
    private PaymentCreatedEvent(
            ...
            Optional<PaymentCreatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;payment.created&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<PaymentCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentCreatedEvent && equalTo((PaymentCreatedEvent) other);
    }
    ...
    private boolean equalTo(PaymentCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<PaymentCreatedEventData> data = Optional.empty();
        ...
        public Builder from(PaymentCreatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;payment.created&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<PaymentCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(PaymentCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public PaymentCreatedEvent build() {
            return new PaymentCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
