...
@JsonDeserialize(builder = OauthAuthorizationRevokedEvent.Builder.class)
public final class OauthAuthorizationRevokedEvent {
    ...
    private final Optional<OauthAuthorizationRevokedEventData> data;

    private final Map<String, Object> additionalProperties;

    private OauthAuthorizationRevokedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<OauthAuthorizationRevokedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;oauth.authorization.revoked&quot;</code>.
     */
    @JsonIgnore
    ...
    /**
     * @return Timestamp of when the event was created, in RFC 3339 format.
     */
     ...
     */
    @JsonProperty("data")
    public Optional<OauthAuthorizationRevokedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof OauthAuthorizationRevokedEvent && equalTo((OauthAuthorizationRevokedEvent) other);
    }
    ...
    private boolean equalTo(OauthAuthorizationRevokedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<OauthAuthorizationRevokedEventData> data = Optional.empty();
        ...
        public Builder from(OauthAuthorizationRevokedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;oauth.authorization.revoked&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<OauthAuthorizationRevokedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(OauthAuthorizationRevokedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public OauthAuthorizationRevokedEvent build() {
            return new OauthAuthorizationRevokedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
