...
public final class ListJobsRequest {
    ...
    private ListJobsRequest(Optional<String> cursor, Map<String, Object> additionalProperties) {
        this.cursor = cursor;
        this.additionalProperties = additionalProperties;
    }

    /**
     * @return The pagination cursor returned by the previous call to this endpoint. Provide this
    ...
    public static final class Builder {
        ...
        public ListJobsRequest build() {
            return new ListJobsRequest(cursor, additionalProperties);
        }
    }
}
