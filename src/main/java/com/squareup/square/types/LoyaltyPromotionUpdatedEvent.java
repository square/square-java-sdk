...
@JsonDeserialize(builder = LoyaltyPromotionUpdatedEvent.Builder.class)
public final class LoyaltyPromotionUpdatedEvent {
    ...
    private final Optional<LoyaltyPromotionUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LoyaltyPromotionUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LoyaltyPromotionUpdatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>loyalty.promotion.updated</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LoyaltyPromotionUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LoyaltyPromotionUpdatedEvent && equalTo((LoyaltyPromotionUpdatedEvent) other);
    }
    ...
    private boolean equalTo(LoyaltyPromotionUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LoyaltyPromotionUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(LoyaltyPromotionUpdatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>loyalty.promotion.updated</code>.</p>
         */
        ...
        public Builder data(Optional<LoyaltyPromotionUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LoyaltyPromotionUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LoyaltyPromotionUpdatedEvent build() {
            return new LoyaltyPromotionUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
