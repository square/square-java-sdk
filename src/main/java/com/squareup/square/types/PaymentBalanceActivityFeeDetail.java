...
@JsonDeserialize(builder = PaymentBalanceActivityFeeDetail.Builder.class)
public final class PaymentBalanceActivityFeeDetail {
    private final Optional<String> paymentId;

    private final Map<String, Object> additionalProperties;

    private PaymentBalanceActivityFeeDetail(Optional<String> paymentId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentBalanceActivityFeeDetail && equalTo((PaymentBalanceActivityFeeDetail) other);
    }
    ...
    private boolean equalTo(PaymentBalanceActivityFeeDetail other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PaymentBalanceActivityFeeDetail other) {
        ...
        public PaymentBalanceActivityFeeDetail build() {
            return new PaymentBalanceActivityFeeDetail(paymentId, additionalProperties);
        }
    }
}
