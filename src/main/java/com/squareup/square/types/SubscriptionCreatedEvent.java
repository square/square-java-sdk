...
@JsonDeserialize(builder = SubscriptionCreatedEvent.Builder.class)
public final class SubscriptionCreatedEvent {
    ...
    private final Optional<SubscriptionCreatedEventData> data;
    ...
    private SubscriptionCreatedEvent(
            ...
            Optional<SubscriptionCreatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;subscription.created&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<SubscriptionCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SubscriptionCreatedEvent && equalTo((SubscriptionCreatedEvent) other);
    }
    ...
    private boolean equalTo(SubscriptionCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<SubscriptionCreatedEventData> data = Optional.empty();
        ...
        public Builder from(SubscriptionCreatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;subscription.created&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<SubscriptionCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(SubscriptionCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public SubscriptionCreatedEvent build() {
            return new SubscriptionCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
