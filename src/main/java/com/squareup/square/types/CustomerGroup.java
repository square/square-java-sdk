...
@JsonDeserialize(builder = CustomerGroup.Builder.class)
public final class CustomerGroup {
    ...
    /**
     * @return A unique Square-generated ID for the customer group.
     */
    @JsonProperty("id")
    ...
    /**
     * @return The timestamp when the customer group was created, in RFC 3339 format.
     */
    ...
    /**
     * @return The timestamp when the customer group was last updated, in RFC 3339 format.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CustomerGroup && equalTo((CustomerGroup) other);
    }
