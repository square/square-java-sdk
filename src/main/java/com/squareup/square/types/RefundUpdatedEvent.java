...
@JsonDeserialize(builder = RefundUpdatedEvent.Builder.class)
public final class RefundUpdatedEvent {
    ...
    private final Optional<RefundUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private RefundUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<RefundUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;refund.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<RefundUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RefundUpdatedEvent && equalTo((RefundUpdatedEvent) other);
    }
    ...
    private boolean equalTo(RefundUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<RefundUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(RefundUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;refund.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<RefundUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(RefundUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public RefundUpdatedEvent build() {
            return new RefundUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
