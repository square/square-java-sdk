...
@JsonDeserialize(builder = GiftCardActivityBlock.Builder.class)
public final class GiftCardActivityBlock {
    private final String reason;

    private final Map<String, Object> additionalProperties;

    private GiftCardActivityBlock(String reason, Map<String, Object> additionalProperties) {
        this.reason = reason;
        this.additionalProperties = additionalProperties;
    }

    /**
     * @return The reason the gift card was blocked.
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GiftCardActivityBlock && equalTo((GiftCardActivityBlock) other);
    }
    ...
    private boolean equalTo(GiftCardActivityBlock other) {
    ...
    public static final class Builder implements ReasonStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GiftCardActivityBlock other) {
