...
@JsonDeserialize(builder = MerchantCustomAttributeDefinitionVisibleDeletedEvent.Builder.class)
public final class MerchantCustomAttributeDefinitionVisibleDeletedEvent {
    ...
    private final Optional<CustomAttributeDefinitionEventData> data;

    private final Map<String, Object> additionalProperties;

    private MerchantCustomAttributeDefinitionVisibleDeletedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<CustomAttributeDefinitionEventData> data,
    ...
    /**
     * @return The ID of the seller associated with the event that triggered the event notification.
     */
    @JsonIgnore
    ...
    /**
     * @return The type of this event. The value is <code>&quot;merchant.custom_attribute_definition.visible.deleted&quot;</code>.
     */
    @JsonIgnore
    ...
    /**
     * @return A unique ID for the event notification.
     */
    @JsonIgnore
    ...
    /**
     * @return The timestamp that indicates when the event notification was created, in RFC 3339 format.
     */
    ...
    /**
     * @return The data associated with the event that triggered the event notification.
     */
    @JsonProperty("data")
    public Optional<CustomAttributeDefinitionEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MerchantCustomAttributeDefinitionVisibleDeletedEvent
                && equalTo((MerchantCustomAttributeDefinitionVisibleDeletedEvent) other);
    }
    ...
    private boolean equalTo(MerchantCustomAttributeDefinitionVisibleDeletedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<CustomAttributeDefinitionEventData> data = Optional.empty();
        ...
        public Builder from(MerchantCustomAttributeDefinitionVisibleDeletedEvent other) {
        ...
        /**
         * <p>The type of this event. The value is <code>&quot;merchant.custom_attribute_definition.visible.deleted&quot;</code>.</p>
         */
        ...
        public Builder data(CustomAttributeDefinitionEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public MerchantCustomAttributeDefinitionVisibleDeletedEvent build() {
            return new MerchantCustomAttributeDefinitionVisibleDeletedEvent(
