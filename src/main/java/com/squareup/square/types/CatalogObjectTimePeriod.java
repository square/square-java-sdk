...
@JsonDeserialize(builder = CatalogObjectTimePeriod.Builder.class)
public final class CatalogObjectTimePeriod implements ICatalogObjectBase {
    ...
    private final Optional<CatalogTimePeriod> timePeriodData;

    private final Map<String, Object> additionalProperties;

    private CatalogObjectTimePeriod(
            String id,
            ...
            Optional<CatalogTimePeriod> timePeriodData,
    ...
    /**
     * @return Structured data for a <code>CatalogTimePeriod</code>, set for CatalogObjects of type <code>TIME_PERIOD</code>.
     */
    @JsonProperty("time_period_data")
    public Optional<CatalogTimePeriod> getTimePeriodData() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectTimePeriod && equalTo((CatalogObjectTimePeriod) other);
    }
    ...
    private boolean equalTo(CatalogObjectTimePeriod other) {
        return id.equals(other.id)
                ...
                && timePeriodData.equals(other.timePeriodData);
    }
    ...
    public interface IdStage {
        ...
        Builder from(CatalogObjectTimePeriod other);
    }

    public interface _FinalStage {
        CatalogObjectTimePeriod build();
        ...
        /**
         * <p>Structured data for a <code>CatalogTimePeriod</code>, set for CatalogObjects of type <code>TIME_PERIOD</code>.</p>
         */
        _FinalStage timePeriodData(Optional<CatalogTimePeriod> timePeriodData);

        _FinalStage timePeriodData(CatalogTimePeriod timePeriodData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        private Optional<CatalogTimePeriod> timePeriodData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CatalogObjectTimePeriod other) {
            id(other.getId());
            ...
            timePeriodData(other.getTimePeriodData());
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage timePeriodData(CatalogTimePeriod timePeriodData) {
            this.timePeriodData = Optional.ofNullable(timePeriodData);
            return this;
        }
         ...
         */
        @java.lang.Override
        @JsonSetter(value = "time_period_data", nulls = Nulls.SKIP)
        public _FinalStage timePeriodData(Optional<CatalogTimePeriod> timePeriodData) {
            this.timePeriodData = timePeriodData;
            return this;
        }
        ...
        @java.lang.Override
        public CatalogObjectTimePeriod build() {
            return new CatalogObjectTimePeriod(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
