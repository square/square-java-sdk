...
@JsonDeserialize(builder = LaborTimecardDeletedEvent.Builder.class)
public final class LaborTimecardDeletedEvent {
    ...
    private final Optional<LaborTimecardDeletedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LaborTimecardDeletedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LaborTimecardDeletedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>labor.timecard.deleted</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LaborTimecardDeletedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LaborTimecardDeletedEvent && equalTo((LaborTimecardDeletedEvent) other);
    }
    ...
    private boolean equalTo(LaborTimecardDeletedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LaborTimecardDeletedEventData> data = Optional.empty();
        ...
        public Builder from(LaborTimecardDeletedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>labor.timecard.deleted</code>.</p>
         */
        ...
        public Builder data(Optional<LaborTimecardDeletedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LaborTimecardDeletedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LaborTimecardDeletedEvent build() {
            return new LaborTimecardDeletedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
