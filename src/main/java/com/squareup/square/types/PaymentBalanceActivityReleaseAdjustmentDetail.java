...
@JsonDeserialize(builder = PaymentBalanceActivityReleaseAdjustmentDetail.Builder.class)
public final class PaymentBalanceActivityReleaseAdjustmentDetail {
    private final Optional<String> paymentId;

    private final Map<String, Object> additionalProperties;

    private PaymentBalanceActivityReleaseAdjustmentDetail(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentBalanceActivityReleaseAdjustmentDetail
                && equalTo((PaymentBalanceActivityReleaseAdjustmentDetail) other);
    }
    ...
    private boolean equalTo(PaymentBalanceActivityReleaseAdjustmentDetail other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PaymentBalanceActivityReleaseAdjustmentDetail other) {
        ...
        public PaymentBalanceActivityReleaseAdjustmentDetail build() {
            return new PaymentBalanceActivityReleaseAdjustmentDetail(paymentId, additionalProperties);
        }
    }
}
