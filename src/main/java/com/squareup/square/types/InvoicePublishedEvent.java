...
@JsonDeserialize(builder = InvoicePublishedEvent.Builder.class)
public final class InvoicePublishedEvent {
    ...
    private final Optional<InvoicePublishedEventData> data;

    private final Map<String, Object> additionalProperties;

    private InvoicePublishedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<InvoicePublishedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;invoice.published&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<InvoicePublishedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InvoicePublishedEvent && equalTo((InvoicePublishedEvent) other);
    }
    ...
    private boolean equalTo(InvoicePublishedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<InvoicePublishedEventData> data = Optional.empty();
        ...
        public Builder from(InvoicePublishedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;invoice.published&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<InvoicePublishedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(InvoicePublishedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public InvoicePublishedEvent build() {
            return new InvoicePublishedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
