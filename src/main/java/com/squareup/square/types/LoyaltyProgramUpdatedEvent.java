...
@JsonDeserialize(builder = LoyaltyProgramUpdatedEvent.Builder.class)
public final class LoyaltyProgramUpdatedEvent {
    ...
    private final Optional<LoyaltyProgramUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LoyaltyProgramUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LoyaltyProgramUpdatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>loyalty.program.updated</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LoyaltyProgramUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LoyaltyProgramUpdatedEvent && equalTo((LoyaltyProgramUpdatedEvent) other);
    }
    ...
    private boolean equalTo(LoyaltyProgramUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LoyaltyProgramUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(LoyaltyProgramUpdatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>loyalty.program.updated</code>.</p>
         */
        ...
        public Builder data(Optional<LoyaltyProgramUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LoyaltyProgramUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LoyaltyProgramUpdatedEvent build() {
            return new LoyaltyProgramUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
