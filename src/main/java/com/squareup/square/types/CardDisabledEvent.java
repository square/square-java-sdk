...
@JsonDeserialize(builder = CardDisabledEvent.Builder.class)
public final class CardDisabledEvent {
    ...
    private final Optional<CardDisabledEventData> data;

    private final Map<String, Object> additionalProperties;

    private CardDisabledEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<CardDisabledEventData> data,
    ...
    /**
     * @return The type of this event. The value is <code>&quot;card.disabled&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<CardDisabledEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CardDisabledEvent && equalTo((CardDisabledEvent) other);
    }
    ...
    private boolean equalTo(CardDisabledEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<CardDisabledEventData> data = Optional.empty();
        ...
        public Builder from(CardDisabledEvent other) {
        ...
        /**
         * <p>The type of this event. The value is <code>&quot;card.disabled&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<CardDisabledEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(CardDisabledEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public CardDisabledEvent build() {
            return new CardDisabledEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
