...
@JsonDeserialize(builder = BankAccountVerifiedEvent.Builder.class)
public final class BankAccountVerifiedEvent {
    ...
    private final Optional<BankAccountVerifiedEventData> data;

    private final Map<String, Object> additionalProperties;

    private BankAccountVerifiedEvent(
            Optional<String> merchantId,
            Optional<String> locationId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<BankAccountVerifiedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;bank_account.verified&quot;</code>.
     */
    @JsonIgnore
    ...
    /**
     * @return Timestamp of when the event was verified, in RFC 3339 format.
     */
     ...
     */
    @JsonProperty("data")
    public Optional<BankAccountVerifiedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BankAccountVerifiedEvent && equalTo((BankAccountVerifiedEvent) other);
    }
    ...
    private boolean equalTo(BankAccountVerifiedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<BankAccountVerifiedEventData> data = Optional.empty();
        ...
        public Builder from(BankAccountVerifiedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;bank_account.verified&quot;</code>.</p>
         */
        ...
        /**
         * <p>Timestamp of when the event was verified, in RFC 3339 format.</p>
         */
        ...
        public Builder data(Optional<BankAccountVerifiedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(BankAccountVerifiedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public BankAccountVerifiedEvent build() {
            return new BankAccountVerifiedEvent(
