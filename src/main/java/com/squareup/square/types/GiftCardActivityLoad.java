...
@JsonDeserialize(builder = GiftCardActivityLoad.Builder.class)
public final class GiftCardActivityLoad {
    ...
    /**
     * @return The UID of the <code>GIFT_CARD</code> line item in the order that represents the additional funds for the gift card.
    ...
    /**
     * @return The payment instrument IDs used to process the order for the additional funds, such as a credit card ID
     * or bank account ID.
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GiftCardActivityLoad && equalTo((GiftCardActivityLoad) other);
    }
