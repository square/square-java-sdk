...
@JsonDeserialize(builder = LoyaltyAccountDeletedEvent.Builder.class)
public final class LoyaltyAccountDeletedEvent {
    ...
    private final Optional<LoyaltyAccountDeletedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LoyaltyAccountDeletedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LoyaltyAccountDeletedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>loyalty.account.deleted</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LoyaltyAccountDeletedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LoyaltyAccountDeletedEvent && equalTo((LoyaltyAccountDeletedEvent) other);
    }
    ...
    private boolean equalTo(LoyaltyAccountDeletedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LoyaltyAccountDeletedEventData> data = Optional.empty();
        ...
        public Builder from(LoyaltyAccountDeletedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>loyalty.account.deleted</code>.</p>
         */
        ...
        public Builder data(Optional<LoyaltyAccountDeletedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LoyaltyAccountDeletedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LoyaltyAccountDeletedEvent build() {
            return new LoyaltyAccountDeletedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
