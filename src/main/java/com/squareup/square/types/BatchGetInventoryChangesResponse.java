...
@JsonDeserialize(builder = BatchGetInventoryChangesResponse.Builder.class)
public final class BatchGetInventoryChangesResponse {
    ...
    private BatchGetInventoryChangesResponse(
    ...
    /**
     * @return The current calculated inventory changes for the requested objects
     * and locations.
     */
     ...
     * See the <a href="https://developer.squareup.com/docs/working-with-apis/pagination">Pagination</a> guide for more information.
     */
    @JsonProperty("cursor")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BatchGetInventoryChangesResponse && equalTo((BatchGetInventoryChangesResponse) other);
    }
    ...
    private boolean equalTo(BatchGetInventoryChangesResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(BatchGetInventoryChangesResponse other) {
        ...
        public BatchGetInventoryChangesResponse build() {
            return new BatchGetInventoryChangesResponse(errors, changes, cursor, additionalProperties);
        }
    }
}
