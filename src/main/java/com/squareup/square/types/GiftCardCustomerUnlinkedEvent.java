...
@JsonDeserialize(builder = GiftCardCustomerUnlinkedEvent.Builder.class)
public final class GiftCardCustomerUnlinkedEvent {
    ...
    private final Optional<GiftCardCustomerUnlinkedEventData> data;

    private final Map<String, Object> additionalProperties;

    private GiftCardCustomerUnlinkedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<GiftCardCustomerUnlinkedEventData> data,
    ...
    /**
     * @return The ID of the Square seller associated with the event.
     */
    @JsonIgnore
    ...
    /**
     * @return The type of event. For this event, the value is <code>gift_card.customer_unlinked</code>.
     */
    @JsonIgnore
    ...
    /**
     * @return The unique ID of the event, which is used for
     * <a href="https://developer.squareup.com/docs/webhooks/step4manage#webhooks-best-practices">idempotency support</a>.
     */
    @JsonIgnore
    ...
    /**
     * @return The timestamp of when the event was created, in RFC 3339 format.
     */
     ...
     */
    @JsonProperty("data")
    public Optional<GiftCardCustomerUnlinkedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GiftCardCustomerUnlinkedEvent && equalTo((GiftCardCustomerUnlinkedEvent) other);
    }
    ...
    private boolean equalTo(GiftCardCustomerUnlinkedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<GiftCardCustomerUnlinkedEventData> data = Optional.empty();
        ...
        public Builder from(GiftCardCustomerUnlinkedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>gift_card.customer_unlinked</code>.</p>
         */
        ...
        /**
         * <p>The unique ID of the event, which is used for
        ...
        public Builder data(Optional<GiftCardCustomerUnlinkedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(GiftCardCustomerUnlinkedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public GiftCardCustomerUnlinkedEvent build() {
            return new GiftCardCustomerUnlinkedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
