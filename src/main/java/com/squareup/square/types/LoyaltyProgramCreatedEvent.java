...
@JsonDeserialize(builder = LoyaltyProgramCreatedEvent.Builder.class)
public final class LoyaltyProgramCreatedEvent {
    ...
    private final Optional<LoyaltyProgramCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LoyaltyProgramCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LoyaltyProgramCreatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>loyalty.program.created</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LoyaltyProgramCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LoyaltyProgramCreatedEvent && equalTo((LoyaltyProgramCreatedEvent) other);
    }
    ...
    private boolean equalTo(LoyaltyProgramCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LoyaltyProgramCreatedEventData> data = Optional.empty();
        ...
        public Builder from(LoyaltyProgramCreatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>loyalty.program.created</code>.</p>
         */
        ...
        public Builder data(Optional<LoyaltyProgramCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LoyaltyProgramCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LoyaltyProgramCreatedEvent build() {
            return new LoyaltyProgramCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
