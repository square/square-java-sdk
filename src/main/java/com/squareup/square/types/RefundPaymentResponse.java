...
@JsonDeserialize(builder = RefundPaymentResponse.Builder.class)
public final class RefundPaymentResponse {
    ...
    /**
     * @return The successfully created <code>PaymentRefund</code>.
     */
    @JsonProperty("refund")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RefundPaymentResponse && equalTo((RefundPaymentResponse) other);
    }
    ...
    public static final class Builder {
        ...
        /**
         * <p>The successfully created <code>PaymentRefund</code>.</p>
         */
        ...
        public RefundPaymentResponse build() {
            return new RefundPaymentResponse(errors, refund, additionalProperties);
        }
    }
}
