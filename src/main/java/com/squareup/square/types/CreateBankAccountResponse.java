...
@JsonDeserialize(builder = CreateBankAccountResponse.Builder.class)
public final class CreateBankAccountResponse {
    ...
    private CreateBankAccountResponse(
    ...
    /**
     * @return The 'BankAccount' that was created.
     */
    ...
    public static final class Builder {
        ...
        public Builder from(CreateBankAccountResponse other) {
        ...
        /**
         * <p>The 'BankAccount' that was created.</p>
         */
        ...
        public CreateBankAccountResponse build() {
            return new CreateBankAccountResponse(bankAccount, errors, additionalProperties);
        }
    }
}
