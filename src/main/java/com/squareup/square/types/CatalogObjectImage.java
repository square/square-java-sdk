...
@JsonDeserialize(builder = CatalogObjectImage.Builder.class)
public final class CatalogObjectImage implements ICatalogObjectBase {
    ...
    private final Optional<CatalogImage> imageData;

    private final Map<String, Object> additionalProperties;

    private CatalogObjectImage(
            String id,
            ...
            Optional<CatalogImage> imageData,
    ...
    /**
     * @return Structured data for a <code>CatalogImage</code>, set for CatalogObjects of type <code>IMAGE</code>.
     */
    @JsonProperty("image_data")
    public Optional<CatalogImage> getImageData() {
        return imageData;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectImage && equalTo((CatalogObjectImage) other);
    }
    ...
    private boolean equalTo(CatalogObjectImage other) {
    ...
    public interface IdStage {
        ...
        Builder from(CatalogObjectImage other);
    }

    public interface _FinalStage {
        CatalogObjectImage build();
        ...
        /**
         * <p>Structured data for a <code>CatalogImage</code>, set for CatalogObjects of type <code>IMAGE</code>.</p>
         */
        _FinalStage imageData(Optional<CatalogImage> imageData);

        _FinalStage imageData(CatalogImage imageData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        private Optional<CatalogImage> imageData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CatalogObjectImage other) {
            id(other.getId());
         ...
         */
        @java.lang.Override
        public _FinalStage imageData(CatalogImage imageData) {
            this.imageData = Optional.ofNullable(imageData);
            return this;
        }
         ...
         */
        @java.lang.Override
        @JsonSetter(value = "image_data", nulls = Nulls.SKIP)
        public _FinalStage imageData(Optional<CatalogImage> imageData) {
            this.imageData = imageData;
            return this;
        }
        ...
        @java.lang.Override
        public CatalogObjectImage build() {
            return new CatalogObjectImage(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
