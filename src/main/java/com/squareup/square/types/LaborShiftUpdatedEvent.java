...
@JsonDeserialize(builder = LaborShiftUpdatedEvent.Builder.class)
public final class LaborShiftUpdatedEvent {
    ...
    private final Optional<LaborShiftUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LaborShiftUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LaborShiftUpdatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>labor.shift.updated</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LaborShiftUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LaborShiftUpdatedEvent && equalTo((LaborShiftUpdatedEvent) other);
    }
    ...
    private boolean equalTo(LaborShiftUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LaborShiftUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(LaborShiftUpdatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>labor.shift.updated</code>.</p>
         */
        ...
        public Builder data(Optional<LaborShiftUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LaborShiftUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LaborShiftUpdatedEvent build() {
            return new LaborShiftUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
