...
@JsonDeserialize(builder = PaymentUpdatedEvent.Builder.class)
public final class PaymentUpdatedEvent {
    ...
    private final Optional<PaymentUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private PaymentUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<PaymentUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;payment.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<PaymentUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentUpdatedEvent && equalTo((PaymentUpdatedEvent) other);
    }
    ...
    private boolean equalTo(PaymentUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<PaymentUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(PaymentUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;payment.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<PaymentUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(PaymentUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public PaymentUpdatedEvent build() {
            return new PaymentUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
