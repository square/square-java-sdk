...
@JsonDeserialize(builder = GiftCardActivityCreatedEvent.Builder.class)
public final class GiftCardActivityCreatedEvent {
    ...
    private final Optional<GiftCardActivityCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private GiftCardActivityCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<GiftCardActivityCreatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>gift_card.activity.created</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<GiftCardActivityCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GiftCardActivityCreatedEvent && equalTo((GiftCardActivityCreatedEvent) other);
    }
    ...
    private boolean equalTo(GiftCardActivityCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<GiftCardActivityCreatedEventData> data = Optional.empty();
        ...
        public Builder from(GiftCardActivityCreatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>gift_card.activity.created</code>.</p>
         */
        ...
        public Builder data(Optional<GiftCardActivityCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(GiftCardActivityCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public GiftCardActivityCreatedEvent build() {
            return new GiftCardActivityCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
