...
@JsonDeserialize(builder = LaborTimecardCreatedEvent.Builder.class)
public final class LaborTimecardCreatedEvent {
    ...
    private final Optional<LaborTimecardCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LaborTimecardCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LaborTimecardCreatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>labor.timecard.created</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LaborTimecardCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LaborTimecardCreatedEvent && equalTo((LaborTimecardCreatedEvent) other);
    }
    ...
    private boolean equalTo(LaborTimecardCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LaborTimecardCreatedEventData> data = Optional.empty();
        ...
        public Builder from(LaborTimecardCreatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>labor.timecard.created</code>.</p>
         */
        ...
        public Builder data(Optional<LaborTimecardCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LaborTimecardCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LaborTimecardCreatedEvent build() {
            return new LaborTimecardCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
