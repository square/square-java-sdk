...
@JsonDeserialize(builder = CreateTerminalCheckoutResponse.Builder.class)
public final class CreateTerminalCheckoutResponse {
    ...
    private CreateTerminalCheckoutResponse(
    ...
    /**
     * @return The created <code>TerminalCheckout</code>.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateTerminalCheckoutResponse && equalTo((CreateTerminalCheckoutResponse) other);
    }
    ...
    private boolean equalTo(CreateTerminalCheckoutResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CreateTerminalCheckoutResponse other) {
        ...
        /**
         * <p>The created <code>TerminalCheckout</code>.</p>
         */
        ...
        public CreateTerminalCheckoutResponse build() {
            return new CreateTerminalCheckoutResponse(errors, checkout, additionalProperties);
        }
    }
}
