...
@JsonDeserialize(builder = PaymentBalanceActivityOtherAdjustmentDetail.Builder.class)
public final class PaymentBalanceActivityOtherAdjustmentDetail {
    private final Optional<String> paymentId;

    private final Map<String, Object> additionalProperties;

    private PaymentBalanceActivityOtherAdjustmentDetail(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentBalanceActivityOtherAdjustmentDetail
                && equalTo((PaymentBalanceActivityOtherAdjustmentDetail) other);
    }
    ...
    private boolean equalTo(PaymentBalanceActivityOtherAdjustmentDetail other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PaymentBalanceActivityOtherAdjustmentDetail other) {
        ...
        public PaymentBalanceActivityOtherAdjustmentDetail build() {
            return new PaymentBalanceActivityOtherAdjustmentDetail(paymentId, additionalProperties);
        }
    }
}
