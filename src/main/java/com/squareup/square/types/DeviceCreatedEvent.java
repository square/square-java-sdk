...
@JsonDeserialize(builder = DeviceCreatedEvent.Builder.class)
public final class DeviceCreatedEvent {
    ...
    private final Optional<DeviceCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private DeviceCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<DeviceCreatedEventData> data,
    ...
    /**
     * @return The merchant the newly created device belongs to.
     */
    @JsonIgnore
    ...
    /**
     * @return The type of event this represents. The value is <code>&quot;device.created&quot;</code>.
     */
    @JsonIgnore
    ...
    /**
     * @return A UUID that uniquely identifies this device creation event.
     */
    @JsonIgnore
    ...
    /**
     * @return The time when the device creation event was first created, in RFC 3339 format.
     */
    ...
    /**
     * @return The metadata associated with the device creation event.
     */
    @JsonProperty("data")
    public Optional<DeviceCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeviceCreatedEvent && equalTo((DeviceCreatedEvent) other);
    }
    ...
    private boolean equalTo(DeviceCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<DeviceCreatedEventData> data = Optional.empty();
        ...
        public Builder from(DeviceCreatedEvent other) {
        ...
        public Builder data(DeviceCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public DeviceCreatedEvent build() {
            return new DeviceCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
