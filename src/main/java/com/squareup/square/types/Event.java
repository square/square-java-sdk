...
public final class Event {
    ...
    public static final class Builder {
        ...
        private Optional<EventData> data = Optional.empty();
        ...
        public Builder data(Optional<EventData> data) {
            this.data = data;
            return this;
        }
        ...
        public Event build() {
            return new Event(merchantId, locationId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
