...
@JsonDeserialize(builder = LaborShiftCreatedEvent.Builder.class)
public final class LaborShiftCreatedEvent {
    ...
    private final Optional<LaborShiftCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LaborShiftCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LaborShiftCreatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>labor.shift.created</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LaborShiftCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LaborShiftCreatedEvent && equalTo((LaborShiftCreatedEvent) other);
    }
    ...
    private boolean equalTo(LaborShiftCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LaborShiftCreatedEventData> data = Optional.empty();
        ...
        public Builder from(LaborShiftCreatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>labor.shift.created</code>.</p>
         */
        ...
        public Builder data(Optional<LaborShiftCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LaborShiftCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LaborShiftCreatedEvent build() {
            return new LaborShiftCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
