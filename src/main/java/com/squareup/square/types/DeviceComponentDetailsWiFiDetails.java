...
@JsonDeserialize(builder = DeviceComponentDetailsWiFiDetails.Builder.class)
public final class DeviceComponentDetailsWiFiDetails {
    ...
    /**
     * @return A boolean to represent whether the WiFI interface is currently active.
     */
    @JsonIgnore
    ...
    /**
     * @return The security protocol for a secure connection (e.g. WPA2). None provided if the connection
     * is unsecured.
     */
    @JsonIgnore
    ...
    /**
     * @return A representation of signal strength of the WIFI network connection.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeviceComponentDetailsWiFiDetails && equalTo((DeviceComponentDetailsWiFiDetails) other);
    }
    ...
    public static final class Builder {
        ...
        public Builder ssid(Nullable<String> ssid) {
            if (ssid.isNull()) {
                ...
                this.ssid = Optional.of(ssid.get());
            }
            return this;
        }
        ...
        public Builder secureConnection(Nullable<String> secureConnection) {
            if (secureConnection.isNull()) {
                this.secureConnection = null;
            } else if (secureConnection.isEmpty()) {
                this.secureConnection = Optional.empty();
            } else {
                this.secureConnection = Optional.of(secureConnection.get());
            }
            return this;
        }
