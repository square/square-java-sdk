...
@JsonDeserialize(builder = GetCustomerCustomAttributeDefinitionResponse.Builder.class)
public final class GetCustomerCustomAttributeDefinitionResponse {
    ...
    private GetCustomerCustomAttributeDefinitionResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetCustomerCustomAttributeDefinitionResponse
                && equalTo((GetCustomerCustomAttributeDefinitionResponse) other);
    }
    ...
    private boolean equalTo(GetCustomerCustomAttributeDefinitionResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetCustomerCustomAttributeDefinitionResponse other) {
        ...
        public GetCustomerCustomAttributeDefinitionResponse build() {
            return new GetCustomerCustomAttributeDefinitionResponse(
