...
public final class Error {
    ...
    /**
     * @return The high-level category for the error.
     * See <a href="#type-errorcategory">ErrorCategory</a> for possible values
     */
    ...
    /**
     * @return The specific code of the error.
     * See <a href="#type-errorcode">ErrorCode</a> for possible values
     */
    @JsonProperty("code")
    ...
    /**
     * @return A human-readable description of the error for debugging purposes.
     */
    @JsonProperty("detail")
    ...
    /**
     * @return The name of the field provided in the original request (if any) that
