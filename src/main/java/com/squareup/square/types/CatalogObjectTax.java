...
@JsonDeserialize(builder = CatalogObjectTax.Builder.class)
public final class CatalogObjectTax implements ICatalogObjectBase {
    ...
    private final Optional<CatalogTax> taxData;

    private final Map<String, Object> additionalProperties;

    private CatalogObjectTax(
            String id,
    ...
    /**
     * @return Structured data for a <code>CatalogTax</code>, set for CatalogObjects of type <code>TAX</code>.
     */
    @JsonProperty("tax_data")
    public Optional<CatalogTax> getTaxData() {
        return taxData;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectTax && equalTo((CatalogObjectTax) other);
    }
    ...
    private boolean equalTo(CatalogObjectTax other) {
    ...
    public interface IdStage {
        ...
        Builder from(CatalogObjectTax other);
    }

    public interface _FinalStage {
        CatalogObjectTax build();
        ...
        _FinalStage taxData(Optional<CatalogTax> taxData);

        _FinalStage taxData(CatalogTax taxData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        private Optional<CatalogTax> taxData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CatalogObjectTax other) {
            id(other.getId());
        ...
        /**
         * <p>Structured data for a <code>CatalogTax</code>, set for CatalogObjects of type <code>TAX</code>.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
        public _FinalStage taxData(CatalogTax taxData) {
            this.taxData = Optional.ofNullable(taxData);
            return this;
        }

        @java.lang.Override
        @JsonSetter(value = "tax_data", nulls = Nulls.SKIP)
        public _FinalStage taxData(Optional<CatalogTax> taxData) {
            this.taxData = taxData;
            return this;
        }
        ...
        @java.lang.Override
        public CatalogObjectTax build() {
            return new CatalogObjectTax(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
