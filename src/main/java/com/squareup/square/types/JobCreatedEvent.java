...
@JsonDeserialize(builder = JobCreatedEvent.Builder.class)
public final class JobCreatedEvent {
    ...
    private final Optional<JobCreatedEventData> data;
    ...
    private JobCreatedEvent(
            ...
            Optional<JobCreatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;job.created&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<JobCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof JobCreatedEvent && equalTo((JobCreatedEvent) other);
    }
    ...
    private boolean equalTo(JobCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<JobCreatedEventData> data = Optional.empty();
        ...
        public Builder from(JobCreatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;job.created&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<JobCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(JobCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public JobCreatedEvent build() {
            return new JobCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
