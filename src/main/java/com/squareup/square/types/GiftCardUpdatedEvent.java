...
@JsonDeserialize(builder = GiftCardUpdatedEvent.Builder.class)
public final class GiftCardUpdatedEvent {
    ...
    private final Optional<GiftCardUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private GiftCardUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<GiftCardUpdatedEventData> data,
    ...
    /**
     * @return The type of this event. For this event, the value is <code>gift_card.updated</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<GiftCardUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GiftCardUpdatedEvent && equalTo((GiftCardUpdatedEvent) other);
    }
    ...
    private boolean equalTo(GiftCardUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<GiftCardUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(GiftCardUpdatedEvent other) {
        ...
        /**
         * <p>The type of this event. For this event, the value is <code>gift_card.updated</code>.</p>
         */
        ...
        public Builder data(Optional<GiftCardUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(GiftCardUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public GiftCardUpdatedEvent build() {
            return new GiftCardUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
