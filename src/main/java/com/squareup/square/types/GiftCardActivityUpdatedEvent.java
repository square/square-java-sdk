...
@JsonDeserialize(builder = GiftCardActivityUpdatedEvent.Builder.class)
public final class GiftCardActivityUpdatedEvent {
    ...
    private final Optional<GiftCardActivityUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private GiftCardActivityUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<GiftCardActivityUpdatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>gift_card.activity.updated</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<GiftCardActivityUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GiftCardActivityUpdatedEvent && equalTo((GiftCardActivityUpdatedEvent) other);
    }
    ...
    private boolean equalTo(GiftCardActivityUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<GiftCardActivityUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(GiftCardActivityUpdatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>gift_card.activity.updated</code>.</p>
         */
        ...
        public Builder data(Optional<GiftCardActivityUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(GiftCardActivityUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public GiftCardActivityUpdatedEvent build() {
            return new GiftCardActivityUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
