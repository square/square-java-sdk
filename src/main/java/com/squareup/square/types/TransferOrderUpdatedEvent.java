...
@JsonDeserialize(builder = TransferOrderUpdatedEvent.Builder.class)
public final class TransferOrderUpdatedEvent {
    ...
    private final Optional<TransferOrderUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private TransferOrderUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<TransferOrderUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;transfer_order.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<TransferOrderUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TransferOrderUpdatedEvent && equalTo((TransferOrderUpdatedEvent) other);
    }
    ...
    private boolean equalTo(TransferOrderUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<TransferOrderUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(TransferOrderUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;transfer_order.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<TransferOrderUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(TransferOrderUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public TransferOrderUpdatedEvent build() {
            return new TransferOrderUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
