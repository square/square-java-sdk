...
public final class ShiftWorkdayMatcher {
    ...
    ShiftWorkdayMatcher(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof ShiftWorkdayMatcher && this.string.equals(((ShiftWorkdayMatcher) other).string));
    }
    ...
    public static ShiftWorkdayMatcher valueOf(String value) {
        switch (value) {
            case "END_AT":
                return END_AT;
            case "INTERSECTION":
            ...
            case "START_AT":
                return START_AT;
            default:
                return new ShiftWorkdayMatcher(Value.UNKNOWN, value);
        }
    }
