...
@JsonDeserialize(builder = CatalogObjectPricingRule.Builder.class)
public final class CatalogObjectPricingRule implements ICatalogObjectBase {
    ...
    private final Optional<CatalogPricingRule> pricingRuleData;

    private final Map<String, Object> additionalProperties;

    private CatalogObjectPricingRule(
            String id,
            ...
            Optional<CatalogPricingRule> pricingRuleData,
    ...
    /**
     * @return Structured data for a <code>CatalogPricingRule</code>, set for CatalogObjects of type <code>PRICING_RULE</code>.
     * A <code>CatalogPricingRule</code> object often works with a <code>CatalogProductSet</code> object or a <code>CatalogTimePeriod</code> object.
     */
    @JsonProperty("pricing_rule_data")
    public Optional<CatalogPricingRule> getPricingRuleData() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectPricingRule && equalTo((CatalogObjectPricingRule) other);
    }
    ...
    private boolean equalTo(CatalogObjectPricingRule other) {
        return id.equals(other.id)
                ...
                && pricingRuleData.equals(other.pricingRuleData);
    }
    ...
    public interface IdStage {
        ...
        Builder from(CatalogObjectPricingRule other);
    }

    public interface _FinalStage {
        CatalogObjectPricingRule build();
        ...
        _FinalStage pricingRuleData(Optional<CatalogPricingRule> pricingRuleData);

        _FinalStage pricingRuleData(CatalogPricingRule pricingRuleData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        private Optional<CatalogPricingRule> pricingRuleData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CatalogObjectPricingRule other) {
            id(other.getId());
            ...
            pricingRuleData(other.getPricingRuleData());
            return this;
        }
        ...
        /**
         * <p>Structured data for a <code>CatalogPricingRule</code>, set for CatalogObjects of type <code>PRICING_RULE</code>.
         * A <code>CatalogPricingRule</code> object often works with a <code>CatalogProductSet</code> object or a <code>CatalogTimePeriod</code> object.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
        public _FinalStage pricingRuleData(CatalogPricingRule pricingRuleData) {
            this.pricingRuleData = Optional.ofNullable(pricingRuleData);
            return this;
        }

        @java.lang.Override
        @JsonSetter(value = "pricing_rule_data", nulls = Nulls.SKIP)
        public _FinalStage pricingRuleData(Optional<CatalogPricingRule> pricingRuleData) {
            this.pricingRuleData = pricingRuleData;
            return this;
        }
        ...
        @java.lang.Override
        public CatalogObjectPricingRule build() {
            return new CatalogObjectPricingRule(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
