...
@JsonDeserialize(builder = InvoicePaymentMadeEvent.Builder.class)
public final class InvoicePaymentMadeEvent {
    ...
    private final Optional<InvoicePaymentMadeEventData> data;

    private final Map<String, Object> additionalProperties;

    private InvoicePaymentMadeEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<InvoicePaymentMadeEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;invoice.payment_made&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<InvoicePaymentMadeEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InvoicePaymentMadeEvent && equalTo((InvoicePaymentMadeEvent) other);
    }
    ...
    private boolean equalTo(InvoicePaymentMadeEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<InvoicePaymentMadeEventData> data = Optional.empty();
        ...
        public Builder from(InvoicePaymentMadeEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;invoice.payment_made&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<InvoicePaymentMadeEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(InvoicePaymentMadeEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public InvoicePaymentMadeEvent build() {
            return new InvoicePaymentMadeEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
