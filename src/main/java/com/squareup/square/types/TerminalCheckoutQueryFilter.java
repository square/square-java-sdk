...
@JsonDeserialize(builder = TerminalCheckoutQueryFilter.Builder.class)
public final class TerminalCheckoutQueryFilter {
    ...
    private TerminalCheckoutQueryFilter(
    ...
    /**
     * @return The <code>TerminalCheckout</code> objects associated with a specific device. If no device is specified, then all
     * <code>TerminalCheckout</code> objects for the merchant are displayed.
     */
    @JsonIgnore
    ...
    /**
     * @return The time range for the beginning of the reporting period, which is inclusive.
     * Default value: The current time minus one day.
     * Note that <code>TerminalCheckout</code>s are available for 30 days after creation.
     */
    ...
    /**
     * @return Filtered results with the desired status of the <code>TerminalCheckout</code>.
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TerminalCheckoutQueryFilter && equalTo((TerminalCheckoutQueryFilter) other);
    }
    ...
    private boolean equalTo(TerminalCheckoutQueryFilter other) {
    ...
    public static final class Builder {
        ...
        public Builder from(TerminalCheckoutQueryFilter other) {
        ...
        public TerminalCheckoutQueryFilter build() {
            return new TerminalCheckoutQueryFilter(deviceId, createdAt, status, additionalProperties);
        }
    }
}
