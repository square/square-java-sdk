...
@JsonDeserialize(builder = CatalogObjectProductSet.Builder.class)
public final class CatalogObjectProductSet implements ICatalogObjectBase {
    ...
    private final Optional<CatalogProductSet> productSetData;

    private final Map<String, Object> additionalProperties;

    private CatalogObjectProductSet(
            String id,
            ...
            Optional<CatalogProductSet> productSetData,
    ...
    /**
     * @return Structured data for a <code>CatalogProductSet</code>, set for CatalogObjects of type <code>PRODUCT_SET</code>.
     */
    @JsonProperty("product_set_data")
    public Optional<CatalogProductSet> getProductSetData() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectProductSet && equalTo((CatalogObjectProductSet) other);
    }
    ...
    private boolean equalTo(CatalogObjectProductSet other) {
        return id.equals(other.id)
                ...
                && productSetData.equals(other.productSetData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        private Optional<CatalogProductSet> productSetData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CatalogObjectProductSet other) {
            id(other.getId());
            ...
            productSetData(other.getProductSetData());
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage productSetData(CatalogProductSet productSetData) {
            this.productSetData = Optional.ofNullable(productSetData);
            return this;
        }
        ...
        @java.lang.Override
        public CatalogObjectProductSet build() {
            return new CatalogObjectProductSet(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
