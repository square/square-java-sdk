...
@JsonDeserialize(builder = CatalogObjectModifier.Builder.class)
public final class CatalogObjectModifier implements ICatalogObjectBase {
    ...
    private final Optional<CatalogModifier> modifierData;

    private final Map<String, Object> additionalProperties;

    private CatalogObjectModifier(
            String id,
            ...
            Optional<CatalogModifier> modifierData,
    ...
    /**
     * @return Structured data for a <code>CatalogModifier</code>, set for CatalogObjects of type <code>MODIFIER</code>.
     */
    @JsonProperty("modifier_data")
    public Optional<CatalogModifier> getModifierData() {
        return modifierData;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectModifier && equalTo((CatalogObjectModifier) other);
    }
    ...
    private boolean equalTo(CatalogObjectModifier other) {
        return id.equals(other.id)
                ...
                && modifierData.equals(other.modifierData);
    }
    ...
    public interface IdStage {
        ...
        Builder from(CatalogObjectModifier other);
    }

    public interface _FinalStage {
        CatalogObjectModifier build();
        ...
        /**
         * <p>Structured data for a <code>CatalogModifier</code>, set for CatalogObjects of type <code>MODIFIER</code>.</p>
         */
        _FinalStage modifierData(Optional<CatalogModifier> modifierData);

        _FinalStage modifierData(CatalogModifier modifierData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        private Optional<CatalogModifier> modifierData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CatalogObjectModifier other) {
            id(other.getId());
            ...
            modifierData(other.getModifierData());
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage modifierData(CatalogModifier modifierData) {
            this.modifierData = Optional.ofNullable(modifierData);
            return this;
        }
         ...
         */
        @java.lang.Override
        @JsonSetter(value = "modifier_data", nulls = Nulls.SKIP)
        public _FinalStage modifierData(Optional<CatalogModifier> modifierData) {
            this.modifierData = modifierData;
            return this;
        }
        ...
        @java.lang.Override
        public CatalogObjectModifier build() {
            return new CatalogObjectModifier(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
