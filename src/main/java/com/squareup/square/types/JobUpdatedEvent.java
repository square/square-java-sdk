...
@JsonDeserialize(builder = JobUpdatedEvent.Builder.class)
public final class JobUpdatedEvent {
    ...
    private final Optional<JobUpdatedEventData> data;
    ...
    private JobUpdatedEvent(
            ...
            Optional<JobUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;job.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<JobUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof JobUpdatedEvent && equalTo((JobUpdatedEvent) other);
    }
    ...
    private boolean equalTo(JobUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<JobUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(JobUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;job.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<JobUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(JobUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public JobUpdatedEvent build() {
            return new JobUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
