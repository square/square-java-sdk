...
@JsonDeserialize(builder = LoyaltyPromotionCreatedEvent.Builder.class)
public final class LoyaltyPromotionCreatedEvent {
    ...
    private final Optional<LoyaltyPromotionCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LoyaltyPromotionCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LoyaltyPromotionCreatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>loyalty.promotion.created</code>.
     */
    @JsonIgnore
    ...
    /**
     * @return The unique ID for the event, which is used for
     ...
     */
    @JsonProperty("data")
    public Optional<LoyaltyPromotionCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LoyaltyPromotionCreatedEvent && equalTo((LoyaltyPromotionCreatedEvent) other);
    }
    ...
    private boolean equalTo(LoyaltyPromotionCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LoyaltyPromotionCreatedEventData> data = Optional.empty();
        ...
        public Builder from(LoyaltyPromotionCreatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>loyalty.promotion.created</code>.</p>
         */
        ...
        public Builder data(Optional<LoyaltyPromotionCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LoyaltyPromotionCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LoyaltyPromotionCreatedEvent build() {
            return new LoyaltyPromotionCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
