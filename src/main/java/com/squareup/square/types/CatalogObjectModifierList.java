...
@JsonDeserialize(builder = CatalogObjectModifierList.Builder.class)
public final class CatalogObjectModifierList implements ICatalogObjectBase {
    ...
    private final Optional<CatalogModifierList> modifierListData;

    private final Map<String, Object> additionalProperties;

    private CatalogObjectModifierList(
            String id,
            ...
            Optional<CatalogModifierList> modifierListData,
    ...
    /**
     * @return Structured data for a <code>CatalogModifierList</code>, set for CatalogObjects of type <code>MODIFIER_LIST</code>.
     */
    @JsonProperty("modifier_list_data")
    public Optional<CatalogModifierList> getModifierListData() {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectModifierList && equalTo((CatalogObjectModifierList) other);
    }
    ...
    private boolean equalTo(CatalogObjectModifierList other) {
        return id.equals(other.id)
                ...
                && modifierListData.equals(other.modifierListData);
    }
    ...
    public interface IdStage {
        ...
        Builder from(CatalogObjectModifierList other);
    }

    public interface _FinalStage {
        CatalogObjectModifierList build();
        ...
        /**
         * <p>Structured data for a <code>CatalogModifierList</code>, set for CatalogObjects of type <code>MODIFIER_LIST</code>.</p>
         */
        _FinalStage modifierListData(Optional<CatalogModifierList> modifierListData);

        _FinalStage modifierListData(CatalogModifierList modifierListData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        private Optional<CatalogModifierList> modifierListData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CatalogObjectModifierList other) {
            id(other.getId());
            ...
            modifierListData(other.getModifierListData());
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage modifierListData(CatalogModifierList modifierListData) {
            this.modifierListData = Optional.ofNullable(modifierListData);
            return this;
        }
         ...
         */
        @java.lang.Override
        @JsonSetter(value = "modifier_list_data", nulls = Nulls.SKIP)
        public _FinalStage modifierListData(Optional<CatalogModifierList> modifierListData) {
            this.modifierListData = modifierListData;
            return this;
        }
        ...
        @java.lang.Override
        public CatalogObjectModifierList build() {
            return new CatalogObjectModifierList(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
