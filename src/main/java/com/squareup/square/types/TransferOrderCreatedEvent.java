...
@JsonDeserialize(builder = TransferOrderCreatedEvent.Builder.class)
public final class TransferOrderCreatedEvent {
    ...
    private final Optional<TransferOrderCreatedEventData> data;
    ...
    private TransferOrderCreatedEvent(
            ...
            Optional<TransferOrderCreatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;transfer_order.created&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<TransferOrderCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TransferOrderCreatedEvent && equalTo((TransferOrderCreatedEvent) other);
    }
    ...
    private boolean equalTo(TransferOrderCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<TransferOrderCreatedEventData> data = Optional.empty();
        ...
        public Builder from(TransferOrderCreatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;transfer_order.created&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<TransferOrderCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(TransferOrderCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public TransferOrderCreatedEvent build() {
            return new TransferOrderCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
