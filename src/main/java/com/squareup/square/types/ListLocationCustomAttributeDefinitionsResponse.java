...
@JsonDeserialize(builder = ListLocationCustomAttributeDefinitionsResponse.Builder.class)
public final class ListLocationCustomAttributeDefinitionsResponse {
    ...
    private ListLocationCustomAttributeDefinitionsResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListLocationCustomAttributeDefinitionsResponse
                && equalTo((ListLocationCustomAttributeDefinitionsResponse) other);
    }
    ...
    private boolean equalTo(ListLocationCustomAttributeDefinitionsResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListLocationCustomAttributeDefinitionsResponse other) {
        ...
        /**
         * <p>The retrieved custom attribute definitions. If no custom attribute definitions are found,
         * Square returns an empty object (<code>{}</code>).</p>
         */
        ...
        /**
         * <p>The cursor to provide in your next call to this endpoint to retrieve the next page of
         * results for your original request. This field is present only if the request succeeded and
         * additional results are available. For more information, see <a href="https://developer.squareup.com/docs/build-basics/common-api-patterns/pagination">Pagination</a>.</p>
         */
