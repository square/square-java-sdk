...
@JsonDeserialize(builder = BookingCreatedEventObject.Builder.class)
public final class BookingCreatedEventObject {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BookingCreatedEventObject && equalTo((BookingCreatedEventObject) other);
    }
    ...
    public static final class Builder {
        ...
        public BookingCreatedEventObject build() {
            return new BookingCreatedEventObject(booking, additionalProperties);
        }
    }
}
