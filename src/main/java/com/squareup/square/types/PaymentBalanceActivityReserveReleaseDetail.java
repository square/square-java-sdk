...
@JsonDeserialize(builder = PaymentBalanceActivityReserveReleaseDetail.Builder.class)
public final class PaymentBalanceActivityReserveReleaseDetail {
    private final Optional<String> paymentId;

    private final Map<String, Object> additionalProperties;

    private PaymentBalanceActivityReserveReleaseDetail(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentBalanceActivityReserveReleaseDetail
                && equalTo((PaymentBalanceActivityReserveReleaseDetail) other);
    }
    ...
    private boolean equalTo(PaymentBalanceActivityReserveReleaseDetail other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PaymentBalanceActivityReserveReleaseDetail other) {
        ...
        public PaymentBalanceActivityReserveReleaseDetail build() {
            return new PaymentBalanceActivityReserveReleaseDetail(paymentId, additionalProperties);
        }
    }
}
