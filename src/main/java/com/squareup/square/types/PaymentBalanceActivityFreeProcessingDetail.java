...
@JsonDeserialize(builder = PaymentBalanceActivityFreeProcessingDetail.Builder.class)
public final class PaymentBalanceActivityFreeProcessingDetail {
    private final Optional<String> paymentId;

    private final Map<String, Object> additionalProperties;

    private PaymentBalanceActivityFreeProcessingDetail(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentBalanceActivityFreeProcessingDetail
                && equalTo((PaymentBalanceActivityFreeProcessingDetail) other);
    }
    ...
    private boolean equalTo(PaymentBalanceActivityFreeProcessingDetail other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PaymentBalanceActivityFreeProcessingDetail other) {
        ...
        public PaymentBalanceActivityFreeProcessingDetail build() {
            return new PaymentBalanceActivityFreeProcessingDetail(paymentId, additionalProperties);
        }
    }
}
