...
@JsonDeserialize(builder = InvoiceCanceledEvent.Builder.class)
public final class InvoiceCanceledEvent {
    ...
    private final Optional<InvoiceCanceledEventData> data;

    private final Map<String, Object> additionalProperties;

    private InvoiceCanceledEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<InvoiceCanceledEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;invoice.canceled&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<InvoiceCanceledEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InvoiceCanceledEvent && equalTo((InvoiceCanceledEvent) other);
    }
    ...
    private boolean equalTo(InvoiceCanceledEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<InvoiceCanceledEventData> data = Optional.empty();
        ...
        public Builder from(InvoiceCanceledEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;invoice.canceled&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<InvoiceCanceledEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(InvoiceCanceledEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public InvoiceCanceledEvent build() {
            return new InvoiceCanceledEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
