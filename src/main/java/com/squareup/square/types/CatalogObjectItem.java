...
@JsonDeserialize(builder = CatalogObjectItem.Builder.class)
public final class CatalogObjectItem implements ICatalogObjectBase {
    ...
    private final Optional<CatalogItem> itemData;

    private final Map<String, Object> additionalProperties;

    private CatalogObjectItem(
            String id,
    ...
    /**
     * @return Structured data for a <code>CatalogItem</code>, set for CatalogObjects of type <code>ITEM</code>.
     */
    @JsonProperty("item_data")
    public Optional<CatalogItem> getItemData() {
        return itemData;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectItem && equalTo((CatalogObjectItem) other);
    }
    ...
    private boolean equalTo(CatalogObjectItem other) {
    ...
    public interface IdStage {
        ...
        Builder from(CatalogObjectItem other);
    }

    public interface _FinalStage {
        CatalogObjectItem build();
        ...
        /**
         * <p>Structured data for a <code>CatalogItem</code>, set for CatalogObjects of type <code>ITEM</code>.</p>
         */
        _FinalStage itemData(Optional<CatalogItem> itemData);

        _FinalStage itemData(CatalogItem itemData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        private Optional<CatalogItem> itemData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CatalogObjectItem other) {
            id(other.getId());
         ...
         */
        @java.lang.Override
        public _FinalStage itemData(CatalogItem itemData) {
            this.itemData = Optional.ofNullable(itemData);
            return this;
        }
         ...
         */
        @java.lang.Override
        @JsonSetter(value = "item_data", nulls = Nulls.SKIP)
        public _FinalStage itemData(Optional<CatalogItem> itemData) {
            this.itemData = itemData;
            return this;
        }
        ...
        @java.lang.Override
        public CatalogObjectItem build() {
            return new CatalogObjectItem(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
