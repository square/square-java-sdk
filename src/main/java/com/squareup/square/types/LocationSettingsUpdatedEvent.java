...
@JsonDeserialize(builder = LocationSettingsUpdatedEvent.Builder.class)
public final class LocationSettingsUpdatedEvent {
    ...
    private final Optional<LocationSettingsUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LocationSettingsUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LocationSettingsUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;online_checkout.location_settings.updated&quot;</code>.
     */
    @JsonIgnore
    ...
    /**
     * @return RFC 3339 timestamp of when the event was created.
     */
     ...
     */
    @JsonProperty("data")
    public Optional<LocationSettingsUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LocationSettingsUpdatedEvent && equalTo((LocationSettingsUpdatedEvent) other);
    }
    ...
    private boolean equalTo(LocationSettingsUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LocationSettingsUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(LocationSettingsUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;online_checkout.location_settings.updated&quot;</code>.</p>
         */
        ...
        /**
         * <p>RFC 3339 timestamp of when the event was created.</p>
         */
        ...
        public Builder data(Optional<LocationSettingsUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LocationSettingsUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LocationSettingsUpdatedEvent build() {
            return new LocationSettingsUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
