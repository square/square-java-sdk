...
@JsonDeserialize(builder = TerminalCheckoutCreatedEvent.Builder.class)
public final class TerminalCheckoutCreatedEvent {
    ...
    private final Optional<TerminalCheckoutCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private TerminalCheckoutCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<TerminalCheckoutCreatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;terminal.checkout.created&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<TerminalCheckoutCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TerminalCheckoutCreatedEvent && equalTo((TerminalCheckoutCreatedEvent) other);
    }
    ...
    private boolean equalTo(TerminalCheckoutCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<TerminalCheckoutCreatedEventData> data = Optional.empty();
        ...
        public Builder from(TerminalCheckoutCreatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;terminal.checkout.created&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<TerminalCheckoutCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(TerminalCheckoutCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public TerminalCheckoutCreatedEvent build() {
            return new TerminalCheckoutCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
