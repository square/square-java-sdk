...
@JsonDeserialize(builder = MerchantSettingsUpdatedEvent.Builder.class)
public final class MerchantSettingsUpdatedEvent {
    ...
    private final Optional<MerchantSettingsUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private MerchantSettingsUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<MerchantSettingsUpdatedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;online_checkout.merchant_settings.updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<MerchantSettingsUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MerchantSettingsUpdatedEvent && equalTo((MerchantSettingsUpdatedEvent) other);
    }
    ...
    private boolean equalTo(MerchantSettingsUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<MerchantSettingsUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(MerchantSettingsUpdatedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;online_checkout.merchant_settings.updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<MerchantSettingsUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(MerchantSettingsUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public MerchantSettingsUpdatedEvent build() {
            return new MerchantSettingsUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
