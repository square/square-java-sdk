...
@JsonDeserialize(builder = LaborShiftDeletedEvent.Builder.class)
public final class LaborShiftDeletedEvent {
    ...
    private final Optional<LaborShiftDeletedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LaborShiftDeletedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LaborShiftDeletedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>labor.shift.deleted</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LaborShiftDeletedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LaborShiftDeletedEvent && equalTo((LaborShiftDeletedEvent) other);
    }
    ...
    private boolean equalTo(LaborShiftDeletedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LaborShiftDeletedEventData> data = Optional.empty();
        ...
        public Builder from(LaborShiftDeletedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>labor.shift.deleted</code>.</p>
         */
        ...
        public Builder data(Optional<LaborShiftDeletedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LaborShiftDeletedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LaborShiftDeletedEvent build() {
            return new LaborShiftDeletedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
