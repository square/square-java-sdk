...
@JsonDeserialize(builder = VendorUpdatedEventObject.Builder.class)
public final class VendorUpdatedEventObject {
    ...
    private VendorUpdatedEventObject(
    ...
    /**
     * @return The operation on the vendor that caused the event to be published. The value is <code>UPDATED</code>.
    ...
    /**
     * @return The updated vendor as the result of the specified operation.
     */
    @JsonProperty("vendor")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VendorUpdatedEventObject && equalTo((VendorUpdatedEventObject) other);
    }
    ...
    private boolean equalTo(VendorUpdatedEventObject other) {
    ...
    public static final class Builder {
        ...
        public Builder from(VendorUpdatedEventObject other) {
        ...
        /**
         * <p>The operation on the vendor that caused the event to be published. The value is <code>UPDATED</code>.
        ...
        /**
         * <p>The updated vendor as the result of the specified operation.</p>
         */
        ...
        public VendorUpdatedEventObject build() {
