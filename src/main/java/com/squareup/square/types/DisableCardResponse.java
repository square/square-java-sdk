...
@JsonDeserialize(builder = DisableCardResponse.Builder.class)
public final class DisableCardResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DisableCardResponse && equalTo((DisableCardResponse) other);
    }
    ...
    private boolean equalTo(DisableCardResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(DisableCardResponse other) {
        ...
        public DisableCardResponse build() {
            return new DisableCardResponse(errors, card, additionalProperties);
        }
    }
}
