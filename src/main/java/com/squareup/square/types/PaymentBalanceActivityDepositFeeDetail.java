...
@JsonDeserialize(builder = PaymentBalanceActivityDepositFeeDetail.Builder.class)
public final class PaymentBalanceActivityDepositFeeDetail {
    private final Optional<String> payoutId;

    private final Map<String, Object> additionalProperties;

    private PaymentBalanceActivityDepositFeeDetail(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PaymentBalanceActivityDepositFeeDetail
                && equalTo((PaymentBalanceActivityDepositFeeDetail) other);
    }
    ...
    public static final class Builder {
        ...
        public PaymentBalanceActivityDepositFeeDetail build() {
            return new PaymentBalanceActivityDepositFeeDetail(payoutId, additionalProperties);
        }
    }
}
