...
public final class InventoryPhysicalCount {
    ...
    private final Optional<String> adjustmentId;
    ...
    /**
     * @return The Square-generated ID of the InventoryAdjustment that was generated by this physical count in order to
    ...
    private boolean equalTo(InventoryPhysicalCount other) {
        return id.equals(other.id)
                ...
                && adjustmentId.equals(other.adjustmentId);
    }
    ...
    public static final class Builder {
        ...
        private Optional<String> adjustmentId = Optional.empty();
        ...
        /**
         * <p>The Square-generated ID of the InventoryAdjustment that was generated by this physical count in order to
         * adjust the current stock count to reflect the re-counted quantity.
         * This field may be empty if the merchant does not have an active subscription for either Retail Plus, Restaurants Plus, or Restaurants Premium.</p>
         */
        @JsonSetter(value = "adjustment_id", nulls = Nulls.SKIP)
        public Builder adjustmentId(Optional<String> adjustmentId) {
            this.adjustmentId = adjustmentId;
            return this;
        }

        public Builder adjustmentId(String adjustmentId) {
            this.adjustmentId = Optional.ofNullable(adjustmentId);
            return this;
        }
