...
@JsonDeserialize(builder = InvoiceDeletedEvent.Builder.class)
public final class InvoiceDeletedEvent {
    ...
    private final Optional<InvoiceDeletedEventData> data;

    private final Map<String, Object> additionalProperties;

    private InvoiceDeletedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<InvoiceDeletedEventData> data,
    ...
    /**
     * @return The type of event this represents, <code>&quot;invoice.deleted&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<InvoiceDeletedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InvoiceDeletedEvent && equalTo((InvoiceDeletedEvent) other);
    }
    ...
    private boolean equalTo(InvoiceDeletedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<InvoiceDeletedEventData> data = Optional.empty();
        ...
        public Builder from(InvoiceDeletedEvent other) {
        ...
        /**
         * <p>The type of event this represents, <code>&quot;invoice.deleted&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<InvoiceDeletedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(InvoiceDeletedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public InvoiceDeletedEvent build() {
            return new InvoiceDeletedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
