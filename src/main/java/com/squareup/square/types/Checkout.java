...
public final class Checkout {
    ...
    public static final class Builder {
        ...
        /**
         * <p>ID generated by Square Checkout when a new checkout is requested.</p>
         */
        ...
        /**
         * <p>The URL that the buyer's browser should be redirected to after the
         * checkout is completed.</p>
         */
        ...
        /**
         * <p>If <code>true</code>, Square Checkout will collect shipping information on your
         * behalf and store that information with the transaction information in your
         * Square Dashboard.</p>
         * <p>Default: <code>false</code>.</p>
         */
         ...
         * and confirmation email that the buyer can use to contact the merchant.</p>
         * <p>If this value is not set, the confirmation page and email will display the
         * primary email address associated with the merchant's Square account.</p>
         * <p>Default: none; only exists if explicitly set.</p>
         */
        ...
        /**
         * <p>If provided, the buyer's email is pre-populated on the checkout page
        ...
        /**
         * <p>If provided, the buyer's shipping info is pre-populated on the
        ...
        /**
         * <p>The URL to redirect to after checkout is completed with <code>checkoutId</code>,
         * Square's <code>orderId</code>, <code>transactionId</code>, and <code>referenceId</code> appended as URL
         * parameters. For example, if the provided redirect_url is
         * <code>http://www.example.com/order-complete</code>, a successful transaction redirects
         * the customer to:</p>
        ...
        /**
         * <p>The time when the checkout was created, in RFC 3339 format.</p>
         */
        ...
        /**
         * <p>Additional recipients (other than the merchant) receiving a portion of this checkout.
