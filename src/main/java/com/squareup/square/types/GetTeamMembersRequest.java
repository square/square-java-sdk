...
@JsonDeserialize(builder = GetTeamMembersRequest.Builder.class)
public final class GetTeamMembersRequest {
    private final String teamMemberId;

    private final Map<String, Object> additionalProperties;

    private GetTeamMembersRequest(String teamMemberId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetTeamMembersRequest && equalTo((GetTeamMembersRequest) other);
    }
    ...
    private boolean equalTo(GetTeamMembersRequest other) {
    ...
    public static final class Builder implements TeamMemberIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetTeamMembersRequest other) {
        ...
        public GetTeamMembersRequest build() {
            return new GetTeamMembersRequest(teamMemberId, additionalProperties);
        }
    }
}
