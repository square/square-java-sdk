...
@JsonDeserialize(builder = CatalogObjectDiscount.Builder.class)
public final class CatalogObjectDiscount implements ICatalogObjectBase {
    ...
    private final Optional<CatalogDiscount> discountData;

    private final Map<String, Object> additionalProperties;

    private CatalogObjectDiscount(
            String id,
            ...
            Optional<CatalogDiscount> discountData,
    ...
    /**
     * @return Structured data for a <code>CatalogDiscount</code>, set for CatalogObjects of type <code>DISCOUNT</code>.
     */
    @JsonProperty("discount_data")
    public Optional<CatalogDiscount> getDiscountData() {
        return discountData;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CatalogObjectDiscount && equalTo((CatalogObjectDiscount) other);
    }
    ...
    private boolean equalTo(CatalogObjectDiscount other) {
        return id.equals(other.id)
                ...
                && discountData.equals(other.discountData);
    }
    ...
    public interface IdStage {
        ...
        Builder from(CatalogObjectDiscount other);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage discountData(Optional<CatalogDiscount> discountData);

        _FinalStage discountData(CatalogDiscount discountData);
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        private Optional<CatalogDiscount> discountData = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CatalogObjectDiscount other) {
            id(other.getId());
            ...
            discountData(other.getDiscountData());
            return this;
        }
        ...
        /**
         * <p>Structured data for a <code>CatalogDiscount</code>, set for CatalogObjects of type <code>DISCOUNT</code>.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
        public _FinalStage discountData(CatalogDiscount discountData) {
            this.discountData = Optional.ofNullable(discountData);
            return this;
        }

        @java.lang.Override
        @JsonSetter(value = "discount_data", nulls = Nulls.SKIP)
        public _FinalStage discountData(Optional<CatalogDiscount> discountData) {
            this.discountData = discountData;
            return this;
        }
        ...
        @java.lang.Override
        public CatalogObjectDiscount build() {
            return new CatalogObjectDiscount(
                    id,
                    updatedAt,
                    version,
                    isDeleted,
