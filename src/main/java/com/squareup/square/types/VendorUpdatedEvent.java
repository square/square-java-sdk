...
@JsonDeserialize(builder = VendorUpdatedEvent.Builder.class)
public final class VendorUpdatedEvent {
    ...
    private final Optional<VendorUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private VendorUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> locationId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<VendorUpdatedEventData> data,
    ...
    /**
     * @return The ID of a seller associated with this event.
     */
    @JsonIgnore
    ...
    /**
     * @return The ID of a seller location associated with this event, if the event is associated with the location.
     */
    @JsonIgnore
    ...
    /**
     * @return The type of this event. The value is <code>&quot;vendor.updated&quot;.</code>
     */
    @JsonIgnore
    ...
    /**
     * @return A unique ID for this webhoook event.
     */
    @JsonIgnore
    ...
    /**
     * @return The RFC 3339-formatted time when the underlying event data object is created.
     */
     ...
     */
    @JsonProperty("data")
    public Optional<VendorUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VendorUpdatedEvent && equalTo((VendorUpdatedEvent) other);
    }
    ...
    private boolean equalTo(VendorUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<VendorUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(VendorUpdatedEvent other) {
        ...
        /**
         * <p>The ID of a seller location associated with this event, if the event is associated with the location.</p>
         */
        ...
        /**
         * <p>The type of this event. The value is <code>&quot;vendor.updated&quot;.</code></p>
         */
        ...
        /**
         * <p>A unique ID for this webhoook event.</p>
         */
        ...
        public Builder data(Optional<VendorUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(VendorUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public VendorUpdatedEvent build() {
            return new VendorUpdatedEvent(merchantId, locationId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
