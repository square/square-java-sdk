...
@JsonDeserialize(builder = ResumeSubscriptionResponse.Builder.class)
public final class ResumeSubscriptionResponse {
    ...
    /**
     * @return A list of <code>RESUME</code> actions created by the request and scheduled for the subscription.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ResumeSubscriptionResponse && equalTo((ResumeSubscriptionResponse) other);
    }
    ...
    private boolean equalTo(ResumeSubscriptionResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ResumeSubscriptionResponse other) {
        ...
        public ResumeSubscriptionResponse build() {
            return new ResumeSubscriptionResponse(errors, subscription, actions, additionalProperties);
        }
    }
}
