...
@JsonDeserialize(builder = LoyaltyEventCreatedEvent.Builder.class)
public final class LoyaltyEventCreatedEvent {
    ...
    private final Optional<LoyaltyEventCreatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LoyaltyEventCreatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LoyaltyEventCreatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>loyalty.event.created</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LoyaltyEventCreatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LoyaltyEventCreatedEvent && equalTo((LoyaltyEventCreatedEvent) other);
    }
    ...
    private boolean equalTo(LoyaltyEventCreatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LoyaltyEventCreatedEventData> data = Optional.empty();
        ...
        public Builder from(LoyaltyEventCreatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>loyalty.event.created</code>.</p>
         */
        ...
        public Builder data(Optional<LoyaltyEventCreatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LoyaltyEventCreatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LoyaltyEventCreatedEvent build() {
            return new LoyaltyEventCreatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
