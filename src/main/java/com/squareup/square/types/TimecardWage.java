...
@JsonDeserialize(builder = TimecardWage.Builder.class)
public final class TimecardWage {
    ...
    /**
     * @return The name of the job performed during this timecard.
     */
    @JsonIgnore
    ...
    /**
     * @return The ID of the <a href="entity:Job">job</a> performed for this timecard. Square
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TimecardWage && equalTo((TimecardWage) other);
    }
    ...
    private boolean equalTo(TimecardWage other) {
    ...
    public static final class Builder {
        ...
        public Builder from(TimecardWage other) {
        ...
        /**
         * <p>The name of the job performed during this timecard.</p>
         */
        ...
        /**
         * <p>The ID of the <a href="entity:Job">job</a> performed for this timecard. Square
         * labor-reporting UIs might group timecards together by ID.</p>
         */
        ...
        public TimecardWage build() {
            return new TimecardWage(title, hourlyRate, jobId, tipEligible, additionalProperties);
        }
    }
}
