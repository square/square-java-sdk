...
@JsonDeserialize(builder = CardAutomaticallyUpdatedEvent.Builder.class)
public final class CardAutomaticallyUpdatedEvent {
    ...
    private final Optional<CardAutomaticallyUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private CardAutomaticallyUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<CardAutomaticallyUpdatedEventData> data,
    ...
    /**
     * @return The type of this event. The value is <code>&quot;card.automatically_updated&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<CardAutomaticallyUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CardAutomaticallyUpdatedEvent && equalTo((CardAutomaticallyUpdatedEvent) other);
    }
    ...
    private boolean equalTo(CardAutomaticallyUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<CardAutomaticallyUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(CardAutomaticallyUpdatedEvent other) {
        ...
        /**
         * <p>The type of this event. The value is <code>&quot;card.automatically_updated&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<CardAutomaticallyUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(CardAutomaticallyUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public CardAutomaticallyUpdatedEvent build() {
            return new CardAutomaticallyUpdatedEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
