...
public final class ListPayoutsRequest {
    ...
    public static final class Builder {
        ...
        /**
         * <p>The ID of the location for which to list the payouts.
         * By default, payouts are returned for the default (main) location associated with the seller.</p>
         */
        ...
        /**
         * <p>If provided, only payouts with the given status are returned.</p>
         */
        ...
        /**
         * <p>The timestamp for the beginning of the payout creation time, in RFC 3339 format.
        ...
        /**
         * <p>The timestamp for the end of the payout creation time, in RFC 3339 format.
         * Default: The current time.</p>
         */
        ...
        /**
         * <p>The order in which payouts are listed.</p>
         */
