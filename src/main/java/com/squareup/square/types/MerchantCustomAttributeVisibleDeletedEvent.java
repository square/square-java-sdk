...
@JsonDeserialize(builder = MerchantCustomAttributeVisibleDeletedEvent.Builder.class)
public final class MerchantCustomAttributeVisibleDeletedEvent {
    ...
    private final Optional<CustomAttributeEventData> data;

    private final Map<String, Object> additionalProperties;

    private MerchantCustomAttributeVisibleDeletedEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<CustomAttributeEventData> data,
    ...
    /**
     * @return The type of this event. The value is <code>&quot;merchant.custom_attribute.visible.deleted&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<CustomAttributeEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MerchantCustomAttributeVisibleDeletedEvent
                && equalTo((MerchantCustomAttributeVisibleDeletedEvent) other);
    }
    ...
    private boolean equalTo(MerchantCustomAttributeVisibleDeletedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<CustomAttributeEventData> data = Optional.empty();
        ...
        public Builder from(MerchantCustomAttributeVisibleDeletedEvent other) {
        ...
        /**
         * <p>The type of this event. The value is <code>&quot;merchant.custom_attribute.visible.deleted&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<CustomAttributeEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(CustomAttributeEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public MerchantCustomAttributeVisibleDeletedEvent build() {
            return new MerchantCustomAttributeVisibleDeletedEvent(
