...
@JsonDeserialize(builder = GetShiftResponse.Builder.class)
public final class GetShiftResponse {
    ...
    /**
     * @return The requested <code>Shift</code>.
     */
    @JsonProperty("shift")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetShiftResponse && equalTo((GetShiftResponse) other);
    }
    ...
    private boolean equalTo(GetShiftResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetShiftResponse other) {
        ...
        public GetShiftResponse build() {
            return new GetShiftResponse(shift, errors, additionalProperties);
        }
    }
}
