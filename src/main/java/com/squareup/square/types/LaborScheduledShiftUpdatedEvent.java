...
@JsonDeserialize(builder = LaborScheduledShiftUpdatedEvent.Builder.class)
public final class LaborScheduledShiftUpdatedEvent {
    ...
    private final Optional<LaborScheduledShiftUpdatedEventData> data;

    private final Map<String, Object> additionalProperties;

    private LaborScheduledShiftUpdatedEvent(
            Optional<String> merchantId,
            Optional<String> locationId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<LaborScheduledShiftUpdatedEventData> data,
    ...
    /**
     * @return The type of event. For this event, the value is <code>labor.scheduled_shift.updated</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<LaborScheduledShiftUpdatedEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LaborScheduledShiftUpdatedEvent && equalTo((LaborScheduledShiftUpdatedEvent) other);
    }
    ...
    private boolean equalTo(LaborScheduledShiftUpdatedEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<LaborScheduledShiftUpdatedEventData> data = Optional.empty();
        ...
        public Builder from(LaborScheduledShiftUpdatedEvent other) {
        ...
        /**
         * <p>The type of event. For this event, the value is <code>labor.scheduled_shift.updated</code>.</p>
         */
        ...
        public Builder data(Optional<LaborScheduledShiftUpdatedEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(LaborScheduledShiftUpdatedEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public LaborScheduledShiftUpdatedEvent build() {
            return new LaborScheduledShiftUpdatedEvent(
