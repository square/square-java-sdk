...
@JsonDeserialize(builder = CardCreatedEventObject.Builder.class)
public final class CardCreatedEventObject {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CardCreatedEventObject && equalTo((CardCreatedEventObject) other);
    }
    ...
    public static final class Builder {
        ...
        public CardCreatedEventObject build() {
            return new CardCreatedEventObject(card, additionalProperties);
        }
    }
}
