...
@JsonDeserialize(builder = CardForgottenEvent.Builder.class)
public final class CardForgottenEvent {
    ...
    private final Optional<CardForgottenEventData> data;

    private final Map<String, Object> additionalProperties;

    private CardForgottenEvent(
            Optional<String> merchantId,
            Optional<String> type,
            Optional<String> eventId,
            Optional<String> createdAt,
            Optional<CardForgottenEventData> data,
    ...
    /**
     * @return The type of this event. The value is <code>&quot;card.forgotten&quot;</code>.
     */
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public Optional<CardForgottenEventData> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CardForgottenEvent && equalTo((CardForgottenEvent) other);
    }
    ...
    private boolean equalTo(CardForgottenEvent other) {
    ...
    public static final class Builder {
        ...
        private Optional<CardForgottenEventData> data = Optional.empty();
        ...
        public Builder from(CardForgottenEvent other) {
        ...
        /**
         * <p>The type of this event. The value is <code>&quot;card.forgotten&quot;</code>.</p>
         */
        ...
        public Builder data(Optional<CardForgottenEventData> data) {
            this.data = data;
            return this;
        }

        public Builder data(CardForgottenEventData data) {
            this.data = Optional.ofNullable(data);
            return this;
        }

        public CardForgottenEvent build() {
            return new CardForgottenEvent(merchantId, type, eventId, createdAt, data, additionalProperties);
        }
    }
}
