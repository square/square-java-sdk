...
@JsonDeserialize(builder = TerminalActionQueryFilter.Builder.class)
public final class TerminalActionQueryFilter {
    ...
    private TerminalActionQueryFilter(
    ...
    /**
     * @return <code>TerminalAction</code>s associated with a specific device. If no device is specified then all
     * <code>TerminalAction</code>s for the merchant will be displayed.
     */
    @JsonIgnore
    ...
    /**
     * @return Time range for the beginning of the reporting period. Inclusive.
     * Default value: The current time minus one day.
     * Note that <code>TerminalAction</code>s are available for 30 days after creation.
     */
    ...
    /**
     * @return Filter results with the desired status of the <code>TerminalAction</code>
    ...
    /**
     * @return Filter results with the requested ActionType.
     * See <a href="#type-terminalactionactiontype">TerminalActionActionType</a> for possible values
     */
    @JsonProperty("type")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TerminalActionQueryFilter && equalTo((TerminalActionQueryFilter) other);
    }
