...
@JsonDeserialize(builder = ClearpayDetails.Builder.class)
public final class ClearpayDetails {
    ...
    /**
     * @return Email address on the buyer's Clearpay account.
     */
    @JsonIgnore
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ClearpayDetails && equalTo((ClearpayDetails) other);
    }
    ...
    public static final class Builder {
        ...
        public ClearpayDetails build() {
            return new ClearpayDetails(emailAddress, additionalProperties);
        }
    }
}
