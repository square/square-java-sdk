...
public class RawGiftCardsClient {
    protected final ClientOptions clientOptions;

    public RawGiftCardsClient(ClientOptions clientOptions) {
     ...
     */
    public SquareClientHttpResponse<SyncPagingIterable<GiftCard>> list() {
     ...
     * a subset of the gift cards. Results are sorted by <code>created_at</code> in ascending order.
     */
    public SquareClientHttpResponse<SyncPagingIterable<GiftCard>> list(RequestOptions requestOptions) {
     ...
     * a subset of the gift cards. Results are sorted by <code>created_at</code> in ascending order.
     */
    public SquareClientHttpResponse<SyncPagingIterable<GiftCard>> list(ListGiftCardsRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ...
                return new SquareClientHttpResponse<>(
                        new SyncPagingIterable<GiftCard>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     */
    public SquareClientHttpResponse<CreateGiftCardResponse> create(CreateGiftCardRequest request) {
     ...
     * to refund a payment to the new gift card.
     */
    public SquareClientHttpResponse<CreateGiftCardResponse> create(
     ...
     */
    public SquareClientHttpResponse<GetGiftCardFromGanResponse> getFromGan(GetGiftCardFromGanRequest request) {
     ...
     * Retrieves a gift card using the gift card account number (GAN).
     */
    public SquareClientHttpResponse<GetGiftCardFromGanResponse> getFromGan(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetGiftCardFromGanResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     */
    public SquareClientHttpResponse<GetGiftCardFromNonceResponse> getFromNonce(GetGiftCardFromNonceRequest request) {
     ...
     * Retrieves a gift card using a secure payment token that represents the gift card.
     */
    public SquareClientHttpResponse<GetGiftCardFromNonceResponse> getFromNonce(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetGiftCardFromNonceResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     */
    public SquareClientHttpResponse<LinkCustomerToGiftCardResponse> linkCustomer(
    ...
    public SquareClientHttpResponse<LinkCustomerToGiftCardResponse> linkCustomer(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, LinkCustomerToGiftCardResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     */
    public SquareClientHttpResponse<UnlinkCustomerFromGiftCardResponse> unlinkCustomer(
     ...
     */
    public SquareClientHttpResponse<GetGiftCardResponse> get(GetGiftCardsRequest request) {
     ...
     * Retrieves a gift card using the gift card ID.
     */
    public SquareClientHttpResponse<GetGiftCardResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetGiftCardResponse.class), response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
                    "Error with status code " + response.code(), response.code(), errorBody, response);
