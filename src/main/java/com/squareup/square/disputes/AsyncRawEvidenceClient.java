...
public class AsyncRawEvidenceClient {
    protected final ClientOptions clientOptions;

    public AsyncRawEvidenceClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<DisputeEvidence>>> list(
    ...
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<DisputeEvidence>>> list(
        ...
        CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<DisputeEvidence>>> future =
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetDisputeEvidenceResponse>> get(GetEvidenceRequest request) {
    ...
    public CompletableFuture<SquareClientHttpResponse<GetDisputeEvidenceResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetDisputeEvidenceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<SquareClientHttpResponse<DeleteDisputeEvidenceResponse>> delete(
        ...
        CompletableFuture<SquareClientHttpResponse<DeleteDisputeEvidenceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
