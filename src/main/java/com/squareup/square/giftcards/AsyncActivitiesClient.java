...
public class AsyncActivitiesClient {
    ...
    public CompletableFuture<SyncPagingIterable<GiftCardActivity>> list(
        ...
        CompletableFuture<SyncPagingIterable<GiftCardActivity>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<CreateGiftCardActivityResponse> create(
        ...
        CompletableFuture<CreateGiftCardActivityResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
