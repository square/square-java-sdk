...
public class AsyncRawInvoicesClient {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<Invoice>>> list(ListInvoicesRequest request) {
     ...
     * use in a subsequent request to retrieve the next set of invoices.
     */
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<Invoice>>> list(
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<CreateInvoiceResponse>> create(CreateInvoiceRequest request) {
     ...
     * You must publish the invoice before Square can process it (send it to the customer's email address or charge the customer’s card on file).</p>
     */
    public CompletableFuture<SquareClientHttpResponse<CreateInvoiceResponse>> create(
        ...
        CompletableFuture<SquareClientHttpResponse<CreateInvoiceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetInvoiceResponse>> get(GetInvoicesRequest request) {
     ...
     * Retrieves an invoice by invoice ID.
     */
    public CompletableFuture<SquareClientHttpResponse<GetInvoiceResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetInvoiceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<UpdateInvoiceResponse>> update(UpdateInvoiceRequest request) {
     ...
     * <code>order_id</code> or <code>location_id</code> field.
     */
    public CompletableFuture<SquareClientHttpResponse<UpdateInvoiceResponse>> update(
        ...
        CompletableFuture<SquareClientHttpResponse<UpdateInvoiceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteInvoiceResponse>> delete(DeleteInvoicesRequest request) {
     ...
     * invoice (you cannot delete a published invoice, including one that is scheduled for processing).
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteInvoiceResponse>> delete(
        ...
        CompletableFuture<SquareClientHttpResponse<DeleteInvoiceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<CreateInvoiceAttachmentResponse>> createInvoiceAttachment(
    ...
    public CompletableFuture<SquareClientHttpResponse<CreateInvoiceAttachmentResponse>> createInvoiceAttachment(
        ...
        CompletableFuture<SquareClientHttpResponse<CreateInvoiceAttachmentResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteInvoiceAttachmentResponse>> deleteInvoiceAttachment(
    ...
    public CompletableFuture<SquareClientHttpResponse<DeleteInvoiceAttachmentResponse>> deleteInvoiceAttachment(
        ...
        CompletableFuture<SquareClientHttpResponse<DeleteInvoiceAttachmentResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<CancelInvoiceResponse>> cancel(CancelInvoiceRequest request) {
     ...
     * <p>You cannot cancel an invoice in the <code>DRAFT</code> state or in a terminal state: <code>PAID</code>, <code>REFUNDED</code>, <code>CANCELED</code>, or <code>FAILED</code>.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<CancelInvoiceResponse>> cancel(
        ...
        CompletableFuture<SquareClientHttpResponse<CancelInvoiceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<PublishInvoiceResponse>> publish(PublishInvoiceRequest request) {
     ...
     * and <code>PAYMENTS_WRITE</code> are required when publishing invoices configured for card-on-file payments.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<PublishInvoiceResponse>> publish(
        ...
        CompletableFuture<SquareClientHttpResponse<PublishInvoiceResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
