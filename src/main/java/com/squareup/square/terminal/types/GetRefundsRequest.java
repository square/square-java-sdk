...
public final class GetRefundsRequest {
    ...
    private GetRefundsRequest(String terminalRefundId, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder implements TerminalRefundIdStage, _FinalStage {
        ...
        public GetRefundsRequest build() {
            return new GetRefundsRequest(terminalRefundId, additionalProperties);
        }
    }
}
