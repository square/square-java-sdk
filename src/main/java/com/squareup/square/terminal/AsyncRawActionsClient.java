...
public class AsyncRawActionsClient {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<CreateTerminalActionResponse>> create(
    ...
    public CompletableFuture<SquareClientHttpResponse<CreateTerminalActionResponse>> create(
        ...
        CompletableFuture<SquareClientHttpResponse<CreateTerminalActionResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CreateTerminalActionResponse.class),
                                response));
                        return;
                    }
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, SearchTerminalActionsResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetTerminalActionResponse>> get(GetActionsRequest request) {
     ...
     * Retrieves a Terminal action request by <code>action_id</code>. Terminal action requests are available for 30 days.
     */
    public CompletableFuture<SquareClientHttpResponse<GetTerminalActionResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetTerminalActionResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetTerminalActionResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<CancelTerminalActionResponse>> cancel(
    ...
    public CompletableFuture<SquareClientHttpResponse<CancelTerminalActionResponse>> cancel(
        ...
        CompletableFuture<SquareClientHttpResponse<CancelTerminalActionResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CancelTerminalActionResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
