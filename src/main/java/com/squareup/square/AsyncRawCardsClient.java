...
public class AsyncRawCardsClient {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<Card>>> list() {
    ...
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<Card>>> list(
        ...
        CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<Card>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new SquareClientHttpResponse<>(
                                new SyncPagingIterable<Card>(startingAfter.isPresent(), result, parsedResponse, () -> {
                                    try {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<CreateCardResponse>> create(CreateCardRequest request) {
     ...
     * Adds a card on file to an existing merchant.
     */
    public CompletableFuture<SquareClientHttpResponse<CreateCardResponse>> create(
        ...
        CompletableFuture<SquareClientHttpResponse<CreateCardResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetCardResponse>> get(GetCardsRequest request) {
     ...
     * Retrieves details for a specific Card.
     */
    public CompletableFuture<SquareClientHttpResponse<GetCardResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetCardResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<DisableCardResponse>> disable(DisableCardsRequest request) {
     ...
     * Disabling an already disabled card is allowed but has no effect.
     */
    public CompletableFuture<SquareClientHttpResponse<DisableCardResponse>> disable(
        ...
        CompletableFuture<SquareClientHttpResponse<DisableCardResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
