...
public class AsyncRawPaymentLinksClient {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<PaymentLink>>> list() {
    ...
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<PaymentLink>>> list(
        ...
        CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<PaymentLink>>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new SquareClientHttpResponse<>(
                                new SyncPagingIterable<PaymentLink>(startingAfter.isPresent(), result, () -> {
                                    try {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<CreatePaymentLinkResponse>> create() {
    ...
    public CompletableFuture<SquareClientHttpResponse<CreatePaymentLinkResponse>> create(
        ...
        CompletableFuture<SquareClientHttpResponse<CreatePaymentLinkResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetPaymentLinkResponse>> get(GetPaymentLinksRequest request) {
     ...
     * Retrieves a payment link.
     */
    public CompletableFuture<SquareClientHttpResponse<GetPaymentLinkResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetPaymentLinkResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<UpdatePaymentLinkResponse>> update(
    ...
    public CompletableFuture<SquareClientHttpResponse<UpdatePaymentLinkResponse>> update(
        ...
        CompletableFuture<SquareClientHttpResponse<UpdatePaymentLinkResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<DeletePaymentLinkResponse>> delete(
    ...
    public CompletableFuture<SquareClientHttpResponse<DeletePaymentLinkResponse>> delete(
        ...
        CompletableFuture<SquareClientHttpResponse<DeletePaymentLinkResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
