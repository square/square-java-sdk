...
public final class GetShiftsRequest {
    ...
    private GetShiftsRequest(String id, Map<String, Object> additionalProperties) {
        this.id = id;
        this.additionalProperties = additionalProperties;
    }

    /**
     * @return The UUID for the <code>Shift</code> being retrieved.
     */
    @JsonProperty("id")
    public String getId() {
        return id;
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        /**
         * <p>The UUID for the <code>Shift</code> being retrieved.</p>
        ...
        public GetShiftsRequest build() {
            return new GetShiftsRequest(id, additionalProperties);
        }
    }
}
