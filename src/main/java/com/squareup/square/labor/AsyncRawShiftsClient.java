...
public class AsyncRawShiftsClient {
     ...
     * </ul>
     */
    public CompletableFuture<SquareClientHttpResponse<CreateShiftResponse>> create(CreateShiftRequest request) {
     ...
     * </ul>
     */
    public CompletableFuture<SquareClientHttpResponse<CreateShiftResponse>> create(
            CreateShiftRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<SquareClientHttpResponse<CreateShiftResponse>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateShiftResponse.class),
                                response));
                        return;
                    }
     ...
     * </ul>
     */
    public CompletableFuture<SquareClientHttpResponse<SearchShiftsResponse>> search(RequestOptions requestOptions) {
        return search(SearchShiftsRequest.builder().build(), requestOptions);
    }
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SearchShiftsResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetShiftResponse>> get(GetShiftsRequest request) {
     ...
     * Returns a single <code>Shift</code> specified by <code>id</code>.
     */
    public CompletableFuture<SquareClientHttpResponse<GetShiftResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetShiftResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetShiftResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<UpdateShiftResponse>> update(UpdateShiftRequest request) {
     ...
     * set on each <code>Break</code>.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<UpdateShiftResponse>> update(
            UpdateShiftRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v2/labor/shifts")
                .addPathSegment(request.getId())
        ...
        CompletableFuture<SquareClientHttpResponse<UpdateShiftResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UpdateShiftResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteShiftResponse>> delete(DeleteShiftsRequest request) {
     ...
     * Deletes a <code>Shift</code>.
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteShiftResponse>> delete(
            DeleteShiftsRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v2/labor/shifts")
                .addPathSegment(request.getId())
        ...
        CompletableFuture<SquareClientHttpResponse<DeleteShiftResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DeleteShiftResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
