...
public class AsyncRawTeamMemberWagesClient {
    protected final ClientOptions clientOptions;

    public AsyncRawTeamMemberWagesClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<TeamMemberWage>>> list() {
    ...
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<TeamMemberWage>>> list(
        ...
        CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<TeamMemberWage>>> future =
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetTeamMemberWageResponse>> get(
    ...
    public CompletableFuture<SquareClientHttpResponse<GetTeamMemberWageResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetTeamMemberWageResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
