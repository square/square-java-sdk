...
public class RawBreakTypesClient {
    protected final ClientOptions clientOptions;

    public RawBreakTypesClient(ClientOptions clientOptions) {
     ...
     */
    public SquareClientHttpResponse<SyncPagingIterable<BreakType>> list() {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ListBreakTypesResponse parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListBreakTypesResponse.class);
                ...
                return new SquareClientHttpResponse<>(
                        new SyncPagingIterable<BreakType>(startingAfter.isPresent(), result, parsedResponse, () -> list(
     ...
     * is returned.</p>
     */
    public SquareClientHttpResponse<CreateBreakTypeResponse> create(CreateBreakTypeRequest request) {
     ...
     * is returned.</p>
     */
    public SquareClientHttpResponse<CreateBreakTypeResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateBreakTypeResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     */
    public SquareClientHttpResponse<GetBreakTypeResponse> get(GetBreakTypesRequest request) {
     ...
     * Returns a single <code>BreakType</code> specified by <code>id</code>.
     */
    public SquareClientHttpResponse<GetBreakTypeResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetBreakTypeResponse.class), response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
                    "Error with status code " + response.code(), response.code(), errorBody, response);
     ...
     */
    public SquareClientHttpResponse<UpdateBreakTypeResponse> update(UpdateBreakTypeRequest request) {
     ...
     * Updates an existing <code>BreakType</code>.
     */
    public SquareClientHttpResponse<UpdateBreakTypeResponse> update(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, UpdateBreakTypeResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     */
    public SquareClientHttpResponse<DeleteBreakTypeResponse> delete(DeleteBreakTypesRequest request) {
     ...
     * <p>A <code>BreakType</code> can be deleted even if it is referenced from a <code>Shift</code>.</p>
     */
    public SquareClientHttpResponse<DeleteBreakTypeResponse> delete(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DeleteBreakTypeResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
