...
public class AsyncGiftCardsClient {
    ...
    public CompletableFuture<SyncPagingIterable<GiftCard>> list(
        ...
        CompletableFuture<SyncPagingIterable<GiftCard>> future = new CompletableFuture<>();
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        ...
                        future.complete(new SyncPagingIterable<GiftCard>(startingAfter.isPresent(), result, () -> {
                            try {
    ...
    public CompletableFuture<CreateGiftCardResponse> create(
        ...
        CompletableFuture<CreateGiftCardResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<GetGiftCardFromGanResponse> getFromGan(
        ...
        CompletableFuture<GetGiftCardFromGanResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<GetGiftCardFromNonceResponse> getFromNonce(
        ...
        CompletableFuture<GetGiftCardFromNonceResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<LinkCustomerToGiftCardResponse> linkCustomer(
        ...
        CompletableFuture<LinkCustomerToGiftCardResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<UnlinkCustomerFromGiftCardResponse> unlinkCustomer(
        ...
        CompletableFuture<UnlinkCustomerFromGiftCardResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<GetGiftCardResponse> get(GetGiftCardsRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<GetGiftCardResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
