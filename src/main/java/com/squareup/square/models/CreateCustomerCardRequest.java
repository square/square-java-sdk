...
public class CreateCustomerCardRequest {
     ...
     * by the Square Payment Form when customers enter their card information. See [Embedding the
     * payment form](https://developer.squareup.com/docs/payment-form/payment-form-walkthrough) for
     * more information. __NOTE:__ Card nonces generated by digital wallets (e.g., Apple Pay) cannot
     * be used to create a customer card.
     ...
     * Square has verified the buyer identity.
     * @return Returns the String
     */
