...
public class RefundPaymentRequest {
     ...
     * The unique ID of the payment being refunded. Must not be provided if `unlinked=true`.
     ...
     * any of the following: A token generated by Web Payments SDK or RSDK2; a card-on-file
     * identifier. Required for requests specifying unlinked=true. Otherwise, if included when
     * `unlinked=false`, will throw an error.
     * @return Returns the Internal String
     */
     ...
     * `unlinked=true`. Otherwise, if included when `unlinked=false` or unset, will throw an error.
     * @return Returns the Internal String
     */
     ...
     * if the `destination_id` refers to a card on file created using the Customers API. Only
