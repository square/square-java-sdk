...
public class TipSettings {
     ...
     * the Square seller is active. In the United States and Canada, tipping options are presented
     * in whole dollar amounts for payments under $10 USD/CAD respectively. If set to true, the
     * `tip_percentages` settings is ignored. Defaults to false. To learn more about smart tipping,
     * see [Accept Tips with the Square
