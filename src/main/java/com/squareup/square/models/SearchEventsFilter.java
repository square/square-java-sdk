...
public class SearchEventsFilter {
    ...
    protected SearchEventsFilter(OptionalNullable<List<String>> eventTypes,
            OptionalNullable<List<String>> merchantIds, OptionalNullable<List<String>> locationIds,
            TimeRange createdAt) {
    ...
    public String toString() {
        return "SearchEventsFilter [" + "eventTypes=" + eventTypes + ", merchantIds=" + merchantIds
                + ", locationIds=" + locationIds + ", createdAt=" + createdAt + "]";
    }
