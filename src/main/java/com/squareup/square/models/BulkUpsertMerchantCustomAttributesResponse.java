...
public class BulkUpsertMerchantCustomAttributesResponse {
    ...
    public BulkUpsertMerchantCustomAttributesResponse(
            @JsonProperty("values") Map<String, BulkUpsertMerchantCustomAttributesResponseMerchantCustomAttributeUpsertResponse> values,
    ...
    public boolean equals(Object obj) {
        ...
        BulkUpsertMerchantCustomAttributesResponse other =
                (BulkUpsertMerchantCustomAttributesResponse) obj;
    ...
    public String toString() {
        return "BulkUpsertMerchantCustomAttributesResponse [" + "values=" + values + ", errors="
                + errors + "]";
    }
