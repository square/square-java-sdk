...
public class ListLocationBookingProfilesResponse {
    ...
    public String toString() {
        return "ListLocationBookingProfilesResponse [" + "locationBookingProfiles="
                + locationBookingProfiles + ", cursor=" + cursor + ", errors=" + errors + "]";
    }
    ...
    public static class Builder {
        ...
        public ListLocationBookingProfilesResponse build() {
            ListLocationBookingProfilesResponse model =
                    new ListLocationBookingProfilesResponse(locationBookingProfiles, cursor,
                            errors);
