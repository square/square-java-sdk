...
public class DeviceComponentDetailsApplicationDetails {
    ...
    public boolean equals(Object obj) {
        ...
        DeviceComponentDetailsApplicationDetails other =
                (DeviceComponentDetailsApplicationDetails) obj;
    ...
    public static class Builder {
        ...
        public DeviceComponentDetailsApplicationDetails build() {
            return new DeviceComponentDetailsApplicationDetails(applicationType, version,
                    sessionLocation, deviceCodeId);
        }
    }
}
