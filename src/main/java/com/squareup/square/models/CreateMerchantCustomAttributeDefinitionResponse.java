...
public class CreateMerchantCustomAttributeDefinitionResponse {
    ...
    public boolean equals(Object obj) {
        ...
        CreateMerchantCustomAttributeDefinitionResponse other =
                (CreateMerchantCustomAttributeDefinitionResponse) obj;
    ...
    public static class Builder {
        ...
        public CreateMerchantCustomAttributeDefinitionResponse build() {
            CreateMerchantCustomAttributeDefinitionResponse model =
                    new CreateMerchantCustomAttributeDefinitionResponse(customAttributeDefinition,
                            errors);
