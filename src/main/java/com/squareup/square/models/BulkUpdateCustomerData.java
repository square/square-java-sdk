...
/**
 * This is a model class for BulkUpdateCustomerData type.
 */
public class BulkUpdateCustomerData {
    ...
    protected BulkUpdateCustomerData(OptionalNullable<String> givenName,
            ...
            OptionalNullable<String> birthday, CustomerTaxIds taxIds, Long version) {
    ...
    public int hashCode() {
        return Objects.hash(givenName, familyName, companyName, nickname, emailAddress, address,
                phoneNumber, referenceId, note, birthday, taxIds, version);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BulkUpdateCustomerData)) {
            return false;
        }
        BulkUpdateCustomerData other = (BulkUpdateCustomerData) obj;
    ...
    /**
     * Converts this BulkUpdateCustomerData into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BulkUpdateCustomerData [" + "givenName=" + givenName + ", familyName=" + familyName
                ...
                + ", taxIds=" + taxIds + ", version=" + version + "]";
    }

    /**
     * Builds a new {@link BulkUpdateCustomerData.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BulkUpdateCustomerData.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BulkUpdateCustomerData}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link BulkUpdateCustomerData} object using the set fields.
         * @return {@link BulkUpdateCustomerData}
         */
        public BulkUpdateCustomerData build() {
            return new BulkUpdateCustomerData(givenName, familyName, companyName, nickname,
