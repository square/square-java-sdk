...
public class BulkDeleteMerchantCustomAttributesRequest {
    ...
    public BulkDeleteMerchantCustomAttributesRequest(
            @JsonProperty("values") Map<String, BulkDeleteMerchantCustomAttributesRequestMerchantCustomAttributeDeleteRequest> values) {
        this.values = values;
    }
    ...
    public boolean equals(Object obj) {
        ...
        BulkDeleteMerchantCustomAttributesRequest other =
                (BulkDeleteMerchantCustomAttributesRequest) obj;
