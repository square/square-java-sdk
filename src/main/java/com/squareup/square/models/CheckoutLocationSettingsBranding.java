...
public class CheckoutLocationSettingsBranding {
    ...
    protected CheckoutLocationSettingsBranding(String headerType,
            OptionalNullable<String> buttonColor, String buttonShape) {
        this.headerType = headerType;
    ...
    public String toString() {
        return "CheckoutLocationSettingsBranding [" + "headerType=" + headerType + ", buttonColor="
                + buttonColor + ", buttonShape=" + buttonShape + "]";
    }
