...
public class CatalogItemFoodAndBeverageDetails {
    ...
    public CatalogItemFoodAndBeverageDetails(
            ...
            @JsonProperty("dietary_preferences") List<CatalogItemFoodAndBeverageDetailsDietaryPreference> dietaryPreferences,
    ...
    protected CatalogItemFoodAndBeverageDetails(OptionalNullable<Integer> calorieCount,
    ...
    public static class Builder {
        ...
        public CatalogItemFoodAndBeverageDetails build() {
            return new CatalogItemFoodAndBeverageDetails(calorieCount, dietaryPreferences,
                    ingredients);
        }
    }
}
