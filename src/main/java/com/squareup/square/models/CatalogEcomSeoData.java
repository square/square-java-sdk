...
public class CatalogEcomSeoData {
    ...
    protected CatalogEcomSeoData(OptionalNullable<String> pageTitle,
            OptionalNullable<String> pageDescription, OptionalNullable<String> permalink) {
    ...
    public String toString() {
        return "CatalogEcomSeoData [" + "pageTitle=" + pageTitle + ", pageDescription="
                + pageDescription + ", permalink=" + permalink + "]";
    }
