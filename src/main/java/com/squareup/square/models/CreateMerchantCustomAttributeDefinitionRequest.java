...
public class CreateMerchantCustomAttributeDefinitionRequest {
    ...
    public boolean equals(Object obj) {
        ...
        CreateMerchantCustomAttributeDefinitionRequest other =
                (CreateMerchantCustomAttributeDefinitionRequest) obj;
    ...
    public static class Builder {
        ...
        public CreateMerchantCustomAttributeDefinitionRequest build() {
            return new CreateMerchantCustomAttributeDefinitionRequest(customAttributeDefinition,
                    idempotencyKey);
        }
    }
}
