...
public class InventoryPhysicalCount {
    ...
    /**
     * Getter for Id.
     * A unique ID generated by Square for the [InventoryPhysicalCount]($m/InventoryPhysicalCount).
    ...
    /**
     * Getter for Quantity.
     * The number of items affected by the physical count as a decimal string. Can support up to 5
     ...
     * The Square ID of the [Employee]($m/Employee) responsible for the physical count.
     * @return Returns the String
     */
     ...
     * A client-generated timestamp in RFC 3339 format that indicates when the physical count took
     ...
     * A read-only timestamp in RFC 3339 format that indicates when Square received the physical
     * count.
     * @return Returns the String
     */
