...
public class ListMerchantCustomAttributeDefinitionsRequest {
     ...
     */
    protected ListMerchantCustomAttributeDefinitionsRequest(String visibilityFilter,
    ...
    public boolean equals(Object obj) {
        ...
        ListMerchantCustomAttributeDefinitionsRequest other =
                (ListMerchantCustomAttributeDefinitionsRequest) obj;
    ...
    public String toString() {
        return "ListMerchantCustomAttributeDefinitionsRequest [" + "visibilityFilter="
    ...
    public static class Builder {
        ...
        public ListMerchantCustomAttributeDefinitionsRequest build() {
            return new ListMerchantCustomAttributeDefinitionsRequest(visibilityFilter, limit,
                    cursor);
        }
    }
}
