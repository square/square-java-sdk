...
public class CheckoutLocationSettings {
    ...
    protected CheckoutLocationSettings(OptionalNullable<String> locationId,
            OptionalNullable<Boolean> customerNotesEnabled,
            OptionalNullable<List<CheckoutLocationSettingsPolicy>> policies,
            CheckoutLocationSettingsBranding branding, CheckoutLocationSettingsTipping tipping,
            CheckoutLocationSettingsCoupons coupons, String updatedAt) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(locationId, customerNotesEnabled, policies, branding, tipping, coupons,
                updatedAt);
    }
    ...
    public static class Builder {
        ...
        public CheckoutLocationSettings build() {
            return new CheckoutLocationSettings(locationId, customerNotesEnabled, policies,
                    branding, tipping, coupons, updatedAt);
        }
    }
}
