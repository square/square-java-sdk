...
public class CategoryPathToRootNode {
    ...
    protected CategoryPathToRootNode(OptionalNullable<String> categoryId,
            OptionalNullable<String> categoryName) {
    ...
    public String toString() {
        return "CategoryPathToRootNode [" + "categoryId=" + categoryId + ", categoryName="
                + categoryName + "]";
    }
