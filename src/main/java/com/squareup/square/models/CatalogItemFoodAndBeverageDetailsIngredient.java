...
public class CatalogItemFoodAndBeverageDetailsIngredient {
    ...
    protected CatalogItemFoodAndBeverageDetailsIngredient(String type, String standardName,
    ...
    public boolean equals(Object obj) {
        ...
        CatalogItemFoodAndBeverageDetailsIngredient other =
                (CatalogItemFoodAndBeverageDetailsIngredient) obj;
    ...
    public String toString() {
        return "CatalogItemFoodAndBeverageDetailsIngredient [" + "type=" + type + ", standardName="
                + standardName + ", customName=" + customName + "]";
    }

    /**
     * Builds a new {@link CatalogItemFoodAndBeverageDetailsIngredient.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CatalogItemFoodAndBeverageDetailsIngredient.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CatalogItemFoodAndBeverageDetailsIngredient}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CatalogItemFoodAndBeverageDetailsIngredient} object using the set
         * fields.
         * @return {@link CatalogItemFoodAndBeverageDetailsIngredient}
         */
        public CatalogItemFoodAndBeverageDetailsIngredient build() {
            return new CatalogItemFoodAndBeverageDetailsIngredient(type, standardName, customName);
        }
    }
}
