...
public class UpdateMerchantCustomAttributeDefinitionRequest {
    ...
    public boolean equals(Object obj) {
        ...
        UpdateMerchantCustomAttributeDefinitionRequest other =
                (UpdateMerchantCustomAttributeDefinitionRequest) obj;
    ...
    public static class Builder {
        ...
        public UpdateMerchantCustomAttributeDefinitionRequest build() {
            return new UpdateMerchantCustomAttributeDefinitionRequest(customAttributeDefinition,
                    idempotencyKey);
        }
    }
}
