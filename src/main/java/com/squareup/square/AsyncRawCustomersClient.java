...
public class AsyncRawCustomersClient {
     ...
     * </ul>
     */
    public CompletableFuture<SquareClientHttpResponse<CreateCustomerResponse>> create(RequestOptions requestOptions) {
     ...
     * profiles can take closer to one minute or longer, especially during network incidents and outages.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<SearchCustomersResponse>> search(RequestOptions requestOptions) {
