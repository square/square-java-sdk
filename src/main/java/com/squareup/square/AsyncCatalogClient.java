...
public class AsyncCatalogClient {
     ...
     * and set the <code>include_deleted_objects</code> attribute value to <code>true</code>.</p>
     */
    public CompletableFuture<SyncPagingIterable<CatalogObject>> list(RequestOptions requestOptions) {
     ...
     * </ul>
     */
    public CompletableFuture<SearchCatalogItemsResponse> searchItems(RequestOptions requestOptions) {
