...
public class RawInvoicesClient {
     ...
     */
    public SquareClientHttpResponse<SyncPagingIterable<Invoice>> list(ListInvoicesRequest request) {
     ...
     * use in a subsequent request to retrieve the next set of invoices.
     */
    public SquareClientHttpResponse<SyncPagingIterable<Invoice>> list(
     ...
     */
    public SquareClientHttpResponse<CreateInvoiceResponse> create(CreateInvoiceRequest request) {
     ...
     * You must publish the invoice before Square can process it (send it to the customer's email address or charge the customer’s card on file).</p>
     */
    public SquareClientHttpResponse<CreateInvoiceResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateInvoiceResponse.class), response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
                    "Error with status code " + response.code(), response.code(), errorBody, response);
     ...
     */
    public SquareClientHttpResponse<GetInvoiceResponse> get(GetInvoicesRequest request) {
     ...
     * Retrieves an invoice by invoice ID.
     */
    public SquareClientHttpResponse<GetInvoiceResponse> get(GetInvoicesRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v2/invoices")
     ...
     */
    public SquareClientHttpResponse<UpdateInvoiceResponse> update(UpdateInvoiceRequest request) {
     ...
     * <code>order_id</code> or <code>location_id</code> field.
     */
    public SquareClientHttpResponse<UpdateInvoiceResponse> update(
     ...
     */
    public SquareClientHttpResponse<DeleteInvoiceResponse> delete(DeleteInvoicesRequest request) {
     ...
     * invoice (you cannot delete a published invoice, including one that is scheduled for processing).
     */
    public SquareClientHttpResponse<DeleteInvoiceResponse> delete(
     ...
     */
    public SquareClientHttpResponse<CreateInvoiceAttachmentResponse> createInvoiceAttachment(
    ...
    public SquareClientHttpResponse<CreateInvoiceAttachmentResponse> createInvoiceAttachment(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateInvoiceAttachmentResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     */
    public SquareClientHttpResponse<DeleteInvoiceAttachmentResponse> deleteInvoiceAttachment(
    ...
    public SquareClientHttpResponse<DeleteInvoiceAttachmentResponse> deleteInvoiceAttachment(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DeleteInvoiceAttachmentResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     */
    public SquareClientHttpResponse<CancelInvoiceResponse> cancel(CancelInvoiceRequest request) {
     ...
     * <p>You cannot cancel an invoice in the <code>DRAFT</code> state or in a terminal state: <code>PAID</code>, <code>REFUNDED</code>, <code>CANCELED</code>, or <code>FAILED</code>.</p>
     */
    public SquareClientHttpResponse<CancelInvoiceResponse> cancel(
     ...
     */
    public SquareClientHttpResponse<PublishInvoiceResponse> publish(PublishInvoiceRequest request) {
     ...
     * and <code>PAYMENTS_WRITE</code> are required when publishing invoices configured for card-on-file payments.</p>
     */
    public SquareClientHttpResponse<PublishInvoiceResponse> publish(
