...
public final class GetCustomAttributesRequest {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.locationId, this.key, this.withDefinition, this.version);
    }
    ...
    public static final class Builder implements LocationIdStage, KeyStage, _FinalStage {
        ...
        public GetCustomAttributesRequest build() {
            return new GetCustomAttributesRequest(locationId, key, withDefinition, version, additionalProperties);
        }
    }
}
