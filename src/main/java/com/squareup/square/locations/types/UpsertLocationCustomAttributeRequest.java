...
@JsonDeserialize(builder = UpsertLocationCustomAttributeRequest.Builder.class)
public final class UpsertLocationCustomAttributeRequest {
    ...
    private UpsertLocationCustomAttributeRequest(
            String locationId,
            String key,
     ...
     * If this is not important for your application, version can be set to -1.</li>
     * </ul>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpsertLocationCustomAttributeRequest
                && equalTo((UpsertLocationCustomAttributeRequest) other);
    }
    ...
    public interface LocationIdStage {
        ...
        Builder from(UpsertLocationCustomAttributeRequest other);
    }
    ...
    public interface _FinalStage {
        UpsertLocationCustomAttributeRequest build();
    ...
    public static final class Builder implements LocationIdStage, KeyStage, CustomAttributeStage, _FinalStage {
        ...
        public UpsertLocationCustomAttributeRequest build() {
            return new UpsertLocationCustomAttributeRequest(
                    locationId, key, customAttribute, idempotencyKey, additionalProperties);
        }
    }
}
