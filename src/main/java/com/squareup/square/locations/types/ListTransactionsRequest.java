...
public final class ListTransactionsRequest {
    ...
    /**
     * @return The ID of the location to list transactions for.
     */
    ...
    /**
     * @return The beginning of the requested reporting period, in RFC 3339 format.
    ...
    /**
     * @return The end of the requested reporting period, in RFC 3339 format.
     * <p>See <a href="https://developer.squareup.com/docs/build-basics/working-with-dates">Date ranges</a> for details on date inclusivity/exclusivity.</p>
    ...
    /**
     * @return The order in which results are listed in the response (<code>ASC</code> for
     * oldest first, <code>DESC</code> for newest first).
