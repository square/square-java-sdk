...
public class AsyncRawCustomAttributeDefinitionsClient {
                    ...
                    if (response.isSuccessful()) {
                        ListLocationCustomAttributeDefinitionsResponse parsedResponse =
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ListLocationCustomAttributeDefinitionsResponse.class);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<CreateLocationCustomAttributeDefinitionResponse>> create(
    ...
    public CompletableFuture<SquareClientHttpResponse<CreateLocationCustomAttributeDefinitionResponse>> create(
        ...
        CompletableFuture<SquareClientHttpResponse<CreateLocationCustomAttributeDefinitionResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CreateLocationCustomAttributeDefinitionResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<RetrieveLocationCustomAttributeDefinitionResponse>> get(
    ...
    public CompletableFuture<SquareClientHttpResponse<RetrieveLocationCustomAttributeDefinitionResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<RetrieveLocationCustomAttributeDefinitionResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, RetrieveLocationCustomAttributeDefinitionResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<UpdateLocationCustomAttributeDefinitionResponse>> update(
    ...
    public CompletableFuture<SquareClientHttpResponse<UpdateLocationCustomAttributeDefinitionResponse>> update(
        ...
        CompletableFuture<SquareClientHttpResponse<UpdateLocationCustomAttributeDefinitionResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, UpdateLocationCustomAttributeDefinitionResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteLocationCustomAttributeDefinitionResponse>> delete(
    ...
    public CompletableFuture<SquareClientHttpResponse<DeleteLocationCustomAttributeDefinitionResponse>> delete(
        ...
        CompletableFuture<SquareClientHttpResponse<DeleteLocationCustomAttributeDefinitionResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, DeleteLocationCustomAttributeDefinitionResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
