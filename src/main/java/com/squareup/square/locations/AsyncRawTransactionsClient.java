...
public class AsyncRawTransactionsClient {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<ListTransactionsResponse>> list(ListTransactionsRequest request) {
     ...
     * <p>Max results per <a href="https://developer.squareup.com/docs/working-with-apis/pagination">page</a>: 50</p>
     */
    public CompletableFuture<SquareClientHttpResponse<ListTransactionsResponse>> list(
        ...
        CompletableFuture<SquareClientHttpResponse<ListTransactionsResponse>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetTransactionResponse>> get(GetTransactionsRequest request) {
    ...
    public CompletableFuture<SquareClientHttpResponse<GetTransactionResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetTransactionResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<SquareClientHttpResponse<Void>> capture(CaptureTransactionsRequest request) {
        return capture(request, null);
    }

    public CompletableFuture<SquareClientHttpResponse<Void>> capture(
    ...
    public CompletableFuture<SquareClientHttpResponse<Void>> void_(VoidTransactionsRequest request) {
        return void_(request, null);
    }

    public CompletableFuture<SquareClientHttpResponse<Void>> void_(
