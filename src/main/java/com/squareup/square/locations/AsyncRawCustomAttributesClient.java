...
public class AsyncRawCustomAttributesClient {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<BulkDeleteLocationCustomAttributesResponse>> batchDelete(
    ...
    public CompletableFuture<SquareClientHttpResponse<BulkDeleteLocationCustomAttributesResponse>> batchDelete(
        ...
        CompletableFuture<SquareClientHttpResponse<BulkDeleteLocationCustomAttributesResponse>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, BulkDeleteLocationCustomAttributesResponse.class),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<BulkUpsertLocationCustomAttributesResponse>> batchUpsert(
    ...
    public CompletableFuture<SquareClientHttpResponse<BulkUpsertLocationCustomAttributesResponse>> batchUpsert(
        ...
        CompletableFuture<SquareClientHttpResponse<BulkUpsertLocationCustomAttributesResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, BulkUpsertLocationCustomAttributesResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ListLocationCustomAttributesResponse parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, ListLocationCustomAttributesResponse.class);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<RetrieveLocationCustomAttributeResponse>> get(
    ...
    public CompletableFuture<SquareClientHttpResponse<RetrieveLocationCustomAttributeResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<RetrieveLocationCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, RetrieveLocationCustomAttributeResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * must be <code>VISIBILITY_READ_WRITE_VALUES</code>.
     */
    public CompletableFuture<SquareClientHttpResponse<UpsertLocationCustomAttributeResponse>> upsert(
    ...
    public CompletableFuture<SquareClientHttpResponse<UpsertLocationCustomAttributeResponse>> upsert(
        ...
        CompletableFuture<SquareClientHttpResponse<UpsertLocationCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, UpsertLocationCustomAttributeResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * <code>VISIBILITY_READ_WRITE_VALUES</code>.
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteLocationCustomAttributeResponse>> delete(
    ...
    public CompletableFuture<SquareClientHttpResponse<DeleteLocationCustomAttributeResponse>> delete(
        ...
        CompletableFuture<SquareClientHttpResponse<DeleteLocationCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, DeleteLocationCustomAttributeResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
