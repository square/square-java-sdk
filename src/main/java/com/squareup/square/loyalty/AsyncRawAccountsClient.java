...
public class AsyncRawAccountsClient {
    ...
    public CompletableFuture<SquareClientHttpResponse<CreateLoyaltyAccountResponse>> create(
        ...
        CompletableFuture<SquareClientHttpResponse<CreateLoyaltyAccountResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CreateLoyaltyAccountResponse.class),
                                response));
                        return;
                    }
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, SearchLoyaltyAccountsResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetLoyaltyAccountResponse>> get(GetAccountsRequest request) {
    ...
    public CompletableFuture<SquareClientHttpResponse<GetLoyaltyAccountResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetLoyaltyAccountResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetLoyaltyAccountResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
    ...
    public CompletableFuture<SquareClientHttpResponse<AccumulateLoyaltyPointsResponse>> accumulatePoints(
        ...
        CompletableFuture<SquareClientHttpResponse<AccumulateLoyaltyPointsResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, AccumulateLoyaltyPointsResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
    ...
    public CompletableFuture<SquareClientHttpResponse<AdjustLoyaltyPointsResponse>> adjust(
        ...
        CompletableFuture<SquareClientHttpResponse<AdjustLoyaltyPointsResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, AdjustLoyaltyPointsResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
