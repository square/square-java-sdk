...
public class AsyncRewardsClient {
    ...
    public CompletableFuture<CreateLoyaltyRewardResponse> create(
        ...
        CompletableFuture<CreateLoyaltyRewardResponse> future = new CompletableFuture<>();
    ...
    public CompletableFuture<SearchLoyaltyRewardsResponse> search(
        ...
        CompletableFuture<SearchLoyaltyRewardsResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<GetLoyaltyRewardResponse> get(GetRewardsRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<GetLoyaltyRewardResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<DeleteLoyaltyRewardResponse> delete(
        ...
        CompletableFuture<DeleteLoyaltyRewardResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<RedeemLoyaltyRewardResponse> redeem(
        ...
        CompletableFuture<RedeemLoyaltyRewardResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
