...
public class RawPromotionsClient {
     ...
     * Results are sorted by the <code>created_at</code> date in descending order (newest to oldest).
     */
    public SquareClientHttpResponse<SyncPagingIterable<LoyaltyPromotion>> list(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                ListLoyaltyPromotionsResponse parsedResponse =
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListLoyaltyPromotionsResponse.class);
                ...
                return new SquareClientHttpResponse<>(
                        new SyncPagingIterable<LoyaltyPromotion>(
     ...
     * <code>ACTIVE</code> or <code>SCHEDULED</code> status.</p>
     */
    public SquareClientHttpResponse<CreateLoyaltyPromotionResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateLoyaltyPromotionResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     * Retrieves a loyalty promotion.
     */
    public SquareClientHttpResponse<GetLoyaltyPromotionResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetLoyaltyPromotionResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     * <p>This endpoint sets the loyalty promotion to the <code>CANCELED</code> state</p>
     */
    public SquareClientHttpResponse<CancelLoyaltyPromotionResponse> cancel(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CancelLoyaltyPromotionResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
