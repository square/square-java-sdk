...
public class RawRewardsClient {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateLoyaltyRewardResponse.class),
                        response);
            }
     ...
     * <p>Search results are sorted by <code>updated_at</code> in descending order.</p>
     */
    public SquareClientHttpResponse<SearchLoyaltyRewardsResponse> search(RequestOptions requestOptions) {
        return search(SearchLoyaltyRewardsRequest.builder().build(), requestOptions);
    }
    ...
    public SquareClientHttpResponse<GetLoyaltyRewardResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetLoyaltyRewardResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
    ...
    public SquareClientHttpResponse<DeleteLoyaltyRewardResponse> delete(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DeleteLoyaltyRewardResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
    ...
    public SquareClientHttpResponse<RedeemLoyaltyRewardResponse> redeem(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, RedeemLoyaltyRewardResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
