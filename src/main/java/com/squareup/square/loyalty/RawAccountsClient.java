...
public class RawAccountsClient {
     ...
     */
    public SquareClientHttpResponse<CreateLoyaltyAccountResponse> create(CreateLoyaltyAccountRequest request) {
     ...
     * Creates a loyalty account. To create a loyalty account, you must provide the <code>program_id</code> and a <code>mapping</code> with the <code>phone_number</code> of the buyer.
     */
    public SquareClientHttpResponse<CreateLoyaltyAccountResponse> create(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateLoyaltyAccountResponse.class),
                        response);
            }
     ...
     * <p>Search results are sorted by <code>created_at</code> in ascending order.</p>
     */
    public SquareClientHttpResponse<SearchLoyaltyAccountsResponse> search(RequestOptions requestOptions) {
        return search(SearchLoyaltyAccountsRequest.builder().build(), requestOptions);
    }
    ...
    public SquareClientHttpResponse<SearchLoyaltyAccountsResponse> search(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SearchLoyaltyAccountsResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     */
    public SquareClientHttpResponse<GetLoyaltyAccountResponse> get(GetAccountsRequest request) {
     ...
     * Retrieves a loyalty account.
     */
    public SquareClientHttpResponse<GetLoyaltyAccountResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetLoyaltyAccountResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     * </ul>
     */
    public SquareClientHttpResponse<AccumulateLoyaltyPointsResponse> accumulatePoints(
    ...
    public SquareClientHttpResponse<AccumulateLoyaltyPointsResponse> accumulatePoints(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AccumulateLoyaltyPointsResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
     ...
     */
    public SquareClientHttpResponse<AdjustLoyaltyPointsResponse> adjust(AdjustLoyaltyPointsRequest request) {
     ...
     * to add points when a buyer pays for the purchase.</p>
     */
    public SquareClientHttpResponse<AdjustLoyaltyPointsResponse> adjust(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AdjustLoyaltyPointsResponse.class),
                        response);
            }
            Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            throw new SquareApiException(
