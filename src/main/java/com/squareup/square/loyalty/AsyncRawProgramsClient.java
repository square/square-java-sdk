...
public class AsyncRawProgramsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawProgramsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<ListLoyaltyProgramsResponse>> list() {
        return list(null);
    }
    ...
    public CompletableFuture<SquareClientHttpResponse<ListLoyaltyProgramsResponse>> list(
        ...
        CompletableFuture<SquareClientHttpResponse<ListLoyaltyProgramsResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ListLoyaltyProgramsResponse.class),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetLoyaltyProgramResponse>> get(GetProgramsRequest request) {
     ...
     * <p>Loyalty programs define how buyers can earn points and redeem points for rewards. Square sellers can have only one loyalty program, which is created and managed from the Seller Dashboard. For more information, see <a href="https://developer.squareup.com/docs/loyalty/overview">Loyalty Program Overview</a>.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<GetLoyaltyProgramResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetLoyaltyProgramResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, GetLoyaltyProgramResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * </ul>
     */
    public CompletableFuture<SquareClientHttpResponse<CalculateLoyaltyPointsResponse>> calculate(
    ...
    public CompletableFuture<SquareClientHttpResponse<CalculateLoyaltyPointsResponse>> calculate(
        ...
        CompletableFuture<SquareClientHttpResponse<CalculateLoyaltyPointsResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CalculateLoyaltyPointsResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
