...
public class AsyncSubscriptionsClient {
    ...
    public CompletableFuture<SyncPagingIterable<WebhookSubscription>> list(
        ...
        CompletableFuture<SyncPagingIterable<WebhookSubscription>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<CreateWebhookSubscriptionResponse> create(
        ...
        CompletableFuture<CreateWebhookSubscriptionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<GetWebhookSubscriptionResponse> get(
        ...
        CompletableFuture<GetWebhookSubscriptionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<UpdateWebhookSubscriptionResponse> update(
        ...
        CompletableFuture<UpdateWebhookSubscriptionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<DeleteWebhookSubscriptionResponse> delete(
        ...
        CompletableFuture<DeleteWebhookSubscriptionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<UpdateWebhookSubscriptionSignatureKeyResponse> updateSignatureKey(
        ...
        CompletableFuture<UpdateWebhookSubscriptionSignatureKeyResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<TestWebhookSubscriptionResponse> test(
        ...
        CompletableFuture<TestWebhookSubscriptionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
