...
public class RawWageSettingClient {
    protected final ClientOptions clientOptions;

    public RawWageSettingClient(ClientOptions clientOptions) {
     ...
     */
    public SquareClientHttpResponse<GetWageSettingResponse> get(GetWageSettingRequest request) {
     ...
     * to get this information directly from the <code>TeamMember.wage_setting</code> field.</p>
     */
    public SquareClientHttpResponse<GetWageSettingResponse> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), GetWageSettingResponse.class),
                        response);
            }
     ...
     */
    public SquareClientHttpResponse<UpdateWageSettingResponse> update(UpdateWageSettingRequest request) {
     ...
     * to manage the <code>TeamMember.wage_setting</code> field directly.</p>
     */
    public SquareClientHttpResponse<UpdateWageSettingResponse> update(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), UpdateWageSettingResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new SquareApiException(
