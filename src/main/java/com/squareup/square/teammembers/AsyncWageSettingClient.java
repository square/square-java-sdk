...
public class AsyncWageSettingClient {
    ...
    public CompletableFuture<GetWageSettingResponse> get(GetWageSettingRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<GetWageSettingResponse> future = new CompletableFuture<>();
     ...
     * to manage the <code>TeamMember.wage_setting</code> field directly.</p>
     */
    public CompletableFuture<UpdateWageSettingResponse> update(
        ...
        CompletableFuture<UpdateWageSettingResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
