...
public class ApplePayClient {
    ...
    public RegisterDomainResponse registerDomain(RegisterDomainRequest request) {
        return this.rawClient.registerDomain(request).body();
    }
     ...
     * <p>To learn more about the Web Payments SDK and how to add Apple Pay, see <a href="https://developer.squareup.com/docs/web-payments/apple-pay">Take an Apple Pay Payment</a>.</p>
     */
    public RegisterDomainResponse registerDomain(RegisterDomainRequest request, RequestOptions requestOptions) {
        return this.rawClient.registerDomain(request, requestOptions).body();
    }
}
