...
public class AsyncRawSubscriptionsClient {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<CreateSubscriptionResponse>> create(
    ...
    public CompletableFuture<SquareClientHttpResponse<CreateSubscriptionResponse>> create(
        ...
        CompletableFuture<SquareClientHttpResponse<CreateSubscriptionResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CreateSubscriptionResponse.class),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<BulkSwapPlanResponse>> bulkSwapPlan(BulkSwapPlanRequest request) {
     ...
     * variation. For more information, see <a href="https://developer.squareup.com/docs/subscriptions-api/swap-plan-variations">Swap Subscription Plan Variations</a>.
     */
    public CompletableFuture<SquareClientHttpResponse<BulkSwapPlanResponse>> bulkSwapPlan(
        ...
        CompletableFuture<SquareClientHttpResponse<BulkSwapPlanResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, BulkSwapPlanResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, SearchSubscriptionsResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<GetSubscriptionResponse>> get(GetSubscriptionsRequest request) {
     ...
     * Retrieves a specific subscription.
     */
    public CompletableFuture<SquareClientHttpResponse<GetSubscriptionResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<GetSubscriptionResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetSubscriptionResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<UpdateSubscriptionResponse>> update(
    ...
    public CompletableFuture<SquareClientHttpResponse<UpdateSubscriptionResponse>> update(
        ...
        CompletableFuture<SquareClientHttpResponse<UpdateSubscriptionResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteSubscriptionActionResponse>> deleteAction(
    ...
    public CompletableFuture<SquareClientHttpResponse<DeleteSubscriptionActionResponse>> deleteAction(
        ...
        CompletableFuture<SquareClientHttpResponse<DeleteSubscriptionActionResponse>> future =
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, DeleteSubscriptionActionResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * for a subscription.
     */
    public CompletableFuture<SquareClientHttpResponse<ChangeBillingAnchorDateResponse>> changeBillingAnchorDate(
    ...
    public CompletableFuture<SquareClientHttpResponse<ChangeBillingAnchorDateResponse>> changeBillingAnchorDate(
        ...
        CompletableFuture<SquareClientHttpResponse<ChangeBillingAnchorDateResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ChangeBillingAnchorDateResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<CancelSubscriptionResponse>> cancel(
    ...
    public CompletableFuture<SquareClientHttpResponse<CancelSubscriptionResponse>> cancel(
        ...
        CompletableFuture<SquareClientHttpResponse<CancelSubscriptionResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CancelSubscriptionResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<SubscriptionEvent>>> listEvents(
    ...
    public CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<SubscriptionEvent>>> listEvents(
        ...
        CompletableFuture<SquareClientHttpResponse<SyncPagingIterable<SubscriptionEvent>>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ListSubscriptionEventsResponse parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, ListSubscriptionEventsResponse.class);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<PauseSubscriptionResponse>> pause(
    ...
    public CompletableFuture<SquareClientHttpResponse<PauseSubscriptionResponse>> pause(
        ...
        CompletableFuture<SquareClientHttpResponse<PauseSubscriptionResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, PauseSubscriptionResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<ResumeSubscriptionResponse>> resume(
    ...
    public CompletableFuture<SquareClientHttpResponse<ResumeSubscriptionResponse>> resume(
        ...
        CompletableFuture<SquareClientHttpResponse<ResumeSubscriptionResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ResumeSubscriptionResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<SwapPlanResponse>> swapPlan(SwapPlanRequest request) {
     ...
     * For more information, see <a href="https://developer.squareup.com/docs/subscriptions-api/swap-plan-variations">Swap Subscription Plan Variations</a>.
     */
    public CompletableFuture<SquareClientHttpResponse<SwapPlanResponse>> swapPlan(
            SwapPlanRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v2/subscriptions")
                .addPathSegment(request.getSubscriptionId())
        ...
        CompletableFuture<SquareClientHttpResponse<SwapPlanResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SwapPlanResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
