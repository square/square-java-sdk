...
public class RawPaymentsClient {
     ...
     * <code>Payment</code> object and returns it in the response.</p>
     */
    public SquareClientHttpResponse<CreatePaymentResponse> create(
     ...
     */
    public SquareClientHttpResponse<CancelPaymentByIdempotencyKeyResponse> cancelByIdempotencyKey(
     ...
     * You can update the <code>amount_money</code> and <code>tip_money</code> using this endpoint.
     */
    public SquareClientHttpResponse<UpdatePaymentResponse> update(
     ...
     * the APPROVED <code>status</code>.
     */
    public SquareClientHttpResponse<CancelPaymentResponse> cancel(
     ...
     * <p>You can use this endpoint to complete a payment with the APPROVED <code>status</code>.</p>
     */
    public SquareClientHttpResponse<CompletePaymentResponse> complete(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CompletePaymentResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new SquareApiException(
