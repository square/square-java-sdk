...
public class RawOAuthClient {
     ...
     */
    public SquareClientHttpResponse<RevokeTokenResponse> revokeToken() {
     ...
     * page for your application in the Developer Dashboard.</p>
     */
    public SquareClientHttpResponse<RevokeTokenResponse> revokeToken(RequestOptions requestOptions) {
     ...
     * page for your application in the Developer Dashboard.</p>
     */
    public SquareClientHttpResponse<RevokeTokenResponse> revokeToken(RevokeTokenRequest request) {
     ...
     */
    public SquareClientHttpResponse<ObtainTokenResponse> obtainToken(ObtainTokenRequest request) {
     ...
     * Application clients should never interact directly with OAuth tokens.</p>
     */
    public SquareClientHttpResponse<ObtainTokenResponse> obtainToken(
     ...
     */
    public SquareClientHttpResponse<RetrieveTokenStatusResponse> retrieveTokenStatus() {
     ...
     * <p>If the access token is expired or not a valid access token, the endpoint returns an <code>UNAUTHORIZED</code> error.</p>
     */
    public SquareClientHttpResponse<RetrieveTokenStatusResponse> retrieveTokenStatus(RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
    ...
    public SquareClientHttpResponse<Void> authorize() {
        return authorize(null);
    }

    public SquareClientHttpResponse<Void> authorize(RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
