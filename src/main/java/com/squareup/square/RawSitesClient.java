...
public class RawSitesClient {
    protected final ClientOptions clientOptions;

    public RawSitesClient(ClientOptions clientOptions) {
     ...
     */
    public SquareClientHttpResponse<ListSitesResponse> list() {
        return list(null);
    }
     ...
     * <p><strong>Note:</strong> Square Online APIs are publicly available as part of an early access program. For more information, see <a href="https://developer.squareup.com/docs/online-api#early-access-program-for-square-online-apis">Early access program for Square Online APIs</a>.</p>
     */
    public SquareClientHttpResponse<ListSitesResponse> list(RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SquareClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), ListSitesResponse.class), response);
            }
