...
public class AsyncCustomAttributeDefinitionsClient {
    ...
    public CompletableFuture<CreateMerchantCustomAttributeDefinitionResponse> create(
        ...
        CompletableFuture<CreateMerchantCustomAttributeDefinitionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<RetrieveMerchantCustomAttributeDefinitionResponse> get(
        ...
        CompletableFuture<RetrieveMerchantCustomAttributeDefinitionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<UpdateMerchantCustomAttributeDefinitionResponse> update(
        ...
        CompletableFuture<UpdateMerchantCustomAttributeDefinitionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<DeleteMerchantCustomAttributeDefinitionResponse> delete(
        ...
        CompletableFuture<DeleteMerchantCustomAttributeDefinitionResponse> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
