...
public class AsyncRawCustomAttributesClient {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<BulkDeleteMerchantCustomAttributesResponse>> batchDelete(
    ...
    public CompletableFuture<SquareClientHttpResponse<BulkDeleteMerchantCustomAttributesResponse>> batchDelete(
        ...
        CompletableFuture<SquareClientHttpResponse<BulkDeleteMerchantCustomAttributesResponse>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, BulkDeleteMerchantCustomAttributesResponse.class),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<BulkUpsertMerchantCustomAttributesResponse>> batchUpsert(
    ...
    public CompletableFuture<SquareClientHttpResponse<BulkUpsertMerchantCustomAttributesResponse>> batchUpsert(
        ...
        CompletableFuture<SquareClientHttpResponse<BulkUpsertMerchantCustomAttributesResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, BulkUpsertMerchantCustomAttributesResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
                ...
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        ListMerchantCustomAttributesResponse parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, ListMerchantCustomAttributesResponse.class);
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<RetrieveMerchantCustomAttributeResponse>> get(
    ...
    public CompletableFuture<SquareClientHttpResponse<RetrieveMerchantCustomAttributeResponse>> get(
        ...
        CompletableFuture<SquareClientHttpResponse<RetrieveMerchantCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, RetrieveMerchantCustomAttributeResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * must be <code>VISIBILITY_READ_WRITE_VALUES</code>.
     */
    public CompletableFuture<SquareClientHttpResponse<UpsertMerchantCustomAttributeResponse>> upsert(
    ...
    public CompletableFuture<SquareClientHttpResponse<UpsertMerchantCustomAttributeResponse>> upsert(
        ...
        CompletableFuture<SquareClientHttpResponse<UpsertMerchantCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, UpsertMerchantCustomAttributeResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * <code>VISIBILITY_READ_WRITE_VALUES</code>.
     */
    public CompletableFuture<SquareClientHttpResponse<DeleteMerchantCustomAttributeResponse>> delete(
    ...
    public CompletableFuture<SquareClientHttpResponse<DeleteMerchantCustomAttributeResponse>> delete(
        ...
        CompletableFuture<SquareClientHttpResponse<DeleteMerchantCustomAttributeResponse>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, DeleteMerchantCustomAttributeResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
