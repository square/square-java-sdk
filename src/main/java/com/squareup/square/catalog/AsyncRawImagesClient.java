...
public class AsyncRawImagesClient {
    protected final ClientOptions clientOptions;

    public AsyncRawImagesClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<SquareClientHttpResponse<CreateCatalogImageResponse>> create() {
     ...
     * JPEG, PJPEG, PNG, or GIF format. The maximum file size is 15MB.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<CreateCatalogImageResponse>> create(CreateImagesRequest request) {
    ...
    public CompletableFuture<SquareClientHttpResponse<CreateCatalogImageResponse>> create(
        ...
        CompletableFuture<SquareClientHttpResponse<CreateCatalogImageResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CreateCatalogImageResponse.class),
                                response));
                        return;
                    }
     ...
     * JPEG, PJPEG, PNG, or GIF format. The maximum file size is 15MB.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<UpdateCatalogImageResponse>> update(UpdateImagesRequest request) {
     ...
     * JPEG, PJPEG, PNG, or GIF format. The maximum file size is 15MB.</p>
     */
    public CompletableFuture<SquareClientHttpResponse<UpdateCatalogImageResponse>> update(
        ...
        CompletableFuture<SquareClientHttpResponse<UpdateCatalogImageResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SquareClientHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, UpdateCatalogImageResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
