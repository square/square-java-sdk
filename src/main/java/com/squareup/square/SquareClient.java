...
import com.squareup.square.api.DefaultEventsApi;
...
public final class SquareClient implements SquareClientInterface {
    ...
    private static String userAgent = "Square-Java-SDK/40.1.1.20240717 ({api-version}) {engine}/{engine-version} ({os-info}) {detail}";
